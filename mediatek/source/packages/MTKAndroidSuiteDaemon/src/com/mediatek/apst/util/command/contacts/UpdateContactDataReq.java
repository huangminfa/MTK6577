...
/**
 * Class Name: UpdateContactDataReq
 * <p>Package: com.mediatek.apst.util.command.contacts
 * <p>Created on: 2010-12-18
 * <p>
 * <p>Description: 
 * <p>Request for updating a contact data.
 * <p>
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class UpdateContactDataReq extends RequestCommand {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    private ContactData newOne;
    
    //==============================================================
    // Constructors                                                 
    //==============================================================
    public UpdateContactDataReq(){
    ...
    public void setNewOne(ContactData newOne){
        this.newOne = newOne;
    }
