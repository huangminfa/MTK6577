...
public abstract class DeviceListPreferenceFragment extends
    ...
    public void onBluetoothStateChanged(int bluetoothState) {
        if (bluetoothState == BluetoothAdapter.STATE_TURNING_OFF) {
            ...
            Log.d(PERFORMANCE_TAG, "[Performance test][Settings][Bt] Bluetooth disable end ["+ disableEndTime +"]"); 
        } else if(bluetoothState == BluetoothAdapter.STATE_ON){
            long enableEndTime = System.currentTimeMillis();
            Log.d(PERFORMANCE_TAG, "[Performance test][Settings][Bt] Bluetooth enable end ["+ enableEndTime +"]");
        }
    }
}
