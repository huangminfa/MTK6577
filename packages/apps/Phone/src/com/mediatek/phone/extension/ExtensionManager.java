...
import com.mediatek.phone.extension.rcse.InCallScreenRCSeExtension;
...
public class ExtensionManager {
    ...
    //private InCallScreenExtension mInCallScreenExtension;
    ...
    /*public InCallScreenExtension getInCallScreenExtension() {
        return mInCallScreenExtension;
    } */

    public InCallScreenExtension createInCallScreenExtension(Context context) {
        if (InCallScreenRCSeExtension.isSupport(context)) {
            log("create InCallScreenRCSeExtension");
            return new InCallScreenRCSeExtension();
        } else {
            log("create default InCallScreenExtension");
