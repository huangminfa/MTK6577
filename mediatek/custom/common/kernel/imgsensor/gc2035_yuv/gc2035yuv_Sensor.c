...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xf8 , 0x87);
	GC2035_write_cmos_sensor(0xfe , 0x00);
	...
	GC2035_write_cmos_sensor(0x2e , 0xa2);                               
	GC2035_write_cmos_sensor(0x2f , 0x10);//level4                       
	GC2035_write_cmos_sensor(0x30 , 0x67);                               
	GC2035_write_cmos_sensor(0x3e , 0x40);//max level                       
	GC2035_write_cmos_sensor(0xfe , 0x00);           
...
*/
	...
	GC2035_write_cmos_sensor(0x03 , 0x05);
	GC2035_write_cmos_sensor(0x04 , 0x2e); 
	GC2035_write_cmos_sensor(0x84 , 0x01); //YUV
	GC2035_write_cmos_sensor(0x86 , 0x02); //sync 
	...
	GC2035_write_cmos_sensor(0x4e , 0x10);//cwf
	...
	///====YCP
	GC2035_write_cmos_sensor(0xd1 , 0x38);  //saturation
	GC2035_write_cmos_sensor(0xd2 , 0x38);  //saturation
...
UINT32 GC2035Capture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
		volatile kal_uint32 shutter = 0, temp_reg;
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x2b,0x06);//level2
		GC2035_write_cmos_sensor(0x2c,0xe8);
		GC2035_write_cmos_sensor(0x2d,0x08);//6e8//level3
		GC2035_write_cmos_sensor(0x2e,0xa2);
		GC2035_write_cmos_sensor(0x2f,0x10);//level4
		GC2035_write_cmos_sensor(0x30,0x67);
		GC2035_SET_PAGE0;
