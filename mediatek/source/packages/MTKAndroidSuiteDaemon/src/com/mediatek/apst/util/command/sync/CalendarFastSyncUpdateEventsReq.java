...
public class CalendarFastSyncUpdateEventsReq extends RawBlockRequest {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    // Constructors                                                 
    //==============================================================
    public CalendarFastSyncUpdateEventsReq(){
    ...
    public static class Builder extends RawBlockRequest.Builder {
        ...
        protected RawBlockRequest onCreateCommand(int featureId){
            return new CalendarFastSyncUpdateEventsReq();
        }
        ...
        public CalendarFastSyncUpdateEventsReq build(){
            ...
            return (CalendarFastSyncUpdateEventsReq)super.build();
        }
