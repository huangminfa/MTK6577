...
public class ThreePaneLayout extends LinearLayout implements View.OnClickListener {
    ...
    /**
     * A view where the MessaageList is visible. Currently only used when searching mails
     */
    private static final int STATE_MIDDLE_VISIBLE = 3;
    ...
    protected void onFinishInflate() {
        ...
        if (!isPaneCollapsible()) {
            ...
            mShowHideViews = new View[][][] {
                    ...
                    // STATE_MIDDLE_VISIBLE
                    {
                        {mMiddlePane},  //Visible
                        {mRightPane, mMessageCommandButtons, mFoggedGlass, mLeftPane},  // Invisible
                        {}, // Gone
                    }
            };
        }
...
//        final Resources resources = getResources();
    ...
    /**
     * Show the middle pane. (i.e. message list)
     */
    public boolean showMiddlePane() {
        return changePaneState(STATE_MIDDLE_VISIBLE, true);
    }
        ...
        if (!isPaneCollapsible()) {
            ...
            switch (mPaneState) {
                ...
                case STATE_RIGHT_VISIBLE:
                    ...
                    expectedMessageListWidth = mMessageListWidth;
                    break;
                case STATE_MIDDLE_VISIBLE:
                    animatorLabel = "moving to [message list]";
                    expectedMailboxLeft = -mMailboxListWidth;
                    expectedMessageListWidth = getResources().getDimensionPixelSize(R.dimen.message_list_width_full);
                    break;
                default:
                    throw new IllegalStateException();
            }
