...
public class InputMethodService extends AbstractInputMethodService {
    ...
    public boolean sendDefaultEditorAction(boolean fromEnterKey) {
        ...
        if (ei != null &&
            ...
            InputConnection ic = getCurrentInputConnection();
            if (ic != null) {
                /** M: If user pressed enter key finish the action mode.@{ **/
                if (mShowInputRequested
                        && isExtractViewShown()
                        && mExtractView instanceof ExtractEditLayout
                        && (ei.imeOptions&EditorInfo.IME_MASK_ACTION) == EditorInfo.IME_ACTION_DONE) {
                    ExtractEditLayout extractEditLayout = (ExtractEditLayout) mExtractView;
                    if (extractEditLayout.isActionModeStarted()) {
