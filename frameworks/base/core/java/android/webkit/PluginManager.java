...
public class PluginManager {
    ...
    private static final String SIGNATURE_MTK ="";
    ...
    String[] getPluginDirectories() {
        ...
        synchronized(mPackageInfoCache) {
            ...
            for (ResolveInfo info : plugins) {
                ...
                // IPackageManager.performDexOpt() only can be called
                // from UI thread in ICS. So if call this function here, 
                // will cause exception. Because it is in WebViewCoreThread
                // ensurePackageDexOpt(pkgInfo.packageName);
	...
	void ensurePackageDexOpt(String packageName) {
		...
		try {
			if(!ipm.performDexOpt(packageName))
			{
				Xlog.d(XLOGTAG,"plugin performDexOpt not work, " + packageName);
			}
			else
			{
				Xlog.d(XLOGTAG,"plugin performDexOpt done, " + packageName);
			}
		} catch(RemoteException e) {
				Xlog.e(XLOGTAG,"plugin performDexOpt exception occur");
		}
	}
}
