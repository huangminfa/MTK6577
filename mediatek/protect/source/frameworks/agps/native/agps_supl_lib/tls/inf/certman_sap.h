...
/*------------ MSG_ID_CERTMAN_MSG_CODE_BEGIN ---------------*/
    ...
    *  index 2 the label of the issuer at index 1… and so on, until at index size-1 the label of the root CA for this chain.
    *
...
/* DOM-NOT_FOR_SDK_BEGIN */
    ...
    MSG_ID_CERTMAN_CODE_END = MSG_ID_CERTMAN_EXPORT_CNF,
