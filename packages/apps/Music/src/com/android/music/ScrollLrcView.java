...
public class ScrollLrcView extends ScrollView {
     ...
     * static members
     */
    private static final String TAG = "ScrollLrcView";
    ...
    public ScrollLrcView(Context context) {
        this(context, null);
        MusicLogUtils.v(TAG, "constructed with (Context)");
    }
    ...
    public ScrollLrcView(Context context, AttributeSet attrs) {
        ...
        resetLrcState();
        MusicLogUtils.v(TAG, "constructed with (Context, AttributeSet)");
    }
    ...
    public ScrollLrcView(Context context, AttributeSet attrs, int defStyle) {
        ...
        resetLrcState();
        MusicLogUtils.v(TAG, "constructed with (Context, AttributeSet, int)");
    }
    ...
    public boolean isSameFile(String file) {
        return file.equals(mLastTrack);
    }
