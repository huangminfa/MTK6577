 ...
 *      Created On:			May 2004
 *
 *      Version:			$Id: //depot/main/os/win/32/syncml/xpt/bindings/common/tcp/xptitcp.h#3 $
 *
...
/**
 * @file
 * SyncML Communication Protocol selection module
 *
 * @target_system   win
 * @target_os       win
 * @description This module contains Windows specific definitions for the
