...
public class MediaGetStorageStateRsp extends ResponseCommand{
    ...
    /*
     * storageState[0] means internal emmc state
     * storageState[1] means external SDCard state
     */
    ...
    public MediaGetStorageStateRsp(int requestToken) {
