...
/**
 * Class Name: ImportSmsRsp
 * <p>Package: com.mediatek.apst.util.command.message
 * <p>Created on: 2010-12-18
 * <p>
 * <p>Description: 
 * <p>Response for importing multiple SMS messages.
 * <p>
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class ImportSmsRsp extends ResponseCommand {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    // Constructors                                                 
    //==============================================================
    public ImportSmsRsp(int token){
        super(FEATURE_MESSAGE, token);
    }
