...
** setting, define PVLOGGER_ANDROIDLOG_LEVEL in the osclconfig.h file.
** Possible values and the resulting intrumentation:
**
**  PVLOGGER_ANDROIDLOG_LEVEL 0 : No logging.  All logging statements compiled out.
**  PVLOGGER_ANDROIDLOG_LEVEL 1 : Release level only.
**  PVLOGGER_ANDROIDLOG_LEVEL 2 : Release level + profile level
**  PVLOGGER_ANDROIDLOG_LEVEL 3 : Release level + profile level + high-level debug
**  PVLOGGER_ANDROIDLOG_LEVEL 4 : Release level + profile level + high-level debug + mid-level debug
**  PVLOGGER_ANDROIDLOG_LEVEL 5 & above : Release level + profile level + high-level debug
...
//<-------
/*
    weiguo li. ALPS00131603
    if macro  PVLOGGER_ANDROIDLOG_ENABLE  is enabled, use android log. 
