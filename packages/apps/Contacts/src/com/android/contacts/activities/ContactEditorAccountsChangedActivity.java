...
//            if (accountType.equals(mSimAccountType) || accountType.equals(mUsimAccountType)) {
            ...
            //UIM
                ...
                Log.i(TAG, "the checkCount = " + checkCount);
                checkCount++;
    ...
    protected void onResume() {
		...
		if (numAccounts >= 2) {
			...
			accountListView
					.setOnItemClickListener(mAccountListItemClickListener);
    ...
    private void saveAccountAndReturnResult(AccountWithDataSet account) {
        ...
        Log.i(TAG," the mslotid and msimid is = "+mSlotId+"   "+mSimId+" | mNewSimType : "+mNewSimType);
        /*
         * Change Feature by Mediatek End.
         */
    ...
    private Runnable serviceComplete = new Runnable() {
        public void run() {
            ...
            if (mCellMgr.RESULT_ABORT == nRet) {
                ...
                SIMInfo siminfo = SIMInfo.getSIMInfoBySlot(ContactEditorAccountsChangedActivity.this, mSlotId); 
                if (siminfo != null) {
