...
class FetchUrlMimeType extends Thread {
    ...
    public void run() {
       ...
       // M: Add to support CU and CMCC customization
       ...
       if (optr != null && optr.equals("OP01")) {
           ...
           Xlog.d(XLOGTAG, "For OP01: selected download full path is: " + 
       ...
       if (optr != null && optr.equals("OP02")) {
           String op02Folder = DownloadHandler.getStorageDirectoryForOperator(mimeType);
