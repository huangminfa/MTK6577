...
import com.android.bluetooth.pbap.VCardUtils;
import com.android.bluetooth.pbap.Constants;
...
public class BluetoothVCardComposer {
    ...
    public BluetoothVCardComposer(Context context, String vcardTypeStr,
    ...
    public boolean init(final String selection, final String[] selectionArgs, final String orderBy /* SH modified*/) {
        ...
        if (mIsCallLogComposer) {
            mCursor = mContentResolver.query(CallLog.Calls.CONTENT_URI, sCallLogProjection,
                    selection, selectionArgs, orderBy /* SH modified*/);
        } else {
    ...
    private String createOneEntryInternal(final String contactId) {
        ...
        try {
            ...
            Cursor c = mContentResolver.query(sDataRequestUri, null, selection, selectionArgs, null);
            if(c != null) {
    ...
    public static final int VCARD_ATTRIB_N = (1<<2);    /* Structured Presentation of Name */
    public static final int VCARD_ATTRIB_PHOTO = (1<<3); /* Associated Image or Photo */
    ...
    public static final int VCARD_ATTRIB_EMAIL = (1<<8); /* Electronic Mail Address */
    ...
    public static final int VCARD_ATTRIB_ROLE = (1<<13); /* Role within the Organization */
    public static final int VCARD_ATTRIB_LOGO = (1<<14); /* Organization Logo */
    public static final int VCARD_ATTRIB_AGENT = (1<<15); /* vCard of Person Representing */
    public static final int VCARD_ATTRIB_ORG = (1<<16); /* Name of Organization */
    public static final int VCARD_ATTRIB_NOTE = (1<<17); /* Comments */
    public static final int VCARD_ATTRIB_REV = (1<<18); /* Revision */
    public static final int VCARD_ATTRIB_SOUND = (1<<19); /* Pronunciation of Name */
    public static final int VCARD_ATTRIB_URL = (1<<20); /* Uniform Resource Locator */
    public static final int VCARD_ATTRIB_UID = (1<<21); /* Unique ID */
    public static final int VCARD_ATTRIB_KEY = (1<<22); /* Public Encryption Key */
    ...
    public static final int VCARD_ATTRIB_SORTSTRING = (1<<27); /* String used for sorting operations */
    public static final int VCARD_ATTRIB_XIRMCCALLDATETIME = (1<<28); /* Time stamp */
    ...
    private void appendTitles(final StringBuilder builder,
            final Map<String, List<ContentValues>> contentValuesListMap) {
        final List<ContentValues> contentValuesList = contentValuesListMap
                .get(Organization.CONTENT_ITEM_TYPE);
        if (contentValuesList != null) {
