...
{
    QemudSerial*  s = opaque;
    //temporary mark below line because the "quote_bytes" function may cause emulator crash 
    ...
    while (len > 0) {
		...
		//temporary mark above line because the "quote_bytes" function may cause emulator crash 
