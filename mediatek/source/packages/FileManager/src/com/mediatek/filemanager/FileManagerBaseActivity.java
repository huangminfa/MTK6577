...
import com.mediatek.filemanager.NavigationHistory.NavigationRecord;
...
public abstract class FileManagerBaseActivity extends Activity implements OnItemClickListener,
    ...
    private static final String[] sCategoryArray = { "Document", "Download", "Music", "Photo",
            "Received File", "Video" };
    protected static List<String> sCategoryFoldersPath = new ArrayList<String>();
    ...
    // drm lock type
    protected static final int NOT_DRM_FILE = -1;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (INSTRUMENTATION_DEBUG) {
            ...
            KeyguardManager.KeyguardLock lock = keyGuardManager
                    .newKeyguardLock("com.mediatek.filemanager");
    ...
    protected void addTab(String text) {
        ...
        if (mBlankTab == null) {
            ...
            mBlankTab.setBackgroundDrawable(mResources.getDrawable(R.drawable.fm_blank_tab));
        } else {
        ...
        if (mTabsCounter == 0) {
            ...
            btn.setBackgroundDrawable(mResources.getDrawable(R.drawable.custom_tab));
            ...
            mlp = new LinearLayout.LayoutParams(new ViewGroup.MarginLayoutParams(
                    LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.MATCH_PARENT));
            mlp.setMargins(mTabMarginLeft, 0, 0, 0);
            btn.setLayoutParams(mlp);
            btn.setOnClickListener(this);
        ...
        mlp.setMargins(mTabMarginLeft, 0, mTabMarginRight, 0);
    ...
    protected void updateHomeButton() {
        ...
        if (mTabsHolder.getChildCount() == 2) { // two tabs: home tab + blank tab
            ...
            homeBtn.setPadding(mHomeBtnPadding, 0, mHomeBtnPadding, 0);
        } else {
            homeBtn.setBackgroundDrawable(mResources
                    .getDrawable(R.drawable.custom_home_ninepatch_tab));
