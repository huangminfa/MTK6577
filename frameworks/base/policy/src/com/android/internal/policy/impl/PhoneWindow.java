    ...
    public void invalidatePanelMenu(int featureId) {
        ...
        if ((featureId == FEATURE_ACTION_BAR || featureId == FEATURE_OPTIONS_PANEL)
            ...
            if (st != null) {
                ...
                /*  Due to the NavigationBar design were added from ICS,
                 *  its purpose is to replace hardware-key on device in default situation. 
                 *  But we have to deal with the special case when the hardware-key exist on 
                 *  the device (means no NavigationBar). 
                 *  What we do here is to reset the isPrepared flag, it will cause the callback
                 *  of Activity (onPrepareOptionsMenu) triggered when user first time tap Menu key.
                 **/
