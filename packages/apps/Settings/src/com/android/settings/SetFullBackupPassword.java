...
Log.i(TAG, "password mismatch");
                    Toast.makeText(SetFullBackupPassword.this,
                            SetFullBackupPassword.this.getString(R.string.password_mismatch),
...
Log.i(TAG, "password set successfully");
                    Toast.makeText(SetFullBackupPassword.this,
                            SetFullBackupPassword.this.getString(R.string.password_set_successfully),
                            Toast.LENGTH_LONG).show();
                    finish();
                } else {
...
Log.i(TAG, "failure; password mismatch?");
                    Toast.makeText(SetFullBackupPassword.this,
                            SetFullBackupPassword.this.getString(R.string.password_set_failure),
                            Toast.LENGTH_LONG).show();
                }
            } else if (v == mCancel) {
                finish();
