...
/**
 * Class Name: SendSmsRsp
 * <p>Package: com.mediatek.apst.util.command.message
 * <p>Created on: 2010-12-18
 * <p>
 * <p>Description: 
 * <p>Response for sending a SMS message.
 * <p>
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class SendSmsRsp extends ResponseCommand {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    // Constructors                                                 
    //==============================================================
    public SendSmsRsp(int requestToken){
    ...
    // For MTK DUAL-SIM feature.
    /**
     * Gets via which SIM card the SMS message is sent.
     * @return The ID of SIM via which the SMS message is sent. 
    ...
    // Setters                                                      
    //==============================================================
    public void setInsertedIds(long[] insertedIds){
    ...
    // For MTK DUAL-SIM feature.
    /**
     * Sets via which SIM car the SMS message is sent.
     * @param simId The ID of SIM via which the SMS message is sent. 
     * Valid value can be SIM_ID, SIM1_ID or SIM2_ID.
     * @see com.mediatek.apst.util.entity.message.Message#SIM_ID
     * @see com.mediatek.apst.util.entity.message.Message#SIM1_ID
     * @see com.mediatek.apst.util.entity.message.Message#SIM2_ID
