...
#ifndef _RRLP_SEND_GAS_MSGS_H
#define _RRLP_SEND_GAS_MSGS_H


/*****************************************************************************
 * exported function prototypes
 *****************************************************************************/
void rrlp_send_gas_data_req(
    INOUT rrlp_session_context_struct* rrlp_sctx_ptr,
    IN rrlp_payload_enum payload_type, 
    IN kal_uint8 *pdu_ptr, 
    IN kal_uint16 pdu_len,
    IN kal_bool more);

#endif /* _RRLP_SEND_GAS_MSGS_H */
