...
public class CalendarProvider2 extends SQLiteContentProvider implements OnAccountsUpdateListener {
    ...
    /**
     * M:Broadcast Action: update the event reminder(s).
     */
    private static final String UPDATE_EVENT_REMINDER_ACTION = "android.intent.action.UPDATE_EVENT_REMINDERS";
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_TIMEZONE_CHANGED.equals(action)) {
                ...
                mCalendarAlarm.scheduleNextAlarm(false /* do not remove alarms */);
                ///M:If the Date has been changed manually, clear instance range.
                //TODO: find better method to clear the instance range when user change the date manually.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case INSTANCES_BY_DAY:
                ...
                Log.d(CalendarProvider2.TAG, "query: " + begin / DAY_IN_MILLIS + 
                        " ~ " + end / DAY_IN_MILLIS);
    ...
    void acquireInstanceRangeLocked(long begin, long end, boolean useMinimumExpansionWindow,
        ...
        Log.d(CalendarProvider2.TAG, "maxIns = " + maxInstance / DAY_IN_MILLIS + 
                ", minIns = " + minInstance / DAY_IN_MILLIS + 
                ", begin = " + begin / DAY_IN_MILLIS + 
                ", end = " + end / DAY_IN_MILLIS);
    ...
    protected Uri insertInTransaction(Uri uri, ContentValues values, boolean callerIsSyncAdapter) {
        ...
        switch (match) {
            ...
            case EVENTS:
                ...
                updatedValues.put(Events.CREATE_TIME, System.currentTimeMillis());
    ...
    private int handleUpdateEvents(Cursor cursor, ContentValues updateValues,
        ...
        while (cursor.moveToNext()) {
            ...
            if (isUpdate) {
                ...
                modValues.put(Events.MODIFY_TIME, System.currentTimeMillis());
                ///M: limit the text length to avoid potential ANR. if the title, description or location
                /// is too long, drop the tail text, replace with " ...".
    ...
    static {
        ...
        ///M:CREATE_TIME/MODIFY_TIME are added for PC sync account.
        sEventsProjectionMap.put(Events.CREATE_TIME, Events.CREATE_TIME);
        sEventsProjectionMap.put(Events.MODIFY_TIME, Events.MODIFY_TIME);
        ///M: IS_LUNAR/LUNAR_RRULE are added for lunar calendar.
        sEventsProjectionMap.put(Events.IS_LUNAR, Events.IS_LUNAR);
        sEventsProjectionMap.put(Events.LUNAR_RRULE, Events.LUNAR_RRULE);
        ...
        ///M:CREATE_TIME/MODIFY_TIME are added for PC sync account.
        sEventEntitiesProjectionMap.put(Events.CREATE_TIME, Events.CREATE_TIME);
        sEventEntitiesProjectionMap.put(Events.MODIFY_TIME, Events.MODIFY_TIME);
        ///M: IS_LUNAR/LUNAR_RRULE are added for lunar calendar.
        sEventEntitiesProjectionMap.put(Events.IS_LUNAR, Events.IS_LUNAR);
        sEventEntitiesProjectionMap.put(Events.LUNAR_RRULE, Events.LUNAR_RRULE);
            ...
            for (String table : new String[]{Tables.CALENDARS, Tables.COLORS}) {
                ...
                while (c.moveToNext()) {
                    ...
                    if (c.getString(0) != null
                            && c.getString(1) != null
                            && /**M: filter out PC sync account.*/
                            !CalendarContract.ACCOUNT_TYPE_LOCAL.equalsIgnoreCase(c.getString(1))) {
