...
public class LunarUtil {
     ...
     */
    private static final String[] ALL_SC_SOLAR_TERM_NAMES = { "小寒", "大寒", "立春", "雨水", "惊蛰", "春分",
            "清明", "谷雨", "立夏", "小满", "芒种", "夏至", "小暑", "大暑", "立秋", "处暑", "白露", "秋分", "寒露", "霜降",
            "立冬", "小雪", "大雪", "冬至" };
    private static final String[] ALL_TC_SOLAR_TERM_NAMES = { "小寒", "大寒", "立春", "雨水", "驚蟄", "春分",
            "清明", "穀雨", "立夏", "小滿", "芒種", "夏至", "小暑", "大暑", "立秋", "處暑", "白露", "秋分", "寒露", "霜降",
            "立冬", "小雪", "大雪", "冬至" };
     ...
     * int[3] represent is  current month leap month,if is leap month,will return LEAP_MONTH,else return 
     * NORMAL_MONTH
     */
    public static int[] calculateLunarByGregorian(int gregorianYear, int gregorianMonth, int gregorianDay) {
        ...
        int offsetDaysFromBaseDate = (int)Math.round((currentDate.getTime() - baseDate.getTime()) / 86400000D);
    ...
    private static String[] getAMonthSolarTermNames(int gregorianMonth) {
        ...
        int firstSolarTermIndex = (gregorianMonth - 1) * 2;
        final boolean isTCLunarCalendarEnabled = Features.isTCLunarCalendarEnabled(); 
        String firstSolarTermName = isTCLunarCalendarEnabled ?
                ALL_TC_SOLAR_TERM_NAMES[firstSolarTermIndex] : ALL_SC_SOLAR_TERM_NAMES[firstSolarTermIndex];
        String secondSolarTermName = isTCLunarCalendarEnabled ?
                ALL_TC_SOLAR_TERM_NAMES[firstSolarTermIndex + 1] : ALL_SC_SOLAR_TERM_NAMES[firstSolarTermIndex + 1];
     ...
     * @param lunarMonth
     * @param lunarDay
     * @param lunarMonthType lunar year
     * @return null for not the festival.
     */
    private static String getLunarFestival(int lunarMonth,int lunarDay, int lunarMonthType) {
        ...
        if ((lunarMonth == 1) && (lunarDay == 1)) {
            return isTCLunarCalendarEnabled ? "春節" : "春节";
        } else if ((lunarMonth == 5) && (lunarDay == 5)) {
            return isTCLunarCalendarEnabled ? "端午節" : "端午节";
        } else if ((lunarMonth == 8) && (lunarDay == 15)) {
            return isTCLunarCalendarEnabled ? "中秋節" : "中秋节";
        } else if ((lunarMonth == 1) && (lunarDay == 15)) {
            return isTCLunarCalendarEnabled ? "" : "元宵节";
        } else if ((lunarMonth == 7) && (lunarDay == 7)) {
            return isTCLunarCalendarEnabled ? "" : "七夕";
        } else if ((lunarMonth == 9) && (lunarDay == 9)) {
            return isTCLunarCalendarEnabled ? "" : "重阳节";
        }
    ...
    private static String getGregFestival(int gregorianMonth, int gregorianDay) {
        ...
        if ((gregorianMonth == 1) && (gregorianDay == 1)) {
            return isTCLunarCalendarEnabled ? "" : "元旦";
        } else if (gregorianMonth == 5) {
            if (gregorianDay == 1) {
                return isTCLunarCalendarEnabled ? "" : "劳动节";
            } else if (gregorianDay == 4) {
                return isTCLunarCalendarEnabled ? "" : "青年节";
            }
        } else if ((gregorianMonth == 10) && (gregorianDay == 1)) {
            return isTCLunarCalendarEnabled ? "" : "国庆节";
        } else if ((gregorianMonth == 2) && (gregorianDay == 14)) {
            return isTCLunarCalendarEnabled ? "" : "情人节";
        } else if (gregorianMonth == 3) {
            if (gregorianDay == 8) {
                return isTCLunarCalendarEnabled ? "" : "妇女节";
            } else if (gregorianDay == 12) {
                return isTCLunarCalendarEnabled ? "" : "植树节";
            }
        } else if ((gregorianMonth == 4) && (gregorianDay == 1)) {
            return isTCLunarCalendarEnabled ? "" : "愚人节";
        } else if ((gregorianMonth == 6) && (gregorianDay == 1)) {
            return isTCLunarCalendarEnabled ? "" : "儿童节";
        } else if ((gregorianMonth == 7) && (gregorianDay == 1)) {
            return isTCLunarCalendarEnabled ? "" : "建党节";
        } else if ((gregorianMonth == 8) && (gregorianDay == 1)) {
            return isTCLunarCalendarEnabled ? "" : "建军节";
        } else if ((gregorianMonth == 9) && (gregorianDay) == 10) {
            return isTCLunarCalendarEnabled ? "" : "教师节";
        } else if ((gregorianMonth == 12) && (gregorianDay == 25)) {
            return isTCLunarCalendarEnabled ? "" : "圣诞节";
        }
