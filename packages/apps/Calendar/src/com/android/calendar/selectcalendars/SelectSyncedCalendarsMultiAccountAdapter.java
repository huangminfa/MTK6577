...
public class SelectSyncedCalendarsMultiAccountAdapter extends CursorTreeAdapter implements
    ...
    ///M:modify the mChildrenCursors's key from "account" to "account,accountType"
    ...
    protected Cursor getChildrenCursor(Cursor groupCursor) {
        ...
        ///M: the groups are divided by account name and account type.
        String key = account + COMMA +accountType;
        Cursor childCursor = mChildrenCursors.get(key);
    ...
    private class RefreshCalendars implements Runnable {
        ...
        public void run() {
            ...
            String cookie = mAccount + COMMA +mAccountType;
