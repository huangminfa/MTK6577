...
public class SearchPackageActivity extends Activity implements View.OnClickListener {
    ...
    private void initialize(Bundle savedInstanceState) {
        ...
        mAdapter = new PackageAdapter(this, R.layout.purchase_item, null, new String[]{}, new int[]{}, mListView, mEmptyView);
        mAdapter.changeCursor(mLocalCursor);
        if (LOG) Log.i(TAG, "mLocalCursor.count=" + mLocalCursor.getCount());
        //init ui handler
    ...
    /*package*/ class PackageAdapter extends SimpleCursorAdapter {
        ...
        private String getDescription(String description) {
            ...
            if (LOG) Log.i(TAG, "getDescription(" + description + ") return " + result);
            return result;
        }
        ...
        private String getTip(String packageGlobalId, int isLocal) {
            if (LOG) Log.i(TAG, "getTip(" + packageGlobalId + ", " + isLocal + ")");
    ...
    private String getServiceNames(String packageGlobalId) {
        ...
        if (LOG) Log.i(TAG, "getServiceNames(" + packageGlobalId + ") return " + serviceNames);
        return serviceNames;
    }
    ...
    public void onClick(View v) {
        if (LOG) Log.i(TAG, "onClick() v.id=" + v.getId());
        AlertDialog dialog;
        int id = v.getId();
        switch(id) {
    ...
    private boolean checkContentPass(DataHolder holder) {
        ...
        if (Utils.checkLocalTime() && 
            ...
            Cursor cursor = mContentResolver.query(SG.PurchaseItemContentDetail.CONTENT_URI,
                    new String[]{SG.PurchaseItemContentDetail.START_TIME, SG.PurchaseItemContent.NAME},
                    SG.PurchaseItem.GLOBAL_PURCHASE_ITEM_ID + "=? ",
