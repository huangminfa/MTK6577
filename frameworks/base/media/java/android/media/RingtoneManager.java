...
public class RingtoneManager {
    ...
    /**
     * Given to the ringtone picker as a boolean. Whether to show an item for "More Ringtones". 
    ...
    private static final String[] MEDIA_COLUMNS = new String[] {
        ...
        MediaStore.Audio.Media.TITLE_KEY,
        MediaStore.Audio.Media.IS_DRM,    // add for handling OMA DRM v1 content
        MediaStore.Audio.Media.DRM_METHOD // add for handling OMA DRM v1 content
    };
    ...
    private static final boolean DRM_FL_ONLY = true;
    private static final int METHOD_FL = 1;
    ...
    private static String constructBooleanTrueWhereClause(List<String> columns, boolean includeDrm) {
        ...
        // for OMA DRM v1 implementation, we also shows those "Forward Lock" audio. the where clause
        // will be something like "(is_notification=1) and (is_drm!=1 or drm_method=1)"
        //      or something like "(is_notification=1) and (is_drm!=1)"
        sb.append(" and ");
        sb.append("(");

        sb.append(MediaStore.Audio.Media.IS_DRM).append("!=1");
        if (DRM_FL_ONLY) {
            sb.append(" or ").append(MediaStore.Audio.Media.DRM_METHOD).append("=" + METHOD_FL);
        }
    ...
    public static Ringtone getRingtone(final Context context, Uri ringtoneUri) {
        ...
        // If the given uri can't open, return default uri
        if (null == ringtone) {
            ringtone = getRingtone(context, Settings.System.DEFAULT_RINGTONE_URI, -1);
            Log.w(TAG, "getRingtone: the given ringtone uri can't open, use default ringtone");
        }
        return ringtone;
    }
     ...
     *            {@link #TYPE_ALARM}, or {@link #TYPE_VIDEO_CALL}.
     ...
     *            {@link System#DEFAULT_NOTIFICATION_URI}, or
     *            {@link System#DEFAULT_ALARM_ALERT_URI}, or
     *            {@link System#DEFAULT_VIDEO_CALL_URI}.
