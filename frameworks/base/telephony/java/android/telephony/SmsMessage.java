...
public class SmsMessage {
    ...
    */
    ...
    public static SmsMessage createFromPdu(byte[] pdu, String format) {
        ...
        if(wrappedMessage == null) {
            Log.e(LOG_TAG, "createFromPdu: can not parse pdu with GSM/CDMA");
        }
    ...
    /**
     * Returns true if the <code>TP-Reply-Path</code> bit is set in
     * this message.
     */
    ...
    // MTK-START [ALPS00101764] Can not call SmsMessage.getMessageSimId by mtk80589 in 2011.12.09
    /** 
    ...
    // MTK-END [ALPS00101764] Can not call SmsMessage.getMessageSimId by mtk80589 in 2011.12.09
