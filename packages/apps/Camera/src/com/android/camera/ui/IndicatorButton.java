...
public class IndicatorButton extends AbstractIndicatorButton
    ...
    public void overrideSettings(final String ... keyvalues) {
    	if (keyvalues.length > 2) {
    		throw new RuntimeException("performance defect! please check");
    	}
    ...
    //Mediatek merge begin
  	...
  	public void overrideSettings(String key, String value, String[] values) {
  		if (mPreference.getKey() == null || !mPreference.getKey().equals(key)) return;
  		...
  		((BasicSettingPopup)mPopup).overrideSettings(key, value, values);
  	}
  	//Mediatek merge end
}
