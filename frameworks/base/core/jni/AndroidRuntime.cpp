...
extern int register_com_mediatek_xlog_BLog(JNIEnv* env);
...
extern int register_android_server_RTT(JNIEnv* env);
...
static void readLocale(char* language, char* region)
{
    ...
    char propSIMLang[PROPERTY_VALUE_MAX], propSIMRegn[PROPERTY_VALUE_MAX]; // [Note] SIM Locale feature
...
static const RegJNIRec gRegJNI[] = {
    ...
    REG_JNI(register_com_mediatek_xlog_BLog),
    ...
    REG_JNI(register_android_server_RTT),
