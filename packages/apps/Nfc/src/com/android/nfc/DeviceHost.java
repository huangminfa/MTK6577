...
public interface DeviceHost {
	...
	// ----- MTK begins ----- //
	public static final int SELECT_UICC = 1;	
	public static final int DESELECT_UICC = 0;	
	public void selectUiccSecureElement(int select);
	public void selectUiccSecureElementInPBTF(int select);

	public static final int ENABLE_P2P_BITRATE106 = 1;
	public static final int DISABLE_P2P_BITRATE106 = 0;
	public void doSelectP2pBitrate106(int select);
	// ----- MTK ends ----- //
