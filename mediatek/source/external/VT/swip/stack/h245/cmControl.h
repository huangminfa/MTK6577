...
typedef struct
{
    RvUint16     entries;     /* table indexes that are requested in this
                                 requestMultiplexEntry message*/
} IncomingRMEInfo;
/////////////////////////////////////////////////////////////////////////////
/* MTK */
...
typedef struct
{
   ...
   /* Channel Information */
    ...
    /* MTK */
    OutgoingRMEInfo         outRME;
    IncomingRMEInfo         inRME;           
    RmeStatus              eInRmeStatus;    
    RmeStatus              eOutRmeStatus; 
    /* MTK */
...
#define H245APIEnter(_args) RvLogEnter (_args)
#define H245APIExit(_args) RvLogLeave (_args)
#define H245CBEnter(_args) RvLogEnter (_args)
#define H245CBExit(_args) RvLogLeave (_args)
