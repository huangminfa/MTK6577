    ...
    private void processMapMediaItems(ArrayList<PathId> list,
        ...
        for (int i = 0; i < n; ) {
            ...
            for(int k = i ; k < j; k++) {
            	...
            	if (t instanceof PriorityThreadFactory.CancelableThread) {
            		if (((CancelableThread)t).isThreadCancelled()) {
            			// before each step of the entire time-consuming task,
            			// we check if thread has been cancelled
            			return;
            		}
            	}
