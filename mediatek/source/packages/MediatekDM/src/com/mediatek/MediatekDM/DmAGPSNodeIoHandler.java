...
public class DmAGPSNodeIoHandler implements NodeIoHandler {
    ...
    private String[] item = { "IAPID", "ProviderID", "Name", "PrefConRef",
                              "ToConRef", "ConRef", "SLP", "port"
                            };

    private String[] projection = {"appId","providerId" ,"name" ,"defaultApn" ,
    ...
    public int read(int arg0, byte[] arg1) throws MdmException {
        ...
        if (DmService.mCCStoredParams.containsKey(uriPath)) {
            ...
            Log.d(TAG.NodeIOHandler,"get valueToRead from mCCStoredParams, the value is "+valueToRead);
        } else {
            ...
            Log.d(TAG.NodeIOHandler,"put valueToRead to mCCStoredParams, the value is "+valueToRead);
        }
