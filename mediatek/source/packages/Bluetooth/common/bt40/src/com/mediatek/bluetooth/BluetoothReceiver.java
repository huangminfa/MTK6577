...
public class BluetoothReceiver extends BroadcastReceiver {
	...
	public static HashSet<String> UNMOUNTING_STORAGE_SET = new HashSet<String>(2);
...
//			this.stopProfileServices( context );
		...
		// show toast
			...
			if( path != null ){
				...
				UNMOUNTING_STORAGE_SET.add( path.getPath() );
			}
		}
			...
			if( path != null ){
				...
				UNMOUNTING_STORAGE_SET.remove( path.getPath() );
			}
		}
	}
	...
	private void startProfileServices( Context context ){
		...
		//if (FeatureOption.MTK_BT_PROFILE_PAN && btAdapter != null && btAdapter.isEnabled()) 
		    //this.startService( context, PAN_SERVICE_CLASS);//, "BtTethering", (Parcelable)mBTtethering );
	...
	private void stopProfileServices( Context context ){
		...
		if( FeatureOption.MTK_BT_PROFILE_OPP )	this.stopService( context, OPP_SERVICE_CLASS );
		...
		if( FeatureOption.MTK_BT_PROFILE_MAPS )	this.stopService( context, MAP_SERVICE_CLASS );
		if( FeatureOption.MTK_BT_PROFILE_PAN ) this.stopService( context, PAN_SERVICE_CLASS );
	}
