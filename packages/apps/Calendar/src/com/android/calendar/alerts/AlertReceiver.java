...
public class AlertReceiver extends BroadcastReceiver {
    ...
    ///@}
    ///M:#data clear#, define calendar provider package name.@{
    private static final String PROVIDER_PACKAGE_NAME = "com.android.providers.calendar";
    ///@}
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        ///M:#data clear#, receive clear data broadcast send by Setting.@{
        String packageName = intent.getStringExtra("packageName");
        if(/*#data clear#*/Intent.ACTION_SETTINGS_PACKAGE_DATA_CLEARED.equals(action)
                && !PROVIDER_PACKAGE_NAME.equals(packageName)) {
            Log.v(TAG, "onReceive: invalid Package name:" + packageName);
            return;
        }
        ///@}
        ...
        if (DELETE_ACTION.equals(action)) {
            ...
            context.startService(serviceIntent);
                ...
                || AlertService.UPDATE_EVENT_REMINDER_ACTION.equals(action)
                || Intent.ACTION_PROVIDER_CHANGED.equals(action)
                || /*#data clear#*/Intent.ACTION_SETTINGS_PACKAGE_DATA_CLEARED.equals(action) ) {
