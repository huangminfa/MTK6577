...
public class CameraHolder {
    ...
    public static final String Stereo3DSupportFalse = "0";
    public static final String Stereo3DSupportTrue = "1";
    ...
    public boolean getStereo3DSupport() {
        Log.v(TAG, "getStereo3DSupport " + FeatureOption.MTK_S3D_SUPPORT);
		if (FeatureOption.MTK_S3D_SUPPORT) {
	        String support = SystemProperties.get("Camera.Stereo.3D.Support", Stereo3DSupportFalse);
	        return Stereo3DSupportTrue.equals(support);
		}
		return false;
    }
}
