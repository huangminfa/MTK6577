...
public class WifiSwitchTest extends DataServiceTestCase {
	boolean mSwitchTimeouted = false;
	boolean mWifiEnabled = false;
	boolean mWifiConnecting = false;
	
	public WifiSwitchTest() {
		super(null);
	}
	
	public WifiSwitchTest(Handler reportHander) {
        super(reportHander);
    }
	...
	public String getDescription() {
		return "Run test cases randomly";
	}
}
