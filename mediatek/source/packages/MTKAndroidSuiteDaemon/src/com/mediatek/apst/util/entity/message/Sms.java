...
public class Sms extends Message {
    ...
    public void writeRaw(ByteBuffer buffer) throws NullPointerException{
        ...
        // serviceCenter
        RawTransUtil.putString(buffer, this.serviceCenter);
        // body
        RawTransUtil.putString(buffer, this.body);
    }
    ...
    public void readRaw(ByteBuffer buffer) throws NullPointerException{
        ...
        // serviceCenter
        this.serviceCenter = RawTransUtil.getString(buffer);
        // body
        this.body = RawTransUtil.getString(buffer);
    }
