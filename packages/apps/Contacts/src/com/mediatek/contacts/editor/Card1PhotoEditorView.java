...
public class Card1PhotoEditorView extends PhotoEditorView{
    ...
    public Card1PhotoEditorView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onFinishInflate() {
        ...
        mPhotoImageView = (ImageView) findViewById(R.id.card1_photo);
    ...
    protected void resetDefault() {
        ...
        mPhotoImageView.setImageResource(R.drawable.ic_contact_picture_sim1_contact);
