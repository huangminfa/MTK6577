...
public class TodoInfo implements Serializable {
    ...
    public static TodoInfo makeTodoInfoFromCursor(Cursor cursor) {
        String id, title, description, status, dueDate, createTime, completeTime;
        TodoInfo todoInfo = new TodoInfo();

        try {
            id = Utils.getColumnByName(TodoColumn._ID, cursor);
            ...
            LogUtils.e(TAG, "Cursor wrong: " + cursor);
            e.printStackTrace();
            LogUtils.i(TAG, "New empty TodoInfo inited");
            return todoInfo;
        }
