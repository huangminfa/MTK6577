...
public class Activity extends ContextThemeWrapper
     ...
     */
    protected void onCreate(Bundle savedInstanceState) {
    	ActivityThread.logAppLaunchTime(TAG, "activity super.onCreate +");
    ...
    public void onBackPressed() {
        if (!mFragments.popBackStackImmediate()) {
            ActivityThread.logAppLaunchTime(TAG, "Back key pressed");
            finish();
        }
    }
    ...
    public boolean onPreparePanel(int featureId, View view, Menu menu) {
        if (featureId == Window.FEATURE_OPTIONS_PANEL && menu != null) {
            ...
            /// M: remove the condition menu.hasVisibleItems(), or ActionBar can not
            /// get Action menu item update message, patch back from JB
            return goforit;
        }
        return true;
    }
