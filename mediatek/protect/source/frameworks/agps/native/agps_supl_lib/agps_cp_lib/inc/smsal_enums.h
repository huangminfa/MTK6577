 ...
 *
 * 12 14 2010 yuming.hsu
 * [MAUI_02846305] [RHR] Merge to Main Trunk for SMS & FAX part
 * .
 *
 * 10 17 2010 yuming.hsu
 * [MAUI_02828430] [RHR][MAUIW1038OF_RHR] Integration to W10.43 of SMS and FAX part
 * [RHR][MAUI] Check-in MAUI of SMS and FAX part
 *
 * Sep 3 2009 mtk02219
 * [MAUI_01684019] SMS R6 feature
 * 
 *
 * Apr 15 2009 mtk02219
 * [MAUI_01668995] [WISE] sms
 * 
 *
 * Mar 24 2009 mtk02219
 * [MAUI_01653818] [SMSAL][Update] Pending Replace Type MT-SMS during power on
 * 
 *
 * Dec 5 2008 mtk02219
 ...
 * 
 *
 * Nov 28 2008 mtk02219
 * [MAUI_01269557] [SMSAL][Update] SMS raw data access support
 * 
 *
 * Jul 15 2008 mtk02219
 * [MAUI_00804628] [SMSAL][Update] add inject tst for SMS data
 * 
 *
 ...
 * 
 *
 * Dec 26 2006 mtk01202
 * [MAUI_00351219] [SMS][Revise] change default message number and add sms patent for FT
 * 
 *
 * Sep 26 2006 mtk01202
 * [MAUI_00329826] [SMSAL][Revise] Handle SAT send SMS by SIM control
 * 
 *
 * Jul 24 2006 mtk01202
 * [MAUI_00015929] [SMSAL][Revise] Email indication shown on receiving Voice mail or fax  Indication.
 * 
 *
 * Apr 27 2006 mtk01202
 * [MAUI_00189835] [SMSAL][Update] Add SMSS SMSP error handling
 * 
 *
 * Nov 9 2005 mtk00516
 * [MAUI_00155213] [SMSAL][BugFix] Don't store the message with voice message waiting indicator and wit
 * 
 *
 *------------------------------------------------------------------------------
...
typedef enum
{
    ...
    SMSAL_COMPRESSED_CHECK = 0x20,
    
    /* Check for class2 message */
    SMSAL_CLASS2_CHECK     = 0X02,
    
    /* Check for class3 message */
    SMSAL_CLASS3_CHECK     = 0x03,

    /* Check for GSM7-bit data type */
    SMSAL_GSM7_CHECK       = 0x0C,
    
    /* Check for coding groups of 
     * short message data supported */
    SMSAL_CODING1_CHECK    = 0xC0,
    SMSAL_CODING2_CHECK    = 0xF0,
    
    /* Check for PID's supported */

    SMSAL_PID_CHECK        = 0xC0,
    SMSAL_PID_MASK         = 0xE0,
    SMSAL_PID_RESERVED     = 0x80,
#endif 
