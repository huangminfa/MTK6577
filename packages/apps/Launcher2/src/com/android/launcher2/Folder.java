...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    protected void onFinishInflate() {
        ...
        int folderTextColor = 0;
        if (FeatureOption.MTK_THEMEMANAGER_APP) {
            folderTextColor = getContext().getResources().getThemeMainColor();
        }
        if (folderTextColor == 0) {
            folderTextColor = 0xff33b5e5;
        }
    ...
    void bind(FolderInfo info, boolean fromXml) {
    	mInfo = info;
    ...
    public void animateOpen() {
        ...
        // Update unread number of content shortcuts.
    ...
    public void animateClosed() {
        ...
        oa.setDuration(mExpandDuration);
        oa.start();
        //Prevent the impact of the animation time we do not listen to directly close the folder action
        mState = STATE_ANIMATING;
        sendCustomAccessibilityEvent(AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED,
                mContext.getString(R.string.folder_closed));
        onCloseComplete();
    ...
    public void completeDragExit() {
    	//Because of not using animation callback, so we judge this in advance
    ...
    public void onDropCompleted(View target, DragObject d, boolean success) {
        if (LauncherLog.DEBUG) {
            LauncherLog.d(TAG, "(Folder)onDropCompleted: View = " + target + ", DragObject = " + d
                    + ", success = " + success);
        }
        if (success) {
    ...
    private void onCloseComplete() {
		...
		if (null == parent) {
			LauncherLog.d(TAG, "parent = " + parent + ", this = " + this);
			return;
		}
    ...
    private void replaceFolderWithFinalItem() {
        ...
        if (finalItem != null) {
            View child = mLauncher.createShortcut(R.layout.mtk_application, cellLayout,
