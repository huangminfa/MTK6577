...
LOCAL_SRC_FILES += $(call all-c-cpp-files-under, common/hal/camera/$(CUSTOM_HAL_CAMERA)/$(call lc,$(MTK_PLATFORM)))
...
LOCAL_C_INCLUDES += \
    $(MTK_PATH_SOURCE)/external/mhal/src/custom/common/hal/camera \
    $(MTK_PATH_SOURCE)/external/mhal/src/custom/common/hal/flashlight \
    $(MTK_PATH_SOURCE)/external/mhal/src/custom/common/hal/imgsensor \
    $(MTK_PATH_SOURCE)/external/mhal/src/custom/common/hal/lens \
    $(MTK_PATH_SOURCE)/external/mhal/src/custom/common/hal/eeprom \
