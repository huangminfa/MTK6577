...
public class ChooseActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv = (ListView) this.findViewById(R.id.mtkchooselistviewid);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		menu.add(Menu.NONE, MENU_ADD, Menu.NONE, R.string.add_new_city)
				.setIcon(R.drawable.ic_menu_add).setShowAsAction(
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
		...
		case MENU_ADD:
			Intent intentAutoCompleteTextView = new Intent(ChooseActivity.this,
	...
	protected void onResume() {
		...
		mSimpleAdapter = new SimpleAdapter(this, data, R.layout.chooselistview,
		...
		lv.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
				...
				new AlertDialog.Builder(ChooseActivity.this).setTitle(
