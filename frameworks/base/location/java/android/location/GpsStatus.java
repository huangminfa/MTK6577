...
/**
 * This class represents the current state of the GPS engine. This class is used
 * in conjunction with the {@link Listener} interface.
 */
public final class GpsStatus
{
	private static String TAG = "GpsStatus";
	 ...
	 * Call {@link #getTimeToFirstFix()} to find the time from start to first
	 * fix.
	 */
	public static final int GPS_EVENT_FIRST_FIX = 3;

	/**
	 * Event sent periodically to report GPS satellite status. Call
	 * {@link #getSatellites()} to retrieve the status for each satellite.
	 */
	...
	{
		/**
		 * Called to report changes in the GPS status. The event number is one
		 * of:
		 * <ul>
		 ...
		 * {@link LocationManager#getGpsStatus} to get additional status
		 * information.
		 * 
		 * @param event
	...
	/**
	 * Used for receiving NMEA sentences from the GPS. NMEA 0183 is a standard
	 * for communicating with marine electronic devices and is a common method
	 * for receiving data from a GPS, typically over a serial port. See <a
	 * href="http://en.wikipedia.org/wiki/NMEA_0183">NMEA 0183</a> for more
	 * details. You can implement this interface and call
	 * {@link LocationManager#addNmeaListener} to receive NMEA data from the GPS
	 * engine.
	 */
	...
	/**
	 * Used internally within {@link LocationManager} to copy GPS status data
	 * from the Location Manager Service to its cached GpsStatus instance. Is
	 * synchronized to ensure that GPS status updates are atomic.
	 */
	 ...
	 * cached GpsStatus instance to the client's copy. Since this method is only
	 * used within {@link LocationManager#getGpsStatus}, it does not need to be
	 * synchronized.
	 */
