...
public class DmScomoNotification implements OnDmScomoUpdateListener {
    ...
    public void onScomoUpdated() {
        ...
        if (state==DmScomoState.DOWNLOADING) {
            ...
            CharSequence tvText = mContext.getResources().getString(R.string.downloading, scomoState.getName());
            ...
            notifyDownloadNotification(tickerText, contentTitle, contentText, scomoState.currentSize, scomoState.totalSize);
...
//            CharSequence tickerText = mContext.getText(R.string.scomo_downloading_failed);
//            CharSequence contentText = mContext.getText(R.string.downloading_scomo);
//            CharSequence contentTitle = mContext.getText(R.string.scomo_downloading_failed);
//            notifyConfirmNotification(tickerText, contentTitle, contentText, state);
            ...
            CharSequence tickerText = mContext.getText (R.string.confirm_install_scomo);
            CharSequence contentText = mContext.getText(R.string.software_update);
            CharSequence contentTitle = mContext.getText (R.string.download_complete);
            notifyConfirmNotification(tickerText, contentTitle, contentText, state);
            ...
            Notification.Builder notifyBuilder =
                new Notification.Builder(mContext).setOngoing(true)
    ...
    private void notifyDownloadNotification(CharSequence tickerText, CharSequence contentTitle,
        ...
        .setSmallIcon(R.drawable.stat_download_waiting)
        .setWhen(System.currentTimeMillis())
        .setContentIntent(mDownloadDetailPendingIntent)
    ...
    private void notifyConfirmNotification(CharSequence tickerText, CharSequence contentTitle,
        ...
        PendingIntent pendingIntent =
            PendingIntent.getActivity(mContext, 0, intent, PendingIntent.FLAG_ONE_SHOT);
        Notification.Builder notifyBuilder =
            new Notification.Builder(mContext).setAutoCancel(true)
        .setSmallIcon(R.drawable.stat_download_waiting)
        .setWhen(System.currentTimeMillis())
        .setContentIntent(pendingIntent)
        .setTicker(tickerText)
