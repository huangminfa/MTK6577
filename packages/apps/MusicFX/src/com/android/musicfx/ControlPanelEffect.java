...
public class ControlPanelEffect {
    ...
    /**
     * Map the effect parameter and save them to share preference after activity has been in backgaround.
     */
    ...
    /**
     * Map all the effect status when MusicFX activity is on create and use them to instead share 
    ...
    static List<String> mNeedSaved = new ArrayList<String>(Key.values().length);
    // Defaults
    ...
    public static void initEffectsPreferences(final Context context, final String packageName,
        ...
        try {
            ...
            // init all settings to a hash map from share preference,then we can get value from it 
            // to avoid writing share preference too much
                ...
                if (value == true) {
                    ...
                    if (controlMode == ControlMode.CONTROL_EFFECTS) {
                        ...
                        if (equalizerEffect != null) {
                            ...
                            // ALPS00256779:Because every time set global enabled, it will set current
                            ...
                            for (short band = 0; band < len; band++) {
                                mIntParameter.put(Key.eq_preset_user_band_level.toString() + band, String.valueOf(userBandLevels[band]));
                ...
                case eq_current_preset: {
                    ...
                    if (equalizerEffect != null) {
                        ...
                        for (short band = 0; band < numBands; band++) {
                            ...
                            Log.d(TAG, "setParameterInt: key " + Key.eq_band_level.toString() + band + ", level" + level + ", numBands = " + numBands + ",numPresets =" + numPresets);
                        }
                    }
                    break;
                }
     ...
     */
     ...
     /**
      * Gets the auxiliary effect id with audio session.
      *
      * @param audioSession
      * System wide unique audio session identifier.
      ...
      */
      ...
      /**
       * Gets if the reverb effect is enabled with audio session.
       *
       * @param audioSession
       * System wide unique audio session identifier.
      ...
      /**
       * Save setting change in MusicFX to share preference.
       *
       * @param context
       * @param packageName
       * 
