...
public class CallController extends Handler {
    ...
    public void placeCall(Intent intent) {
        ...
        switch (status) {
            ...
            case DROP_VOICECALL:
                ...
                try {
                    realNumber = getInitialNumber(intent);
                } catch (Exception e) {
                    realNumber = null;
                }
    ...
    private CallStatusCode placeCallInternal(Intent intent) {
        ...
        try {
             ...
             * description : move below lines after we get whether
             * the number is an emergency number
             */
        ...
        */
        ...
        //for G+C project
        if (isEmergencyNumber && com.mediatek.featureoption.FeatureOption.MTK_DT_SUPPORT) {
            synchronized (this) {
            ...
            int eccSlot = eccRuleHandler.getPreferedSlot();
