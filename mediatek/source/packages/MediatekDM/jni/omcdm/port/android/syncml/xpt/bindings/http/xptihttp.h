 ...
 *      Created On:			May 2004
 *
 *      Version:			$Id: //depot/main/os/android/syncml/xpt/bindings/http/xptihttp.h#3 $
 *
 *      Coding Standards:	3.0
 *
 *      Purpose:            Android specific files for the SyncML code
 *
...
#define ltoa(l, buff, size) sprintf(buff, "%d", l)
