...
#define MTK_OMX_INPUT_BUFFER_SIZE_MP3 15000 //8192  one mp3 frame max length 1441 byte
#define MTK_OMX_OUTPUT_BUFFER_SIZE_MP3 4608          

#define MTK_OMX_NUMBER_INPUT_BUFFER_MP3  10
#define MTK_OMX_NUMBER_OUTPUT_BUFFER_MP3  9
