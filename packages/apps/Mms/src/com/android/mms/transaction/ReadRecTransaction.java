...
public class ReadRecTransaction extends Transaction implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            Xlog.d(MmsApp.TXN_TAG,"messageid:"+messageId+",and readreport flag:"+readReportState);
            ...
            try {
                ...
                Xlog.d(MmsApp.TXN_TAG,"find address:"+address+",charset:"+charSet);
            ...
            Xlog.d(MmsApp.TXN_TAG,"before send read report pdu.");
            sendPdu(postingData);            
            Xlog.d(MmsApp.TXN_TAG,"after send read report pdu.ok");
            ...
            if (mTransactionState.getState() != TransactionState.SUCCESS) {
                ...
                Xlog.e(MmsApp.TXN_TAG, "send read report failed.uri:"+mId);
            }
