...
public class DmMmiConfirmation implements MmiConfirmation {
    ...
    public MmiResult display(MmiViewContext arg0, ConfirmCommand arg1) {
        ...
        /*
        Log.w("haman", "MmiConfirmation displayed called");
        Log.w("haman", "text: " + arg0.displayText);
        ...
        */
        ...
        if (DmService.getServiceInstance()!=null)
            DmService.getServiceInstance().showNiaNotification(IDmPersistentValues.MSG_NIASESSION_START);
        return MmiResult.OK;
    }
