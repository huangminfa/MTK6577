...
public class WebHistoryItem implements Cloneable {
    ...
    public String getTouchIconUrl() {
        ...
        try {
            // mUrl is the true url of this webpage item. mOrigianlUrl is the first request which might
            // be some redirected url. To get touch icon, we should use webpage's url.
