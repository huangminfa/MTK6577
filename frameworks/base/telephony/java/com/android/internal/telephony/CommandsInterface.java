...
//MTK-END [mtk80950][120810][ALPS00XXXXXX] add UTK
    ...
    * @param result callback message     */    
    ...
    void setNewMessageIndication(int mode, int mt, int bm, int ds, int bfr, Message response);
    void setSmsPreStore(int preStore, Message response);
    void setSimSmsRead(int index, Message response);
    ...
    void setUnsolOemHookRowPrefix (String[] urcPrefixes, Message result);
...
//MTK-START [mtk04258][20120806][International card support]
    ...
    void continueMdInit(Message response);
    void getLimitServiceOperator(Message response);
    void switchModem(int preferredNetworkType, int simId);
