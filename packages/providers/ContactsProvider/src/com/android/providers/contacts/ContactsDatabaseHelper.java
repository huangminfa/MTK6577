...
/* package */ class ContactsDatabaseHelper extends SQLiteOpenHelper {
     ...
     * </pre>
     */
    static final int DATABASE_VERSION = 667;
    ...
    public interface Clauses {
        ...
        final String RAW_CONTACT_IS_LOCAL_SIM = RawContactsColumns.CONCRETE_ACCOUNT_TYPE
                + " = 'SIM Account' AND " + RawContactsColumns.CONCRETE_DATA_SET + " IS NULL";
        
        final String RAW_CONTACT_IS_LOCAL_USIM = RawContactsColumns.CONCRETE_ACCOUNT_TYPE
                + " IS 'USIM Account' AND " + RawContactsColumns.CONCRETE_DATA_SET + " IS NULL";

        final String RAW_CONTACT_IS_LOCAL_PHONE = RawContactsColumns.CONCRETE_ACCOUNT_TYPE 
                + " IS 'Local Phone Account' AND " + RawContactsColumns.CONCRETE_DATA_SET + " IS NULL";
                ...
                "SELECT " +
                    "MAX((SELECT (CASE WHEN " +
                        "(CASE" +
                            ...
                            * Bug Fix by Mediatek End.
                            */
                            /*" WHEN " + RAW_CONTACT_IS_LOCAL_SIM +
                            " THEN 1 " +
                            " WHEN " + RAW_CONTACT_IS_LOCAL_USIM +
                            " THEN 1 " +
                            " WHEN " + RAW_CONTACT_IS_LOCAL_PHONE +
                            " THEN 1 " +*/
...
//        ");");
        ...
        db.execSQL("CREATE TABLE " + Tables.GROUPS + " (" +
                ...
                Groups.ACCOUNT_NAME + " STRING DEFAULT 'Phone', " +
                Groups.ACCOUNT_TYPE + " STRING DEFAULT 'Local Phone Account', " +
    ...
    private void upgradeToVersion666(SQLiteDatabase db) {
        ...
        db.execSQL("UPDATE raw_contacts SET "
                ...
                + " WHERE ("
                + RawContacts.ACCOUNT_NAME + " IS NULL OR " + RawContacts.ACCOUNT_NAME + "='') AND (" 
    ...
    private void updateCustomContactVisibility(SQLiteDatabase db, String selection) {
        ...
        */
        ...
        String selection1 = "(1 = 1)";
        if (null == selection || selection.length() <= 0) {
            // selection1 = "(1 = 1)";
        } else {
            selection1 = "(1 = 1)" + selection;
        }
        db.execSQL("DELETE FROM " + Tables.VISIBLE_CONTACTS +
                   " WHERE " + selection1 + " AND _id NOT IN" +
                     "(SELECT " + Contacts._ID +
                     " FROM " + Tables.CONTACTS +
                     " WHERE " + selection1 + " AND (" + Clauses.CONTACT_IS_VISIBLE + ")=1)",
             selectionArgs);

        db.execSQL("INSERT INTO " + Tables.VISIBLE_CONTACTS +
                   " SELECT " + Contacts._ID +
                   " FROM " + Tables.CONTACTS +
                   " WHERE " + selection1 + " AND " + Contacts._ID +
                   " NOT IN " + Tables.VISIBLE_CONTACTS +
	...
	private void createDialerSearchTable(SQLiteDatabase db) {
		if (FeatureOption.MTK_SEARCH_DB_SUPPORT) {
			db.execSQL("CREATE TABLE " + Tables.DIALER_SEARCH + " ("
					...
					+ DialerSearchLookupColumns.RAW_CONTACT_ID + " INTEGER REFERENCES raw_contacts(_id) NOT NULL,"
					...
					+ DialerSearchLookupColumns.NORMALIZED_NAME_ALTERNATIVE + " VARCHAR DEFAULT NULL,"
					+ DialerSearchLookupColumns.SEARCH_DATA_OFFSETS_ALTERNATIVE + " VARCHAR DEFAULT NULL " + ");");
	...
	private void createDialerSearchView(SQLiteDatabase db) {
		if (FeatureOption.MTK_SEARCH_DB_SUPPORT) {
			...
			String mDSViewSelect = "SELECT "
				+ mDSNumberTable + "." + DialerSearchLookupColumns._ID + " AS " + DialerSearch.NAME_LOOKUP_ID + ","
				+ Tables.CONTACTS + "." + Contacts._ID + " AS " + DialerSearch.CONTACT_ID + ","
				+ mDSNumberTable + "." + DialerSearchLookupColumns.RAW_CONTACT_ID + " AS " + DialerSearch.RAW_CONTACT_ID + ","
				+ Tables.RAW_CONTACTS + "." + RawContacts.DISPLAY_NAME_PRIMARY + " AS " + DialerSearch.NAME + ","
				+ Tables.RAW_CONTACTS + "." + RawContacts.DISPLAY_NAME_ALTERNATIVE + " AS " + DialerSearch.NAME_ALTERNATIVE + ","
				+ Tables.CALLS + "." + Calls.DATE + " AS " + DialerSearch.CALL_DATE + ","
				+ mDSNumberTable + "." + DialerSearchLookupColumns.CALL_LOG_ID + " AS " + DialerSearch.CALL_LOG_ID + ","
				...
				+ Tables.CALLS + "." + Calls.GEOCODED_LOCATION + " AS " + DialerSearch.CALL_GEOCODED_LOCATION + ","
				+ mDSNumberTable + "." + DialerSearchLookupColumns.NORMALIZED_NAME + " AS " + DialerSearch.SEARCH_PHONE_NUMBER + ","
				+ Tables.DATA + "." + Data.DATA2 + " AS " + DialerSearch.SEARCH_PHONE_TYPE + ","
				+ Tables.CONTACTS + "." + Contacts.LOOKUP_KEY + " AS " + DialerSearch.CONTACT_NAME_LOOKUP + ","
				...
				+ Tables.CONTACTS + "." + Contacts.INDICATE_PHONE_SIM + " AS " + DialerSearch.INDICATE_PHONE_SIM + ","
				+ Tables.CONTACTS + "." + Contacts.IS_SDN_CONTACT + " AS " + DialerSearch.IS_SDN_CONTACT + ","  // add by MTK
				+ Tables.RAW_CONTACTS + "." + RawContacts.SORT_KEY_PRIMARY + " AS " + DialerSearch.SORT_KEY_PRIMARY + ","
				+ Tables.RAW_CONTACTS + "." + RawContacts.SORT_KEY_ALTERNATIVE + " AS " + DialerSearch.SORT_KEY_ALTERNATIVE + ","
				+ mDSNameTable + "." + DialerSearchLookupColumns._ID + " AS " + DialerSearch.NAME_ID 
			    + " FROM (SELECT * FROM " + Tables.DIALER_SEARCH + " WHERE " + DialerSearchLookupColumns.NAME_TYPE + " = " + DialerSearchLookupType.PHONE_EXACT + ") AS " + mDSNumberTable
			    + " LEFT JOIN " + Tables.RAW_CONTACTS + " ON " + Tables.RAW_CONTACTS + "." + RawContacts._ID + " = " + mDSNumberTable + "." + DialerSearchLookupColumns.RAW_CONTACT_ID
			    + " LEFT JOIN " + Tables.CONTACTS + " ON " + Tables.CONTACTS + "." + Contacts._ID + " = " + Tables.RAW_CONTACTS + "." + RawContacts.CONTACT_ID
			    + " LEFT JOIN " + Tables.CALLS + " ON " + Tables.CALLS + "." + Calls._ID + " = " + mDSNumberTable + "." + DialerSearchLookupColumns.CALL_LOG_ID
			    + " LEFT JOIN " + Tables.DATA + " ON " + Tables.DATA + "." + Data._ID + " = " + mDSNumberTable + "." + DialerSearchLookupColumns.DATA_ID
			    + " LEFT JOIN " + Tables.DIALER_SEARCH + " AS " + mDSNameTable + " ON " + mDSNameTable + "." + DialerSearchLookupColumns.RAW_CONTACT_ID + " = " + mDSNumberTable + "." + DialerSearchLookupColumns.RAW_CONTACT_ID 
			    + " AND " + mDSNameTable + "." + DialerSearchLookupColumns.NAME_TYPE + " = " + DialerSearchLookupType.NAME_EXACT
			    + " WHERE " + Tables.CONTACTS + "." + Contacts._ID + " >0 OR " + mDSNumberTable + "." + DialerSearchLookupColumns.CALL_LOG_ID + ">0";
    ...
    private void createContactsTriggersWithDialerSearch(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TRIGGER " + Tables.AGGREGATION_EXCEPTIONS + "_splite_contacts AFTER INSERT ON " + Tables.AGGREGATION_EXCEPTIONS
        		+ " BEGIN "
        		+ "   UPDATE " + Tables.DIALER_SEARCH 
        		+ "     SET " + DialerSearchLookupColumns.RAW_CONTACT_ID + "="
        						+"(SELECT " + DialerSearchLookupColumns.RAW_CONTACT_ID 
        						+ " FROM " + Tables.DATA + 
        						" WHERE " + Tables.DATA + "." + Data._ID + "=" + Tables.DIALER_SEARCH + "." + DialerSearchLookupColumns.DATA_ID + ")"
        		+ "   WHERE " + DialerSearchLookupColumns.RAW_CONTACT_ID + " IN (" + "NEW." + AggregationExceptions.RAW_CONTACT_ID1 + ",NEW." + AggregationExceptions.RAW_CONTACT_ID2 + ")"
        		...
        		+ "   WHERE " + DialerSearchLookupColumns.RAW_CONTACT_ID + " IN (" + "NEW." + AggregationExceptions.RAW_CONTACT_ID1 + ",NEW." + AggregationExceptions.RAW_CONTACT_ID2 + ")"
				        		...
				        		+ " AND " + DialerSearchLookupColumns.NAME_TYPE + "=" + DialerSearchLookupType.NAME_EXACT
				        		+ " AND " + "NEW." + AggregationExceptions.TYPE + "=2"
				        		+ ";"        		
        		+ " END");
