...
public class DmPIMNodeIoHandler implements NodeIoHandler {
    ...
    private String[] mItem = {"DefProfile", "ConnProfile", "Addr", "AddressBookURI"};
    ...
    public int read(int arg0, byte[] arg1) throws MdmException {
        ...
        if (DmService.mCCStoredParams.containsKey(uriPath)) {
            ...
            if (mNode.equalsIgnoreCase(mItem[0])) {
                ...
                try {
                    recordToRead = PimContentProvider.ipth_HALGetDefaultPIMProfile(
                                       uri, mContext);
                } catch (Exception e) {
                    e.printStackTrace();
                ...
                try {
                    recordToRead = PimContentProvider.ipth_HALGetCMCCPIMServerAddr(
                                       uri, mContext);
                } catch (Exception e) {
                    e.printStackTrace();
                    throw new MdmException(0xFFFE);
                ...
                try {
                    recordToRead = PimContentProvider.ipth_HALGetCMCCPIMContactPath(
                                       uri, mContext);
                } catch (Exception e) {
                    e.printStackTrace();
                    throw new MdmException(0xFFFE);
    ...
    public void write(int arg0, byte[] arg1, int arg2) throws MdmException {
        ...
        if (mNode.equalsIgnoreCase(mItem[0])) {
            ...
            Uri uri = Uri.parse(databaseUri_DefProfile);
            try {
                PimContentProvider.ipth_HALSetDefaultPIMProfile(
                    uri, mContext,value);
            } catch (Exception e) {
                e.printStackTrace();
                throw new MdmException(0xFFFE);
            ...
            Uri uri = Uri.parse(databaseUri_ConnProfile);
            try {
                PimContentProvider.ipth_HALSetCMCCPIMConnectionProfile(
                    uri, mContext, value);
            } catch (Exception e) {
                e.printStackTrace();
                throw new MdmException(0xFFFE);
            ...
            Uri uri = Uri
                      .parse(databaseUri_Addr);
            try {
                PimContentProvider.ipth_HALSetCMCCPIMServerAddr(
                    uri, mContext, value);
            } catch (Exception e) {
                e.printStackTrace();
                throw new MdmException(0xFFFE);
            ...
            Uri uri = Uri.parse(databaseUri_Contact);
            try {
                PimContentProvider.ipth_HALSetCMCCPIMContactPath(
                    uri, mContext, value);
            } catch (Exception e) {
                e.printStackTrace();
                throw new MdmException(0xFFFE);
