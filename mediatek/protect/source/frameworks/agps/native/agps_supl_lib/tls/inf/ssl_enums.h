 ...
 * Maintain trusted list in SSL wrapper global context to reduce peak memory usage
 *
 * Nov 29 2007 mtk01264
 * [MAUI_00563283] [TLS] Check in TLS task
 * Check in TLS task
 *
 * Oct 18 2007 mtk01264
 * [MAUI_00562310] [SSL] Move security interface files from ps directory to security directory
 * Move SSL header to security directory
 *
 * Oct 15 2007 mtk01264
 * [MAUI_00559724] [SSL] Change return code of sec_ssl_ctx_use_privatekey_file()
 * New error code for ssl_read()
 *
 * Sep 26 2007 mtk01264
 * [MAUI_00037669] Error in sec_ssl_ctx_load_verify_locations()
 * New client auth enum value for both client and server
 *
 * Sep 21 2007 MTK01264
 * [MAUI_00037669] Error in sec_ssl_ctx_load_verify_locations()
 * New enums for identify certificate algorithms
 *
 * Sep 13 2007 MTK01264
 * [MAUI_00547710] [SSL] New API to extract certificate authorities list from cert req message
 * Duplicate certificate authorities to SSL wrapper context
 *
 * Sep 9 2007 MTK01264
 * [MAUI_00545088] [SSL] Seperate adaptation from sslplus5
 * Add sslplus5adp
 *
 *
 *
...
ssl_error_enum
    ...
    SEC_ERROR_LOCAL_IDENTITY_REQUESTED = -256,    /* CIC_ERR_LOCAL_IDENTITY_REQUESTED */
    SEC_ERROR_NONE              =  0x0000,                    /* CIC_ERR_NONE */
    SEC_ERROR_PTR               =  0x0001,                  /* CIC_ERR_NO_PTR */
    SEC_ERROR_PARAM             =  0x0002,           /* CIC_ERR_ILLEGAL_PARAM */
    SEC_ERROR_BUFFER_SIZE       =  0x0003,            /* CIC_ERR_SMALL_BUFFER */
    SEC_ERROR_WOULDBLOCK        = -0x0004,             /* CIC_ERR_WOULD_BLOCK */
    //SEC_ERROR_WOULDBLOCK      =  0x0004,             /* CIC_ERR_WOULD_BLOCK */
    SEC_ERROR_TIMEOUT           =  0x0005,                 /* CIC_ERR_TIMEOUT */
    SEC_ERROR_BAD_LEN           =  0x0006,              /* CIC_ERR_BAD_LENGTH */
    SEC_ERROR_NOT_FOUND         =  0x0007,               /* CIC_ERR_NOT_FOUND */
    SEC_ERROR_BAD_CTX           =  0x0008,                 /* CIC_ERR_BAD_CTX */
    SEC_ERROR_BAD_IDX           =  0x0009,               /* CIC_ERR_BAD_INDEX */
    SEC_ERROR_RANDOM            =  0x000A,                  /* CIC_ERR_RANDOM */
    SEC_ERROR_MEM_UNDERRUN      =  0x000B,            /* CIC_ERR_MEM_UNDERRUN */
    SEC_ERROR_MEM_OVERRUN       =  0x000C,             /* CIC_ERR_MEM_OVERRUN */
    SEC_ERROR_MEM_FREED         =  0x000D,           /* CIC_ERR_MEM_WAS_FREED */
    SEC_ERROR_MEM_NOT_OURS      =  0x000E,            /* CIC_ERR_MEM_NOT_OURS */
    SEC_ERROR_MEM_ZERO          =  0x000F,        /* CIC_ERR_MEM_ZERO_ALLOCED */

    SEC_ERROR_BAD_DER_ENCODING  =  0x0218,        /* CIC_ERR_DER_BAD_ENCODING */
    SEC_ERROR_INCOMPLETE_ID     =  0x1001, /* CIC_ERR_SSL_INCOMPLETE_IDENTITY */
    SEC_ERROR_SSL_BAD_SIDE      =  0x1002,            /* CIC_ERR_SSL_BAD_SIDE */
    SEC_ERROR_SSL_OVERFLOW      =  0x1003,            /* CIC_ERR_SSL_OVERFLOW */
    SEC_ERROR_SSL_UNEXP_MSG     =  0x1004,      /* CIC_ERR_SSL_UNEXPECTED_MSG */
    SEC_ERROR_SSL_BAD_MAC       =  0x1005,             /* CIC_ERR_SSL_BAD_MAC */
    SEC_ERROR_SSL_DECRYPT       =  0x1006,      /* CIC_ERR_SSL_DECRYPT_FAILED */
    SEC_ERROR_SSL_UNKNOWN_REC   =  0x1007,      /* CIC_ERR_SSL_UNKNOWN_RECORD */
    SEC_ERROR_SSL_NEGOTIATION   =  0x1008,         /* CIC_ERR_SSL_NEGOTIATION */
    SEC_ERROR_SSL_IO            = -0x1009,                  /* CIC_ERR_SSL_IO */
    //SEC_ERROR_SSL_IO          =  0x1009,                  /* CIC_ERR_SSL_IO */
    SEC_ERROR_SSL_FATAL_ALERT   =  0x100A,         /* CIC_ERR_SSL_FATAL_ALERT */
    SEC_ERROR_SSL_PROTOCOL      =  0x100B,            /* CIC_ERR_SSL_PROTOCOL */
    SEC_ERROR_SSL_RESUME_SESS   =  0x100C,   /* CIC_ERR_SSL_RESUMABLE_SESSION */
    SEC_ERROR_SSL_BAD_FIN_MSG   =  0x100D,/* CIC_ERR_SSL_BAD_FINISHED_MESSAGE */
    SEC_ERROR_SSL_GRACE_CLOSED  =  0x100E,  /* CIC_ERR_SSL_CONNECTION_CLOSED_GRACEFUL */
    SEC_ERROR_SSL_CLOSED        =  0x100F,   /* CIC_ERR_SSL_CONNECTION_CLOSED */
    SEC_ERROR_SSL_BAD_CERT      =  0x1011,     /* CIC_ERR_SSL_BAD_CERTIFICATE */
    SEC_ERROR_SSL_SESS_NOT_FOUND=  0x1013,   /* CIC_ERR_SSL_SESSION_NOT_FOUND */
    SEC_ERROR_SSL_PROTOCOL_VER  =  0x1019,/* CIC_ERR_SSL_BAD_PROTOCOL_VERSION */
    SEC_ERROR_SSL_NO_CERT       =  0x101E,      /* CIC_ERR_SSL_NO_CERTIFICATE */
    SEC_ERROR_SSL_NO_MATCHING_CERTS = 0x101F, /* CIC_ERR_SSL_NO_MATCHING_CERTIFICATES */
    SEC_ERROR_SSL_CERT_VALIDATE_FAILED = 0x1020,   /* CIC_ERR_SSL_CERTIFICATE_VALIDATE_FAILED */
    SEC_ERROR_SSL_NULL_CB       =  0x1022,             /* CIC_ERR_SSL_NULL_CB */
    SEC_ERROR_SSL_ENTROPY       =  0x1024,  /* CIC_ERR_SSL_ENTROPY_COLLECTION */
    SEC_ERROR_SSL_BAD_CONTEXT   =  0x102F,         /* CIC_ERR_SSL_BAD_CONTEXT */
    SEC_ERROR_SSL_HSHK_REQUIRED =  0x1030,  /* CIC_ERR_SSL_HANDSHAKE_REQUIRED */
    SEC_ERROR_SSL_HSHK_REQUESTED=  0x1031, /* CIC_ERR_SSL_HANDSHAKE_REQUESTED */
    SEC_ERROR_SSL_RENEGOTIATE_REFUSED = 0x1032,  /* CIC_ERR_SSL_RENEGOTIATION_REFUSED */
    SEC_ERROR_SSL_HSHK_COMPLETED      = 0x1033,   /* CIC_ERR_SSL_HANDSHAKE_ALREADY_COMPLETED */
    SEC_ERROR_SSL_READ_REQUIRED =  0x1035,       /* CIC_ERR_SSL_READ_REQUIRED */
    SEC_ERROR_SSL_UNSUPP_PUBKEY =  0x1036,     /* CIC_ERR_SSL_UNSUPPORTED_PUBKEY_TYPE */
    SEC_ERROR_SSL_BAD_REC_LEN   =  0x1037,   /* CIC_ERR_SSL_BAD_RECORD_LENGTH */
    SEC_ERROR_SSL_NEEDS_CIPHER  =  0x1038,  /* CIC_ERR_SSL_NEEDS_CIPHER_OR_CLIENTAUTH */
    SEC_ERROR_SSL_NEEDS_PRNG    =  0x103B,          /* CIC_ERR_SSL_NEEDS_PRNG */
    SEC_ERROR_SSL_CERT_CHAIN_WARN = 0x103C,/* CIC_ERR_SSL_CERT_CHAIN_WARNINGS */
    SEC_ERROR_SSL_TRUSTED_EXPIRED     = 0x103D,   /* CIC_ERR_SSL_WARN_TRUSTED_EXPIRED */
    SEC_ERROR_SSL_NO_TRUSTED_ISSUER   = 0x1046,     /* CIC_ERR_CERT_NO_TRUSTED_ISSUER */
    SEC_ERROR_SSL_INVALID_CERT_CHAIN  = 0x1053,  /* CIC_ERR_SSL_INVALID_CERTIFICATE_CHAIN */
    SEC_ERROR_SSL_COMPRESS_CALLBACK   = 0x1056,          /* CIC_ERR_SSL_COMPRESS_CALLBACK */
    SEC_ERROR_SSL_COMPRESS_EX_MAX_LEN = 0x1057,  /* CIC_ERR_SSL_COMPRESS_EXCEEDED_MAX_LEN */
    SEC_ERROR_SSL_INTERNAL_TP_VALIDATE= 0x106B,       /* CIC_ERR_SSL_INTERNAL_TP_VALIDATE */

    SEC_ERROR_BAD_ENCODING      = 0x0221,      /* CIC_ERR_CODING_BAD_ENCODING */
    SEC_ERROR_BAD_PEM           = 0x0222,           /* CIC_ERR_CODING_BAD_PEM */
    SEC_ERROR_NOT_IMPL          = 0x0FFE,          /* CIC_ERR_NOT_IMPLEMENTED */
    SEC_ERROR_INTERNAL          = 0x0FFF,                 /* CIC_ERR_INTERNAL */
    SEC_ERROR_MEM               = 0xF001,    /* CIC_ERR_MEMORY, SB_FAIL_ALLOC */
    SEC_ERROR_UNKNOWN           = 0xFFFF
/* DOM-NOT_FOR_SDK-END */
...
/* Keep the same order in ssl_auth_mode_enum with ssl_client_auth_modes. */
#endif /* CODING NOTE DO NOT SHOW IN DOM DOCUMENTS! */
...
#if 0 /* CODING NOTE DO NOT SHOW IN DOM DOCUMENTS! */
/* Assure sec_cipher_enum to be coincident with the ordering in
   sec_cipher_suites */
#endif /* CODING NOTE DO NOT SHOW IN DOM DOCUMENTS! */
...
/* DOM-NOT_FOR_SDK-BEGIN */
sec_cert_warn_enum
    SEC_CERT_WARN_NONE                 = 0x00000000,
    SEC_CERT_WARN_CHAIN                = 0x00000001,
    SEC_CERT_WARN_BCONST_NOT_CRITICAL  = 0x00000002,

    SEC_CERT_WARN_UNKNOWN_CRITICAL_EXT = 0x00000008,
    SEC_CERT_WARN_VALIDITY             = 0x00000010,
    SEC_CERT_WARN_NO_KEY_USAGE         = 0x00000020,
    SEC_CERT_WARN_KEY_MISUSE           = 0x00000040,
    SEC_CERT_WARN_BCONST_FAIL          = 0x00000100,
    SEC_CERT_WARN_NO_TRUSTED_CERTS     = 0x00000200,
    SEC_CERT_WARN_INVALID_SIGNATURE    = 0x00000400,
    SEC_CERT_WARN_INTERNAL             = 0x00000800,
    SEC_CERT_WARN_TRUSTED_KEY_MISUSE   = 0x00010000,
    SEC_CERT_WARN_TRUSTED_EXPIRED      = 0x00020000,
    SEC_CERT_WARN_CORRUPTED_CERT       = 0x00040000,
    SEC_CERT_WARN_TRUSTED_NO_KEY_USAGE = 0x00080000,
    SEC_CERT_WARN_NO_CERT_HASH         = 0x00100000,

    /* new for OpenSSL */
    SEC_CERT_WARN_BAD_CERT             = 0x00200000,
    SEC_CERT_WARN_BAD_CRL              = 0x00400000,
    SEC_CERT_WARN_CRL_EXPIRY           = 0x00800000,
    SEC_CERT_WARN_CERT_PURPOSE         = 0x01000000,
    SEC_CERT_WARN_INVALID_KEY_USAGE    = 0x02000000,
    SEC_CERT_WARN_UNRECOGINZED_CRL_EXT = 0x04000000,
    SEC_CERT_WARN_PROXY_CERT           = 0x08000000,
    SEC_CERT_WARN_INVALID_EXT          = 0x10000000,
    SEC_CERT_WARN_POLICY               = 0x20000000,

    SEC_CERT_WARN_BAD_DOMAIN           = 0x40000000, /* Checking domain name failed */

    SEC_CERT_WARN_BCONST_FAIL_NC       = /* 0x00000102 */
        SEC_CERT_WARN_BCONST_FAIL | SEC_CERT_WARN_BCONST_NOT_CRITICAL,

    SEC_CERT_WARN_WEAK_SECURITY_MASK   = /* 0x00000021 */
        SEC_CERT_WARN_NO_KEY_USAGE | SEC_CERT_WARN_CHAIN,

    SEC_CERT_WARN_MISCONFIG_MASK       = /* 0x001B0112 */
        SEC_CERT_WARN_NO_CERT_HASH | SEC_CERT_WARN_TRUSTED_NO_KEY_USAGE |
        SEC_CERT_WARN_TRUSTED_EXPIRED | SEC_CERT_WARN_TRUSTED_KEY_MISUSE |
        SEC_CERT_WARN_BCONST_FAIL | SEC_CERT_WARN_VALIDITY |
        SEC_CERT_WARN_BCONST_NOT_CRITICAL,

    SEC_CERT_WARN_ATTACK_MASK          = /* 0x00000148 */
        SEC_CERT_WARN_BCONST_FAIL | SEC_CERT_WARN_KEY_MISUSE |
        SEC_CERT_WARN_UNKNOWN_CRITICAL_EXT,

    SEC_CERT_WARN_AUTH_FAILED_MASK     = /* 0x00040E00 */
        SEC_CERT_WARN_CORRUPTED_CERT |
        SEC_CERT_WARN_NO_TRUSTED_CERTS |
        SEC_CERT_WARN_INVALID_SIGNATURE |
        SEC_CERT_WARN_INTERNAL
/* DOM-NOT_FOR_SDK-END */
#endif /* CODING NOTE DO NOT SHOW IN DOM DOCUMENTS! */
