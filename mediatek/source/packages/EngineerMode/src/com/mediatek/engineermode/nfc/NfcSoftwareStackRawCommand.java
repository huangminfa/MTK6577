...
public class NfcSoftwareStackRawCommand extends Activity implements OnClickListener {
	...
	private void initUI() {		
		mBtnSend = (Button)findViewById(R.id.NFC_SoftwareStack_RawCommand_Send);
		mBtnExample = (Button)findViewById(R.id.NFC_SoftwareStack_RawCommand_Examp);
		mEditCommand = (EditText)findViewById(R.id.NFC_SoftwareStack_RawCommand_String);	
	...
	public void onClick(View arg0) {	
		...
		if (arg0 == mBtnSend) {			
			...
			mEditCommand.setText("00 A4 04 00 0E A0 00 00 00 18 30 80 05 00 65 63 68 6F 00 00");
		}
	}
