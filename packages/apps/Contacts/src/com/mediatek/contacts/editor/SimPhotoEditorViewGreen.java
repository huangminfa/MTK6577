...
public class SimPhotoEditorViewGreen extends PhotoEditorView{
    
    private static final String TAG = "SimPhotoEditorViewGreen";
    ...
    protected void resetDefault() {
        ...
        mPhotoImageView.setImageResource(R.drawable.ic_contact_picture_sim_contact_green);
