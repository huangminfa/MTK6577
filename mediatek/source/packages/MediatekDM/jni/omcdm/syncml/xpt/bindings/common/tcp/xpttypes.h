 ...
 *      Created On:			May 2004
 *
 *      Version:			$Id: //depot/main/base/syncml/xpt/bindings/common/tcp/xpttypes.h#4 $
 *
...
/**
 * @file
 * Communication Services, standard type definitions
 *
 * @target_system   all
 * @target_os       all
 * @description Definition of several basic datatypes.
 */
...
#ifndef Bool_t
  #if defined(__INIT_SML_XPT_GLOBALS) || defined(__cplusplus)
     typedef bool Bool_t;
  #else
     #if defined(_WIN32) || defined(linux) || defined(__GCC32__)
        // for C compilers without C99 extensions
