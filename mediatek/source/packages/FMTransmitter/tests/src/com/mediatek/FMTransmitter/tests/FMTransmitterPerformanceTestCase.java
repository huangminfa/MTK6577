...
public class FMTransmitterPerformanceTestCase extends
    ...
    public void testcase04_TestSeekTime() {
        ...
        int currentStation = FMTransmitterStation.getCurrentStation(mFMTransmitterActivity);
        mStartTime = System.currentTimeMillis();
        ...
        int searchStation = FMTransmitterStation.getCurrentStation(mFMTransmitterActivity);
