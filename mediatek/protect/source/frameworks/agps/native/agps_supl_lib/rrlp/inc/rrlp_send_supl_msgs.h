...
#ifndef _RRLP_SEND_SUPL_MSGS_H
#define _RRLP_SEND_SUPL_MSGS_H
...
extern void rrlp_send_supl_data_rsp(kal_bool result, supl_lcsp_data_enum msg_type);
extern void rrlp_send_supl_data_req(rrlp_payload_enum payload_type, kal_uint8 *pdu_ptr, kal_uint16 pdu_len, kal_bool more);


#endif /* _RRLP_SEND_SUPL_MSGS_H */
