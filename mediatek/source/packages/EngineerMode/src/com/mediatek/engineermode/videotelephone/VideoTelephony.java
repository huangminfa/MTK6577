...
public class VideoTelephony extends PreferenceActivity implements
		Preference.OnPreferenceChangeListener {
	private static final String TAG = "EM/VideoTelephony";

	public static final String ENGINEER_MODE_PREFERENCE = "engineermode_vt_preferences";

	public static final String WORKING_MODE = "working_mode";
	public static final String WORKING_MODE_DETAIL = "working_mode_detail";

	public static final String CONFIG_AUDIO_CHANNEL_ADAPT = "config_audio_channel_adapt";
	public static final String CONFIG_VIDEO_CHANNEL_ADAPT = "config_video_channel_adapt";
	public static final String CONFIG_VIDEO_CHANNEL_REVERSE = "config_video_channel_reverse";
	public static final String CONFIG_MULTIPLEX_LEVEL = "config_multiplex_level";
	public static final String CONFIG_VIDEO_CODEC_PREFERENCE = "config_video_codec_preference";
	...
	public static final String PEER_AUDIO_RECODER_SERVICE = "peer_audio_recoder_service";
	public static final String PEER_AUDIO_RECODER_FORMAT = "peer_audio_recoder_format";

	public static final String PEER_VIDEO_RECODER_SERVICE = "peer_video_recoder_service";
	public static final String PEER_VIDEO_RECODER_FORMAT = "peer_video_recoder_format";
	...
	public static final String[] logFilterTagKey = { "log_filter_tag_0",
			"log_filter_tag_1", "log_filter_tag_2", "log_filter_tag_3",
			"log_filter_tag_4", "log_filter_tag_5", "log_filter_tag_6" };
	public static final String[] logFilterTagValue = {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (mDebugPref == null || mLogToFilePref == null
				|| mH263OnlyPref == null) {
			Xlog.e("VideoTelephony", "clocwork worked...");
		...
		if (mSDCardFlag) {
			...
			mPreferenceScreen.addPreference(mRawDataPref);
			...
			mPeerAudioRecorder.setOnPreferenceClickListener(mPreferenceScreen
					.getOnPreferenceClickListener());
			mPreferenceScreen.addPreference(mPeerAudioRecorder);
			...
			mPeerVideoRecorder.setOnPreferenceClickListener(mPreferenceScreen
					.getOnPreferenceClickListener());
			mPreferenceScreen.addPreference(mPeerVideoRecorder);
	...
	public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
		...
		} else if (preference.getKey().equals("my3g324m_configuration")) {
	...
	private void initStatus() {
		try {
			...
			mLogToFilePref.setChecked(preferences
					.getBoolean(LOG_TO_FILE, false));
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.vt_set_to_default:
			...
			if (result) {
				initStatus();
				Toast.makeText(this, "Set date to default success!",
						Toast.LENGTH_SHORT).show();
			} else {
				Toast.makeText(this, "Set date to default fail!",
						Toast.LENGTH_SHORT).show();
			}
