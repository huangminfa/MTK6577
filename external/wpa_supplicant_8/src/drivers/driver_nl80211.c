...
static int wpa_driver_nl80211_capa(struct wpa_driver_nl80211_data *drv)
{
	...
	if (info.offchan_tx_supported && 0) {
				   ...
				   struct wpa_driver_scan_params *params)
{
	...
	for (i = 0; i < params->num_ssids; i++) {
		wpa_hexdump_ascii(MSG_INFO, "nl80211: Scan SSID",
				  params->ssids[i].ssid,
	...
	if (params->extra_ies) {
		wpa_hexdump_ascii(MSG_INFO, "nl80211: Scan extra IEs",
...
#if defined(ANDROID_BRCM_P2P_PATCH) && 1 /* defined(HOSTAPD) */
...
static int wpa_driver_nl80211_probe_req_report(void *priv, int report)
{
	...
	if (nl80211_register_frame(drv, drv->nl_handle_preq,
	    ...
	    wpa_printf(MSG_DEBUG, "nl80211: Probe Request reporting "
			   "nl80211_register_frame Success!");
	}

#if 0 // #ifdef   ANDROID_BRCM_P2P_PATCH
	if (drv->nlmode != NL80211_IFTYPE_AP &&
		drv->nlmode != NL80211_IFTYPE_P2P_GO) {
...
static int wpa_driver_nl80211_testmode(void *priv, struct wpa_driver_test_params *params)
{
	struct i802_bss *bss = priv;
	struct wpa_driver_nl80211_data *drv = bss->drv;
	struct nl_msg *msg, *cqm = NULL;

	wpa_printf(MSG_DEBUG, "nl80211: Test Mode (idx_mode=%d, idx =%d "
		   "value=%d )", params->idx_mode, params->idx, params->value);
	...
	NLA_PUT_U32(msg, NL80211_ATTR_IFINDEX, drv->ifindex);
	NLA_PUT(msg, NL80211_ATTR_TESTDATA, sizeof(struct wpa_driver_test_params), params);
...
const struct wpa_driver_ops wpa_driver_nl80211_ops = {
	...
	.set_value = wpa_driver_nl80211_testmode,
