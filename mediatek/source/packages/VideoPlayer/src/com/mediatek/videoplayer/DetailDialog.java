...
public class DetailDialog extends AlertDialog implements DialogInterface.OnClickListener {
    ...
    public DetailDialog(Context context, ViewHolder holder) {
        super(context);
        mContext = context;
        mHolder = holder;
        if (LOG) MtkLog.v(TAG, "LimitDialog() holder=" + holder);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitleView.setText(mContext.getString(R.string.detail_title, mHolder.title));
        mPathView.setText(mContext.getString(R.string.detail_path, mHolder._data));
        mDurationView.setText(mContext.getString(R.string.detail_duration, MtkUtils.stringForTime(mHolder.duration)));
        mTimeView.setText(mContext.getString(R.string.detail_date_taken, MtkUtils.localTime(mHolder.dateTaken)));
        mFileSizeView.setText(mContext.getString(R.string.detail_filesize, Formatter.formatFileSize(
                                mContext, mHolder.fileSize)));
