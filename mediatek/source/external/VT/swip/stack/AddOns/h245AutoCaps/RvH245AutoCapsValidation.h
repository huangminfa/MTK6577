...
/******************************************************************************
 * MTK patch: RvH245AutoCapsSetChannelHandle_bOpenNullData
 * ----------------------------------------------------------------------------
 * General: 
 *
 * Return Value: RV_OK if successful. Other on failure.
 ...
 * Output: None.
 *****************************************************************************/
RVAPI RvStatus RVCALLCONV RvH245AutoCapsSetChannelHandle_bOpenNullData(
    IN HAUTOCAPSCALL             hAutoCapsCall,
    IN HCHAN                     hChan,
    IN cmChannelDataType         eChannelType);

/******************************************************************************
 * MTK patch: RvH245AutoCapsGetParam_bOpenReverseData
 * ----------------------------------------------------------------------------
 * General: 
 *
 * Return Value: RV_OK if successful. Other on failure.
 ...
 * Arguments:
 * Input:  hAutoCapsCall - Handle to the H.245 AutoCaps call object.
 *         eChannelType        - Channel type
 *         bOpenReverseData - True if reverse is data
 *                         
 * Output: None.
 *****************************************************************************/
RVAPI RvStatus RVCALLCONV RvH245AutoCapsGetParam_bOpenReverseData(
    IN HAUTOCAPSCALL             hAutoCapsCall,
    IN cmChannelDataType         eChannelType,
    OUT RvBool                          *bOpenReverseData);
