...
public class TouchScreen_VerificationPoint extends Activity implements View.OnTouchListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
	...
	public boolean onTouch(View arg0, MotionEvent event) {
		...
		{
			Xlog.i(TAG, "The PrePoint.x value is : " + String.valueOf(PrePoint.x));
			Xlog.i(TAG, "The PrePoint.y value is : " + String.valueOf(PrePoint.y));
