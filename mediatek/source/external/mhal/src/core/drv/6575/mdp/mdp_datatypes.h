...
//Kernel Includes
#ifdef MT6577 /* FIXME */
#include "mt6577_mdp.h" //For MDP Element ID,and Kernel Flag
#else
#include "mt6575_mdp.h" //For MDP Element ID,and Kernel Flag
#endif
...
#define MDP_PROFILE(fmt, arg...)        if( g_b_profile )     {   MDPLOGE("[MDP PROFILE](%lu): "fmt,(unsigned long)gettid() ,##arg);  }
