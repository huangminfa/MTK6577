    ...
    public static IntentProvider getReturnCallIntentProvider(final String number, final long simId) {
        return new IntentProvider() {
            ...
            public Intent getIntent(Context context) {
                ...
                */
                return new Intent(Intent.ACTION_CALL_PRIVILEGED, uri).putExtra(Constants.EXTRA_ORIGINAL_SIM_ID, simId).setClassName(Constants.PHONE_PACKAGE, Constants.OUTGOING_CALL_BROADCASTER);
            }
        };
    }
