...
public class MAP {
	...
	public static final String FRACTION_REQUEST_FIRST 			= "first";
	public static final String FRACTION_REQUEST_NEXT			= "next";	

	//fraction deliver response
	public static final String FRACTION_DELIVER_MORE 			= "more";
	public static final String FRACTION_DELIVER_LAST			= "last";	
	...
	public static final int MAX_SUBJECT_LEN					= 256;
	...
	public static final int EVENT_DELIVERY_FAILURE 			= 2;
	public static final int EVENT_SEND_SUCCESS  				= 3;
