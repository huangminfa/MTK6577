...
public class ResolverActivity extends AlertActivity implements
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        // When the activity is relaunched by configuration (like launguage),
        // it will restore the save instance state. However, it won't load the new launguage text.
        // Therefore, we need to set the text again after restoring the instance.
        if (mAlwaysCheck != null) {
            mAlwaysCheck.setText(R.string.alwaysUse);
        }
    }
