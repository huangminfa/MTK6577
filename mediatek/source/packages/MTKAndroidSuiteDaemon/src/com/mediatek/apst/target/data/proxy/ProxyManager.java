 ...
 * <p>Package: com.mediatek.apst.target.data.proxy
 * <p>Created on: 2010-6-18
 * <p>
 * <p>Description: 
 * <p>An factory class for creating instances of proxy classes. 
 * External code should get new proxy instances with this factory class's 
 * creator methods, but not with the proxy classes' constructor directly. This 
 * factory class will create and return new instances of appropriate classes 
 * according to arguments provided by the caller. 
 *
...
public abstract class ProxyManager {
     ...
     * @param context Context needed by the the proxy to get a ContentResolver.
	 ...
	 * 
	 * @param contextContext needed by the the proxy to get a ContentResolver.
	 * @return An instance of media proxy.
	 * @see MediaProxy
	 */
