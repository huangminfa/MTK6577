...
public class AlertService extends Service {
    ...
    void processMessage(Message msg) {
        ...
        if (!action.equals(android.provider.CalendarContract.ACTION_EVENT_REMINDER)
                ...
                && !action.equals(UPDATE_EVENT_REMINDER_ACTION)
                && /*#data clear#*/!action.equals(Intent.ACTION_SETTINGS_PACKAGE_DATA_CLEARED) ) {
    ...
    public static boolean updateAlertNotification(Context context) {
        ...
        if (alertCursor == null || alertCursor.getCount() == 0) {
            ...
            nm.cancel(0);
            ///M: after Notification canceled, write 0 to the unread msg number.
            writeUnreadReminders(context, 0);
            return false;
        }
        ...
        ///M: after postNotification, write the unread msg number to system provider and send a broadcast.
        writeUnreadReminders(context, numReminders);
    ...
    ///M:add the new feature---unread message. @{
    public static void writeUnreadReminders(Context context, int numReminders){
        ...
        boolean result = android.provider.Settings.System.putInt(resolver, Utils.CALENDAR_MTK_UNREAD_KEY, numReminders);
