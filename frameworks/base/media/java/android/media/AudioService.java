...
public class AudioService extends IAudioService.Stub {
   ...
   /** @hide Maximum volume index values for audio streams */
	...
	mAudioManager = (AudioManager)context.getSystemService(Context.AUDIO_SERVICE);
       ...
       // Intialized volume
        ...
        TelephonyManager tmgr = (TelephonyManager)
	      ...
	      //modify by chipeng to listen both sim cards
        // tmgr.listen(mPhoneStateListener, PhoneStateListener.LISTEN_CALL_STATE);
        tmgr.listenGemini(mPhoneStateListener, PhoneStateListener.LISTEN_CALL_STATE,Phone.GEMINI_SIM_1);
        tmgr.listenGemini(mPhoneStateListener, PhoneStateListener.LISTEN_CALL_STATE,Phone.GEMINI_SIM_2);
    }
    ...
    private void createStreamStates() {
	    ...
	    Log.d(TAG, "createStreamStates numStreamTypes =  " + i);
             if(i  !=  AudioSystem.STREAM_FM){
    ...
    public void adjustStreamVolume(int streamType, int direction, int flags) {
        ...
        Log.d(TAG, "adjustStreamVolume: StreamType = " + streamType + ", oldIndex = " + oldIndex);
        ...
        if (((flags & AudioManager.FLAG_ALLOW_RINGER_MODES) != 0) ||
            ...
            Log.d(TAG, "adjustStreamVolume: AdjustVolume = " + adjustVolume);
        }
        ...
        if (streamState.muteCount() != 0) {
            if (adjustVolume) {
                ...
                Log.d(TAG, "adjustStreamVolume: MuteCount > 0.");
                int numStreamTypes = AudioSystem.getNumStreamTypes();
    ...
    private void sendVolumeUpdate(int streamType, int oldIndex, int index, int flags) {
        ...
        Log.d(TAG, "sendVolumeUpdate: StreamType = " + streamType + ", oldIndex = " 
        		+ oldIndex + ", newIndex = " + index);
        mContext.sendBroadcast(intent);
        // Add by jackie lin
        // When ringer volume changed, notify AudioProfile
    ...
    private void setStreamVolumeInt(int streamType, int index, boolean force, boolean lastAudible) {
        ...
        if (streamState.muteCount() != 0) {
        	Log.d(TAG, "setStreamVolumeInt: MuteCount != 0, index = " + index);
    ...
    public void setStreamSolo(int streamType, boolean state, IBinder cb) {
        Log.d(TAG, "setStreamSolo: StreamType = " + streamType + ", state = " + state);
    ...
    public void setStreamMute(int streamType, boolean state, IBinder cb) {
    	Log.d(TAG, "setStreamMute: StreamType = " + streamType + ", state = " + state);
    ...
    public void setSpeakerphoneOn(boolean on){
        ...
        Log.d(TAG, "setSpeakerphoneOn " + mForcedUseForComm);
    }
    ...
    public boolean isBluetoothScoOn() {
        Log.d(TAG, "isBluetoothScoOn " + mForcedUseForComm);
    ...
    private int getActiveStreamType(int suggestedStreamType) {
      ...
      //  String FmStatus = AudioSystem.getParameters("GetFmEnable");
      //  Log.d(TAG, "AudioSystem.getParameters(GetFmEnable) = " + FmStatus);
        ...
        if (mVoiceCapable) {
            ...
            if (isOffhook || getMode() == AudioManager.MODE_IN_COMMUNICATION) {
                ...
                return AudioSystem.STREAM_MUSIC;
				    // add by chiepeng , for fm control
            } else if (isFmOn()) {
                Log.d(TAG, "getActiveStreamType: Forcing STREAM_FM...");
    ...
    private void broadcastRingerMode() {
        ...
        Log.d(TAG, "broadcastRingerMode: Ringer mode = " + mRingerMode);
    ...
    private void broadcastVibrateSetting(int vibrateType) {
        ...
        if (ActivityManagerNative.isSystemReady()) {
            ...
            Log.d(TAG, "broadcastVibrateSetting: Type = " + vibrateType 
            		+ ", setting = " + getVibrateSetting(vibrateType));
        }
    }
        ...
        public void onChange(boolean selfChange) {
            ...
            synchronized (mSettingsLock) {
                ...
                if (ringerModeAffectedStreams != mRingerModeAffectedStreams) {
                    ...
                    Log.d(TAG, "onChange: RingerModeAffectedStreams = " + ringerModeAffectedStreams);
                    setRingerModeInt(getRingerMode(), false);
                }
            }
        }
    ...
    private void makeA2dpDeviceUnavailableLater(String address) {
        ...
        Log.d(TAG, "makeA2dpDeviceUnavailableLater");
    ...
    private class AudioServiceBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_DOCK_EVENT)) {
		      ...
		      // add by chipeng for test inputdevice----------------------------------------------
    ...
    private PhoneStateListener mPhoneStateListener = new PhoneStateListener() {
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            if (state == TelephonyManager.CALL_STATE_RINGING) {
                ...
                //move from hanlefocusforcall to abandonfocus as soon as phone is hang up
                //abandonAudioFocus(null, IN_VOICE_COMM_FOCUS_ID);
            }
        }
    };
...
//        if(true) {
    ...
    /**
     * Register the IAudioProfileListener callback to AudioService to listen RingerMode
     * and volume changed.
     * 
    ...
    /**
     * Notify the change of the RingerMode.
     */
    ...
    /**
     * Notify the change of the ringer volume.
     */
