...
public interface WindowManager extends ViewManager {
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams
         ...
         * @hide
         */
        public static final int TYPE_TOP_MOST     = FIRST_SYSTEM_WINDOW+23;
        ...
        * to the window.
         ...
         * If not set, the default value of flagsEx will be 0
         * Format :
         * -----------------------------------------------
         * |23	 | 22 - 21 |    20   |   19    |18 - 16  |
         * |swap |  split  | unknown | display |reserved |
         * -----------------------------------------------
         * [swap]
         *     0: N/A
        ...
        public static final int FLAG_EX_S3D_2D             = 0x00000000; // It should be operated with FLAG_EX_S3D_MASK
        ...
        public static final int PRIVATE_FLAGS_EX_CHANGED = 1<<17;
        /** {@hide} */
