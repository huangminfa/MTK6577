...
public class SiteNavigationProvider extends ContentProvider {
    ...
    static{
        sUriMatcher.addURI(SiteNavigation.AUTHORITY, "websites" , WEB_SITES_ALL);
        sUriMatcher.addURI(SiteNavigation.AUTHORITY, "websites/#" , WEB_SITES_ID);
    }
	...
	public Cursor query(Uri uri, String[] projection, String selection,
        ...
        case WEB_SITES_ALL:
            break;
        case WEB_SITES_ID:
            qb.appendWhere(SiteNavigation._ID + "=" + uri.getPathSegments().get(0));
            break;
        default:
	...
	public int update(Uri uri, ContentValues values, String selection,
        ...
        case WEB_SITES_ALL:
            ...
            break;            
        case WEB_SITES_ID:
            String newIdSelection = SiteNavigation._ID + "=" + uri.getLastPathSegment() + (!TextUtils.isEmpty(selection) ? " AND (" + selection + ')' : "");
	...
	private class SiteNavigationDatabaseHelper extends SQLiteOpenHelper {
		...
		private void createTable(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE websites (" +
                  SiteNavigation._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
        ...
        private void initTable(SQLiteDatabase db) {
          // Insert predefined websites
          // MTK_OP01_PROTECT_START
          final String op = android.os.SystemProperties.get("ro.operator.optr");
          // MTK_OP01_PROTECT_END
          CharSequence[] websites = null;
          // MTK_OP01_PROTECT_START
          if (op != null && op.equals("OP01")) {
              websites = mContext.getResources().getTextArray(R.array.predefined_websites_op01);
          } else {
              // MTK_OP01_PROTECT_END
              ...
              for (int i = 0; i < websiteSize; i = i + 3) {
                  ...
                  try {
                      if (fileName != null && fileName.length() != 0) {
                          ...
                          bm = BitmapFactory.decodeResource(mContext.getResources(), R.raw.sitenavigation_thumbnail_default);
                      }
                  } catch (Exception e) {
                      android.util.Log.e("SiteNavigationProvider", e.getMessage() + ": " + fileName + "not found, use default.");
                  } finally {
                      if (bm == null) {
                          bm = BitmapFactory.decodeResource(mContext.getResources(), R.raw.sitenavigation_thumbnail_default);
                      }
                  ...
                  CharSequence websiteDestination = BrowserProvider2.replaceSystemPropertyInString(mContext, websites[i + 1]);
