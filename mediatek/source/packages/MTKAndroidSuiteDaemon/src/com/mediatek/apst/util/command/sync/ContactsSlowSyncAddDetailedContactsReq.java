...
/**
 * Class Name: ContactsSlowSyncAddDetailedContactsReq
 * <p>Package: com.mediatek.apst.util.command.sync
 * <p>Created on: 2010-12-20
 * <p>
 * <p>Description: 
 * <p>Request for adding multiple contacts(with contact data) in slow sync.
 * <p>
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class ContactsSlowSyncAddDetailedContactsReq extends RawBlockRequest {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    // Constructors                                                 
    //==============================================================
    public ContactsSlowSyncAddDetailedContactsReq(){
        super(FEATURE_SYNC);
    }
    ...
    //==============================================================
    /**
     * Class Name: ContactsSlowSyncAddDetailedContactsReq.Builder
     * <p>Package: com.mediatek.apst.util.command.sync
     * <p>Created on: 2010-12-18
     * <p>
     * <p>Description: 
     * <p>Builder class help to create and fill a 
     * ContactsSlowSyncAddDetailedContactsReq.
     * <p>
     * @author mtk80734 Siyang.Miao
     * @version V1.0
     */
    public static class Builder extends RawBlockRequest.Builder {
        ...
        protected RawBlockRequest onCreateCommand(int featureId){
            return new ContactsSlowSyncAddDetailedContactsReq();
        }
        ...
        /**
         * Returns a ContactsSlowSyncAddDetailedContactsReq with data supplied 
         * to the builder.
         * @return The ContactsSlowSyncAddDetailedContactsReq instance.
         */
        public ContactsSlowSyncAddDetailedContactsReq build(){
            ...
            return (ContactsSlowSyncAddDetailedContactsReq)super.build();
        }
