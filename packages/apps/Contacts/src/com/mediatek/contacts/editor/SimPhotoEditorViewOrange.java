...
public class SimPhotoEditorViewOrange extends PhotoEditorView{
    
    private static final String TAG = "SimPhotoEditorViewOrange";
    ...
    protected void resetDefault() {
        ...
        mPhotoImageView.setImageResource(R.drawable.ic_contact_picture_sim_contact_orange);
