...
{
    public static abstract class Stub extends android.os.Binder implements DMAgent
    {
	...
	private static class Proxy implements DMAgent
	{
	    ...
	    public boolean setLockFlag() throws android.os.RemoteException
		{
		    android.os.Parcel _data = android.os.Parcel.obtain();
		    android.os.Parcel _reply = android.os.Parcel.obtain();
		    boolean _result;
	    ...
	    public boolean writeIMSI(String imsi) throws android.os.RemoteException {
	       ...
	       public String readCTA() throws android.os.RemoteException {
	            android.os.Parcel _data = android.os.Parcel.obtain();
	            android.os.Parcel _reply = android.os.Parcel.obtain();
	            byte[] _result;
	            String ret=null;
	            try {
	            _data.writeInterfaceToken(DESCRIPTOR);
	            mRemote.transact(Stub.TRANSACTION_readCTA, _data, _reply, 0);
	            _result = _reply.createByteArray();
	            if (_result!=null) {
	            ret = new String(_result);
	            }
	        ...
	        public boolean writeCTA(String cta) throws android.os.RemoteException {
	            if (cta==null) {
	            return false;
	            }
	            android.os.Parcel _data = android.os.Parcel.obtain();
	            ...
	            try {
	            _data.writeInterfaceToken(DESCRIPTOR);
	            _data.writeByteArray(String.valueOf(cta).getBytes());
	            mRemote.transact(Stub.TRANSACTION_writeCTA, _data, _reply, 0);
	            _result = (0!=_reply.readInt());
	            }
	            finally {
	            _reply.recycle();
    ...
    static final int TRANSACTION_readCTA= (IBinder.FIRST_CALL_TRANSACTION + 8);
    static final int TRANSACTION_writeCTA = (IBinder.FIRST_CALL_TRANSACTION + 9);
