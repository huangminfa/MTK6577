...
public final class SmsManager {
    ...
    private static int lastReceivedSmsSimId = Phone.GEMINI_SIM_1;
    ...
    private SmsManager() {
        ...
        try {
            if(getDefaultSim() == Phone.GEMINI_SIM_1) {
    ...
    public ArrayList<SmsMessage> getAllMessagesFromIcc() {
        //getDefault SIM, 
        return GeminiSmsManager.getAllMessagesFromIccGemini(getDefaultSim());
    }
