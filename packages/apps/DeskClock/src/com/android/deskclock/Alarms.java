...
public class Alarms {
    ...
    static Calendar calculateAlarm(int hour, int minute,
        ...
        Log.v("Locale: " + Locale.getDefault() + " timezone: " + TimeZone.getDefault());
        Log.v("calculate alarm: nowHour=" + nowHour + "  nowMinute=" + nowMinute);
        Log.v("calculate alarm: hour=" + hour + "  minute=" + minute);
        ...
        Log.v("alarm time: " + c.getTime() + "  time in milis: " + c.getTimeInMillis());
        return c;
    }
    ...
    static String formatTime(final Context context, Calendar c) {
        ...
        String result = (c == null) ? "" : (String)DateFormat.format(format, c);
        Log.v("format time: " + result);
        return result;
    }
    ...
    private static void storeNearestAlarm(final Context context, final Alarm alarm) {        
        if (alarm.id == -1) {
        	...
        	SharedPreferences prefs = context.getSharedPreferences(
                    AlarmClock.NEAREST_ALARM_PREFERENCES, 0);
