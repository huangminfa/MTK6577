...
public class AttachmentTypeSelectorAdapter extends IconListAdapter {
    ...
    // add for vCard
    public final static int MODE_WITH_FILE_ATTACHMENT        = 4;
    public final static int MODE_WITHOUT_FILE_ATTACHMENT     = 8;
    public final static int MODE_WITH_VCALENDAR    = 16;
