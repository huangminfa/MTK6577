...
*/
    ...
    // NFC SEEK start
    int RIL_REQUEST_SIM_TRANSMIT_BASIC = (RIL_REQUEST_MTK_BASE + 56);
    int RIL_REQUEST_SIM_OPEN_CHANNEL = (RIL_REQUEST_MTK_BASE + 57);
    int RIL_REQUEST_SIM_CLOSE_CHANNEL = (RIL_REQUEST_MTK_BASE + 58);
    int RIL_REQUEST_SIM_TRANSMIT_CHANNEL = (RIL_REQUEST_MTK_BASE + 59);
    int RIL_REQUEST_SIM_GET_ATR = (RIL_REQUEST_MTK_BASE + 60);
    // NFC SEEK end
    
    int RIL_REQUEST_SET_NEW_MESSAGE_INDICATION = (RIL_REQUEST_MTK_BASE + 61);
    int RIL_REQUEST_SET_SIM_SMS_READ = (RIL_REQUEST_MTK_BASE + 62);

    //MTK-START [mt04258][121002] OEM unsol support.
    int RIL_REQUEST_SET_UNSOL_OEM_HOOW_RAW_PREFIX = (RIL_REQUEST_MTK_BASE + 63);
    //MTK-END [mt04258][121002] OEM unsol support.

//MTK-START [mtk04258][20120806][International card support]
    int RIL_REQUEST_SIM_INTERFACE_SWITCH = (RIL_REQUEST_MTK_BASE + 64);
    int RIL_REQUEST_2SATGES_POWER_ON_CONTINUE = (RIL_REQUEST_MTK_BASE + 65);
    int RIL_REQUEST_OPERATOR_LIMIT_SERVICE = (RIL_REQUEST_MTK_BASE + 66);	
...
//MTK-END [mtk04258][20120806][International card support]
    ...
    int RIL_UNSOL_NEED_QUERY_DATA_LIST = (RIL_UNSOL_MTK_BASE + 19);
    int RIL_UNSOL_VIRTUAL_SIM_ON = (RIL_UNSOL_MTK_BASE + 20);
    int RIL_UNSOL_VIRTUAL_SIM_OFF = (RIL_UNSOL_MTK_BASE + 21);
    int RIL_UNSOL_INVALID_SIM = (RIL_UNSOL_MTK_BASE + 22); 
    int RIL_UNSOL_RESPONSE_PS_NETWORK_STATE_CHANGED = (RIL_UNSOL_MTK_BASE + 23);
    ...
    //please unsol response for via cdma ril from here
