...
JNIEXPORT jboolean JNICALL Java_com_mediatek_engineermode_usb_UsbIF_NativeInit
...
JNIEXPORT void JNICALL Java_com_mediatek_engineermode_usb_UsbIF_NativeDeInit
  (JNIEnv * env, jobject obj){
...
JNIEXPORT jboolean JNICALL Java_com_mediatek_engineermode_usb_UsbIF_NativeStartTest
...
JNIEXPORT jboolean JNICALL Java_com_mediatek_engineermode_usb_UsbIF_NativeStopTest
  (JNIEnv * env, jobject obj, jint test_nr){
	if(fd == -1)
		{
			OTG_LOG("FD == -1\n");
...
JNIEXPORT jint JNICALL Java_com_mediatek_engineermode_usb_UsbIF_NativeGetMsg
  (JNIEnv * env, jobject obj){
	if(fd == -1)
		{
			OTG_LOG("FD == -1\n");
...
JNIEXPORT jboolean JNICALL Java_com_mediatek_engineermode_usb_UsbIF_NativeCleanMsg
  (JNIEnv * env, jobject obj){
	if(fd == -1)
		{
			OTG_LOG("FD == -1\n");
