...
typedef enum {
    ...
    //MTK-START [mtk03923][20111123][ALPS00093395]ICS Migration - Telephony
    ...
    //MTK-END [mtk03923][20111123][ALPS00093395]ICS Migration - Telephony
} RIL_Errno;
...
// "response" is a const RIL_SIM_IO_Response *
#define RIL_REQUEST_SIM_TRANSMIT_BASIC (RIL_REQUEST_MTK_BASE + 56)

// "data" is a const char * containing the AID of the applet
// "response" is a int * containing the channel id
#define RIL_REQUEST_SIM_OPEN_CHANNEL (RIL_REQUEST_MTK_BASE + 57)

// "data" is a const int * containing the channel id
// "response" is NULL
#define RIL_REQUEST_SIM_CLOSE_CHANNEL (RIL_REQUEST_MTK_BASE + 58)

// "data" is a const RIL_SIM_IO *
// "response" is a const RIL_SIM_IO_Response *
#define RIL_REQUEST_SIM_TRANSMIT_CHANNEL (RIL_REQUEST_MTK_BASE + 59)

// "data" is NULL *
// "response" is a const char * containing ATR in hexadecimal format
#define RIL_REQUEST_SIM_GET_ATR (RIL_REQUEST_MTK_BASE + 60)
// NFC SEEK end

/*
 * Set new message indication parameters. More infomation can refer to
 * 27.005 3.4.1
 */
#define RIL_REQUEST_SET_NEW_MESSAGE_INDICATION (RIL_REQUEST_MTK_BASE + 61)

/*
 * Read one message saved on SIM and set the status as read if
 * it is a unread message
 */
#define RIL_REQUEST_SET_SIM_SMS_READ (RIL_REQUEST_MTK_BASE + 62)

//MTK-START [mt04258][121002] OEM unsol support.
#define RIL_REQUEST_SET_UNSOL_OEM_HOOW_RAW_PREFIX (RIL_REQUEST_MTK_BASE + 63)
//MTK-END [mt04258][121002] OEM unsol support.

//MTK-START [mtk04258][20120806][International card support]
#define RIL_REQUEST_SIM_INTERFACE_SWITCH (RIL_REQUEST_MTK_BASE + 64)
#define RIL_REQUEST_2SATGES_POWER_ON_CONTINUE (RIL_REQUEST_MTK_BASE + 65)
#define RIL_REQUEST_OPERATOR_LIMIT_SERVICE (RIL_REQUEST_MTK_BASE + 66)
...
#define RIL_UNSOL_NEED_QUERY_DATA_LIST (RIL_UNSOL_MTK_BASE + 19)

#define RIL_UNSOL_VIRTUAL_SIM_ON (RIL_UNSOL_MTK_BASE + 20)
#define RIL_UNSOL_VIRTUAL_SIM_OFF (RIL_UNSOL_MTK_BASE + 21)
#define RIL_UNSOL_INVALID_SIM (RIL_UNSOL_MTK_BASE + 22)
#define RIL_UNSOL_RESPONSE_PS_NETWORK_STATE_CHANGED (RIL_UNSOL_MTK_BASE + 23)
