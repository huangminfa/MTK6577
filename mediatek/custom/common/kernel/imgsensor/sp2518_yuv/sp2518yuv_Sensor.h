...
/* SENSOR PIXEL/LINE NUMBERS IN ONE PERIOD */
    #define SP2518_FULL_PERIOD_PIXEL_NUMS  (1600) //(2500)  // default pixel#(w/o dummy pixels) in UXGA mode
    #define SP2518_FULL_PERIOD_LINE_NUMS   (1200)//(2080)  // default line#(w/o dummy lines) in UXGA mode
    #define SP2518_PV_PERIOD_PIXEL_NUMS   (800)// (2500)  // default pixel#(w/o dummy pixels) in SVGA mode
    #define SP2518_PV_PERIOD_LINE_NUMS     (600)//(693)   // default line#(w/o dummy lines) in SVGA mode

    /* SENSOR EXPOSURE LINE LIMITATION */
    #define SP2518_FULL_EXPOSURE_LIMITATION    (1972)
    #define SP2518_PV_EXPOSURE_LIMITATION      (1478)

/* SENSOR FULL SIZE */
   #define SP2518_IMAGE_SENSOR_FULL_WIDTH	   (1600)
   #define SP2518_IMAGE_SENSOR_FULL_HEIGHT	  (1200)


/* SENSOR PV SIZE */
#define SP2518_IMAGE_SENSOR_PV_WIDTH   (800)
#define SP2518_IMAGE_SENSOR_PV_HEIGHT  (600)

#define SP2518_VIDEO_QCIF_WIDTH   (176)
#define SP2518_VIDEO_QCIF_HEIGHT  (144)

#define SP2518_VIDEO_30FPS_FRAME_LENGTH   (0x29E)
#define SP2518_VIDEO_20FPS_FRAME_LENGTH   (0x3ED)
#define SP2518_VIDEO_15FPS_FRAME_LENGTH   (0x53C)
#define SP2518_VIDEO_10FPS_FRAME_LENGTH   (0x7DA)

// SETUP TIME NEED TO BE INSERTED
#define SP2518_IMAGE_SENSOR_PV_INSERTED_PIXELS (834)
#define SP2518_IMAGE_SENSOR_PV_INSERTED_LINES  (51)

#define SP2518_IMAGE_SENSOR_FULL_INSERTED_PIXELS   (834)
#define SP2518_IMAGE_SENSOR_FULL_INSERTED_LINES    (772)

#define SP2518_PV_DUMMY_PIXELS			(0)
#define SP2518_VIDEO__CIF_DUMMY_PIXELS  (0)
#define SP2518_VIDEO__QCIF_DUMMY_PIXELS (0)
