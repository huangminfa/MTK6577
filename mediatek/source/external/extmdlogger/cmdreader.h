...
#ifndef __MDL_CMD_READER_H__
#define __MDL_CMD_READER_H__
...
{
	typedef unsigned int buf_ctrl;

	class CmdReader : public PCCommHandler
	{
	private:
		PCCommEngine* m_pPCEngine;
		MDCommEngine* m_pMDEngine;
		MDL_BOOL cmdDisconnect(const void *data, unsigned int len);
