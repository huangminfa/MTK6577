...
public class AgendaAdapter extends ResourceCursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        ///M:check time@{
        Time beginTime = new Time(tzString);
        beginTime.set(begin);
        int beginValidJulianDay = Utils.getValidJuLianDay(beginTime);
        beginTime = Utils.changeToJulianDayTime(beginTime, beginValidJulianDay);
        begin = beginTime.toMillis(false);
        
        Time endTime = new Time(tzString);
        endTime.set(end);
        int endValidJulianDay = Utils.getValidJuLianDay(endTime);
        endTime = Utils.changeToJulianDayTime(endTime, endValidJulianDay);
        end = endTime.toMillis(false);
        ///@}
