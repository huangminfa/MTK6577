...
public final class CalendarContract {
    ...
    protected interface EventsColumns {
        ...
        /**
         * The create time of event. Column name.
         * <P>Type: INTEGER (long; millis since epoch)</P>
         * @hide
         */
        ...
        /**
         * The last modify time of event. Column name.
         * <P>Type: INTEGER (long; millis since epoch)</P>
         * @hide
         */
        public static final String MODIFY_TIME = "modifyTime";
        
        //add IS_LUNAR/LUNAR_RRULE Columns for lunar calendar.
        /**
         * Whether the event date should use lunar calendar date. Column name.
         * <P>Type: INTEGER (boolean)</P>
         * @hide
         */
        ...
        /**
         * The lunar calendar recurrence rule for the event. Column name.
         * <P>Type: TEXT</P>
         * @hide
         */
    ...
    public static final class EventsEntity implements BaseColumns, SyncColumns, EventsColumns {
        ...
        private static class EntityIteratorImpl extends CursorEntityIterator {
            ...
            public Entity getEntityAndIncrementCursor(Cursor cursor) throws RemoteException {
                ...
                DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, CAL_SYNC9);
                DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, CAL_SYNC10);
                ///M: Create time / modify time.
                DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, CREATE_TIME);
                DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, MODIFY_TIME);
