...
public class FdnSetting2 extends PreferenceActivity
    ...
    private boolean isFdnSupport = true;
    ...
    private void setFDNSupport(){
        ...
        isFdnSupport = iccCard.isFDNExist();
        mButtonEnableFDN.setEnabled(isFdnSupport);
        mButtonFDNList.setEnabled(isFdnSupport);
    }
    ...
    private void updateMenuEnableState(boolean bEnable) {
        mButtonEnableFDN.setEnabled(isFdnSupport && bEnable);
        mButtonFDNList.setEnabled(isFdnSupport &&  bEnable);
