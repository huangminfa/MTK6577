...
public class LockList extends PreferenceActivity 
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        //get the sim card states
                isSim1Insert = geminiPhone.isSimInsert(Phone.GEMINI_SIM_1);
                isSim2Insert = geminiPhone.isSimInsert(Phone.GEMINI_SIM_2);
        }
        else{
                isSimInsert = TelephonyManager.getDefault().hasIccCard();
        }
//        boolean isRadio1On = geminiPhone.isRadioOnGemini(Phone.GEMINI_SIM_1);
//        boolean isRadio2On = geminiPhone.isRadioOnGemini(Phone.GEMINI_SIM_2);
	...
	protected void onResume() {
		super.onResume();
         if(FeatureOption.MTK_GEMINI_SUPPORT){
                ...
                if(simId == 0){
                       boolean isRadio1On = geminiPhone.isRadioOnGemini(Phone.GEMINI_SIM_1);
                       if((isSim1Insert == false)||(isRadio1On == false)){
                      ...
                      boolean isRadio2On = geminiPhone.isRadioOnGemini(Phone.GEMINI_SIM_2);
                       if((isSim2Insert == false)||(isRadio2On == false)){
                            getPreferenceScreen().setEnabled(false);
                            return;
                       }
                }else{
               ...
               try{
                if(isSimInsert == false || iTel.isRadioOn() == false){
                            getPreferenceScreen().setEnabled(false);
                            return;
                }
        ...
        if(false == FeatureOption.MTK_GEMINI_SUPPORT)
        {
        		...
        		phone.getIccCard().QueryIccNetworkLock(0,4,null,null,null,null,callback);
          		phone.getIccCard().QueryIccNetworkLock(1,4,null,null,null,null,callback2);
          		phone.getIccCard().QueryIccNetworkLock(2,4,null,null,null,null,callback3);
          		phone.getIccCard().QueryIccNetworkLock(3,4,null,null,null,null,callback4);
          		phone.getIccCard().QueryIccNetworkLock(4,4,null,null,null,null,callback5);
       	
        }
        else //Gemini SIM project
        {   
    		...
    		if (0 == intSIMNumber)//choose the Tab1:SIM1 lock setting
    		{
...
//                	//whether some lock category is disabled?
                	...
                	Message callback4 = Message.obtain(mHandler, QUERY_ICC_SML_COMPLETE);
                	Message callback5 = Message.obtain(mHandler, QUERY_ICC_SML_COMPLETE);
                	mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).QueryIccNetworkLock(0,4,null,null,null,null,callback);
                	mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).QueryIccNetworkLock(1,4,null,null,null,null,callback2);
                	mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).QueryIccNetworkLock(2,4,null,null,null,null,callback3);
                	mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).QueryIccNetworkLock(3,4,null,null,null,null,callback4);
                	mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).QueryIccNetworkLock(4,4,null,null,null,null,callback5);              	
    		...
    		else if (1 == intSIMNumber)
    		{
                	...
                	Message callback4 = Message.obtain(mHandler, QUERY_ICC_SML_COMPLETE);
                	Message callback5 = Message.obtain(mHandler, QUERY_ICC_SML_COMPLETE);
                	mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).QueryIccNetworkLock(0,4,null,null,null,null,callback);
                	mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).QueryIccNetworkLock(1,4,null,null,null,null,callback2);
                	mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).QueryIccNetworkLock(2,4,null,null,null,null,callback3);
                	mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).QueryIccNetworkLock(3,4,null,null,null,null,callback4);
                	mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).QueryIccNetworkLock(4,4,null,null,null,null,callback5);              	
	...
	public boolean onPreferenceTreeClick(PreferenceScreen preferencescreen, Preference preference )
    {
    	if (this.getPreferenceScreen().findPreference("nplock") == preference)
    	{
            ...
            if(false == FeatureOption.MTK_GEMINI_SUPPORT)//if it single SIM, no need to pass the card number
            {
            	
            }
            else//Gemini SIM: put the SIM  number to the bundle
            {
              ...
              case QUERY_ICC_SML_COMPLETE:
               {
            	 ...
            	 //Toast.makeText(LockList.this,"LockState: " + String.valueOf(LockState[1]),Toast.LENGTH_LONG).show();
            	   if( LockState[2] == 0){
            	   ...
            	   else if (LockState[1] == 4)//be disabled!
            	   {
					    ((PreferenceActivity) (LockList.this)).getPreferenceScreen().getPreference(LockState[0]).setEnabled(false);
            	   }           	   
