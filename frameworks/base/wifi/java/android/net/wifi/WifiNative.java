...
public class WifiNative {
    ...
    private static WifiStateMachine sStateMachine;
    ...
    public native static boolean connectToSupplicant(boolean isHotspot);
    ...
    /**
     * MTK proprietary : WPS function added by mtk03034
     */
    public native static String doWpsPinCommand(String bssid);

    public native static boolean doWpsPbcCommand(String bssid);

    public native static boolean doWpsAbortCommand();

    public native static boolean doCTIATestOnCommand();

    public native static boolean doCTIATestOffCommand();

    public native static boolean doCTIATestRateCommand(int rate);

    public native static boolean doCTIATestPowerCommand(int powerMode);

    public native static boolean doCTIATestSetCommand(int id, int value);

    public native static String doCTIATestGetCommand(int id);

    //MTK_OP01_PROTECT_START
    public native static boolean saveAPPriorityCommand();
    //MTK_OP01_PROTECT_END
    
    public static void setWifiStateMachine(WifiStateMachine machine) {
        sStateMachine = machine;
    }
    
    private void notifySupplicantHung() {
        if (null != sStateMachine) {
            sStateMachine.sendMessage(WifiMonitor.SUPPLICANT_HUNG_EVENT);
        }
    }
    
    public native static boolean setTxPowerEnabledCommand(boolean enable);
    
    public native static boolean setTxPowerCommand(int offset);
}
