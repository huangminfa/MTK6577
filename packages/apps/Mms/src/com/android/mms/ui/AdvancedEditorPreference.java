...
public class AdvancedEditorPreference extends Preference{
    ...
    protected void onBindView(View view) {
        ...
        simName.setText(simInfo.getSimName(currentId));
         ...
         if (preferenceName.equals(SMS_SAVE_LOCATION)){
              simNumber.setText(getSaveLocation(currentId));
         } else {
...
//        }
    ...
    private String getSaveLocation(int slotid){
        ...
        String stored = sp.getString((Long.toString(slotid) + "_" + SMS_SAVE_LOCATION), "Phone");
        CharSequence res = getVisualTextName(stored, R.array.pref_sms_save_location_choices,
    ...
    private CharSequence getVisualTextName(String enumName, int choiceNameResId, int choiceValueResId) {
        CharSequence[] visualNames = getContext().getResources().getTextArray(
                choiceNameResId);
        CharSequence[] enumNames =  getContext().getResources().getTextArray(
                choiceValueResId);
