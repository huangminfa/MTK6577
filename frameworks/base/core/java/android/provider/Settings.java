...
public final class Settings {
    ...
    private static final String TAG = "Provider/Setting";
    private static final boolean LOCAL_LOGV = Config.LOGV || true;
    ...
    public static class NameValueTable implements BaseColumns {
        ...
        protected static boolean putString(ContentResolver resolver, Uri uri,
            ...
            try {
                Xlog.d(TAG, "NameValueTable putString " + name + " in " + uri + " value "+value);
                ...
                Xlog.e(TAG, "Can't set key " + name + " in " + uri, e);
                return false;
            }
        }
        ...
        public String getString(ContentResolver cr, String name) {
            ...
            synchronized (this) {
                if (mValuesVersion != newValuesVersion) {
                    if (LOCAL_LOGV) {
                        Xlog.v(TAG, "invalidate [" + mUri.getLastPathSegment() + "]: current " +
            ...
            try {
                ...
                if (c == null) {
                    Xlog.e(TAG, "Can't get key " + name + " from " + mUri);
                    return null;
                }
                ...
                if (LOCAL_LOGV) {
                    Xlog.v(TAG, "cache miss [" + mUri.getLastPathSegment() + "]: " +
                            name + " = " + (value == null ? "(null)" : value));
                }
                return value;
            } catch (RemoteException e) {
                Xlog.e(TAG, "Can't get key " + name + " from " + mUri, e);
    ...
    public static final class System extends NameValueTable {
        ...
        static {
            ...
            MOVED_TO_SECURE.add(Secure.DATA_ROAMING_2);
        ...
        public synchronized static String getString(ContentResolver resolver, String name) {
            if (MOVED_TO_SECURE.contains(name)) {
                Xlog.v(TAG, "Setting " + name + " has moved from android.provider.Settings.System"
	...
	/**
       ...
       /**
         ...
         * @hide
         */
        public static final int GPRS_CONNECTION_SETTING_DEFAULT = FeatureOption.MTK_DEFAULT_DATA_OFF ? 0 : 1;
    ...
    public static final int GPRS_TRANSFER_SETTING_DEFAULT = 1;
        ...
        */
        ...
        /**
         * FM volume. This is used internally, changing this
         * value will not change the volume. See AudioManager.
         * @hide
         */
	 ...
	 /**
         * MATV volume. This is used internally, changing this
         * value will not change the volume. See AudioManager.
         * @hide
         */
         ...
         * <p>
         * If you need to play the default ringtone at any given time, it is recommended
         * you give {@link #DEFAULT_VIDEO_CALL_URI} to the media player.  It will resolve
         * to the set default voice call ringtone at the time of playing.
         *
        ...
        /**
         * A {@link Uri} that will point to the current default video call ringtone at any
         * given time.
         * <p>
         * If the current default ringtone is in the DRM provider and the caller
         * does not have permission, the exception will be a
        ...
        /**
         * Control what when rotation happens , what activity will be launched in Launcher,
         * If None, no activity will be launched, or will be activity name to be launched.
         * @hide
         */
        ...
        /**
         * Which web search engine user has selected, QuickSearchBox and Browser and any other 
         * application using web search activity will be forced to use this web search engine.
         * The value is a String, representing the name of a web search activity.
         * @hide
         */
        ...
        /**
         * package name for power off alarm, when system boot up from power off alarm
         * use this to identify the package
         * @hide
         */
        public static final String POWER_OFF_ALARM_PACKAGE_NAME =
                "power_off_alarm_package_name";
    ...
    public static final class Secure extends NameValueTable {
        ...
        /**
         * Whether or not data roaming is enabled of sim1(dual sim) or the single sim. (0 = false, 1 = true)
         */
