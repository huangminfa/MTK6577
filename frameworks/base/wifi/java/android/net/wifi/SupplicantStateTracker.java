...
class SupplicantStateTracker extends StateMachine {
    ...
    private boolean mIsRekey = false;
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case WifiStateMachine.CMD_CONNECT_NETWORK:
                    ...
                    break;
                case WifiStateMachine.CMD_FORGET_NETWORK:
            ...
            switch (message.what) {
                case WifiMonitor.SUPPLICANT_STATE_CHANGE_EVENT:
                    ...
                    if (SupplicantState.isHandshakeState(state)) {
                        ...
                        if (state == SupplicantState.COMPLETED && mIsRekey) {
                            Xlog.i(TAG, "Supplicant rekey ends");
                            mIsRekey = false;
                            break;
                        }
            ...
            switch(message.what) {
                case WifiMonitor.SUPPLICANT_STATE_CHANGE_EVENT:
                    ...
                    if (state == SupplicantState.GROUP_HANDSHAKE) {
                        Xlog.i(TAG, "Supplicant rekey begins");
                        mIsRekey = true;
                        break;
                    }
                    sendSupplicantStateChangedBroadcast(state, mAuthFailureInSupplicantBroadcast);
