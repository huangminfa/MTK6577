...
public class MessageBackupComposer extends Composer {
    private final String MESSAGETAG = "Message:";
	...
	public MessageBackupComposer(Context context) {
        ...
        mComposers.add(new SmsBackupComposer(context));
        mComposers.add(new MmsBackupComposer(context));
	}
    ...
    public int getCount() {
        ...
        Log.d(LogTag.BACKUP, MESSAGETAG + "getCount():" + count);
        return count;
	}
	...
	public boolean init() {
        ...
        Log.d(LogTag.BACKUP, MESSAGETAG + "init():" + result);
		return result;
	}
	...
	public boolean isAfterLast() {
        ...
        Log.d(LogTag.BACKUP, MESSAGETAG + "isAfterLast():" + result);
		return result;
	}
