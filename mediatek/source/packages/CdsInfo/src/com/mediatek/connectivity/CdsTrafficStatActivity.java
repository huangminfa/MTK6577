...
public class CdsTrafficStatActivity extends Activity {
    private final String TAG = "CdsTrafficStatActivity";
    ...
    private String[] networkInterfaces = {"wlan0", "ccmni0", "ccmni1" , "ccmni2"};
