...
#define SMALL_IMAGE_HEIGHT 60

#define MESHPOS (5*4*2*(SMALL_IMAGE_WIDTH+1)*SMALL_IMAGE_HEIGHT)
#define MESHIDX (2*6*SMALL_IMAGE_WIDTH*SMALL_IMAGE_HEIGHT) 

#define HISTPOS (4*SMALL_IMAGE_WIDTH*SMALL_IMAGE_HEIGHT)
#define HISTMAP (4*SMALL_IMAGE_WIDTH*SMALL_IMAGE_HEIGHT)
#define HISTDIS SMALL_IMAGE_HEIGHT
#define BINS    32
#define FULLHIST (BINS*2)

#define LETTERBOX_CHECK SMALL_IMAGE_HEIGHT

#define VERTEX_INFO_WORK_BUFFER (MESHPOS+MESHIDX)
#define HIST_INFO_WORK_BUFFER (HISTPOS+HISTMAP+HISTDIS+FULLHIST)
#define GLOBAL_MAP_WORK_BUFFER SMALL_IMAGE_HEIGHT

#define TO3D_LOG_BYTE_PER_FRAME 96
#define TO3D_LOG_MAX_FRAMES 600
#define TO3D_LOG_BUFFER_SIZE (TO3D_LOG_BYTE_PER_FRAME*TO3D_LOG_MAX_FRAMES)
#define TO3D_WORKING_BUFFER_SIZE (VERTEX_INFO_WORK_BUFFER+HIST_INFO_WORK_BUFFER+GLOBAL_MAP_WORK_BUFFER+LETTERBOX_CHECK)
#define TO3D_TOTAL_WORKING_BUFFER_SIZE (TO3D_LOG_BUFFER_SIZE+TO3D_WORKING_BUFFER_SIZE)
...
MRESULT To3dCoreBindTextureBuffer(TO3D_SET_PROC_INFO_STRUCT* ProcInfo );
MRESULT To3dCoreMain();
MRESULT To3dCoreReset();
