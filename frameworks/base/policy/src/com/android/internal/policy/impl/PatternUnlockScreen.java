       ...
       Resources res = context.getResources();
        ...
        if (enableScreenRotation)
        {
                ...
                if (FeatureOption.MTK_GEMINI_SUPPORT){
                    Log.i(TAG, "we will initialize the pattern portrait layout");
                    inflater.inflate(R.layout.keyguard_screen_unlock_portrait_gemini, this, true);
                } else {
                    Log.i(TAG, "we will initialize the pattern gemini portrait layout");
                    inflater.inflate(R.layout.keyguard_screen_unlock_portrait, this, true);
                }
            } else {
                Log.d(TAG, "landscape mode");
                if (FeatureOption.MTK_GEMINI_SUPPORT){
                    Log.i(TAG, "we will initialize the pattern gemini land layout");
                    inflater.inflate(R.layout.keyguard_screen_unlock_landscape_gemini, this, true);
                } else {
                    Log.i(TAG, "we will initialize the pattern land layout");
        ...
        mLockPatternView = (LockPatternView) findViewById(R.id.unlock_widget);
        ...
        //Check DM mode
        int invisible = mUpdateMonitor.DM_IsLocked()?View.INVISIBLE:View.VISIBLE;
