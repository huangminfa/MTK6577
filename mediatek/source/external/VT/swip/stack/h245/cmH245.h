...
/* MTK */
/* check the mux table entries for the request multiplex entry message */
typedef RvStatus (*h245iH223RMECheckMUXEvT)(
    IN  HCALL           h3G324mCall,
    OUT RvUint16        *validEntries);
typedef RvStatus (*h245iH223RMEtoMESEvT)(
    IN  HCALL           h3G324mCall,
    OUT RvUint16        *validEntries);
/* MTK */
...
typedef struct
{
    ...
    /* MTK */
    h245iH223RMECheckMUXEvT           pfnH223RMECheckMUXEv;
    h245iH223RMEtoMESEvT              pfnH223RMEtoMESEv;
    /* MTK */
} H245EvHandlers;
