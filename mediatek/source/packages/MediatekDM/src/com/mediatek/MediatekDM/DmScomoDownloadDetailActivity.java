...
public class DmScomoDownloadDetailActivity extends Activity implements OnDmScomoUpdateListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        mPauseButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (scomoState.mState==DmScomoState.PAUSED) {
        ...
        mCancelButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mCancelButton.setEnabled(false);
                DmService.getInstance().pauseDlScomoPkg();
                DialogFactory.newAlert(DmScomoDownloadDetailActivity.this)
    ...
    public void onScomoUpdated() {
        ...
        mNewFeature.setText(getString(R.string.featureNotes, version, String.valueOf(scomoState.totalSize/1024)+"KB"));
        // set progress
        ...
        //
        Log.i(TAG.Scomo,"state is "+scomoState.mState);
        if (scomoState.mState==DmScomoState.DOWNLOADING ) {
            mPauseButton.setText(R.string.pause);
            mPauseButton.setEnabled(true);
            mCancelButton.setEnabled(true);
        } else if (scomoState.mState==DmScomoState.RESUMED) {
            mPauseButton.setText(R.string.pause);
            mPauseButton.setEnabled(false);
            mCancelButton.setEnabled(false);
            ...
            mPauseButton.setEnabled(true);
            mCancelButton.setEnabled(true);
        } /*else if (scomoState.mState==DmScomoState.DOWNLOAD_FAILED) {
