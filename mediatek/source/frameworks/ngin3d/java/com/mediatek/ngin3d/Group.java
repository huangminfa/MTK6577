 ...
 * @hide
 */
public abstract class Group<T extends Presentation> extends Actor<T> {
    ...
    protected T createPresentation(PresentationEngine engine) {
        return (T) engine.createContainer();
    }
    ...
    public HitTestResult hitTestFull(Point screenPoint) {
        ...
        if (mPresentation != null) {
            ...
            if (hit != null) {
                Actor actor = (Actor) hit.getOwner();
