...
public class MailService extends Service {
    ...
    public static  WakeLock sWakeLock = null;
    public static Object sSynchronizeLock = new Object();
                ...
                public void run() {
                    ...
                    if (account != null) {
                        android.accounts.Account accountManagerAccount =
                            new android.accounts.Account(account.mEmailAddress, AccountManagerTypes.TYPE_POP_IMAP);
                        if (accountId != -1
                                && ContentResolver.getSyncAutomatically(accountManagerAccount, EmailContent.AUTHORITY)) {
    ...
    class ControllerResults extends Controller.Result {
        ...
        public void serviceCheckMailCallback(MessagingException result, long accountId,
            ...
            if (result != null || progress == 100) {
                ...
                // Release wakelock and Callback here, because OnDestroy would be trigger by Exchange Notify.
                new Thread() {
                    @Override
                    public void run() {
                        Controller.getInstance(getApplication()).removeResultCallback(mControllerCallback);
