...
final class FragmentManagerImpl extends FragmentManager {
    ...
    public boolean popBackStackImmediate() {
        if (DEBUG) Log.v(TAG, "popBackStackImmediate()");
        checkStateLoss();
    ...
    public void popBackStack(final String name, final int flags) {
        if (DEBUG) Log.v(TAG, "popBackStack() ["+ "name:" + name + "flags" + flags + "]");
        enqueueAction(new Runnable() {
            @Override public void run() {
    ...
    public boolean popBackStackImmediate(String name, int flags) {
        if (DEBUG) Log.v(TAG, "popBackStackImmediate() ["+ "name:" + name + "flags" + flags + "]");
        checkStateLoss();
        executePendingTransactions();
    ...
    public void popBackStack(final int id, final int flags) {
        if (DEBUG) Log.v(TAG, "popBackStack() ["+ "id:" + id + "flags" + flags + "]");
        if (id < 0) {
    ...
    public boolean popBackStackImmediate(int id, int flags) {
        if (DEBUG) Log.v(TAG, "popBackStackImmediate() ["+ "id:" + id + "flags" + flags + "]");
        checkStateLoss();
        executePendingTransactions();
        if (id < 0) {
            throw new IllegalArgumentException("Bad id: " + id);
    ...
    public boolean execPendingActions() {
        ...
        if (mActivity == null) {
	    if (DEBUG) Log.v(TAG, "mActivity is null");
    ...
    public void dispatchCreate() {
    	ActivityThread.logAppLaunchTime(TAG, "fragment dispatchCreate +");
        mStateSaved = false;
    ...
    public void dispatchActivityCreated() {
    	ActivityThread.logAppLaunchTime(TAG, "fragment dispatchActivityCreated +");
        mStateSaved = false;
    ...
    public void dispatchStart() {
    	ActivityThread.logAppLaunchTime(TAG, "fragment dispatchStart +");
        mStateSaved = false;
    ...
    public void dispatchResume() {
    	ActivityThread.logAppLaunchTime(TAG, "fragment dispatchResume +");
        mStateSaved = false;
