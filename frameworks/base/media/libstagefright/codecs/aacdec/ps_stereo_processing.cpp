                          ...
                          Int32          *qmfRightImag)
{
    ...
    for (group = 0; group < SUBQMF_GROUPS; group++)     /* SUBQMF_GROUPS == 10 */
    {
        ...
        temp1 = shft_lft_1(*(ptr_hybrLeftReal));
        temp2 = shft_lft_1(*(ptr_hybrRightReal));
...
#ifndef ANDROID_DEFAULT_CODE
        temp1 = shft_lft_1(*(ptr_hybrLeftImag));
        temp2 = shft_lft_1(*(ptr_hybrRightImag));
#else
...
#ifndef ANDROID_DEFAULT_CODE
        *(ptr_hybrLeftImag) = shft_lft_1(fxp_mac32_by_16(temp2, h21, temp3));
#else        
...
#ifndef ANDROID_DEFAULT_CODE
        *(ptr_hybrRightImag) = shft_lft_1(fxp_mac32_by_16(temp2, h22, temp3));
#else        
...
#ifndef ANDROID_DEFAULT_CODE
     *(ptr_hybrLeftReal) = shft_lft_1(fxp_mac32_by_16(temp2, h21, temp3));
#else    
    *(ptr_hybrLeftReal)  = fxp_mac32_by_16(temp2, h21, temp3) << 1;
#endif
...
#ifndef ANDROID_DEFAULT_CODE
    *(ptr_hybrRightReal) = shft_lft_1(fxp_mac32_by_16(temp2, h22, temp3));
#else    
    *(ptr_hybrRightReal)  = fxp_mac32_by_16(temp2, h22, temp3) << 1;
#endif    
