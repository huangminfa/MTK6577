 ...
 * <p>
 * <p>Description: 
 * <p>Note data of a contact.
 *
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class Note extends ContactData implements Cloneable {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    public int getRawSize(){
        ...
        // note
        size += RawTransUtil.sizeOfString(this.note);
        return size;
    }
    */
    //@Override
    public void writeRaw(ByteBuffer buffer) throws NullPointerException{
        ...
        // note
        RawTransUtil.putString(buffer, this.note);
    }
    ...
    public void readRaw(ByteBuffer buffer) throws NullPointerException{
        ...
        // note
        this.note = RawTransUtil.getString(buffer);
    }
