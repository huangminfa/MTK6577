...
public class ActivityMusic extends Activity implements OnSeekBarChangeListener {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        //Use our string to display with different language
            ...
            mToggleSwitch.setOnCheckedChangeListener(new OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(final CompoundButton buttonView,
                    ...
                    if (!isChecked || (PRESET_REVERB_NONE == mPRPresetPrevious)) {
                        Intent intent_auxudioreverbeffect = new Intent(DETACHAUXAUDIOEFFECT);
                        intent_auxudioreverbeffect.putExtra("auxaudioeffectid", ControlPanelEffect.getAuxiliaryEffectId(mAudioSession));
                        sendBroadcast(intent_auxudioreverbeffect);
        ...
        //Set text selected to add marquee
