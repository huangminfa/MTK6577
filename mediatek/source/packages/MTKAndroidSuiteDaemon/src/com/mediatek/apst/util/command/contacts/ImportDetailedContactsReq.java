...
/**
 * Class Name: ImportDetailedContactsReq
 * <p>Package: com.mediatek.apst.util.command.contacts
 * <p>Created on: 2010-12-18
 * <p>
 * <p>Description: 
 * <p>Request for importing multiple contacts(with contact data).
 * <p>
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class ImportDetailedContactsReq extends RawBlockRequest {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    // Constructors                                                 
    //==============================================================
    public ImportDetailedContactsReq(){
    ...
    //==============================================================
    /**
     * Class Name: ImportDetailedContactsReq.Builder
     * <p>Package: com.mediatek.apst.util.command.contacts
     * <p>Created on: 2010-12-18
     * <p>
     * <p>Description: 
     * <p>Builder class help to create and fill a ImportDetailedContactsReq.
     * <p>
     * @author mtk80734 Siyang.Miao
     * @version V1.0
     */
    public static class Builder extends RawBlockRequest.Builder {
        ...
        protected Builder(int rawBlockSize){
            super(rawBlockSize, FEATURE_CONTACTS);
            this.count = 0;
        }
        ...
        protected RawBlockRequest onCreateCommand(int featureId){
            return new ImportDetailedContactsReq();
        }
        ...
        /**
         * Returns a ImportDetailedContactsReq with data supplied to the 
         * builder.
         * @return The ImportDetailedContactsReq instance.
         */
        public ImportDetailedContactsReq build(){
            ...
            return (ImportDetailedContactsReq)super.build();
        }
