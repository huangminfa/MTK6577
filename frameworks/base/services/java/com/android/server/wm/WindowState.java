...
final class WindowState implements WindowManagerPolicy.WindowState {
        ...
        if (mSurface == null) {
            ...
            try {
                ...
                mSurface = new Surface(
                        ...
                        0, w, h, format, flags);
                if (WindowManagerService.SHOW_TRANSACTIONS || WindowManagerService.SHOW_SURFACE_ALLOC) Slog.i(WindowManagerService.TAG,
                        "  CREATE SURFACE "
                        + mSurface + " IN SESSION "
            ...
            try {
                try {
                    // The position is initilalized. 
                    mSurfaceX = mFrame.left + mXOffset;
                    mSurfaceY = mFrame.top + mYOffset;
                    mSurface.setPosition(mSurfaceX, mSurfaceY);
                    // If someone sets the position again, 
    ...
    public boolean isGoneForLayoutLw() {
        ...
        return mViewVisibility == View.GONE
                ...
                || (atoken != null && (atoken.hiddenRequested /*|| atoken.hidden*/))//[ALPS00279337]To solve the side effect caused by 4.0.4 migration, we 
