...
public class RefreshManager {
        ...
        public void onCallback(MessagingException exception, int progress, Clock clock) {
            if (exception == null && progress == 0) {
                ...
                if (Logging.LOG_PERFORMANCE) {
                    Logging.d(Logging.LOG_TAG, "[Exchange Download Speed] MessageList:updateMailbox:finished ["
    ...
    private boolean checkIsLowStorage(Context context) {
        ...
        if (pref.getLowStorage()) {
            ...
            Toast.makeText(context, R.string.low_storage_hint_delete_mail, Toast.LENGTH_SHORT).show();
