    ...
    public void overrideSettings(String key, String value, String[] values) {
    	for (AbstractIndicatorButton b: mIndicators) {
    		if (b instanceof IndicatorButton) {
    			b.overrideSettings(key, value, values);
    		}
        }
    }

    public void reInitializeOtherSetting(PreferenceGroup preferenceGroup, String[] prefKeys) {
        android.util.Log.v("Test", "reInitializeOtherSetting");
        setPreferenceGroup(preferenceGroup);
        for (AbstractIndicatorButton b: mIndicators) {
            if (b instanceof OtherSettingIndicatorButton) {
                b.reInitialSetting(preferenceGroup, prefKeys);
            }
        }
    }
