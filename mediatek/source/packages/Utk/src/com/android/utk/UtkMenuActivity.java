...
public class UtkMenuActivity extends ListActivity {
    ...
    private final BroadcastReceiver mSIMStateChangeReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if(TelephonyIntents.ACTION_SIM_STATE_CHANGED.equals(intent.getAction())) {
                ...
                CatLog.d(this, "mSIMStateChangeReceiver() - simId[" + simId + "]  state[" + simState + "]");
                if ((simId == com.android.internal.telephony.Phone.GEMINI_SIM_1) && 
                    (IccCard.INTENT_VALUE_ICC_NOT_READY.equals(simState))) {
                    CatLog.d(this, "UtkMenuActivity.finish()");
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        CatLog.d(this, "onListItemClick");
        CatLog.d(this, "mState :"+mState + "mAcceptUsersInput:" + mAcceptUsersInput);                
        if (!mAcceptUsersInput) {
            return;
        }

        Item item = getSelectedItem(position);
        CatLog.d(this, "item :"+item + "position:" + position);                
        if (item == null) {
            return;
        }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        CatLog.d(this, "onKeyDown");
        CatLog.d(this,"mState :"+mState + "mAcceptUsersInput:" + mAcceptUsersInput);        
        if (!mAcceptUsersInput) {
            return true;
        }
        CatLog.d(this, "keyCode:"+ keyCode + "event:" + event);
        switch (keyCode) {
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        CatLog.d (this, "onRestoreInstanceState");
        CatLog.d(this, "mState :"+mState + "mAcceptUsersInput:" + mAcceptUsersInput);                
    ...
    private void initFromIntent(Intent intent) {
        CatLog.d (this, "initFromIntent");
        if (intent != null) {
            mState = intent.getIntExtra("STATE", STATE_MAIN);
            CatLog.d(this, "mState :"+mState + "mAcceptUsersInput:" + mAcceptUsersInput);
        } else {
            CatLog.d (this, "initFromIntent null");        
            finish();
        }
    }
    ...
    private void sendResponse(int resId, int itemId, boolean help) {
        ...
        CatLog.d (this, "sendResponse resId:" + resId);             
