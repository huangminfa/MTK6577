...
public class ThermalSensorActivity extends Activity implements OnItemClickListener{
    ...
    public void onResume(){
        ...
        {
            Toast.makeText(this, "No thermal sensors found!", Toast.LENGTH_LONG).show();
            return;
        }
        ...
        thermal_sensors_lv.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, items));
    }
