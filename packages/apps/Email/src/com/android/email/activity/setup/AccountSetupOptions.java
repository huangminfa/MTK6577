...
public class AccountSetupOptions extends AccountSetupActivity implements OnClickListener {
    ...
    private static Object mCommitQueueLock = new Object();
    ...
    private void saveAccountAndFinish() {
        ...
        Utility.runAsync(new Runnable() {
            ...
            public void run() {
                ...
                Account account = SetupData.getAccount();
                synchronized (mCommitQueueLock) {
                    Logging.d("saveAccountAndFinish clearSecurityHoldFlag, accountId: " + account.mId);
