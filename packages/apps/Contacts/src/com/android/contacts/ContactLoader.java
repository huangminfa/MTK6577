...
public class ContactLoader extends Loader<ContactLoader.Result> {
    ...
    public static final class Result {
         ...
         * save contacts's new add field value        
         */
        private int mSlot = -1;
        ...
        */
        ...
        private Result(Uri requestedUri, Uri uri, Uri lookupUri, long directoryId, String lookupKey,
                ...
                boolean starred, Integer presence, boolean sendToVoicemail, boolean blockVideoCall, 
                String customRingtone, boolean isUserProfile, int isSdnContact) {
        ...
        */
        ...
        /*
         * New Feature by Mediatek Begin.            
         * get all NamedContentValues's object by the mimeType       
         */
        public List<NamedContentValues> getAllNamedContentValues(final String mimeType) {   
            List<NamedContentValues> contentValueList = new ArrayList<NamedContentValues>();                       
            for (Entity entity: this.getEntities()) {          
                for (NamedContentValues subValue : entity.getSubValues()) {                
                    if (mimeType.equals(subValue.values.getAsString(Data.MIMETYPE))) {
                        contentValueList.add(subValue);                    
                    }
                }
            }            
    ...
    private final class LoadContactTask extends AsyncTask<Void, Void, Result> {
            ...
            try {
                ...
                for (; !cursor.isAfterLast(); cursor.moveToNext()) {
                    ...
                    if (rawContactId != currentRawContactId) {
                         ...
                         */
                        result.setIndicate(cursor.getInt(ContactQuery.INDICATE_PHONE_OR_SIM_CONTACT));
                        result.setSimIndex(cursor.getInt(ContactQuery.INDEX_IN_SIM));
                        result.setSlot(SIMInfo.getSlotById(getContext(), result.getIndicate()));
                        /*
                         * New Feature  by Mediatek End.
                        */
        ...
        private Result loadContactHeaderData(final Cursor cursor, Uri contactUri) {
            ...
            return new Result(mRequestedUri, contactUri, lookupUri, directoryId, lookupKey,
                    ...
                    altDisplayName, phoneticName, starred, presence, sendToVoicemail, blockVideoCall, 
                    customRingtone, isUserProfile, isSdnContact);
        }
