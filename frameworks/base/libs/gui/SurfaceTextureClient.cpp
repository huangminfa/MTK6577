...
int SurfaceTextureClient::perform(int operation, va_list args)
{
    ...
    //---------------------------------------------
	case NATIVE_WINDOW_SET_S3D_OFFSET:
		res = dispatchSetS3DOffset(args);
		break;
    //---------------------------------------------
...
// [MTK] for S3D offset control
//---------------------------------------------------------------------------
int SurfaceTextureClient::dispatchSetS3DOffset(va_list args) {
    int offset = va_arg(args, int);
    return setS3DOffset(offset);
}

int SurfaceTextureClient::setS3DOffset(int offset) {
    LOGV("SurfaceTextureClient::setS3DOffset");
    Mutex::Autolock lock(mMutex);
    status_t err = mSurfaceTexture->setS3DOffset(offset);
    return err;
}
