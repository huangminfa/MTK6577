 ...
 *
 * Feb 20 2008 mtk01890
 * [MAUI_00275507] [IMPS] It doesnot deactive bearer when login failed.
 * 
 *
 ...
 *
 * Feb 3 2007 MTK01264
 * [MAUI_00363451] [VoIP] SIP Can't auto-login
 * Passing error code from SOC to upper layer (SIP, VOIP, MMI) to destinguish Wi-Fi out of coverage and DHCP failed
 *
 * Jan 21 2007 MTK01264
 * [MAUI_00360227] [SOC] Add account_id in deactivate_cnf message
 * Add account_id in DEACTIVATE_CNF message to app
 *
 * Nov 30 2006 MTK01264
 * [MAUI_00347388] [1] Fatal Error (804): Buffer not available - SOC
 * Do not send mass indication ILMs
 *
 * Nov 12 2006 MTK01264
 * [MAUI_00342491] [SOC] Modifications for socket enhancement
 * Change structure for primitives for DNS related APIs
 *
 * Oct 10 2006 MTK01264
 * [MAUI_00335073] [SOC] Check in VoWLAN feature
 * New feature supporting VoWLAN
 *
 *------------------------------------------------------------------------------
