...
public class BtTest {
	...
	private int iPocketType;
	private int iPocketTypeLen;
	private int iFreq;
	private int iPower;

  static {
        System.loadLibrary("embttest_jni");
    }
	...
	/*
	-1: error
	0: BLE is not supported
	1: BLE is supported
	*/
	public native int isBLESupport();	
	public native int doBtTest(int kind);
 	public native boolean NoSigRxTestStart(int nPatternIdx, int nPocketTypeIdx, int nFreq, int nAddress);
