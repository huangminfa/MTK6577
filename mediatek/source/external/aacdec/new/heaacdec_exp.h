...
//  enableParser            [i] enable AAC parser in decoder or not
//                              1: enable  - decoder will parse AAC header.
//                              0: disable - decoder will decode raw_data_block directly.
// RETURNS
...
int HEAACDec_DecodeFrameBypass(HEAACDEC_HANDLE *pHEAACDecHandle,
                           void *pPcmBuf,
                           void *pTmpBuf,
                           const void *pBsBuf,
                           int BsBufLen,
...
//======================================================================//
// FUNCTION
//  HEAACDec_SetAudioSpecificConfig
//
// DESCRIPTION
//  This function set audio specific config into decoder.
//  Note: only used in raw decode mode
//
// PARAMETERS
//  pHEAACDecHandle         [i] pointer to HEAAC decoder handler.
//  u4AudioObjectType       [i] audio object type
//  u4SamplingFreqIndex     [i] sampling frequency index.
//  u1ChannelNum            [i] channel number
//
// RETURNS
//  0: successful  , no-zero : error.
//
//======================================================================//  

int HEAACDec_SetAudioSpecificConfig(HEAACDEC_HANDLE *pHEAACDecHandle,
