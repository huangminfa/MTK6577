...
LOCAL_SRC_FILES += \
	...
	voip/java/android/net/sip/ISipService.aidl\
        /../../mediatek/source/frameworks/media/audio/java/com/mediatek/audioprofile/IAudioProfileListener.aidl\
        /../../mediatek/source/frameworks/media/audio/java/com/mediatek/audioprofile/IAudioProfileService.aidl
...
LOCAL_SECONDARY_JAVA_CLASSES += android/app/* android/view/*
...
ifeq ($(strip $(MTK_SIM_AUTHENTICATION_SUPPORT)), yes)
LOCAL_STATIC_JAVA_LIBRARIES += SimCardAuthenticationManagerLib
endif
...
LOCAL_PROGUARD_FLAG_FILES := ../../mediatek/source/frameworks/jpe/files/gemini.proguard.flags

LOCAL_EXCLUDED_JAVA_CLASSES += com/android/internal/telephony/gemini/**.class 
LOCAL_JAVASSIST_ENABLED := true
LOCAL_JAVASSIST_OPTIONS := mediatek/source/frameworks/jpe/files/gemini.jpe.config
endif
...
include $(LOCAL_PATH)/../../mediatek/source/frameworks/config.mk
...
LOCAL_SRC_FILES += $(call all-java-files-under,  ../../mediatek/source/frameworks/base/core/java/android/app/)
#LOCAL_SRC_FILES += $(call all-java-files-under,  ../../mediatek/source/frameworks/base/core/java/android/view/)
...
LOCAL_NO_STANDARD_LIBRARIES := true
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := secondary_framework
...
ifeq ($(MTK_MVNO_SUPPORT),yes)
   PRODUCT_COPY_FILES += mediatek/source/frameworks/telephony/etc/virtual-spn-conf-by-efspn.xml:system/etc/virtual-spn-conf-by-efspn.xml
   PRODUCT_COPY_FILES += mediatek/source/frameworks/telephony/etc/virtual-spn-conf-by-imsi.xml:system/etc/virtual-spn-conf-by-imsi.xml
endif
