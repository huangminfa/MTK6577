...
extern int rtt_dump_backtrace(pid_t pid, pid_t tid, const char* file_path); 
extern int rtt_dump_all_backtrace(pid_t pid, const char* file_path);
extern int rtt_dump_all_backtrace_by_name(const char *ps_name, const char *file_path);
