...
public class ContactsFastSyncUpdateDetailedContactsReq extends RawBlockRequest {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    // Constructors                                                 
    //==============================================================
    public ContactsFastSyncUpdateDetailedContactsReq(){
        super(FEATURE_SYNC);
    }
    ...
    public static class Builder extends RawBlockRequest.Builder {
        ...
        protected RawBlockRequest onCreateCommand(int featureId){
            return new ContactsFastSyncUpdateDetailedContactsReq();
        }
        ...
        public ContactsFastSyncUpdateDetailedContactsReq build(){
            ...
            return (ContactsFastSyncUpdateDetailedContactsReq)super.build();
        }
