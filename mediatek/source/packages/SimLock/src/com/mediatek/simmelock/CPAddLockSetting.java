...
public class CPAddLockSetting extends Activity implements DialogInterface.OnKeyListener
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        //Let the user to choose "put in" for just read MCCMNC from the SIM card
      ...
      //Press the CONFIRM Button
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.Input_mode, android.R.layout.simple_spinner_item);
        ...
        AdapterView.OnItemSelectedListener l = 
	        ...
	        ArrayAdapter<CharSequence> adapter2 = ArrayAdapter.createFromResource(this, R.array.Input_mode, android.R.layout.simple_spinner_item);
	        adapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
	        s2.setAdapter(adapter2);
	        AdapterView.OnItemSelectedListener l2 = 
	        	new AdapterView.OnItemSelectedListener() {
	        		public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3)
	        		{
	        ...
	        ArrayAdapter<CharSequence> adapter3 = ArrayAdapter.createFromResource(this, R.array.Input_mode, android.R.layout.simple_spinner_item);
	        adapter3.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
	        s3.setAdapter(adapter3);
	        AdapterView.OnItemSelectedListener l3 = 
	        	new AdapterView.OnItemSelectedListener() {
	        		public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3)
	        		{
        ...
        btnConfirm.setOnClickListener(new Button.OnClickListener()
        {
        	public void onClick(View view)
        	{
           		...
           		if(clickFlag == false)
           			clickFlag = true;
        	    if(((false == mbMCCMNCReadSIM)&&(false == mbMCCMNCReadSIM1)&&(false == mbMCCMNCReadSIM2))&&((5 > etMCCMNC.getText().length())||(6 < etMCCMNC.getText().length())))
        	    {
        	    ...
        	    else if ((Integer.parseInt(etGID1.getText().toString()) < 0) ||(Integer.parseInt(etGID1.getText().toString()) >254) ||((intSIMGID1 > 254) && mbGID1ReadSIM))
        	    {
        	    	showDialog(DIALOG_GID1WRONG);
        	    }
        	    else if ((Integer.parseInt(etGID2.getText().toString()) < 0) ||(Integer.parseInt(etGID2.getText().toString()) >254) ||((intSIMGID2 > 254) && mbGID2ReadSIM))
        	    {
        	    	showDialog(DIALOG_GID2WRONG);
        	    }
...
//        		else if ((etPwdConfirm.getText().length() < 4) || ((etPwdConfirm.getText().length() > 8)))
//        		{
//        			showDialog(DIALOG_PASSWORDLENGTHINCORRECT);
//        		}
        		...
        		else
        		{
                    ...
                    if (mbMCCMNCReadSIM == false)//user input
                    {      	
                		if(mbGID1ReadSIM == false)
                		{
                			if(mbGID2ReadSIM == false)
                			{
                				phone.getIccCard().setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),etGID1.getText().toString(),etGID2.getText().toString(),callback);
                			}
                			else
                			{
                				phone.getIccCard().setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),etGID1.getText().toString(),msSIMGID2,callback);
                			}
                		...
                		else
                		{
                			if(mbGID2ReadSIM == false)
                			{
                				phone.getIccCard().setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),msSIMGID2,etGID2.getText().toString(),callback);
                			}
                			else
                			{
                				phone.getIccCard().setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),msSIMGID2,msSIMGID2,callback);
                			}
                		}                	
                    }
                    else
                    {
                		if(mbGID1ReadSIM == false)
                		{
                			if(mbGID2ReadSIM == false)
                			{
                				phone.getIccCard().setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),msSIMMCCMNC,etGID1.getText().toString(),etGID2.getText().toString(),callback);
                			}
                			else
                			{
                				phone.getIccCard().setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),msSIMMCCMNC,etGID1.getText().toString(),msSIMGID2,callback);
                			}
                    ...
                    else
                    {
                			if(mbGID2ReadSIM == false)
                			{
                				phone.getIccCard().setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),msSIMMCCMNC,msSIMGID2,etGID2.getText().toString(),callback);
                			}
                			else
                			{
                				phone.getIccCard().setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),msSIMMCCMNC,msSIMGID2,msSIMGID2,callback);
                			}
                		}
                    }
                    }
                    else
                    {
                    	...
                    	if (intSIMNumber == 0)
                    	{
                    		//mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(0,3,etPwd.getText().toString(),etMCCMNC.getText().toString(),etGID1.getText().toString(),etGID2.getText().toString(),callback);
                    		//editPwdProcess(et, "12345678");       	//compare with the true password "lockPassword"	
                        	if (mbMCCMNCReadSIM1 == false)//user input
                        	{
                        		if(mbGID1ReadSIM1 == false)
                        		{
                        			if(mbGID2ReadSIM1 == false)
                        			{
                        				mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),etGID1.getText().toString(),etGID2.getText().toString(),callback);
                        			}
                        			else
                        			{
                        				mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),etGID1.getText().toString(),msSIM1GID2,callback);
                        			}
                        		...
                        		else
                        		{
                        			if(mbGID2ReadSIM1 == false)
                        			{
                        				mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),msSIM1GID2,etGID2.getText().toString(),callback);
                        			}
                        			else
                        			{
                        				mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),msSIM1GID2,msSIM1GID2,callback);
                        			}
                        		}
                        	...
                        	else
                        	{
                        		if(mbGID1ReadSIM1 == false)
                        		{
                        			if(mbGID2ReadSIM1 == false)
                        			{
                        				mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),msSIM1MCCMNC,etGID1.getText().toString(),etGID2.getText().toString(),callback);
                        			}
                        			else
                        			{
                        				mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),msSIM1MCCMNC,etGID1.getText().toString(),msSIM1GID2,callback);
                        			}
                        		...
                        		else
                        		{
                        			if(mbGID2ReadSIM1 == false)
                        			{
                        				mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),msSIM1MCCMNC,msSIM1GID1,etGID2.getText().toString(),callback);
                        			}
                        			else
                        			{
                        				mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),msSIM1MCCMNC,msSIM1GID1,msSIM1GID2,callback);
                        			}
                        		}
                        	}   
                    	}
                    	...
                    	{
                    		//mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).setIccNetworkLockEnabled(0,3,etPwd.getText().toString(),etMCCMNC.getText().toString(),etGID1.getText().toString(),etGID2.getText().toString(),callback);
                    		//editPwdProcess(et, "12345678");       	//compare with the true password "lockPassword"	
                    		
                    		
                       		//mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(0,3,etPwd.getText().toString(),etMCCMNC.getText().toString(),etGID1.getText().toString(),etGID2.getText().toString(),callback);
                    		//editPwdProcess(et, "12345678");       	//compare with the true password "lockPassword"	
                        	if (mbMCCMNCReadSIM2 == false)//user input
                        	{
                        		if(mbGID1ReadSIM2 == false)
                        		{
                        			if(mbGID2ReadSIM2 == false)
                        			{
                        				mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),etGID1.getText().toString(),etGID2.getText().toString(),callback);
                        			}
                        			else
                        			{
                        				mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),etGID1.getText().toString(),msSIM2GID2,callback);
                        			}
                        		...
                        		else
                        		{
                        			if(mbGID2ReadSIM1 == false)
                        			{
                        				mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),msSIM2GID2,etGID2.getText().toString(),callback);
                        			}
                        			else
                        			{
                        				mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),msSIM2GID2,msSIM2GID2,callback);
                        			}
                        		}
                        	...
                        	else
                        	{
                        		if(mbGID1ReadSIM1 == false)
                        		{
                        			if(mbGID2ReadSIM1 == false)
                        			{
                        				mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),msSIM2MCCMNC,etGID1.getText().toString(),etGID2.getText().toString(),callback);
                        			}
                        			else
                        			{
                        				mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),msSIM2MCCMNC,etGID1.getText().toString(),msSIM2GID2,callback);
                        			}
                        		...
                        		else
                        		{
                        			if(mbGID2ReadSIM1 == false)
                        			{
                        				mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),msSIM2MCCMNC,msSIM2GID1,etGID2.getText().toString(),callback);
                        			}
                        			else
                        			{
                        				mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).setIccNetworkLockEnabled(3,2,etPwd.getText().toString(),msSIM2MCCMNC,msSIM2GID1,msSIM1GID2,callback);
                        			}
                        		}
                        	}   
                    	}
	...
	protected void onResume() {
        ...
        if(false == FeatureOption.MTK_GEMINI_SUPPORT)
        {
            ...
            if (TelephonyManager.SIM_STATE_ABSENT == miSIMState)//SIM1 not ready!
            {
...
//                }
        ...
        {   
            miSIM1State = telephonyManager.getSimStateGemini(0);
            miSIM2State = telephonyManager.getSimStateGemini(1);
            if (TelephonyManager.SIM_STATE_ABSENT == miSIM1State)//SIM1 not ready!
            {
            ...
            if (TelephonyManager.SIM_STATE_ABSENT == miSIM2State)//SIM2 not ready!
            {
            ...
            msSIM1MCCMNC = telephonyManager.getSimOperatorGemini(0);
            ...
            msSIM2MCCMNC = telephonyManager.getSimOperatorGemini(1);
...
//            }
        	...
        	if (intSIMNumber == 0)
        	{
                IccFileHandler iccFh = mGeminiPhone.getIccFileHandlerGemini(Phone.GEMINI_SIM_1);
        	...
        	{
                IccFileHandler iccFh = mGeminiPhone.getIccFileHandlerGemini(Phone.GEMINI_SIM_2);
	...
	protected Dialog onCreateDialog(int id) {
    	...
    	case DIALOG_ADDLOCKFAIL: //password is wrong
    		{
    	    	...
    	    	.setMessage(R.string.strAddLockFail)
    	...
    	case DIALOG_PASSWORDLENGTHINCORRECT://Length is incorrect
    		{
    	    	...
    	    	.setTitle(R.string.strAttention)
    	    	.setIcon(android.R.drawable.ic_dialog_alert)
    	    	.setMessage(R.string.strPasswordLengthIncorrect)
    	    	.setOnKeyListener(this)
    	    	.setPositiveButton(R.string.strYes, new DialogInterface.OnClickListener() 
    	    	{			
    				public void onClick(DialogInterface dialog, int id) 
    	...
    	case DIALOG_MCCMNCLENGTHINCORRECT://Length is incorrect
		{
	    	...
	    	.setTitle(R.string.strAttention)
	    	.setIcon(android.R.drawable.ic_dialog_alert)
	    	.setMessage(R.string.strMCCMNCLengthIncorrect)
	    	.setOnKeyListener(this)
	    	.setPositiveButton(R.string.strYes, new DialogInterface.OnClickListener() 
	    	{			
				public void onClick(DialogInterface dialog, int id) 
    	...
    	case DIALOG_ADDLOCKSUCCEED://Length is incorrect
	    	...
	    	.setTitle(R.string.strAttention)
	    	.setIcon(android.R.drawable.ic_dialog_alert)
	    	.setMessage(R.string.strAddLockSucceed)
	    	.setOnKeyListener(this)
	    	.setPositiveButton(R.string.strYes, new DialogInterface.OnClickListener() 
	    		{			
				public void onClick(DialogInterface dialog, int id) 
    	...
    	.setTitle(R.string.strAttention)
    	.setIcon(android.R.drawable.ic_dialog_alert)
    	.setMessage(R.string.strGID1WRONG)
    	.setOnKeyListener(this)
    	.setPositiveButton(R.string.strYes, new DialogInterface.OnClickListener() 
    		{			
			public void onClick(DialogInterface dialog, int id) 
    	...
    	.setTitle(R.string.strAttention)
    	.setIcon(android.R.drawable.ic_dialog_alert)
    	.setMessage(R.string.strGID2WRONG)
    	.setOnKeyListener(this)
    	.setPositiveButton(R.string.strYes, new DialogInterface.OnClickListener() 
    		{			
			public void onClick(DialogInterface dialog, int id) 
		...
		case DIALOG_PASSWORDWRONG://Length is incorrect
		{
			...
			.setTitle(R.string.strAttention)
			.setIcon(android.R.drawable.ic_dialog_alert)
			.setMessage(R.string.str_simme_passwords_dont_match)
			.setOnKeyListener(this)
			.setPositiveButton(R.string.strYes, new DialogInterface.OnClickListener() 
				{			
				public void onClick(DialogInterface dialog, int id) 
    ...
    boolean mbMCCMNCReadSIM1 = false;//whether to read MCC+MNC from SIM1 card,default to set false
    boolean mbMCCMNCReadSIM2 = false;//whether to read MCC+MNC from SIM2 card,default to set false
	boolean mbMCCMNCReadSIM = false;
	boolean mbGID1ReadSIM = false;
    boolean mbGID1ReadSIM1 = false;//whether to read GID1 from SIM1 card,default to set false
    boolean mbGID1ReadSIM2 = false;//whether to read GID1 from SIM2 card,default to set false
    boolean mbGID2ReadSIM = false;
    boolean mbGID2ReadSIM1 = false;//whether to read GID2 from SIM1 card,default to set false
    boolean mbGID2ReadSIM2 = false;//whether to read GID2 from SIM2 card,default to set false
