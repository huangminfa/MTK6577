...
const NVRAM_LENS_PARA_STRUCT A8141AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 A8141AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &A8141AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pA8141AF_getDefaultData = A8141AF_getDefaultData;
