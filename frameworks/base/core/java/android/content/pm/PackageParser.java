...
public class PackageParser {
    ...
    private Package parsePackage(
        ...
        TypedArray a = res.obtainAttributes(attrs,
                com.mediatek.internal.R.styleable.MTKManifest);
        pkg.isThemePackage = a.getInteger(
                com.mediatek.internal.R.styleable.MTKManifest_isThemePackage, 0);
        pkg.mThemeNameId = a.getResourceId(
                com.mediatek.internal.R.styleable.MTKManifest_themeNameId, 0);
        a.recycle();
        //M        
