...
public class DBHelper extends SQLiteOpenHelper {  
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        CatLog.d(this, "DBHelper: onCreate");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // TODO Auto-generated method stub
        CatLog.d(this, "DBHelper: onUpgrade");
    ...
    public long insert(String inst, String newData) {
    	  CatLog.d(this, "DBHelper: insert :" + newData + "for :" + inst);
    ...
    public void update(int id,String newData) {
    	  CatLog.d(this, "DBHelper: update: " + newData + "for:" + id);
        SQLiteDatabase db=this.getWritableDatabase();
        String where=DB_ID+"=?";
        String[] whereValue={Integer.toString(id)};
        ContentValues cv=new ContentValues(); 
    ...
    public String readDataFromDB(String s) {
    	  CatLog.d(this, "DBHelper: readDataFromDB:" + s);
    	  String str = null;
    	  String s1 = null;
        Cursor cs = select();
        ...
        while(cs.moveToNext()) {
            ...
            if(s.equals(s1)) {
                ...
                CatLog.d(this, "readDataFromDB:" + str);
                cs.close();
                return str;
            }
        }
        ...
        cs.close();	
        CatLog.d(this, "readDataFromDB: null 0");
        return null;        	
    }
    
    public void saveDataToDB(String inst, String data) {
    	  CatLog.d(this, "DBHelper: saveDataToDB: " + data + "into: " + inst);
    	  String str = null;
    	  String s1 = null;
    	  int id = -1;
    	  Cursor cs = select();
        ...
        while(cs.moveToNext()) {
            ...
            if(inst.equals(s1)) {
                ...
                CatLog.d(this, "saveDataToDB: update");
                update (id, data);
            }
        }
        cs.close();
        ...
        if (id == -1) {
        	  CatLog.d(this, "saveDataToDB: insert");
            insert(inst, data);
        }	
    }
}  
