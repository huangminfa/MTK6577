    ...
    protected Dialog onCreateDialog(int id, Bundle bundle) {
        ...
        switch (id) {
            case R.id.multichoice_confirm_dialog: {
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(this).setTitle(title)
            ...
            case R.id.multichoice_report_dialog: {
                final AlertDialog.Builder builder = new AlertDialog.Builder(this).setTitle(
                        mReportTitle).setMessage(mReportContent).setPositiveButton(
