...
public class SetupData implements Parcelable {
    ...
    public static final int FLOW_MODE_CHANGE_PASSWORD = 8;
    ...
    static public boolean getFromAccountManager() {
        return getInstance().mFromAccountManager;
    }

    static public void setFromAccountManager(boolean isAccountManager) {
