...
public class ClockActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.getLayoutInflater().inflate(R.layout.clock_layout, (ViewGroup) container, true);
        ...
        tweakButton.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(ClockActivity.this, TweakListActivity.class);
        ...
        // Add some default tweaks applicable for all widgets

        addTweak("camera_fov", "Camera FOV", new FloatTweak() {
            public float get() {
                return clockView.getCameraFov();
            }

            public void set(float value) {
                clockView.setCameraFov(value);
            }
        });

        addTweak("camera_angle_x", "Camera Angle X", new FloatTweak() {
            public float get() {
                return clockView.getCameraAngleX();
            }

            public void set(float value) {
                clockView.setCameraAngleX(value);
            }
        });

        addTweak("camera_angle_y", "Camera Angle Y", new FloatTweak() {
            public float get() {
                return clockView.getCameraAngleY();
            }

            public void set(float value) {
                clockView.setCameraAngleY(value);
            }
        });

        addTweak("camera_distance", "Camera Distance", new FloatTweak() {
            public float get() {
                return clockView.getCameraDistance();
            }

            public void set(float value) {
                clockView.setCameraDistance(value);
            }
        });

        addTweak("camera_lookat_y", "Camera LookAt Y", new FloatTweak() {
            public float get() {
                return clockView.getCameraLookAt().y;
            }

            public void set(float value) {
                Point lookAt = clockView.getCameraLookAt();
                lookAt.y = value;
                clockView.setCameraLookAt(lookAt);
            }
        });
        ...
        addTweak("screen_distance", "Screen Distance", new FloatTweak() {
            public float get() {
                return clockView.getScreenDistance();
            }

            public void set(float value) {
                clockView.setScreenDistance(value);
            }
        });

        addTweak("animation_speed", "Animation Speed", new FloatTweak() {
            public float get() {
                return clockView.getAnimationSpeed() * 100f;
            }

            public void set(float value) {
                clockView.setAnimationSpeed(value *
                        0.01f);
            }
        });
        ...
        addTweak("light_position_x", "Light Position X", new FloatTweak() {
            public float get() {
                Glo3D light = clockView._getLight();
    ...
    public void onPause() {
        super.onPause();
        ClockView widgetView = (ClockView) findViewById(R.id.clock_view);
        widgetView.freeze(0);
