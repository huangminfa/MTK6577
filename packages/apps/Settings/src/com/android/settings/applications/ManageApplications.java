...
public class ManageApplications extends Fragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // get the sd card description from Storage Manager
        ...
        for(int i = 0; i < len; i++){
        	if(Volumes[i].getPath().equals("/mnt/sdcard")) {
        		mSdDescription = Volumes[i].getDescription();
        		break;
        	}else{
        		mSdDescription = "";
        	}
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (mDefaultTab != null) {
            outState.putString("defaultTabTag", mDefaultTab);
        }
