...
public class IndicatorControlBarContainer extends IndicatorControlContainer {
    ...
    @Override
    public void reInitializeOtherSetting(PreferenceGroup group,
            String[] secondLevelOtherSettingKeys) {
        mSecondLevelIndicatorControlBar.reInitializeOtherSetting(group, secondLevelOtherSettingKeys);
    }
    ...
    public void overrideSettings(String key, String value, String[] values) {
    	mSecondLevelIndicatorControlBar.overrideSettings(key, value, values);
    }

    public void disableCameraPicker() {
        if (mIndicatorControlBar.mCameraPicker != null) {
    	    mIndicatorControlBar.mCameraPicker.setEnabled(false);
        }
    }

    public void setCameraPickerVisibility(int isVisible) {
        if (mIndicatorControlBar.mCameraPicker != null) {
            mIndicatorControlBar.mCameraPicker.setVisibility(isVisible);
        }
    }
    //Mediatek modify end
}
