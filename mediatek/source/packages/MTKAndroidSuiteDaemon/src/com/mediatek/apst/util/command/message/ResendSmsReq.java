...
/**
 * Class Name: ResendSmsReq
 * <p>Package: com.mediatek.apst.util.command.message
 * <p>Created on: 2010-12-18
 * <p>
 * <p>Description: 
 * <p>Request for resending a SMS message.
 * <p>
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class ResendSmsReq extends RequestCommand {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    // For MTK DUAL-SIM feature.
    /**
     * Gets via which SIM card to resend the SMS message.
     * @return The ID of SIM via which to resend the SMS message. 
    ...
    // For MTK DUAL-SIM feature.
    /**
     * Sets via which SIM card to resend the SMS message.
     * @param simId The ID of SIM via which to resend the SMS message. 
     * Valid value can be SIM_ID, SIM1_ID or SIM2_ID.
     * @see com.mediatek.apst.util.entity.message.Message#SIM_ID
     * @see com.mediatek.apst.util.entity.message.Message#SIM1_ID
     * @see com.mediatek.apst.util.entity.message.Message#SIM2_ID
