...
public class WifiManager {
    ...
    /** @hide */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String WPS_SUCCESS_ACTION = "android.net.wifi.WPS_SUCCESS";

    /** @hide */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String WPS_ERROR_ACTION = "android.net.wifi.WPS_ERROR";

    /** @hide */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String WPS_OVERLAP_ACTION = "android.net.wifi.WPS_OVERLAP";
    
    /** @hide */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String WPS_NO_OVERLAP_ACTION = "android.net.wifi.WPS_NO_OVERLAP";

    /** @hide */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String WPS_CRED_ACTION = "android.net.wifi.WPS_CRED";

    /** @hide */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String WPS_AP_PIN_ACTION = "android.net.wifi.WPS_AP_PIN";

    /** @hide */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String WPS_AP_PBC_ACTION = "android.net.wifi.WPS_AP_PBC";
    ...
    /** @hide */
    public static final String WIFI_CONCURRENT_OPERATION_ACTION = "android.net.wifi.WIFI_CONCURRENT_OPERATION";
    /** @hide */
    public static final String WIFI_CONCURRENT_STOP_P2P_ACTION = "android.net.wifi.WIFI_CONCURRENT_STOP_P2P";
    /** @hide */
    public static final String WIFI_CONCURRENT_STOP_HOTSPOT_OR_ANOTHER_P2P_ACTION = "android.net.wifi.WIFI_CONCURRENT_STOP_HOTSPOT_OR_ANOTHER_P2P";
    /** @hide */
    public static final String EXTRA_CONCURRENT_TYPE = "concurrent_type";
    /** @hide */
    public static final int WIFI_CONCURRENT_TYPE_P2P_TO_HOTSPOT = 1;
    /** @hide */
    public static final int WIFI_CONCURRENT_TYPE_HOTSPOT_TO_P2P = 2;
    /** @hide */
    public static final int WIFI_CONCURRENT_TYPE_P2P_TO_P2P = 3;
    /** @hide */
    public static final int WIFI_CONCURRENT_TYPE_AIRPLANE_MODE = 4;
    /** @hide */
    public static final int WIFI_CONCURRENT_TYEP_ERROR = -1;
   ...
   /**
    ...
    /**
     * Do WPS PBC connection added by mtk03034
     * @hide no intent to publish
     */
    public boolean doPbcConnect(String bssid) {
        if (mService == null) {
            return false;
        }
        try {
            return mService.doWpsPbc(bssid);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    /**
     * Do WPS PIN connection added by mtk03034
     * @hide no intent to publish
     */
    public String getPinAndConnect(String bssid) {
        if (mService == null) {
            return null;
        }
        try {
            return mService.doWpsPin(bssid);
        } catch (RemoteException e) {
            return null;
        }
    }
    ...
    /**
     * Abort WPS connection added by mtk03034
     * @hide no intent to publish
     */
    ...
    /**
     * Enable CTIA test added by mtk03034
     * @hide no intent to publish
     */
    ...
    /**
     * Disable CTIA test added by mtk03034
     * @hide no intent to publish
     */
    ...
    /**
     * Set power mode added by mtk03034
     * @hide no intent to publish
     */
    public boolean doCTIATestPower(int powerMode) {
        ...
        try {
            return mService.doCTIATestPower(powerMode);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    /**
     * Set value for specific item added by mtk03034
     * @hide no intent to publish
     */
    public boolean doCTIATestSet(int id, int value) {
        ...
        try {
            return mService.doCTIATestSet(id, value);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    /**
     * Get value for specific item added by mtk03034
     * @hide no intent to publish
     */
    public String doCTIATestGet(int id) {
        ...
        try {
            return mService.doCTIATestGet(id);
        } catch (RemoteException e) {
            return null;
        }
    }
    ...
    /**
     * Check if there is connectable AP exists, added for CMCC customization
     * @hide no intent to publish
     */
