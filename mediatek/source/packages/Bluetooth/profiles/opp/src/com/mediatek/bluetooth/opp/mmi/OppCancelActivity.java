 ...
 * @author jerry.hsu
 * 
 * popup 'Cancel' dialog and call OppManager to cancel task
 */
public class OppCancelActivity extends CancelableActivity {
	...
	protected Dialog onCreateDialog( int id ){
		...
		.setTitle( R.string.bt_opp_cancel_task_title )
		.setMessage( R.string.bt_opp_cancel_task_message )
		.setPositiveButton(R.string.bt_opp_cancel_task_yes, new DialogInterface.OnClickListener() {
		...
		.setNegativeButton( R.string.bt_opp_cancel_task_no, new DialogInterface.OnClickListener() {
	...
	protected void onActivityCancel( int id ){
		...
		if( id == CancelableActivity.NULL_CANCEL_ID ){
			...
			try {
				...
				// will be canceled
				OppLog.e( "OppCancelActivity.onActivityCancel() error: intent[" + this.getIntent() + "], exception[" + ex.getMessage() + "]" );
			}
		}
