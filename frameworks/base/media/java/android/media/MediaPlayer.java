...
public class MediaPlayer
{
    ...
    public void setDataSource(Context context, Uri uri, Map<String, String> headers)
        ...
        setDataSource(uri.toString(), OmaSettingHelper.setSettingHeader(context, uri, headers));
        return;
    }
    ...
    private class EventHandler extends Handler
    {
        ...
        public void handleMessage(Message msg) {
            ...
            case MEDIA_DURATION_UPDATE:
            	Log.i(TAG, "Duration update (duration=" + msg.arg1 + ")");
    ...
    /**
     * When the source is RTSP streaming file, 
    ...
    /** The media CAN be seeked now(seek table has been setup)
     * @see android.media.MediaPlayer.OnInfoListener
     * @hide
     */
    ...
    /**
     * The video size of media file is too large for decoder(or other reason),
    ...
    /**
     * This will be sent after connecting to the server,
    ...
    /**
     * The decoder can't support the audio format of media file ,
    ...
    /**
     * Interface definition to notify application when a new(accurate) duration
    ...
    /**
     * Register a callback to be invoked when a new duration is available from lower layers
