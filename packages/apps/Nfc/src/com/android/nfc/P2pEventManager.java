...
public class P2pEventManager implements P2pEventListener, SendUi.Callback {
    ...
    public P2pEventManager(Context context, P2pEventListener.Callback callback) {
        ...
        mCallback = callback;
		// ----- MTK begins ----- //
        mVibrator = NfcAddon.createVibratorWrapper(context, NfcService.PREF);//mVibrator = (Vibrator) context.getSystemService(Context.VIBRATOR_SERVICE);
        // ----- MTK ends ----- //
