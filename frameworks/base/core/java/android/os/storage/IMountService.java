    ...
    public static abstract class Stub extends Binder implements IMountService {
        private static class Proxy implements IMountService {
            ...
            public int[] getStorageUsers(String path) throws RemoteException {
			 ...
			 public int getMediaProcessStorageUser(String path) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                int _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    _data.writeString(path);
                    mRemote.transact(Stub.TRANSACTION_getMediaProcessStorageUser, _data, _reply, 0);
                    _reply.readException();
                    _result = _reply.readInt();
                } finally {
                    _reply.recycle();
        ...
        static final int TRANSACTION_shareCDRom = IBinder.FIRST_CALL_TRANSACTION + 33;

        static final int TRANSACTION_getMediaProcessStorageUser = IBinder.FIRST_CALL_TRANSACTION + 34;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply,
            ...
            switch (code) {
                ...
                case TRANSACTION_getStorageUsers: {
				 ...
				 case TRANSACTION_getMediaProcessStorageUser: {
                    data.enforceInterface(DESCRIPTOR);
                    String path;
                    path = data.readString();
                    int pids = getMediaProcessStorageUser(path);
                    reply.writeNoException();
                    reply.writeInt(pids);
                    return true;
                }
