...
//MTK-END [mtk04258][20120806][International card support]
     ...
     *
     * @param h    Handler object to receive call state change notification.
     ...
     *
     * @return Return connection object when the call is dialed out.
     */
...
//MTK-END [mtk80601][111212][ALPS00093395]IPO feature
     ...
     * 
     * @return Return voice mail number or return null if the number does not exist or SIM is not ready.
     */
