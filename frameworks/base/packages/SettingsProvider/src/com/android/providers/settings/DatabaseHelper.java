...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadSetting(stmt, Settings.System.GPRS_CONNECTION_SETTING, Settings.System.GPRS_CONNECTION_SETTING_DEFAULT);            
		    ...
		    if(optr != null && optr.equals("OP01")){
	            loadBooleanSetting(stmt, Settings.System.AUTO_TIME,
	                    R.bool.def_auto_time_cmcc); // Sync time to NITZ

	            loadBooleanSetting(stmt, Settings.System.AUTO_TIME_ZONE,
	                    R.bool.def_auto_time_zone_cmcc); // Sync timezone to NITZ
		    }else{
	            loadBooleanSetting(stmt, Settings.System.AUTO_TIME,
	    ...
	    loadIntegerSetting(stmt, Settings.System.VT_CALL_REJECT_MODE, R.integer.def_video_call_reject_mode);
            ...
            loadIntegerSetting(stmt, Settings.System.CRO_SETTING, R.integer.def_cro_setting);//ALPS00279048
			
            loadIntegerSetting(stmt, Settings.System.HOO_SETTING, R.integer.def_hoo_setting);//ALPS00310187
    ...
    private void loadUISoundEffectsSettings(SQLiteStatement stmt) {
        ...
        loadBooleanSetting(stmt, Settings.System.HAPTIC_FEEDBACK_ENABLED,
                R.bool.def_haptic_feedback_op01);
        }else{
        loadBooleanSetting(stmt, Settings.System.HAPTIC_FEEDBACK_ENABLED,
    ...
    private void loadSecureSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadSetting(stmt, Settings.Secure.DATA_ROAMING_2,
                    "true".equalsIgnoreCase(
                            SystemProperties.get("ro.com.android.dataroaming2",
                                    "false")) ? 1 : 0); 
                                    
            loadSetting(stmt, Settings.Secure.MOBILE_DATA, Settings.Secure.MOBILE_DATA_DEFAULT);                                    

            //MTK_OP03_PROTECT_START
             if(optr != null && optr.equals("OP03") && isPackageExist("com.orange.appshop")){
                 loadBooleanSetting(stmt, Settings.Secure.INSTALL_NON_MARKET_APPS,
						R.bool.def_install_non_market_apps_op03); 
             }else
           ...
           //MTK_OP03_PROTECT_START
            if(optr != null && optr.equals("OP03")){
            	loadStringSetting(stmt, Settings.Secure.LOCATION_PROVIDERS_ALLOWED,
                        R.string.def_location_providers_allowed_op03);	
            }else
            //MTK_OP03_PROTECT_END
            {
                loadStringSetting(stmt, Settings.Secure.LOCATION_PROVIDERS_ALLOWED,
		...
		loadSetting(stmt, Settings.Secure.DEFAULT_INPUT_METHOD,
					strBuffer.toString());
        Log.d(TAG, "in DatabaseHelper loadSecureSettings: " + strBuffer.toString());
		...
		Log.i(TAG, "default IME from IMEFeatureOption is null!!");
            ...
            /*loadStringSetting(stmt, Settings.Secure.WIFIP2P_DEV_NAME,
                    com.android.internal.R.string.wifi_p2p_configure_device_name_default);*/

           //MTK_OP01_PROTECT_START
           if(optr != null && optr.equals("OP01")){
              loadBooleanSetting(stmt, Settings.Secure.BATTERY_PERCENTAGE,
                    R.bool.def_battery_percentage_op01);
           }else
