...
public class RotateDialogController implements Rotatable {
	...
	//mediatek migration start
	private ViewGroup mCenterRoot;
	private Resources res;
    public RotateDialogController(Activity a, int layoutResource, ViewGroup root) {
        mActivity = a;
    ...
    private void inflateDialogLayout() {
        if (mDialogRootLayout == null) {
            ViewGroup layoutRoot = mCenterRoot != null ? mCenterRoot : (ViewGroup) mActivity.getWindow().getDecorView();
			...
			//mediatek migration start
			if (mCenterRoot != null && mCenterRoot instanceof RelativeLayout) {
				RelativeLayout.LayoutParams params = 
					(RelativeLayout.LayoutParams)mDialogRootLayout.getLayoutParams(); 
    ...
    public void showAlertDialog(String title, String msg, String button1Text,
        ...
        if (FeatureOption.MTK_THEMEMANAGER_APP) {
           ...
           if (textColor != 0) {
               mRotateDialogTitle.setTextColor(textColor);
               mRotateDialogTitleDivider.setBackgroundColor(textColor);
           }
        }
        if (button1Text != null) {
