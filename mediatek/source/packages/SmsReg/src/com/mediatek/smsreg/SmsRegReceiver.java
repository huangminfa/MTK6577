...
public class SmsRegReceiver extends BroadcastReceiver {
	private String TAG = "SmsReg/Receiver";
	private ConfigInfoGenerator xmlG = XMLGenerator.getInstance(SmsRegConst.CONFIG_PATH);;
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (intentAction.equals(SmsRegConst.ACTION_BOOTCOMPLETED)) {
			...
			if (enableSmsReg()) {
				...
				if (xmlG != null) {
					Boolean isCustomized = xmlG.getCustomizedStatus();
					if (isCustomized) {
