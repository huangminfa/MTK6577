...
public class RespondViaSmsManager {
    ...
    public class RespondViaSmsCancelListener implements DialogInterface.OnCancelListener {
        ...
        public void onCancel(DialogInterface dialog) {
            ...
            if (null != mInCallScreen.getInCallTouchUi()) {
                mInCallScreen.getInCallTouchUi().cancelIncomingCallActionTime();
            }
    ...
    private void launchSmsCompose(String phoneNumber) {
        ...
        try {
            ...
            if (VDBG) log("Can not start SMS activity, which does not exist");
        }
...
//                id = (int)simInfo.mSimId;
            Call call = PhoneApp.getInstance().mCM.getFirstActiveRingingCall();
            if (DualTalkUtils.isSupportDualTalk) {
                call = DualTalkUtils.getInstance().getFirstActiveRingingCall();
            }
