...
//MTK-START [mtk80601][111215][ALPS00093395]
        ...
        mPhone.mCM.registerForSimMissing(mHandler, EVENT_SIM_MISSING, null);
        mPhone.mCM.registerForSimRecovery(mHandler, EVENT_SIM_RECOVERY, null);
        mPhone.mCM.registerForVirtualSimOn(mHandler, EVENT_VIRTUAL_SIM_ON, null);
        mPhone.mCM.registerForVirtualSimOff(mHandler, EVENT_VIRTUAL_SIM_OFF, null);
//MTK-END [mtk80601][111212][ALPS00093395]
        updateStateProperty();
    }
    ...
    */
    ...
    public void dispose() {
        ...
        mPhone.mCM.unregisterForSimMissing(mHandler);
        mPhone.mCM.unregisterForSimRecovery(mHandler);
        mPhone.mCM.unregisterForVirtualSimOn(mHandler);
        mPhone.mCM.unregisterForVirtualSimOff(mHandler);
        if(mPhone.getLteOnCdmaMode() == Phone.LTE_ON_CDMA_TRUE) {
