...
public class Instrumentation {
    ...
    public void callActivityOnCreate(Activity activity, Bundle icicle) {
        ...
        ActivityThread.logAppLaunchTime(TAG, "activity.onCreate +"); // [Note] It's for debugging App Launch time
...
//      }
    ...
    public void callActivityOnStart(Activity activity) {
        ActivityThread.logAppLaunchTime(TAG, "activity.onStart +"); // [Note] It's for debugging App Launch time
        activity.onStart();
        ActivityThread.logAppLaunchTime(TAG, "activity.onStart -"); // [Note] It's for debugging App Launch time
    }
    ...
    public void callActivityOnResume(Activity activity) {
        ActivityThread.logAppLaunchTime(TAG, "activity.onResume +"); // [Note] It's for debugging App Launch time
