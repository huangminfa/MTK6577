...
/**
 * Stereo3DConversion is the class that converts a 2D image to a stereoscopic image.
 */
public final class Stereo3DConversion {
     ...
     *
     * @param bitmap The 2D bitmap
     * @param isRewritable Whether the 2D bitmap can be rewritable or not
     * @return The converted bitmap, i.e. side-by-side bitmap
     */
    public static Bitmap execute(Bitmap bitmap, boolean isRewritable) {
        return execute(bitmap, bitmap.getWidth() * 2, bitmap.getHeight(), isRewritable);
    }
    ...
    public static Bitmap execute(Bitmap bitmap, int outputWidth, int outputHeight,
        ...
        if ((outputWidth > IMG_MAX_WIDTH) || (outputHeight > IMG_MAX_HEIGHT)
