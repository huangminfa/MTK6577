 ...
 *      Created On:			May 2004
 *
 *      Version:			$Id: //android/syncml/xpt/manager/xptdef.h#3 $
 *
...
/**
 * @file
 * SyncML Communication Protocol include file (Android)
 *
 * @target_system  Android
 * @target_os       Linux
 * @description Define platform-specific values for public header files.
 */
...
#define LINK_TRANSPORT_STATICALLY
