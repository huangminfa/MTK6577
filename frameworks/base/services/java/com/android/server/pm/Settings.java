...
import libcore.io.IoUtils;//ALPS00106316
...
final class Settings {
    ...
    void writeStoppedLPr() {
        ...
        try {
            ...
            Log.e(PackageManagerService.TAG, "Unable to write package manager stopped packages, "
    ...
    void readStoppedLPw() {
        ...
        try {
            ...
            //ALPS00244356
            //Log.wtf(PackageManagerService.TAG, "Error reading package manager stopped packages", e);
            Log.e(PackageManagerService.TAG, "Error reading package manager stopped packages " + e.toString());
            //ALPS00244356
    ...
    void writeLPr() {
        ...
        try {
            ...
            try {
                ...
                str.close();
                journal.commit();
            } catch (Exception e) {//ALPS00106316 +
                IoUtils.closeQuietly(str);//ALPS00106316 -
                journal.rollback();
            }
    ...
    boolean readLPw() {
        ...
        try {
            ...
            //ALPS00244356
            //Log.wtf(PackageManagerService.TAG, "Error reading package manager settings", e);
            Log.e(PackageManagerService.TAG, "Error reading package manager settings " + e.toString());
            //ALPS00244356
        }
