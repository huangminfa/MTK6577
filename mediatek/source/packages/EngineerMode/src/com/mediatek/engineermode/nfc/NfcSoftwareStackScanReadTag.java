...
public class NfcSoftwareStackScanReadTag extends Activity
	...
	private int currentTag = TAG_TYPE_NONE;
	...
	private int readMC1K() {
		...
		try {
			...
			Elog.e(TAG, "NfcNativeCallClass.ReadMC1K() EXP!" + e.getMessage());
	...
	private int readMC4K() {
		...
		try {
			...
			Elog.e(TAG, "NfcNativeCallClass.ReadMC4K() EXP!" + e.getMessage());
			return NfcCommonDef.ERROR_ERROR;
		}
	...
	private int readNDEF() {
		...
		try {
			...
			Elog.e(TAG, "NfcNativeCallClass.ReadNDEF() EXP!" + e.getMessage());
			return NfcCommonDef.ERROR_ERROR;
		}
	...
	private ArrayList<ModeMap> tagTypeArray = new ArrayList<ModeMap>();
