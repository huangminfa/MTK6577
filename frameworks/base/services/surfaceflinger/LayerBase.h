...
public:
    ...
    mutable bool        contentDirty;
            ...
            struct State {
                ...
                // for extra surface control
                //---------------------------------------------------------------
                uint32_t        flagsEx;

                // [MTK] for S3D mode trigger from buffer info
                //---------------------------------------------------------------
...
public:
    // [mtk04189] used by SurfaceFlinger
    //------------------------------------------------------------------------------------------
    bool bufferDirty;
    mutable uint64_t firstBufferCount;
    //------------------------------------------------------------------------------------------

    // [MTK] for extra surface control
    //---------------------------------------------------------------
    bool setFlagsEx(uint32_t flags, uint32_t mask);
    //---------------------------------------------------------------

    // [mtk03712] to switch debug log
    //------------------------------------------------------------------------------------------
private:
