...
public class DeskClock extends Activity {
    ...
    private static final float DIM_BEHIND_AMOUNT_DIMMED = 0.8f; // higher contrast when display dimmed
    ...
    private TextView mStopWatch = null;
    ...
    private void refreshAlarm() {
		...
		if (mIsOp01) {
			if (mAlarmButton != null) {
				...
				mStopWatch.setText(R.string.stop_watch);
				mNextAlarm.setVisibility(View.VISIBLE);
			}
		}
    }
			...
			mStopWatch.setOnClickListener(new View.OnClickListener() {
	            ...
	            public void onClick(View v) {
		            ...
		            try{
		            	...
		            	intent.setAction("com.mediatek.stopwatch.STOPWATCH");
