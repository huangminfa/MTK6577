...
public:
   ...
   {
      Parcel data, reply;
      LOGV("ATVCS_set_parameterb:%d",in);
      data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
      data.writeInt32(in);
   ...
   {
      Parcel data, reply;
      LOGV("ATVCS_matv_suspend on:%d",on);
      data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
      data.writeInt32(on);
   ...
   {
      Parcel data, reply;
      LOGV("ATVCS_matv_chscan mode:%d",mode);
      data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
   ...
   {
      Parcel data, reply;
      LOGV("ATVCS_matv_get_chtable ch=%d, entry=%p, len=%d",ch,entry,len);
      data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
      data.writeInt32(ch);
      data.writeInt32(len);
   ...
   {
      Parcel data, reply;
      LOGV("ATVCS_matv_set_chtable ch=%d, entry=%p, len=%d",ch,entry,len);
      data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
      data.writeInt32(ch);
      data.writeInt32(len);
      data.write(entry,len);      
   ...
   {
      Parcel data, reply;
      LOGV("ATVCS_matv_change_channel ch=%d",ch);
      data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
      data.writeInt32(ch);
   ...
   {
      Parcel data, reply;
      LOGV("ATVCS_matv_set_country country=%d",country);
      data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
   ...
   {
      Parcel data, reply;
      LOGV("ATVCS_matv_set_tparam mode=%d",mode);
      data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
      data.writeInt32(mode);
   ...
   {
      Parcel data, reply;
      LOGV("ATVCS_matv_audio_get_format");
      data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
   ...
   {
      Parcel data, reply;
      LOGV("ATVCS_matv_audio_set_format val=%d",val);
      data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
      data.writeInt32(val);
   ...
   {
      Parcel data, reply;
      LOGV("ATVCS_matv_audio_get_sound_system");
      data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
   ...
   {
      Parcel data, reply;
      LOGV("ATVCS_matv_adjust item=%d, val=%d",item,val);
      data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
   ...
   {
      Parcel data, reply;
      LOGV("ATVCS_matv_get_chipdep item=%d",item);
      data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
      data.writeInt32(item);
   ...
   {
      Parcel data, reply;
      LOGV("ATVCS_matv_set_chipdep item=%d, val=%d",item,val);
      data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
      data.writeInt32(item);
      data.writeInt32(val);
   ...
   {
      Parcel data, reply;
      LOGV("ATVCS_matv_register_callback");
      data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
   ...
   {
	  Parcel data, reply;
	  LOGV("ATVCS_fm_powerup parm=%p, len=%d",parm,len);
	  data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
	  data.writeInt32(len);
	  data.write(parm,len);	  
   ...
   {
	  Parcel data, reply;
	  LOGV("ATVCS_fm_tune parm=%p, len=%d",parm,len);
	  data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
	  data.writeInt32(len);
	  data.write(parm,len);	  
   ...
   {
	  Parcel data, reply;
	  LOGV("ATVCS_fm_seek parm=%p, len=%d",parm,len);
	  data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
	  data.writeInt32(len);
	  data.write(parm,len);	  
   ...
   {
	  Parcel data, reply;
	  LOGV("ATVCS_fm_scan parm=%p, len=%d",parm,len);
	  data.writeInterfaceToken(IATVCtrlService::getInterfaceDescriptor());
	  data.writeInt32(len);
	  data.write(parm,len);	  
    ...
    uint32_t code, const Parcel& data, Parcel* reply, uint32_t flags)
{
    switch(code) {
        ...
        case ATV_PS_INIT: {
            ...
            LOGV("onTransact:ATV_PS_INIT(%d) ", on);
        ...
        case ATV_SET_PARAMETERB: {
            ...
            LOGV("onTransact:ATV_SET_PARAMETERB(%d) ", in);
        ...
        case ATV_SUSPEND: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            int on = data.readInt32();
            LOGV("onTransact:ATV_SUSPEND(%d)",int(on));
            reply->writeInt32(ATVCS_matv_suspend(on));
            return NO_ERROR;
        } break;
        case ATV_SHUTDOWN: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            LOGV("onTransact:ATV_SHUTDOWN");
        ...
        case ATV_CH_SCAN: {
            ...
            LOGV("onTransact:ATV_CH_SCAN (%d)",int(mode));
            ATVCS_matv_chscan(mode);
            return NO_ERROR;
        } break;        
        case ATV_CH_SCAN_STOP: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            LOGV("onTransact:ATV_CH_SCAN_STOP ");
        ...
        case ATV_GET_CH_TABLE: {
            ...
            data.read(entry,len);
            LOGV("onTransact:ATV_GET_CH_TABLE ");            
        ...
        case ATV_SET_CH_TABLE: {
            ...
            void *entry = malloc(len);
            data.read(entry,len);
            LOGV("onTransact:ATV_SET_CH_TABLE ");            
        ...
        case ATV_CLEAR_CH_TABLE: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            LOGV("onTransact:ATV_CLEAR_CH_TABLE ");            
        ...
        case ATV_CHANGE_CH: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            int ch = data.readInt32();
            LOGV("onTransact:ATV_CHANGE_CH (%d) ",ch);            
        ...
        case ATV_SET_COUNTRY: {
            ...
            LOGV("onTransact:ATV_SET_COUNTRY (%d) ",country);            
        ...
        case ATV_SET_TPARAM: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            int mode = data.readInt32();
            LOGV("onTransact:ATV_SET_TPARAM (%d) ",mode);            
            ATVCS_matv_set_tparam(mode);
            return NO_ERROR;
        } break;
        case ATV_AUDIO_PLAY: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            LOGV("onTransact:ATV_AUDIO_PLAY ");            
            ATVCS_matv_audio_play();
            return NO_ERROR;
        } break;        
        case ATV_AUDIO_STOP: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            LOGV("onTransact:ATV_AUDIO_STOP ");            
            ATVCS_matv_audio_stop();
            return NO_ERROR;
        } break;        
        case ATV_AUDIO_GET_FORMAT: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            LOGV("onTransact:ATV_AUDIO_GET_FORMAT ");            
        ...
        case ATV_AUDIO_SET_FORMAT: {
            ...
            LOGV("onTransact:ATV_AUDIO_SET_FORMAT (%d) ",val);            
            ATVCS_matv_audio_set_format(val);
            return NO_ERROR;
        } break;
        case ATV_GET_SOUND_SYSTEM: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            LOGV("onTransact:ATV_GET_SOUND_SYSTEM ");            
        ...
        case ATV_ADJUST: {
            ...
            int val  = data.readInt32();
            LOGV("onTransact:ATV_ADJUST (%d)(%d) ",item,val);            
        ...
        case ATV_GET_CHIPDEP: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            int item = data.readInt32();
            LOGV("onTransact:ATV_GET_CHIPDEP (%d) ",item);            
        ...
        case ATV_SET_CHIPDEP: {
            ...
            int item = data.readInt32();
            int val = data.readInt32();
            LOGV("onTransact:ATV_SET_CHIPDEP (%d)(%d) ",item,val);            
        ...
        case ATV_REG_CALLBACK: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            int val = data.readInt32();
            LOGV("onTransact:ATV_REG_CALLBACK ");            
        ...
        case REGISTER_CLIENT: {
            ...
            LOGV("onTransact:REGISTER_CLIENT");
        ...
        case REGISTER_CLIENT_FM: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            sp<IATVCtrlClient> client = interface_cast<IATVCtrlClient>(data.readStrongBinder());
            LOGV("onTransact:REGISTER_CLIENT_FM");
        ...
        case FM_POWERDOWN: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            LOGV("onTransact:FM_POWERDOWN ");
            reply->writeInt32( ATVCS_fm_powerdown() );
            return NO_ERROR;
        } break;
        case FM_GETRSSI: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            LOGV("onTransact:FM_GETRSSI ");
		...
		case FM_MUTE: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            int val = data.readInt32();
            LOGV("onTransact:FM_MUTE (%d) ",val);            
            reply->writeInt32( ATVCS_fm_mute(val) );
            return NO_ERROR;
        } break;
        case FM_GETCHIPID: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            LOGV("onTransact:FM_GETCHIPID ");
            reply->writeInt32( ATVCS_fm_getchipid() );
            return NO_ERROR;
        } break;
        case FM_ISFMPOWERUP: {
            CHECK_INTERFACE(IATVCtrlService, data, reply);
            LOGV("onTransact:FM_ISFMPOWERUP ");
