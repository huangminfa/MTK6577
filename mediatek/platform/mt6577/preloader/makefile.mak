...
AFLAGS 		 := -c -Os -fno-strict-aliasing -fno-common -ffixed-r8 -fno-builtin -ffreestanding -pipe -mno-thumb-interwork -Wstrict-prototypes -march=armv7-a $(AFLAGS_DEBUG) $(INCLUDE_FILE) -mfpu=softfpa -D__ASSEMBLY__ -msoft-float
AFLAGS_OPTIMIZE	 := -c -Os -fno-strict-aliasing -fno-common -ffixed-r8 -fno-builtin -ffreestanding -pipe -mno-thumb-interwork -Wstrict-prototypes -march=armv7-a $(AFLAGS_DEBUG) $(INCLUDE_FILE) -mfpu=softfpa -D__ASSEMBLY__ -msoft-float
