...
public class EffectsRecorder {
	...
	public interface OnSurfaceStateChangeListener {
		/** Callback method to be called when the surface is unregistered
		 *
		 * @param surfaceReady will be true if the surface id is unregistered.
		 */
    ...
    */
    ...
    private void initializeFilterFramework() {
        ...
        if (!mAppIsLandscape && mProfile.videoFrameWidth > mProfile.videoFrameHeight) {
            int tmp;
    ...
    public synchronized void startRecording() {
		...
		if (recorder instanceof MediaEncoderFilter) {
        	((MediaEncoderFilter)recorder).setMuteAudio(mMuteAudio);
        }
        if (!mMuteAudio) {
