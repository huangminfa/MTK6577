...
public abstract class DataConnection extends StateMachine {
   ...
   //***** Constructor
    protected DataConnection(PhoneBase phone, String name, int id, RetryManager rm,
        ...
        filter.addAction(TelephonyIntents.ACTION_ABORT_DATA_CONNECTION);
        phone.getContext().registerReceiver(mDataConnectionReceiver, filter, null, phone);        
        // MTK-End
    ...
    // MTK-Start
    protected BroadcastReceiver mDataConnectionReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(TelephonyIntents.ACTION_ABORT_DATA_CONNECTION)) {
                int simId = intent.getIntExtra(Phone.GEMINI_SIM_ID_KEY, Phone.GEMINI_SIM_1);
                if (simId == phone.getMySimId()) {
                    log("received ACTION_ABORT_DATA_CONNECTION (simId=" + simId + ") remove EVENT_CONNECT");
