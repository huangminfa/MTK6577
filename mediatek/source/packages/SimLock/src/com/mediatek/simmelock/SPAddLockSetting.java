      ...
      //  btnConfirm.setHighFocusPriority(true);
        btnConfirm.setOnClickListener(new Button.OnClickListener()
        {
        	public void onClick(View view)
        	{
           		...
           		if(clickFlag == false)
           			clickFlag = true;
        		//do something after verify all the input things,for example: write a password to the modem      		
////        		//To get GID1
...
////        		//SPAddLockSetting.this.finish();
               ...
               // else if (etPwd.getText().toString().equals("11112222") == false)
               // {
                ...
                {   
                    ...
                    if(false == FeatureOption.MTK_GEMINI_SUPPORT)
                    {
                    	...
                    	if (mbMCCMNCReadSIM == false)//user input
                    	{
                    		...
                    		{
                    			phone.getIccCard().setIccNetworkLockEnabled(2,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),etGID1.getText().toString(),null,callback);
                    		}
                    		else
                    		{
                    			phone.getIccCard().setIccNetworkLockEnabled(2,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),msSIMGID1,null,callback);
                    		}
                    	...
                    	else
                    	{
                    		if(mbGID1ReadSIM == false)
                    		{
                    			phone.getIccCard().setIccNetworkLockEnabled(2,2,etPwd.getText().toString(),msSIMMCCMNC,etGID1.getText().toString(),null,callback);
                    		}
                    		else
                    		{
                    			phone.getIccCard().setIccNetworkLockEnabled(2,2,etPwd.getText().toString(),msSIMMCCMNC,msSIMGID1,null,callback);
                    		}
                    	}                	
                    }
                    else
...
//                    	intSIMNumber = bundle.getInt("SIMNo");
                    	if (intSIMNumber == 0)
                    	{
                    		//mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(0,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),etGID1.getText().toString(),null,callback);
                        	...
                        	if (mbMCCMNCReadSIM1 == false)//user input
                        	{
                        		...
                        		{
                        			mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(2,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),etGID1.getText().toString(),null,callback);
                        		}
                        		else
                        		{
                        			mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(2,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),msSIM1GID1,null,callback);
                        		}
                        	...
                        	else
                        	{
                        		if(mbGID1ReadSIM1 == false)
                        		{
                        			mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(2,2,etPwd.getText().toString(),msSIM1MCCMNC,etGID1.getText().toString(),null,callback);
                        		}
                        		else
                        		{
                        			mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(2,2,etPwd.getText().toString(),msSIM1MCCMNC,msSIM1GID1,null,callback);
                        		}
                        	}                	
                    	...
                    	else
                    	{
                        	if (mbMCCMNCReadSIM2 == false)//user input
                        	{
                        		...
                        		{
                        			mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).setIccNetworkLockEnabled(2,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),etGID1.getText().toString(),null,callback);
                        		}
                        		else
                        		{
                        			mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).setIccNetworkLockEnabled(2,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),msSIM2GID1,null,callback);
                        		}
                        	...
                        	else
                        	{
                        		if(mbGID1ReadSIM2 == false)
                        		{
                        			mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).setIccNetworkLockEnabled(2,2,etPwd.getText().toString(),msSIM2MCCMNC,etGID1.getText().toString(),null,callback);
                        		}
                        		else
                        		{
                        			mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).setIccNetworkLockEnabled(2,2,etPwd.getText().toString(),msSIM2MCCMNC,msSIM2GID1,null,callback);
                        		}
                        	}                  		
                    	}
    		        }                
