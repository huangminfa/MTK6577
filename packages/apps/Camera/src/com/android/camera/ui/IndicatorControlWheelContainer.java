...
public class IndicatorControlWheelContainer extends IndicatorControlContainer {
    ...
    public void disableCameraPicker() {
    	//note CameraPicker is initialize in mIndicatorControlWheel
    	mIndicatorControlWheel.mCameraPicker.setEnabled(false);
    }

    public void setCameraPickerVisibility(int isVisible) {
		if (mIndicatorControlWheel.mCameraPicker != null) {
        	mIndicatorControlWheel.mCameraPicker.setVisibility(isVisible);
		}
    }
    ...
    public void reInitializeOtherSetting(PreferenceGroup group,
        ...
        mIndicatorControlWheel.reInitializeOtherSetting(group, secondLevelOtherSettingKeys);
    }
    //Mediatek merge end
}
