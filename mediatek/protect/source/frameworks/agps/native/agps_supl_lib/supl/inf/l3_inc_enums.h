 ...
 *
 * Mar 31 2010 mtk02124
 * [MAUI_02385236] [RVCT 3.1] Compile warning cleaning
 * 
 *
 * Mar 20 2010 mtk02475
 * [MAUI_02361221] [MT6276] HSPA on/off menu
 * add data_speed_support_enum for H icon
 *
 * Feb 23 2010 mtk02475
 * [MAUI_02361221] [MT6276] HSPA on/off menu
 * add hspa_preference_enum
 *
 * Jan 24 2010 MTK02304
 * [MAUI_02338152] [New Feature] EHPLMN
 * 
 *
 * Dec 22 2009 mtk02508
 * [MAUI_01801045] [3G-Gemini][AT COMMAND] The MS show call end Processing all the time
 * add L4C local disconnect cause
 *
 * Nov 25 2009 mtk00938
 * [MAUI_01723305] [Merge R5R6 code] [Essential CR][CC support MM R6 feature] 1.establish MM with VT ca
 * 
 *
 * Nov 25 2009 mtk00938
 * [MAUI_01997615] [Merge R5R6 code] [Essential CR][EQPLMN List Number] Change EQPLMN list number to 15
 * 
 *
 * Nov 25 2009 mtk01446
 * [MAUI_01996667] [Merge R5R6 code][RR] Merge RR in R5R6tmp into MAUI W09.49
 * 
 *
 * Nov 25 2009 mtk01202
 * [MAUI_01997974] [Merge R5R6 code] [Essential CR][AMRWB] CC support AMRWB
 * 
 *
 * Nov 25 2009 mtk02118
 * [MAUI_01997784] [Merge R5R6 code] [Essential CR][Network Sharing] MM modifications
 * 
 *
 * Sep 24 2009 mtk02475
 * [MAUI_01943476] [EM Request] Preference for PLMN List
 * add plmn_list_preference_enum
 *
 ...
 * add gprs_transfer_preference_enum
 *
 * Aug 9 2009 mtk02124
 * [MAUI_01935972] [AGPS 2G CP] Merge AGPS_Dev_branch to MAUI maintrunk
 * 
 *
 * Aug 4 2009 mtk01936
 ...
 * 
 *
 * Jul 22 2009 MTK02304
 * [MAUI_01925119] revise sim_rr_ready_ind and add including scsi_asn.h
 * 
 *
 * Jul 20 2009 MTK02304
 * [MAUI_01724287] [3G Gemini] Check in to MAUI and MT6268_Gemini_W09.29_Dev
 * 
 *
 * Jun 29 2009 mtk02475
 * [MAUI_01593853] [WW FT][India-Ambala] Phone shows PDP Activated in NO Service state.
 * notify RAC when MM is performing recovery search
 *
 * Jun 17 2009 mtk02475
 * [MAUI_01705173] [WISE Compile Error][MM]rename est_cause_enum:REGITRATION to REGISTRATE
 * 
 *
 * Jun 15 2009 mtk01591
 * [MAUI_01703599] [MT6276_R5R6_Dev] Code Synch to MAUI, 09A, A-GPS, 3G Gemini for W09.25
 * 
 *
 * May 19 2009 mtk01936
 * [MAUI_01689884] [MAUI][09A][TCM] Move tcm_encode_qos function to custom folder
 * 
 *
 * Mar 4 2009 mtk00419
 * [MAUI_01640727] [Pioneer68] Add new feature RSSI sniffer for fast recovery from no service
 * 
 *
 * Dec 23 2008 mtk01602
 * [MAUI_01300426] [L4C][CSM][Revise] Specific MO call fail cause for call control by SIM not allowed
 * Add call rejected by SAT call control for customer requirement
 *
 * Dec 10 2008 mtk01921
 * [MAUI_01294217] [Gemini on MONZA2G] Merge Gemini into MONZA architecture
 * 
 *
 * Dec 8 2008 mtk01142
 * [MAUI_01292775] [Tier-1 Performance] Two quick PLMN Recovery improvement
 * Modified for ANY PLMN found H/R-PLMN cell, then perform Given PLMN Search while directly camped on.
 *
 * Oct 6 2008 mtk01936
 * [MAUI_01250537] [SM][Change Feature][24.008 R6 CR841] NewSM Cause APN_RESTRICTION_VALUE_INCOMPATIBLE
 * 
 *
 * Sep 5 2008 mtk02219
 ...
 * 
 *
 * Aug 13 2008 mtk00714
 * [MAUI_00821794] [Revise] NDIS support compile option
 * 
 *
 * Aug 11 2008 mtk01446
 ...
 * 
 *
 * May 16 2008 mtk00938
 * [MAUI_00772733] [New Feature][MMI][L4C][TCM][SIM] APN control list (__ACL_SUPPORT__)
 * 
 *
 * Mar 29 2008 mtk00714
 * [MAUI_00611270] [TCM][RAC] WM feature checked in to MAUI (__WINCE__)
 * 
 *
 * Mar 7 2008 mtk00714
 * [MAUI_00728840] [TCM][L4C] __APP_SECONDARY_PDP_SUPPORT__ : Streaming application may activate second
 * 
 *
 * Feb 24 2008 mtk00714
 * [MAUI_00550966] [SM][MM] R4R5 new feature check in
 * 
 *
 * Feb 22 2008 mtk00714
 * [MAUI_00611270] [TCM][RAC] WM feature checked in to MAUI (__WINCE__)
 * 
 *
 * Jan 30 2008 mtk01778
 * [MAUI_00613613] Abort a MO CM request during connection establishment
 * 
 *
 * Jan 24 2008 mtk00714
 * [MAUI_00611270] [TCM][RAC] WM feature checked in to MAUI (__WINDOWS_MOBILE__)
 * 
 *
 * Jan 23 2008 mtk00714
 * [MAUI_00610186] [GEMINI] merge to 07B and MAUI : MM, SM, SNDCP, TCM, RAC
 * 
 *
 * Nov 28 2007 mtk00516
 * [MAUI_00583647] [DATA][LLC][FLC] Gemini check in
 * 
 *
 * Sep 7 2007 mtk00419
 * [MAUI_00544047] [MM for MRAT] Merge MONZA29E4 to MAUI
 * 
 *
 * Jul 18 2007 mtk00714
 * [MAUI_00417891] [MAUI/MONZA][L4/MM/RR/MPAL/L1] tier-1 improvement: L1 priority queue and MMI advance
 * 
 *
 * Apr 27 2007 MTK00714
 * [MAUI_00232280] Network_G icon will show on Phone Lock password required scenario.
 * 
 *
 * Mar 27 2007 MTK01446
 ...
 * 
 *
 * Jun 22 2006 mtk01162
 * [MAUI_00204282] [RLC/MAC] Modification for IT simulation
 * 
 *
 * Jun 16 2006 mtk00938
 * [MAUI_00201576] [LLC][BugFix] LLC copy local para to free header space of peer buff when suspended
 * Add SND_UL_FREE_HEADER_LENGTH
 *
 * May 3 2006 mtk00888
 * [MAUI_00221048] handset shows "Unrecognized Number" when dialing 112
 * 
 *
 * May 2 2006 mtk00714
 * [MAUI_00191180] [SND][Bugfix]SND_UL_CTRL_HEADER_LENGTH should set as 20 to fit LLC ack mode
 * 
 *
 * Dec 30 2005 mtk00888
 * [MAUI_00163549] BT-MMI will popup "Network Failed" screen
 * 
 *
 *------------------------------------------------------------------------------
...
#if (defined(__R6_NETWORK_SHARING__) || defined(__R6_DSAC__))
...
typedef unsigned char band_selection_enum;
