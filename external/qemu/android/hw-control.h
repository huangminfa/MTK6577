...
typedef void  (*AndroidHwLedNotificationFunc)( void*       opaque,
                                               const char* name,
                                               int         on, int off, int color );

typedef void  (*AndroidHwVibratorNotificationFunc)( void*  opaque,
                                               const char* name,
                                               int         on, int off);
...
typedef struct {
    ...
    AndroidHwLedNotificationFunc  		led_notification;
    AndroidHwVibratorNotificationFunc  		vibrator_notification;
