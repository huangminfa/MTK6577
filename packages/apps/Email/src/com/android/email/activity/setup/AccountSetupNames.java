...
public class AccountSetupNames extends AccountSetupActivity implements OnClickListener {
    ...
    private static final String EXTRA_DATA = "setupdata";

    private EditText mDescription;
    private EditText mName;
    private Button mNextButton;
    private boolean mEasAccount = false;
    private static String TAG = "AccountSetupNames";

    /**
     * Cause we use this action was in background thread, So if email process was kill by system
     * when it was pause in background, this onSaveInstane would not been excuted, and the setupdata will be lost.
     * Now we use intent to transfer setupdata.
     * @param fromActivity
     */
    public static void actionSetNames(Activity fromActivity) {
        ...
        i.putExtra(EXTRA_DATA, setupData);
    ...
    private void finishActivity() {
        ...
        if (SetupData.getFlowMode() != SetupData.FLOW_MODE_NORMAL
                && SetupData.getFlowMode() != SetupData.FLOW_MODE_ACCOUNT_MANAGER_POP_IMAP) {
            ...
            Account account = SetupData.getAccount();
            if (account != null) {
                if (SetupData.getFlowMode() == SetupData.FLOW_MODE_ACCOUNT_MANAGER_POP_IMAP) {
