...
public class RecordingFileList extends Activity implements
    ...
    public void onClick(View button) {
        ...
        case R.id.recordButton:
            SRLogUtils.i(TAG, "<onClick> recordButton in recordingfilelist");
        ...
        case R.id.deleteButton:
            SRLogUtils.i(TAG, "<onClick> deleteButton in recordingfilelist");
        ...
        protected Void doInBackground(Void... params) {
            ...
            for (int i = 0; i < list.size(); i++) {
                if (!list.get(i).delete()) {
                    SRLogUtils.i(TAG, "<doInBackground> delete file ["
