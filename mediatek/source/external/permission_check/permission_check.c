...
void change_md_nvram_attr(void)
{
    ...
    system("chmod 0755 /data/nvram/dm");
    system("chmod 0755 /data/nvram/dm/*");

	//change mobilelog configure file permission
	system("chmod 0751 /data/data/com.mediatek.mobilelog");
	system("chmod 0751 /data/data/com.mediatek.mobilelog/files");
	system("chmod 0604 /data/data/com.mediatek.mobilelog/files/MobileLogSettings.xml");
    ...
    system("chown root.nvram /data/nvram/md/NVRAM/NVD_CORE/*");
    system("chown root.nvram /data/nvram/md/NVRAM/NVD_DATA/*");
    system("chmod shell.shell /data/mdl");
    system("chmod shell.shell /data/mdl/*");
