...
void synthesis_sub_band(Int32 Sr[], Int32 Si[], Int16 data[])
{
    ...
    {
    #ifndef ANDROID_DEFAULT_CODE
         *(pt_data_1++) = (Int16) saturate16(fxp_mul32_Q31((tmp2 - tmp1), SCALE_DOWN_HQ));
         *(pt_data_1++) = (Int16) saturate16(fxp_mul32_Q31(-(tmp3 + tmp4), SCALE_DOWN_HQ));
         *(pt_data_2--) = (Int16) saturate16(fxp_mul32_Q31((tmp1 + tmp2), SCALE_DOWN_HQ));
         *(pt_data_2--) = (Int16) saturate16(fxp_mul32_Q31((tmp3 - tmp4), SCALE_DOWN_HQ));
    #else
