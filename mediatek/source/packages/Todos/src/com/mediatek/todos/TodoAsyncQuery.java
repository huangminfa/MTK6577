...
public class TodoAsyncQuery extends AsyncQueryHandler {
    ...
    private static HashMap<Context, TodoAsyncQuery> mInstance = new HashMap<Context, TodoAsyncQuery>();
    ...
    public static TodoAsyncQuery getInstatnce(Context context) {
        if (!mInstance.containsKey(context)) {
            ...
            mInstance.put(context, newQuery);
        }
        return mInstance.get(context);
    }
    ...
    protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
        ...
        if (cookie instanceof QueryListener) {
            ...
            try {
                ...
                LogUtils.e(TAG, "Error about cursor: " + cursor);
                e.printStackTrace();
            } finally {
                cursor.close();
            }
