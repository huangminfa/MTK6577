...
public class SimPickerDialog {
    ...
    public static AlertDialog createSingleChoice(Context context, String title, int choiceItem, DialogInterface.OnClickListener listener) {
    ...
    public static AlertDialog create(Context context, String title, boolean internet, DialogInterface.OnClickListener listener) {
    ...
    public static AlertDialog create(Context context, String title, long suggestedSimId, boolean internet, DialogInterface.OnClickListener listener) {
