...
import  com.android.pqtuningtool.data.ImageCacheService.ImageData;
...
abstract class ImageCacheRequest implements Job<Bitmap> {
    ...
    public Bitmap run(JobContext jc) {
        ...
        ImageData data = null;
        MtkLog.i(TAG, "ImageCacheRequest, start Decode Bitmap");
        ...
        if (data != null) {
            ...
            MtkLog.i(TAG, "run if data!=null : bitmap is  " + bitmap);
            return bitmap;
        } else {
            MtkLog.i(TAG, "Color Index is " + PictureQualityOptions.getColorOptin());
            MtkLog.i(TAG, "Sharpness Index is " + PictureQualityOptions.getSharpnessOptin());
            Bitmap bitmap = onDecodeOriginal(jc, mType, true);
            if (jc.isCancelled()) return null;
            ...
            MtkLog.i(TAG, "run else data=null : bitmap is  " + bitmap);
            return bitmap;
        }
    }

    public abstract Bitmap onDecodeOriginal(JobContext jc, int targetSize, boolean isPictureQualistyEnhance);
}
