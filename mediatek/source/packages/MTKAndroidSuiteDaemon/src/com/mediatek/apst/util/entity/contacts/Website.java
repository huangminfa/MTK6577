 ...
 * <p>
 * <p>Description: 
 * <p>Website data of a contact.
 *
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class Website extends ContactData implements BaseTypes, Cloneable{
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    //@Override
    public Website clone() throws CloneNotSupportedException{
        Website copy = (Website)(super.clone());
    ...
    public int getRawSize(){
        ...
        // url
        size += RawTransUtil.sizeOfString(this.url);
        // type
