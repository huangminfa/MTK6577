...
public class BluetoothMapServerSettings 
	...
	private ListPreference mMapServerAccountIndex;
	...
	public void onCreate( PreferenceActivity parentActivity ){
		...
		mMapServerAccountIndex = (ListPreference)this.parentActivity.findPreference(KEY_MAP_SERVER_ACCOUNT_INDEX);
		if (mMapServerEnabler != null) {
	...
	public boolean onPreferenceChange(Preference preference, Object objValue) 
{
	...
	private void updateSimPreference(boolean[] selectedSims){
		...
		mSimCards.add("SIM1");
		mSimIds.add(Integer.toString(NetworkUtil.SIM1));		
			
		if (FeatureOption.MTK_GEMINI_SUPPORT == true) {
			mSimCards.add("SIM2");	
			mSimIds.add(Integer.toString(NetworkUtil.SIM2));						
		} 
		...
		private long getEmailAccountInfo(ArrayList<String> address, ArrayList<String> accountId){
			...
			Cursor accountCursor =resolver.query(mAccountUri, 
									projection,
									null,	
									null, 
									null);
