                ...
                try {
                    ...
                    if (code == HttpStatus.SC_OK) {
                        ...
                        if(Logging.DEBUG){
                            ...
                            if(mMessage != null){
                                Logging.d(Logging.EmailSend_TAG, (new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")).format(new Date())+
                                        " Message sending successful. messageId="+msgId+
                                        ", subject: "+mMessage.mSubject+", From: "+mMessage.mFrom+
                                        ", To: "+mMessage.mTo+", Cc: "+mMessage.mCc+", Bcc: "+mMessage.mBcc);
                            }else{
                                Logging.w(Logging.EmailSend_TAG, (new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")).format(new Date())+
                        ...
                        if(Logging.DEBUG) {
                            Logging.w(Logging.EmailSend_TAG, (new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")).format(new Date())+
                                    " Message sending failed, MessagId="+msgId+". response code: " + code);
                        }
