...
public class AdnRecord implements Parcelable {
    ...
    public String toString() {
        return "ADN Record:" + recordNumber
                ...
                + ",emails:" + emails
                + ",grpIds:" + grpIds;
        //return "ADN Record '" + recordNumber + "' '"  + alphaTag + "' '" + number + "' '" + additionalNumber + "' '" + aas + "' '" + emails + "' '" + grpIds + "' ";
    }

    public boolean isEmpty() {
        return TextUtils.isEmpty(alphaTag) && TextUtils.isEmpty(number) && TextUtils.isEmpty(additionalNumber) && emails == null;
    }
