...
unsigned short g_MD_SIM_CHECK_TOKEN; //check the md sim token

unsigned short g_AP_SIM_CHECK_TOKEN; //check the ap sim token
unsigned short g_AP_SIM_CHECK_REQ_ID; //check the ap sim req id
