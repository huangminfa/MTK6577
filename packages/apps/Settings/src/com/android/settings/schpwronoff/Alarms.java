...
public class Alarms {
    ...
    public static Alarm calculateNextAlert(final Context context, final int alarmId) {
        ...
        Cursor cursor = getFilteredAlarmsCursor(context.getContentResolver(), alarmId);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
                    Alarm a = new Alarm(cursor);
                    Xlog.d(TAG,"Alarms.calculateNextAlert()_atime = " + a.time);
                    ...
                    if (a.time == 0) {
                        a.time = calculateAlarm(a.hour, a.minutes, a.daysOfWeek)
                                .getTimeInMillis();
                        Xlog.d(TAG,"Alarms.calculateNextAlert()_calculateAlarm = " + a.time);
                    } else if (a.time < now) {
            ...
            if (cur.moveToFirst()) {
                do {
                    ...
                    if (alarm.time != 0 && alarm.time < now) {
                            Xlog.d(TAG,"** DISABLE " + alarm.id + " now " + now +" set "
                                + alarm.time);
    ...
    public static void setNextAlert(final Context context) {
        ...
        if (alarm != null) {
            enableAlertPowerOn(context, alarm, alarm.time);
        } else {
    ...
    private static void enableAlert(Context context, final Alarm alarm,
        ...
        Xlog.d(TAG,"** setAlert id " + alarm.id + " atTime " + atTimeInMillis);

        //Intent intent = new Intent(ALARM_ALERT_ACTION);
        //Intent intent = new Intent(context, SchedulePowerOff.class);
        Intent intent = new Intent(context, com.android.settings.schpwronoff.SchPwrOffReceiver.class);
        ...
        Xlog.d(TAG,"Alarms.enableAlertPowerOff(): setAlert id " + alarm.id + " atTime " + atTimeInMillis);
    ...
    private static void enableAlertPowerOn(Context context, final Alarm alarm,
        ...
        //Intent intent = new Intent(ALARM_ALERT_ACTION);
        //Intent intent = new Intent(context, SchedulePowerOff.class);
        Intent intent = new Intent(context, com.android.settings.schpwronoff.SchPwrOnReceiver.class);
        ...
        Xlog.d(TAG,"Alarms.enableAlertPowerOn(): setAlert id " + alarm.id + " atTime " + atTimeInMillis);
