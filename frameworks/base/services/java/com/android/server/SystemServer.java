...
import com.mediatek.epo.MtkEpoClientManagerService;
import com.mediatek.hdmi.HDMIObserver;
...
class ServerThread extends Thread {
	...
	BluetoothProfileManagerService BluetoothProfileManager = null;
        ...
        try {
            ...
            //MTK-START [mtk04070][111128][ALPS00093395]Add telephony.registry2 for ICS
            Slog.i(TAG, "Telephony Registry Phone1");
            ServiceManager.addService("telephony.registry", new TelephonyRegistry(context));

            Slog.i(TAG, "Telephony Registry Phone2");
            ServiceManager.addService("telephony.registry2", new TelephonyRegistry(context,true));
            //MTK-END [mtk04070][111128][ALPS00093395]Add telephony.registry2 for ICS
        ...
        if (factoryTest != SystemServer.FACTORY_TEST_LOW_LEVEL) {
           ...
           try {
            ...
            try {
                ...
                ServiceManager.addService(Context.AUDIOPROFILE_SERVICE, new AudioProfileService(context));
            } catch (Throwable e) {
                reportWtf("starting AudioProfile Service", e);
            }
            ...
            if(true == FeatureOption.MTK_AGPS_APP && true == FeatureOption.MTK_GPS_SUPPORT){ 
                try {
                    Slog.i(TAG, "MTK Agps Manager");
                    ServiceManager.addService(Context.MTK_AGPS_SERVICE, 
                        //new MtkAgpsManagerService(context, true, true, true));
                        new MtkAgpsManagerService(context, FeatureOption.MTK_GEMINI_SUPPORT, FeatureOption.MTK_AGPS_APP, FeatureOption.MTK_GPS_SUPPORT));
                } catch (Throwable e) {
                    Slog.e(TAG, "Failure starting Mtk Agps Manager", e);
                }
            }

            //GPS EPO
            try {
                Slog.i(TAG, "MTK EPO Client Manager");
                ServiceManager.addService(Context.MTK_EPO_CLIENT_SERVICE, new MtkEpoClientManagerService(context));    
            } catch (Throwable e) {
            ...
            //add for HDMI by mtk80906 begin
            try {
