...
/**
 * Class Name: GetMmsDataRsp
 * <p>Package: com.mediatek.apst.util.command.message
 * <p>
 * <p>Description: 
 * <p>A response for backup to getting all MMS.
 * <p>
 * @author mtk54043 Yu.Chen
 * @version V1.0
 */
public class GetMmsDataRsp extends RawBlockResponse{
 //==============================================================
    // Constants
    //==============================================================
    ...
    public GetMmsDataRsp(int requestToken) {
    ...
    public ByteBuffer getMmsResouceBuffer() {
