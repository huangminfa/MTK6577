...
public class EmailActivity extends Activity implements View.OnClickListener, FragmentInstallable {
    ...
    public void showWaitingDialog() {
        ...
        getFragmentManager().beginTransaction().add(mWaitingDialog, "waiting").commitAllowingStateLoss();
        mHandler.postDelayed(new Runnable(){
            public void run() {
                if (mWaitingDialog != null) {
                    getFragmentManager().beginTransaction().remove(mWaitingDialog).commitAllowingStateLoss();
                    mWaitingDialog = null;
                }
            }
        }, DIALOG_DISMISS_TIME);
