...
#ifndef ANDROID_DEFAULT_CODE    
 LOGD("M4MCS_setCurrentWriter():writerType=%d", writerType);
#endif 
                                ...
                                M4VIDEOEDITING_VideoFormat mediaType)
{
    ...
    switch (mediaType)
    {
        ...
        default:
#ifndef ANDROID_DEFAULT_CODE        	
            LOGD(M4OSA_TRUE, M4MCS_WAR_MEDIATYPE_NOT_SUPPORTED,
                 "Video encoder type not supported");
#endif                 
            return M4MCS_WAR_MEDIATYPE_NOT_SUPPORTED;
    }
#ifndef ANDROID_DEFAULT_CODE    
 LOGD("M4MCS_setCurrentVideoEncoder():encoderType=%d", encoderType);
#endif 
...
#ifndef ANDROID_DEFAULT_CODE    
	 LOGD("M4MCS_setCurrentVideoDecoder():decoderType=%d (0-mpeg4, 2 -avc,)", decoderType);
#endif           
