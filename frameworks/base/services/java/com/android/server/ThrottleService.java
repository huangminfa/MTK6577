...
public class ThrottleService extends IThrottleManager.Stub {
    ...
    //Add by MTK03594 ==> Disable the function of ThrottleService
    private static final boolean THROTTLE_DISABLE_FLAG = true;
    ...
    private class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            //Add by MTK03594 -- Disable THROTTTLE function to avoid unnecessary procedures
            if(THROTTLE_DISABLE_FLAG){
                return;
            }
