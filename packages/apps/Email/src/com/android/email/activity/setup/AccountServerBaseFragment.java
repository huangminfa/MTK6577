...
public abstract class AccountServerBaseFragment extends Fragment
    ...
    private static final String BUNDLE_KEY_SETTINGS_ACCOUNTID = "AccountServerBaseFragment.settings.accountId";
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                if (settingsResult == AccountCheckSettingsFragment.CHECK_SETTINGS_OK) {
                    ...
                    if (mode == SetupData.FLOW_MODE_EDIT || mode == SetupData.FLOW_MODE_CHANGE_PASSWORD) {
