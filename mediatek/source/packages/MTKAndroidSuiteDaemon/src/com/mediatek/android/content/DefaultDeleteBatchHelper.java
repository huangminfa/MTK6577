...
public abstract class DefaultDeleteBatchHelper extends OperationBatchHelper {
    ...
    // Fields                                                       
    //==============================================================
    private boolean[] deletionResults;
    
    //==============================================================
    // Constructors                                                 
    //==============================================================
    public DefaultDeleteBatchHelper(ContentProviderOperationBatch opBatch){
        super(opBatch);
    }
    ...
    public void run(int batchSize){
        deletionResults = new boolean[batchSize];
        super.run(batchSize);
    }
    ...
    public void onOperationResult(ContentProviderResult opResult, 
        ...
        if (null == opResult){
            ...
            deletionResults[executedPosition] = false;
        } else if (1 == opResult.count){
            deletionResults[executedPosition] = true;
        } else {
            Debugger.logW(getName(), "onOperationResult", 
                    new Object[]{opResult, executedPosition}, 
