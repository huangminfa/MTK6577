...
public abstract class ServiceStateTracker extends Handler {
    ...
    protected static final int EVENT_SET_SIM_RECOVERY_ON               = 39;
    protected static final int EVENT_GET_SIM_RECOVERY_ON               = 40;
    ...
    */
    ...
    public void enableSingleLocationUpdate() {
    	...
    	log("enableSingleLocationUpdate,mWantSingleLocationUpdate:" + mWantSingleLocationUpdate +
    			",mWantContinuousLocationUpdates:"+mWantContinuousLocationUpdates);
    ...
    public void enableLocationUpdates() {
    	/** currently,modem do not support the function.
    	log("enableLocationUpdates,mWantSingleLocationUpdate:" + mWantSingleLocationUpdate +
    			",mWantContinuousLocationUpdates:"+mWantContinuousLocationUpdates);
        if (mWantSingleLocationUpdate || mWantContinuousLocationUpdates) return;
    ...
    protected void disableSingleLocationUpdate() {
    	/** currently,modem do not support the function.
    	log("disableSingleLocationUpdate,mWantSingleLocationUpdate:" + mWantSingleLocationUpdate +
    			",mWantContinuousLocationUpdates:"+mWantContinuousLocationUpdates);
        mWantSingleLocationUpdate = false;
        if (!mWantSingleLocationUpdate && !mWantContinuousLocationUpdates) {
        	log("disableSingleLocationUpdate: set creg=1");
    ...
    public void disableLocationUpdates() {
    	/** currently,modem do not support the function.
    	log("disableLocationUpdates,mWantSingleLocationUpdate:" + mWantSingleLocationUpdate +
    			",mWantContinuousLocationUpdates:"+mWantContinuousLocationUpdates);
