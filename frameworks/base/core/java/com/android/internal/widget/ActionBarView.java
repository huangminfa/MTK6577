    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        if (mOptionsMenu != null) {
            if (mActionMenuPresenter != null) {
                if (!mSplitActionBar) {
                    mActionMenuPresenter.setWidthLimit(mContext.getResources().getDisplayMetrics().widthPixels / 2, false);
                }
            }
            mOptionsMenu.clearActionItemsState();
        }
        setActionBarMeasureRequired();
        ...
        if (tempHomeLayout != null) {
            ...
            if (tempIconView != null) {
                mHomeLayout.setIconViewLayoutParams(tempIconView.getLayoutParams());
            }
        }
    }
