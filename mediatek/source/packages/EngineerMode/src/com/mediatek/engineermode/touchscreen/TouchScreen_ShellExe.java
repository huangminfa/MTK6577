...
public class TouchScreen_ShellExe {
	...
	private static String TAG = "EM/TouchScreen_ShellExe";
	public static String getOutput()
	{
		Xlog.i(TAG,"getOutPut:sb-- " + sb);
		return sb.toString();
	}
	public static int execCommand(String[] command) throws IOException {
		...
		try {
			if (proc.waitFor() != 0) {
//				sb.append(ERROR);
				Xlog.i(TAG,"exit value = " + proc.exitValue()+"|| get:sb-- " + sb);
				return -1;
			}
			else
			{	
			...
			Xlog.i(TAG,"exe fail " + e.toString()+"|| get:sb-- " + sb);
//			sb.append(ERROR);
