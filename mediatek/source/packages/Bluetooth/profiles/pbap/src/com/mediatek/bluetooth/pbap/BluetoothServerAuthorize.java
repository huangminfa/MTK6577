...
public class BluetoothServerAuthorize extends Activity 
    ...
    private AlertDialog buildDialog(String deviceName) {
        ...
        Log.d(TAG, "buildDialog("+deviceName+")");
        
        p.mIconId = android.R.drawable.ic_dialog_info;
        p.mTitle = getString(R.string.bluetooth_pbap_server_authorize_title);
        p.mView = createView(getString(R.string.bluetooth_pbap_server_authorize_message, deviceName));
        p.mPositiveButtonText = getString(R.string.bluetooth_pbap_server_authorize_allow);
        p.mPositiveButtonListener = this;
        p.mNegativeButtonText = getString(R.string.bluetooth_pbap_server_authorize_decline);
        p.mNegativeButtonListener = this;
        setupAlert();
        */
  	Builder builder = new Builder(this);
       CharSequence[] items = {getString(R.string.bluetooth_pbap_server_authorize_alwaysallowed)};
	...
	builder.setIcon(android.R.drawable.ic_dialog_info)
	       .setTitle(R.string.bluetooth_pbap_server_authorize_title)
	       .setView(createView(msg))
	       //.setMessage(msg)
	       /*
	       .setMultiChoiceItems (items, checked, 
                new DialogInterface.OnMultiChoiceClickListener(){
                    public void onClick (DialogInterface dialog, int which, boolean isChecked){
                        if(which == 0) {
                            mAlwaysAllowedValue = isChecked;
                        }else{
                            Log.w(TAG, "index of always allowed is not correct : "+which);
                        }
                    }
                }
              )
              */
	       .setPositiveButton(R.string.bluetooth_pbap_server_authorize_allow, this)
	       .setNegativeButton(R.string.bluetooth_pbap_server_authorize_decline, this);
	...
	java.util.Set<String> s = b.keySet();
        Log.e(TAG, "Start intent extra listing");    
	for( String ss : s ){

		android.util.Log.e("INTENT", "Intent extra key: [" + ss + "]" );
	}
