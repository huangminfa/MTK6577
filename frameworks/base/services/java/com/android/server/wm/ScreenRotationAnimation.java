...
class ScreenRotationAnimation {
    ...
    public void setRotation(int rotation) {
        ...
        if (DEBUG) Slog.v(WindowManagerService.TAG, "**** ROTATION: " + delta);
    ...
    public boolean stepAnimation(long now) {
        ...
        if (mExitAnimation != null) {
            ...
            if (DEBUG) Slog.v(WindowManagerService.TAG, "Stepped exit: " + mExitTransformation);
            if (!moreExit) {
                if (DEBUG) Slog.v(WindowManagerService.TAG, "Exit animation done!");
                mExitAnimation.cancel();
                mExitAnimation = null;
                mExitTransformation.clear();
                if (mSurface != null) {
