...
public:
    ...
    bool replay(OpenGLRenderer& renderer, Rect& dirty, uint32_t &err, uint32_t level = 0);
...
public:
    ...
    virtual bool drawDisplayList(DisplayList* displayList, uint32_t width, uint32_t height,
            Rect& dirty, uint32_t &err, uint32_t level = 0);
...
public:
    virtual void drawText(const char* text, const float* xOffset, const float* yOffset, int bytesCount, int count, float x, float y,
            SkPaint* paint);
