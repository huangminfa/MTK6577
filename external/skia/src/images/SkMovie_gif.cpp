...
//DGifOpen is over, now for DGifSlurp
    ...
    //maximum pixels in all gif frames is constrained to 10M
    ...
    if (screenWidth * screenHeight * frameCount > 1024*1024*10) {
        LOGE("SkGIFMovie:checkGifStream: total pixels is larger than 10M");
        return false;
    }
