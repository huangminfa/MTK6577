...
public class AlbumSetDataAdapter implements AlbumSetView.Model {
    ...
    private static class UpdateInfo {
        ...
        public String toString() {
            ...
            builder.append("[MediaSet]=" + item + ";");
            builder.append("[covers]=" + covers);
            builder.append("}");
    ...
    private class GetUpdateInfo implements Callable<UpdateInfo> {
        ...
        public UpdateInfo call() throws Exception {
            ...
            MtkLog.d(TAG, "GetUpdateInfo: invalid idx=" + index);
            MtkLog.d(TAG, "GetUpdateInfo: sourceversion=" + mSourceVersion + ", new version=" + mVersion);
            ...
            while (mActive) {
                synchronized (this) {
                    if (mActive && !mDirty && updateComplete) {
                        updateLoading(false);
                        MtkLog.w(TAG, "ReloadTask: waiting for new update");
                ...
                MtkLog.w(TAG, "ReloadTask: <<reload started>>");
                long version;
                synchronized (DataManager.LOCK) {
                    version = mSource.reload();
                }
                UpdateInfo info = executeAndWait(new GetUpdateInfo(version));
                MtkLog.d(TAG, "ReloadTask: get update info=" + info);
                ...
                MtkLog.w(TAG, "ReloadTask: <<reload finish>>, UpdateContent, info=" + info);
            }
            updateLoading(false);
        }
