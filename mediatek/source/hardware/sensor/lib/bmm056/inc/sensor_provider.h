 ...
 *
 *       Filename:  sensor_provider.h
 *
 *    Description:  
 *
 *        Version:  1.0
 *        Created:  07/15/2012 15:44:31 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
...
struct sensor_provider {
	 ...
	 */
	void (*proc)(int);
	/* mandatory, provider relies on this to know the new hw dep, etc */
	int (*on_ch_enabled)(struct channel *, int);
	/* optional, an owner such as an algo might provide this
	...
	/* get current dependency of hw needed to produce 
