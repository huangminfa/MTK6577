...
/**
 * Class Name: AddGroupMembershipReq
 * <p>Package: com.mediatek.apst.util.command.contacts
 * <p>Created on: 2010-12-18
 * <p>
 * <p>Description: 
 * <p>Request for adding multiple contacts into one group.
 * <p>
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class AddGroupMembershipReq extends RequestCommand {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    private int[] mSimIndexes;
    
    //==============================================================
    // Constructors                                                 
    //==============================================================
    public AddGroupMembershipReq(){
    ...
    public void setGroupEntry(Group groupEntry){
        this.groupEntry = groupEntry;
    }
    public void setSimIndexes(int[] simIndexes) {
    	mSimIndexes = simIndexes;
    }
