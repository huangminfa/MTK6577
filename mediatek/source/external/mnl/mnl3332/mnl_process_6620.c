...
MNL_CONFIG_T mnl_config =
{
    ...
    .bee_path = BEE_PATH,
    .epo_file = EPO_FILE,
    .epo_update_file = EPO_UPDATE_FILE,
    .delay_reset_dsp = 500,
    .nmea2file = 0,
    .dbg2file = 0,
    .nmea2socket = 1,
...
/* FIXME!! George Kuo: 26MHz TCXO on EVBv1!!! */
 ...
 /*   if (ioctl(dsp_fd, COMBO_IOC_GPS_HWVER, &hw_ver) < 0)
    ...
    init_cfg.reservedy = (void *)MTK_GPS_THIP_KEY_MT3332;
...
//    init_cfg.if_init_spd = mnl_config.init_speed;               // 38400bps
	...
	init_cfg.Rf_Adc_Type = 3;
	init_cfg.Rf_Sig_Src = 0;
	init_cfg.Galileo_BW = 0;
	init_cfg.HM_Gain = 1;
