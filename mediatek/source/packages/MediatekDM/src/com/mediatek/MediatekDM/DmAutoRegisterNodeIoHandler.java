...
public class DmAutoRegisterNodeIoHandler implements NodeIoHandler {
    ...
    private String[] item = { "AutoRegSMSC", "AutoRegSMSport"};
    private String[] contentValue = {null, null};
    String[] projection = {"AutoRegSMSC", "AutoRegSMSport"};
...
//		}
    ...
    private String getDefaultValue(String key) {
        if (configReader == null) {
            configReader = new DmXMLParser(DmConst.pathname.pathSmsRegConfig);
        }
