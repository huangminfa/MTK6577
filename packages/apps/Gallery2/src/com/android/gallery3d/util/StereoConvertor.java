...
public class StereoConvertor {
    ...
    public static Bitmap convert2Dto3D(Bitmap bitmap) {
        ...
        Bitmap stereo = Stereo3DConversion.execute(bitmap);
    ...
    public static String HIDE_FOLDER_WHERE_CLAUSE = null;
    public static void initialize(Context context) {
        ...
        Log.d(TAG,"initialize:StorageManager.getDefaultPath()="+StorageManager.getDefaultPath());
    ...
    private static Uri createAndInsert(JobContext jc, Context context,Uri origUri,
        ...
        return saveAndInsertLocalImage(jc, origUri, cr, null, mimeType, true, 0,
    ...
    public static ArrayList<Uri> convertMultiple(JobContext jc, 
                                     GalleryActivity activity, ArrayList<Uri> uris) {
        long triggeredTime = System.currentTimeMillis();
...
Log.v(TAG, "convertMultiple:origin uri: "+uri);
    ...
    private static Uri saveAndInsertLocalImage(JobContext jc, Uri origUri,
        ...
        Uri imageUri = null;
        Bitmap image = StereoHelper.getStereoImage(jc, cr, origUri, mimeType,
                                      firstFrame, null, targetSize);
