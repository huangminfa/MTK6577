...
public final class BearerData {
    ...
    private static void encode16bitEms(UserData uData, byte[] udhData)
        throws CodingException
    {
        byte[] payload = BearerDataInterfaces.encodeUtf16(uData.payloadStr, null);
        int udhBytes = udhData.length + 1;  // Add length octet.
        ...
        throws CodingException
    {
        ...
        case UserData.ENCODING_7BIT_ASCII:
            userData.payloadStr = BearerDataInterfaces.decode7bitAscii(userData.payload, offset, userData.numFields);
            break;
