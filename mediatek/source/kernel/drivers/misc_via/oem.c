...
mtk_oem_gpio_des oem_gpio_list[] = {
    {GPIO_VIATEL_MDM_RDY, 15, gpio_irq_handle_usb_mdm_rdy, NULL, NULL},
    {GPIO_VIATEL_USB_MDM_WAKE_AP, 13, gpio_irq_handle_usb_mdm_wake_ap, NULL, NULL},
    {GPIO_VIATEL_MDM_RST_IND,  12, gpio_irq_handle_rst_ind, NULL, NULL},
    {GPIO_VIATEL_UART_MDM_WAKE_AP, 14, gpio_irq_handle_uart_mdm_wake_ap, NULL, NULL},
    {GPIO_VIATEL_MDM_PWR_IND, -1, gpio_irq_handle_pwr_ind, NULL, NULL},
};
...
static void gpio_irq_handle_usb_mdm_rdy(void)
{
    ...
    des = gpio_des_find_by_gpio(GPIO_VIATEL_MDM_RDY);
    if(des && des->handle){
