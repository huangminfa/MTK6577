...
public class MmsXmlParser {
    public static ArrayList<MmsXmlInfo> parse (String mmsString) {
        ...
        ArrayList list = new ArrayList<MmsXmlInfo>();
        try {
                    ...
                    case XmlPullParser.START_TAG:
                        ...
                        if (tagName.equals(MmsXml.RECORD)) {
                            ...
                            for (int i = 0; i < attrNum; ++i) {
                                ...
                                if (name.equals(MmsXml.CATEGORY)) {
                                    record.setCategory(value);
                                } else if (name.equals(MmsXml.ID)) {
                                    record.setID(value);
                                } else if (name.equals(MmsXml.ISREAD)) {
                                    record.setIsRead(value);
                                } else if (name.equals(MmsXml.LOCALDATE)) {
                                    record.setLocalDate(value);
                                } else if (name.equals(MmsXml.ST)) {
                                    record.setST(value);
                                ...
                                Log.d(LogTag.RESTORE, "name:" + name + ",value:" + value);
                            }
                        }
                        break;
