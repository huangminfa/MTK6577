...
*/
                ...
                //MTK-START [mtk04070][111125][ALPS00093395]Add SERVICE_CLASS_VIDEO
                case 24: return SERVICE_CLASS_DATA_SYNC + SERVICE_CLASS_VIDEO;
                //MTK-END [mtk04070][111125][ALPS00093395]Add SERVICE_CLASS_VIDEO
    ...
    static private boolean isShortCode(String dialString, GSMPhone phone) {
        ...
        /* Replace isLocalEmergencyNumber with isEmergencyNumber to reduce dial speed, MTK04070, 2012.01.18 */
                ...
                int pinLen = newPin.length();
                    ...
                    if (!phone.mIccCard.hasIccCard()){
                        ...
                        handlePasswordError(com.android.internal.R.string.needPuk);
                               ...
                               (false == phone.mIccCard.getIccLockEnabled())) {
                        ...
                        if (sc.equals(SC_PIN)) {
                            if (retryPin1.equals(RETRY_BLOCKED)) {
                                ...
                                phone.mIccCard.changeIccLockPassword(oldPinOrPuk, newPin,
                                    obtainMessage(EVENT_SET_COMPLETE, this));
                            }
                            ...
                            if (retryPin2.equals(RETRY_BLOCKED)) {
                                ...
                                //    obtainMessage(EVENT_SET_COMPLETE, this));
                                // Use SimCard provided interfaces.                                
                                phone.mIccCard.changeIccFdnPassword(oldPinOrPuk,newPin,
                                    obtainMessage(EVENT_SET_COMPLETE, this));
                            }
                            ...
                            if (retryPuk1.equals(RETRY_BLOCKED)) {
                                ...
                                if (oldPinOrPuk.length() == 8) {
                                    phone.mIccCard.supplyPuk(oldPinOrPuk,newPin,
                                    obtainMessage(EVENT_SET_COMPLETE, this));
                                } else {
                            ...
                            if (retryPuk2.equals(RETRY_BLOCKED)) {
                                ...
                                //    obtainMessage(EVENT_SET_COMPLETE, this));
                                if (oldPinOrPuk.length() == 8) {
                                    phone.mIccCard.supplyPuk2(oldPinOrPuk, newPin, 
                                    obtainMessage(EVENT_SET_COMPLETE, this));
                                } else {
                                    handlePasswordError(com.mediatek.R.string.invalidPuk);
                                }
    ...
    onUssdFinished(String ussdMessage, boolean isUssdRequest) {
        if (state == State.PENDING) {
            //MTK-START [mtk04070][111125][ALPS00093395]Check the length of ussdMessage
            if (ussdMessage == null || ussdMessage.length() == 0) {
            //MTK-END [mtk04070][111125][ALPS00093395]Check the length of ussdMessage
    ...
    private CharSequence getScString() {
        if (sc != null) {
            ...
            //MTK-START [mtk04070][111125][ALPS00093395]MTK added/modified
            } else if (sc.equals(SC_PIN)){
            ...
            //MTK-END [mtk04070][111125][ALPS00093395]MTK added/modified
        }
