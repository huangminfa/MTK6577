...
public class AgendaListView extends ListView implements OnItemClickListener {
    ...
    ///M:This is for allowing choice event by other applications@{
    private int mAgendaReqType = -1;
    ///@}
    ...
    private void initView(Context context) {
        ...
        ///M: Modification for Tablet only. show_event_details_with_agenda should always be false for smartphone.@{
        ...
        ///M: Modification for Tablet only. mShowEventDetailsWithAgenda should always be false for smartphone.@{
        if(context instanceof AgendaChoiceActivity) {
    ...
    public void onItemClick(AdapterView<?> a, View v, int position, long id) {
        if (id != -1) {
            ...
            if(event != null) {
	            ...
	            if(mAgendaReqType == Utils.REQ_TYPE_AGENDA_CHOICE_EVENT ) {
    ...
    public void goTo(Time time, long id, String searchQuery, boolean forced,
      ...
      ///M:Check time is in right range@{
        int validJulianDay = Utils.getValidJuLianDay(time);
        time = Utils.changeToJulianDayTime(time, validJulianDay);
        ///@}
    ...
    public void resetCleanQueryInitiated() {
        LogUtil.i(TAG, "resetCleanQueryInitiated");
    ...
    ///M:@{
    /**
     * @param agendaReqType like:REQ_TYPE_AGENDA_NULL or REQ_TYPE_AGENDA_CHOICE_EVENT
     */
    public void setAgendaRequestType(int agendaReqType){
        mAgendaReqType = agendaReqType;
    }
    ///@}
}
