...
public abstract class IndicatorControlContainer extends IndicatorControl
    ...
    //Mediatek modify
    public abstract void disableCameraPicker();
    public abstract void setCameraPickerVisibility(int isVisible);
    public abstract void reInitializeOtherSetting(PreferenceGroup group,
