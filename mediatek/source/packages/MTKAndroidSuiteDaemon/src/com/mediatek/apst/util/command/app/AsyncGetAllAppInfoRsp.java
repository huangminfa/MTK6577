...
/**
 * Class Name: AsyncGetAllAppInfoRsp
 * <p>Package: com.mediatek.apst.util.command.app
 * <p>Created on: 2010-12-18
 * <p>
 * <p>Description: 
 * <p>Response for asynchronously getting all application info.
 * <p>
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class AsyncGetAllAppInfoRsp extends RawBlockResponse {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    // Constructors                                                 
    //==============================================================
    public AsyncGetAllAppInfoRsp(int token){
        super(FEATURE_APPLICATION, token);
    }
    ...
    public static class Builder extends RawBlockResponse.Builder {
        ...
        protected RawBlockResponse onCreateCommand(int featureId){
            return new AsyncGetAllAppInfoRsp(-1);
        }
         ...
         */
        public AsyncGetAllAppInfoRsp build(){
            ...
            return (AsyncGetAllAppInfoRsp)super.build();
        }
