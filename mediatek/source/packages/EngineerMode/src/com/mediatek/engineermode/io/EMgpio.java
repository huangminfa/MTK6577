...
public class EMgpio
{
	...
	public static native boolean NewSetCurrent(int hostNumber, int clkpu, int clkpd, int cmdpu, int cmdpd, int datapu, int datapd,int hopbit, int hoptime ,int opcode);
	static {
