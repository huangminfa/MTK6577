...
public class NetworkTemplate implements Parcelable {
    ...
    public static NetworkTemplate buildTemplateMobileAllGemini(String subscriberId, long simId) {
        return new NetworkTemplate(MATCH_MOBILE_ALL, subscriberId, simId);
    }
    ...
    /** {@hide} */
    public NetworkTemplate(int matchRule, String subscriberId, long simId) {
        this.mMatchRule = matchRule;
        this.mSubscriberId = subscriberId;
        this.mSimId = simId;
    }
