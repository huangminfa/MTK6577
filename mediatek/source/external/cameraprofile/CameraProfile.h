...
typedef enum
{
	...
	Event_preUninitFrameService,
	Event_wait_semMainHigh,
	Event_waitFDdone,
...
void CPTEnableEvent(CPT_Event event, int enable);
void CPTLog(CPT_Event event, CPT_LogType type);
void CPTLogEx(CPT_Event event, CPT_LogType type, unsigned int data1, unsigned int data2);
void CPTLogStr(CPT_Event event, CPT_LogType type, const char* str);
void CPTLogStrEx(CPT_Event event, CPT_LogType type, unsigned int data1, unsigned int data2, const char* str);
