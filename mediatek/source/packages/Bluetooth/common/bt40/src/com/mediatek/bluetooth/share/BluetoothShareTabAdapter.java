...
public class BluetoothShareTabAdapter extends ResourceCursorAdapter {
	...
	public void bindView( View view, Context context, Cursor cursor ){
		...
		if( task.getDirection() == Direction.in ){
			...
			icon.setImageResource( (task.getState()==BluetoothShareTask.STATE_SUCCESS) ? R.drawable.bt_share_mgmt_in_success : R.drawable.bt_share_mgmt_failure );
		}
		else {
			icon.setImageResource( (task.getState()==BluetoothShareTask.STATE_SUCCESS) ? R.drawable.bt_share_mgmt_out_success : R.drawable.bt_share_mgmt_failure );
		}
