...
public class CallerInfo {
    ...
    ///M:AAS begin. [ALPS00315231][ALPS00320091]
    public String accountType;
    public int indicate;
    ///M:AAS end. [ALPS00315231][ALPS00320091]
            ...
            if (cursor.moveToFirst()) {
                ...
                if (columnIndex != -1) {
                    ...
                    if (typeColumnIndex != -1) {
                        ...
                        int indicate = -1;
                        // See packages/providers/ContactsProvider/src/com/android/providers/contacts/ContactsProvider2.java 
                        // to check sPhoneLookupProjectionMap to learn all available columns of Phone_Lookup table
                        int accountColumnIndex = cursor.getColumnIndex(RawContacts.ACCOUNT_TYPE);
                        if (accountColumnIndex != -1) {
                            int indicateColumnIndex = cursor.getColumnIndex(Contacts.INDICATE_PHONE_SIM);
                            if(indicateColumnIndex != -1) {
                                accountType = cursor.getString(accountColumnIndex);
                                info.accountType = accountType;
                                indicate = cursor.getInt(indicateColumnIndex);
                                info.indicate = indicate;
                                Log.d(TAG, "get AAS label,1 accountType=" + info.accountType + ";indicate=" + info.indicate);
                            }
                        }
                        ///M:AAS end. [ALPS00315231][ALPS00320091]
                    }
                ...
                //MTK-START [mtk04070][111118][ALPS00093395]Support VT and SIP
                ...
                info.shouldSendToVoicemailSip = (columnIndex != -1) &&
                        ((cursor.getInt(columnIndex)) == 1);
                //MTK-END [mtk04070][111118][ALPS00093395]Support VT and SIP
    ...
    /* package */ CallerInfo markAsVoiceMailGemini(int simId) {
        ...
        try {
            String voiceMailLabel = TelephonyManager.getDefault().getVoiceMailAlphaTagGemini(simId);
