 ...
 * @version V1.0
 */
public class RestoreContactsReq extends RawBlockRequest {
    //==============================================================
    // Constants
    //==============================================================
    ...
    //==============================================================
    /**
     * Class Name: RestoreContactsReq.Builder
     * <p>Package: com.mediatek.apst.util.command.contacts
     * <p>Created on: 2010-12-18
     * <p>
     * <p>Description:
     * <p>Builder class help to create and fill a RestoreContactsReq.
     * <p>
     * @author mtk80734 Siyang.Miao
     * @version V1.0
     */
    public static class Builder extends RawBlockRequest.Builder {
        ...
        /**
         * Returns a RestoreContactsReq with data supplied to the
         * builder.
         * @return The RestoreContactsReq instance.
         */
        public RestoreContactsReq build(){
            ...
            return (RestoreContactsReq)super.build();
        }
