   ...
   //add for multi-delete
    ...
    public void onDraftChanged(final long threadId, final boolean hasDraft) {
        ...
        mQueryHandler.post(new Runnable() {
            public void run() {
                Xlog.d(LogTag.CB, "onDraftChanged: threadId=" + threadId + ", hasDraft=" + hasDraft);
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        Xlog.d(LogTag.CB, "onConfigurationChanged: " + newConfig);
    }
    ...
    private final class MessageListQueryHandler extends BaseProgressQueryHandler {
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            switch (token) {
                ...
                default:
                    Xlog.e(LogTag.CB, "onQueryComplete called with unknown token " + token);
            }
        }
    ...
    private void log(String format, Object... args) {
        ...
        Xlog.d(LogTag.CB, "[" + Thread.currentThread().getId() + "] " + s);
    }
        ...
        if (v == mDeleteButton) { 
            if (mMsgListAdapter.getSelectedNumber() >= mMsgListAdapter.getCount()) {
                ConversationList.confirmDeleteThreadDialog(
                        new ConversationList.DeleteThreadListener(null,
                                mQueryHandler, CBMessageListActivity.this),
                        null, false,  CBMessageListActivity.this);
            } else {
                confirmMultiDelete();
            }
