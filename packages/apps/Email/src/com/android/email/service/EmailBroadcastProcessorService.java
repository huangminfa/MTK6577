...
public class EmailBroadcastProcessorService extends IntentService {
    ...
    private final Preferences pref = Preferences.getPreferences(this);
        ...
        try {
            if (ACTION_BROADCAST.equals(action)) {
                ...
                //       The code below came from very old code....
                    ...
                    Log.w(Logging.LOG_TAG, "Receive STORAGE_LOW broadcast , and Email will stop work");
                    pref.setLowStorage(true);
                    ...
                    Log.w(Logging.LOG_TAG, "Receive STORAGE_OK broadcast , and Email will start work");
                    pref.setLowStorage(false);
                    c = getContentResolver().query(Account.CONTENT_URI,
                            Account.ID_PROJECTION, null, null, null);
                    if (c.getCount() > 0) {
                        mHandler.post(new Runnable() {
    ...
    private void onSettingsPackageClearData() {
        ...
        Log.d(Logging.LOG_TAG, "!!!onSettingsPackageClearData: send broadcast to laucher : unreadCount = "
                + 0);

        android.provider.Settings.System.putInt(this
                .getContentResolver(), "com_android_email_mtk_unread",0);
    }
}
