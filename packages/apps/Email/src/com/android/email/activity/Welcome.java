...
public class Welcome extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        resolveAccount();
        // Reconcile POP/IMAP accounts. EAS accounts are taken care of by
        // ExchangeService.
        EmailAsyncTask.runAsyncParallel(new Runnable() {
            @Override
            public void run() {
                EmailAsyncTask.printStartLog("Welcome#onCreate");
                ...
                EmailAsyncTask.printStopLog("Welcome#onCreate");
            }
        });
    ...
    private void startEmailActivity() {
        ...
        if (mMessageId != Message.NO_MESSAGE) {
            ...
            if (Logging.LOG_PERFORMANCE) {
                Logging.d(Logging.LOG_TAG, "[Exchange Download Speed] Welcome:StartEmailActivity:ShowMessageList ["
                        + System.currentTimeMillis() + "]");
            }
    ...
    private final MailboxFinder.Callback mMailboxFinderCallback = new MailboxFinder.Callback() {
        ...
        public void onAccountNotFound() {
            ...
            if (!Utility.hasConnectivity(mContext)) {
                ...
                dialogFragment = (MyConnectionAlertDialog)fm.findFragmentByTag("connectionalertdialog");

                /// M: Recover and dismiss the progress dialog fragment
                if (dialogFragment != null) {
                    dialogFragment.dismissAllowingStateLoss();
                }
                dialogFragment = MyConnectionAlertDialog
                        .newInstance(mContext);
                fm.beginTransaction().add(dialogFragment, "connectionalertdialog")
