...
public class RunningServiceDetails extends Fragment
    ...
    void addProcessDetailsView(RunningState.ProcessItem pi, boolean isMain) {
        ...
        if(Utils.isCuLoad()||Utils.isCmccLoad()) {
            ...
            detail.c = root.findViewById(R.id.main_launch_category);
            detail.t = root.findViewById(R.id.main_launch);
            detail.mLaunchButton.setVisibility(View.VISIBLE);
            detail.c.setVisibility(View.VISIBLE);
            detail.t.setVisibility(View.VISIBLE);
            detail.mLaunchButton.setOnClickListener(detail);
            detail.i = getActivity().getPackageManager().getLaunchIntentForPackage(
                    detail.mActiveItem.mItem.mPackageInfo.packageName);
            detail.mLaunchButton.setEnabled(detail.i != null);
        }
        //MTK_OPTR_PROTECT_END
