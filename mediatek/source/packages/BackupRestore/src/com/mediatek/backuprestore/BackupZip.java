...
public class BackupZip {
	static private String LOGTAG = "BackupRestore:";
	...
	public static List<String> GetFileList(String zipFileString, boolean bContainFolder, boolean bContainFile)throws IOException {
	...
	public static List<String> GetFileList(String zipFileString, boolean bContainFolder, boolean bContainFile, String tmpString)
        throws IOException {
	...
	public static void UnZipFolder(String zipFileString, String outPathString)throws IOException {
		//Log.v(LOGTAG, "UnZipFolder(String, String)");
		ZipInputStream inZip = new ZipInputStream(new FileInputStream(zipFileString));
		ZipEntry zipEntry;
		String szName = "";
	...
	public static void zipFolder(String srcFileString, String zipFileString)throws IOException {
		Log.v(LOGTAG, "zipFolder(String, String)");
	...
	private static void ZipFiles(String folderString, String fileString, ZipOutputStream zipOutputSteam)throws IOException{
		Log.v(LOGTAG, "ZipFiles(String, String, ZipOutputStream)");
    ...
    public void addFileByFileName(String srcFileName, String desFileName) throws IOException{
        Log.d("BACKUP", "addFileByFileName:" + "srcFile:" + srcFileName + ",desFile:" + desFileName);
        ...
        if (dir.isDirectory()) {
            ...
            if (fileArray != null) {
                for (File file: fileArray) {
                    addFolder(srcPath + File.separator + file.getName(), desPath + File.separator + file.getName());
                }
            } else {
