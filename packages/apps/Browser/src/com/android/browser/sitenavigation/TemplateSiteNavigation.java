...
public class TemplateSiteNavigation {
    ...
    private static HashMap<Integer, TemplateSiteNavigation> sCachedTemplates = new HashMap<Integer, TemplateSiteNavigation>();

    private static boolean mCountryChanged = false;

    private static String mCurrentCountry = "US";
    ...
    public static TemplateSiteNavigation getCachedTemplate(Context context, int id) {
        ...
        Xlog.d(XLOGTAG, "TemplateSiteNavigation.getCachedTemplate() display country :" 
                + changeToCountry + ", before country :" + mCurrentCountry);
        if (changeToCountry != null && !changeToCountry.equals(mCurrentCountry)) {
            mCountryChanged = true;
            mCurrentCountry = changeToCountry;
        }
        synchronized (sCachedTemplates) {
            TemplateSiteNavigation template = sCachedTemplates.get(id);
            if (template == null || mCountryChanged) {
