...
public class WebSettings {
    ...
    /// M: add XLOGTAG.
    static final String XLOGTAG = "webkit/WebSettings";
    /**
    ...
    private boolean         mUsesEncodingDetector = false;
    ...
    WebSettings(Context context, WebView webview) {
        ...
        mDefaultTextEncoding = "auto-detector";
        mUsesEncodingDetector = true;
        // mDefaultTextEncoding =
        //    	context.getString(com.android.internal.R.string.default_text_encoding);
    ...
    public void setDoubleTapZoom(int doubleTapZoom) {
        if (mDoubleTapZoom != doubleTapZoom) {
            ...
            if (mWebView.getSettings() == null) {
                Xlog.d(XLOGTAG, "setDoubleTapZoom return");
                return;
            }
            /// @}
    ...
    public void setDefaultZoom(ZoomDensity zoom) {
        if (mDefaultZoom != zoom) {
            /// M: For browser settings, WebViewCore maybe destroyed early. @{
            if (mWebView.getSettings() == null) {
                Xlog.d(XLOGTAG, "setDefaultZoom return");
                return;
            }
            /// @}
            mDefaultZoom = zoom;
     ...
     * should be disabled. Note that the value of this setting is ignored if the
     * value of {@link #getAllowUniversalAccessFromFileURLs} is true.
     * <p>
     * The default value is true.
     * 
     * @param flag whether JavaScript running in the context of a file scheme URL
     *            should be allowed to access content from other file scheme
     *            URLs
     * @hide
     */
    ...
    public synchronized void setDefaultTextEncodingName(String encoding) {
        if (encoding != null && !encoding.equals(mDefaultTextEncoding)) {
            ...
            if (mDefaultTextEncoding.equals("auto-detector"))
                mUsesEncodingDetector = true;
            else 
                mUsesEncodingDetector = false;
            postSync();
        }
    }
