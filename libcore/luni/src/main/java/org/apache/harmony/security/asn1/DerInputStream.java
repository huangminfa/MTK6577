...
public final class DerInputStream extends BerInputStream {
    ...
    public void readUTCTime() throws IOException {
        ...
        //Modify by MTK03594 for ALPS ALPS00073203
        //Add support for YYMMDDHHMM'Z' with ASN1UTCTime.UTC_HM format
        if (length != ASN1UTCTime.UTC_HMS && length != ASN1UTCTime.UTC_HM) {
