...
public class ExternalStorageFormatter extends Service
    ...
    private String mPath = Environment.getExternalStorageDirectory().toString();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        mPath = mStorageVolume == null ?
                (sdExist == false ? Environment.getExternalStorageDirectory().toString() : "/mnt/sdcard2") :
        ...
        if (volumes != null) {
            for(StorageVolume volume : volumes) {
                if(mPath.equals(volume.getPath())) {
                    ...
                    mStorageDescription = volume.getDescription();
                    break;
                }
            }
        }
    ...
    public void onCancel(DialogInterface dialog) {
        ...
        try {
            if (FeatureOption.MTK_2SDCARD_SWAP) {
                mountService.mountVolumeNotSwap(extStoragePath);
            } else {
