...
public class DmScomoConfirmActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        ((NotificationManager) this.getSystemService(Context.NOTIFICATION_SERVICE)).cancel(DmScomoNotification.NOTIFICATION);
    ...
    private Dialog onConfirmInstall() {
        ...
        .setPositiveButton(text, new OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Log.v(TAG.Scomo, "[DmScomoConfirmActivity] positive button clicked, start to install");
    ...
    private Dialog checkPackageError() {
        ...
        DmScomoPackageManager.ScomoPackageInfo info =
            DmScomoPackageManager.getInstance().getMinimalPackageInfo(scomoState.archiveFilePath);
        ret=(info!=null);
        if (!ret) {
            Log.w(TAG.Scomo, "[DmScomoConfirmActivity] checkPackageError: error! ScomoPackageInfo is null");
            return DialogFactory.newAlert(this)
                   .setCancelable(false)
                   .setTitle(R.string.software_update)
    ...
    private Dialog onConfirmDownload() {
        ...
        .setPositiveButton(R.string.ok, new OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Log.v(TAG.Scomo, "[DmScomoConfirmActivity] positive button clicked, start to download");
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        case DialogInterface.BUTTON_NEGATIVE:
            Log.v(TAG.Scomo, "[DmScomoConfirmActivity] negative button clicked,reset scomo state & cancelDLScomoPkg");
        ...
        case DialogInterface.BUTTON_NEUTRAL:
            Log.v(TAG.Scomo, "[DmScomoConfirmActivity] neutral button clicked, reset scomo state");
            DmScomoState scomoState=DmService.getInstance().getScomoState();
