...
public abstract class PagedView extends ViewGroup {
        ...
        if (mContentIsRefreshable) {
            ...
            if (page < count) {
                ...
                for (int i = 0; i < count; ++i) {
					...
					if (LauncherLog.DEBUG) {
						LauncherLog.d(TAG,
								"< --- loadAssociatedPages: layout = " + layout
										+ "----> " + i);
					}
    ...
    public void enterAppWidget(int page) {    	
    	View mtkWidgetView = getMTKWidgetView(page);                    
    	if (mtkWidgetView != null) {
    		((IMTKWidget) mtkWidgetView).enterAppwidgetScreen();
    		canCallEnterAppWidget = false;
    		if (LauncherLog.DEBUG_SURFACEWIDGET) {
    			LauncherLog.d(Launcher.TAG_SURFACEWIDGET,
    					"action_move: enterAppWidgetScreen whichMtkWidgetView = " + mtkWidgetView);
    		}
    	}
    }
    
    public void leaveAppWidget(int page) {    	
    	View mtkWidgetView = getMTKWidgetView(page);        
        if (mtkWidgetView != null) {
            ...
            if (LauncherLog.DEBUG_SURFACEWIDGET) {
                LauncherLog.d(Launcher.TAG_SURFACEWIDGET,
                        "leaveAppWidgetScreen whichMtkWidgetView = " + mtkWidgetView);
            }
        }	
    }
    
    public void startDragAppWidget(int page) {
    	View mtkWidgetView = getMTKWidgetView(page); 
        if (mtkWidgetView != null) {
    ...
    public void stopDragAppWidget(int page) {
        View mtkWidgetView = getMTKWidgetView(page);
        if (mtkWidgetView != null) {
    ...
    public void moveInAppWidget(int page) {
    	View mtkWidgetView = getMTKWidgetView(page);
		if (mtkWidgetView != null) {
    ...
    public void moveOutAppWidget(int page) {
    	//if (canSendMessage && ! mDragController.isDraging() ) {
    	View mtkWidgetView = getMTKWidgetView(page);
		if (mtkWidgetView != null) {
			((IMTKWidget) mtkWidgetView).moveOut(mCurrentPage);
			canSendMessage = false;
			if (LauncherLog.DEBUG_SURFACEWIDGET) {
    ...
    public void startCovered(int page) {
    	View mtkWidgetView = getMTKWidgetView(page);
    	if ( mtkWidgetView != null) {
    		((IMTKWidget)mtkWidgetView).startCovered(page);
    		if (LauncherLog.DEBUG_SURFACEWIDGET) LauncherLog.d(Launcher.TAG_SURFACEWIDGET, "startCovered mtkWidgetView = " + mtkWidgetView);
    	}
    }
    ...
    public void stopCovered(int page) {
    	...
    	if ( mtkWidgetView != null) {
    		...
    		if (LauncherLog.DEBUG_SURFACEWIDGET) LauncherLog.d(Launcher.TAG_SURFACEWIDGET, "stopCovered mtkWidgetView = " + mtkWidgetView);
    	}
    }
    ...
    public View getMTKWidgetView(int page) {
    	View whichHostView = getChildAt(page);
        View mtkWidgetView = searchIMTKWidget(whichHostView);
