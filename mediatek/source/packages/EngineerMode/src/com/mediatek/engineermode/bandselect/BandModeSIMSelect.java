...
public class BandModeSIMSelect extends Activity implements OnItemClickListener{
	...
	private static final String TAG = "BandModeSIMSelect";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ListView SIMTypeListView = (ListView) findViewById(R.id.ListView_BandModeSIMSelect);
		
		if(SIMTypeListView == null){
			Xlog.e(TAG, "SIMTypeListView is null");
		}
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		case 0:
			if(isTDDType){
                intent.setClass(this,TddBandselect.class);
            	}else{
                intent.setClass(this,Bandselect.class);
                }
			break;
		case 1:
			intent.setClass(this, BandModeSIM2.class);
			break;
	 default :
		 break;
	 }
