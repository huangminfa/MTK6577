...
/**
 * Class Name: AsyncGetAllSimContactsRsp
 * <p>Package: com.mediatek.apst.util.command.contacts
 * <p>Created on: 2010-12-18
 * <p>
 * <p>Description: 
 * <p>Response for asynchronously getting all SIM contacts.
 * <p>
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class AsyncGetAllSimContactsRsp extends RawBlockResponse {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    // Constructors                                                 
    //==============================================================
    public AsyncGetAllSimContactsRsp(int requestToken){
    ...
    //==============================================================
    /**
     * Gets the SIM contacts list.
     * @return The SIM contacts list.
     */
