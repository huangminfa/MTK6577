...
static jstring android_drm_DrmManagerClient_getContentIdFromRights(
    ...
    if (NULL != mData) {
        ...
        XLOGV("onGetContentIdFromRights() ----> %d", uniqueId);
...
static jint android_drm_DrmManagerClient_installDrmMsg(
        JNIEnv* env, jobject thiz, jint uniqueId, jstring path) {
    XLOGV("installDrmMsg");
    return DrmMtkUtil::installDrmMsg(Utility::getStringValue(env, path)) ?
                0 : -2000;
}
...
static jint android_drm_DrmManagerClient_consume(
    ...
    sp<DecryptHandle> handle = getDrmManagerClientImpl(env, thiz)->openDecryptSession(uniqueId, uri.string());
...
static jint android_drm_DrmManagerClient_saveIMEI(
        JNIEnv* env, jobject thiz, jint uniqueId, jstring imei) {
    XLOGV("saveIMEI");
    return DrmMtkUtil::saveIMEI(Utility::getStringValue(env, imei));
}

static jint android_drm_DrmManagerClient_saveDeviceId(
        JNIEnv* env, jclass thiz, jstring id) {
    XLOGV("saveDeviceId");
    return DrmMtkUtil::saveId(Utility::getStringValue(env, id));
}

static jstring android_drm_DrmManagerClient_getDeviceId(
        JNIEnv* env, jclass thiz) {
    XLOGV("getDeviceId");
    return env->NewStringUTF(DrmMtkUtil::loadId().string());
}

static jboolean android_drm_DrmManagerClient_checkSecureTimerStatus(
        JNIEnv* env, jclass thiz) {
    XLOGV("checkSecureTimerStatus");
    SecureTimer::instance().load();
    return SecureTimer::instance().isValid();
}

static jint android_drm_DrmManagerClient_updateClockBase(
        JNIEnv* env, jclass thiz) {
    XLOGV("updateClockBase");
    return SecureTimer::instance().updateTimeBase();
}

static jint android_drm_DrmManagerClient_updateClockOffset(
        JNIEnv* env, jclass thiz) {
    XLOGV("updateClockOffset");
    return SecureTimer::instance().updateOffset();
}

static jint android_drm_DrmManagerClient_updateClock(
        JNIEnv* env, jclass thiz, jint value) {
    XLOGV("updateClock");
    return SecureTimer::instance().updateDRMTime((time_t)value);
}

static jint android_drm_DrmManagerClient_saveClock(
        JNIEnv* env, jclass thiz) {
    XLOGV("saveClock");
    return SecureTimer::instance().save();
}

static jint android_drm_DrmManagerClient_loadClock(
        JNIEnv* env, jclass thiz) {
    XLOGV("loadClock");
    return SecureTimer::instance().load();
}

static jint android_drm_DrmManagerClient_getSecureTime(
        JNIEnv* env, jclass thiz) {
    XLOGV("getSecureTime");
    time_t value = 0;
    SecureTimer::instance().getDRMTime(value);
    return (int)value;
}
...
static JNINativeMethod nativeMethods[] = {
    ...
    {"_installDrmMsg", "(ILjava/lang/String;)I",
                                    (void*)android_drm_DrmManagerClient_installDrmMsg},

    {"_consume", "(ILjava/lang/String;I)I",
                                    (void*)android_drm_DrmManagerClient_consume},

    {"_saveIMEI", "(Ljava/lang/String;)I",
                                    (void*)android_drm_DrmManagerClient_saveIMEI},

    {"_saveDeviceId", "(Ljava/lang/String;)I",
                                    (void*)android_drm_DrmManagerClient_saveDeviceId},

    {"_getDeviceId", "()Ljava/lang/String;",
                                    (void*)android_drm_DrmManagerClient_getDeviceId},

    {"_checkSecureTimerStatus", "()Z",
                                    (void*)android_drm_DrmManagerClient_checkSecureTimerStatus},

    {"_updateClockBase", "()I",
                                    (void*)android_drm_DrmManagerClient_updateClockBase},

    {"_updateClockOffset", "()I",
                                    (void*)android_drm_DrmManagerClient_updateClockOffset},

    {"_updateClock", "(I)I",
                                    (void*)android_drm_DrmManagerClient_updateClock},

    {"_saveClock", "()I",
                                    (void*)android_drm_DrmManagerClient_saveClock},

    {"_loadClock", "()I",
                                    (void*)android_drm_DrmManagerClient_loadClock},

    {"_getSecureTime", "()I",
                                    (void*)android_drm_DrmManagerClient_getSecureTime}
