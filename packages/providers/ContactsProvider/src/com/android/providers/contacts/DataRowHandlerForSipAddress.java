		...
		if (FeatureOption.MTK_SEARCH_DB_SUPPORT) {
			...
			if (mDialerSearchNoNameCallLogNumDataIdUpdate == null) {
	        	mDialerSearchNoNameCallLogNumDataIdUpdate = db.compileStatement(
	        			...
	        			" SET " + DialerSearchLookupColumns.RAW_CONTACT_ID + " = -" + DialerSearchLookupColumns.CALL_LOG_ID + "," + 
	        			DialerSearchLookupColumns.DATA_ID + " = -" + DialerSearchLookupColumns.CALL_LOG_ID +
...
//        }
    ...
    public boolean hasSearchableData() {
        return ContactsProvider2.isCmcc();
    }
