...
public class MenuHelper {
    ...
    private static final String PANORAMA_CLASS = "com.mediatek.camera.panorama.PanoramaActivity";
    private static final String VIDEO_CAMERA_CLASS = "com.android.camera.VideoCamera";
    private static final String MAV_CLASS = "com.mediatek.camera.mav.MavActivity";
    
    private static final String KEY_SWITCH_INTERNAL = "internal";
    ...
    public static void addSwitchModeMenuItem(Menu menu, int mode,
        ...
        switch(mode) {
            ...
            case ModePicker.MODE_MAV:
				if (!Util.isMAVSupport()) {
					return;
				}
				
            	labelId = R.string.switch_to_mav_label;
                iconId = R.drawable.btn_ic_panorama;
                break;
            default:
    ...
    public static void gotoMode(int mode, Activity activity) {
        ...
        startCameraActivity(activity, new Intent(action).putExtra(KEY_SWITCH_INTERNAL, "true"), className);
    }
    ...
    public static void gotoCameraMode(Activity activity, Intent intent) {
    	intent.putExtra(KEY_SWITCH_INTERNAL, "true");
        startCameraActivity(activity, intent, CAMERA_CLASS);
    }
    ...
    public static boolean isCameraModeSwitching(Intent i) {
        if (i.hasExtra(KEY_SWITCH_INTERNAL)) {
            return true;
        }
        return false;
    }
