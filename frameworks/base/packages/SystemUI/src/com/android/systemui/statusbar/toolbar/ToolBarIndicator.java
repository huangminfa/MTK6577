...
public class ToolBarIndicator extends LinearLayout implements ToolBarView.ScrollToScreenCallback {
    ...
    private void init() {
        ...
        mNormalDrawable = this.getResources().getDrawable(R.drawable.zzz_tool_bar_indicator);
        mFocusedDrawable = this.getResources().getDrawable(R.drawable.zzz_tool_bar_indicator_focused);
    }
