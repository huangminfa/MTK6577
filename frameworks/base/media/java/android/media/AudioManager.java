...
public class AudioManager {
    ...
    public void setVibrateSetting(int vibrateType, int vibrateSetting) {
        IAudioService service = getService();
        try {
            Log.d(TAG, "setVibrateSetting: Type = " + vibrateType + ", setting = " + vibrateSetting);
    ...
    */
            ...
            if (looper != null) {
                ...
                mHandler = new Handler(looper) {
                    ...
                    public void handleMessage(Message msg) {
                        ...
                        Log.d(TAG, "FocusHandler: change = " + msg.what + ", id = " + (String)msg.obj + ", isNull = " + (listener == null));
                    }
                };
            } else {
                mHandler = null;
    ...
    private IAudioFocusDispatcher mAudioFocusDispatcher = new IAudioFocusDispatcher.Stub() {
        ...
        public void dispatchAudioFocusChange(int focusChange, String id) {
            Log.d(TAG, "dispatchAudioFocusChange: change = " + focusChange + ", id = " + id);
    ...
    public void listenRingerModeAndVolume(IAudioProfileListener callback, int event) {
        IAudioService service = getService();
        try {
            service.listenRingerModeAndVolume(callback, event);
        } catch (RemoteException e) {
