...
public class CBMessageReceiverService extends Service {
    ...
    private void handleCBMessageReceived(Intent intent) {
        ...
        if (null == msgs) {
            Xlog.e(MmsApp.TXN_TAG, "Intents.getMessagesFromIntent return null !!");
            return;
        }
        ...
        if (messageUri != null) {
            if (FeatureOption.MTK_GEMINI_SUPPORT) {
                ...
                if (null != si) {
                    ...
                    Xlog.w(MmsApp.TXN_TAG, "handleCBMessageReceived:SIMInfo is null for slot " + slotId);
                }
...
//        }
    ...
    private Uri storeCBMessage(Context context, CbSmsMessage[] msgs) {
        ...
        Xlog.d(MmsApp.TXN_TAG, "CB message body: " + body.toString());
