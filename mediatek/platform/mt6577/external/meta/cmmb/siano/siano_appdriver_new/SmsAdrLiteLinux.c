...
#define ADR_LOGE(fmt, args...) LOGE( "sms-appdriver - %s(): " fmt "\n", __FUNCTION__, ##args)
#define ADR_LOGW(fmt, args...) LOGW( "sms-appdriver - %s(): " fmt "\n", __FUNCTION__, ##args)
#define ADR_LOGI(fmt, args...) LOGI( "sms-appdriver - %s(): " fmt "\n", __FUNCTION__, ##args)
#define ADR_LOGD(fmt, args...) LOGD( "sms-appdriver - %s(): " fmt "\n", __FUNCTION__, ##args)
#else
