...
public class TabLockList extends TabActivity implements OnTabChangeListener
{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Sim1State = mGeminiPhone.isSimInsert(Phone.GEMINI_SIM_1) & mGeminiPhone.isRadioOnGemini(Phone.GEMINI_SIM_1);
		Sim2State = mGeminiPhone.isSimInsert(Phone.GEMINI_SIM_2) & mGeminiPhone.isRadioOnGemini(Phone.GEMINI_SIM_2);
	...
	private void SetupSIM1Tab() {
		...
		mTabHost.addTab((mTabHost.newTabSpec("SIM1"))
				.setIndicator("SIM1", getResources().getDrawable(R.drawable.tab_manage_sim1))
				.setContent(intent));
	}
	...
	private void SetupSIM2Tab() {
		...
		mTabHost.addTab((mTabHost.newTabSpec("SIM2"))
				.setIndicator("SIM2", getResources().getDrawable(R.drawable.tab_manage_sim2))
				.setContent(intent));
	}
