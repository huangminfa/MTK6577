...
public class BrowserActivity extends Activity {
    ...
    private final static String XLOGTAG = "browser/BrowserActivity";
    ...
    private class PostDrawListener implements android.view.ViewTreeObserver.OnPostDrawListener {
    	...
    	public boolean onPostDraw() {
    		Xlog.i("AppLaunch", "[AppLaunch] Browser onPostDraw");
    		return true;
    	}
    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (getIntent().getBooleanExtra("inputUrl", false)) {
            ((BaseUi)mUi).setInputUrlFlag(true);
            Xlog.d(XLOGTAG, "onCreate setInputUrlFlag");
        }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        //intent of Action_Search will be handled in handleWebSearch() of onCreate(), 
        ...
        //That's not right.
        if (null == mController) {
            Xlog.w(XLOGTAG, "onNewIntent for Action_Search Intent reached before finish(), so enter onNewIntent instead of on create");
