...
public class VideoLiveWallpaper extends WallpaperService {
	static final String TAG = "VideoLiveWallpaper";
	...
	private class VLWEngine extends Engine {
		...
		public void onDesiredSizeChanged(int desiredWidth, int desiredHeight) {
			if (DEBUG) {
				Xlog.i(TAG, String.format("desiredWidth=%d, desiredHeight=%d",
		...
		public void onVisibilityChanged(boolean visible) {
			...
			// ALPS00095402. 
			// It will send a SCREEN_OFF broadcast before SCREEN_ON
			// when device is rebooting from IPO
			...
			if (mRenderer != null && visibleChange) {
				// Must release MediaPlayer or the device cannot suspend
			    mVisible = visible;
		...
		public void onSurfaceCreated(SurfaceHolder holder) {
            ...
            if (mRenderer == null) {
				mRenderer = new VideoScene(VideoLiveWallpaper.this, holder,
						isPreview());
