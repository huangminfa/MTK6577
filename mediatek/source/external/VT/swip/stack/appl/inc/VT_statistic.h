...
#ifndef _VT_STATISTIC_
#define _VT_STATISTIC_
#ifdef __VT_USE_STAT__
    typedef struct 
    {
        kal_uint32 vt_adm_mem_max_used;
        ...
        kal_uint32 vt_DL_correct_frame_num;
        kal_uint32 vt_DL_error_frame_num;
        ...
        kal_uint32 vt_LC_buffer_num;
        kal_uint32 vt_LC_buffer_size;
    ...
    extern vt_stat_struct vt_global_stat;
    extern void vt_stat_init(void);
#endif
#endif
