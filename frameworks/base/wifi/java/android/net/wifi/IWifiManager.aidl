...
interface IWifiManager
{
     ...
     * @hide
     */
    String doWpsPin(String bssid);

    /**
     * @hide
     */
    boolean doWpsPbc(String bssid);
     ...
     * @hide
     */
    boolean doCTIATestPower(int powerMode);

    /**
     * @hide
     */
    boolean doCTIATestSet(int id, int value);

    /**
     * @hide
     */
    String doCTIATestGet(int id);
