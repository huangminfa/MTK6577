...
/**
 * Class Name: AsyncGetAllSmsRsp
 * <p>Package: com.mediatek.apst.util.command.message
 * <p>Created on: 2010-12-18
 * <p>
 * <p>Description: 
 * <p>Response for asynchronously getting all SMS.
 * <p>
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class AsyncGetAllSmsRsp extends RawBlockResponse {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    // Constructors                                                 
    //==============================================================
    public AsyncGetAllSmsRsp(int requestToken){
    ...
    //==============================================================
    /**
     * Gets a list of all SMS messages.
     * @return The list of all SMS messages.
     */
    public ArrayList<Sms> getAll(int versionCode){
        ByteBuffer buffer = ByteBuffer.wrap(this.getRaw());
        int count = buffer.getInt();
        ArrayList<Sms> list = new ArrayList<Sms>(count);
