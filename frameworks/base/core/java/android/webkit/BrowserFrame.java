...
class BrowserFrame extends Handler {
    ...
    public void loadUrl(String url, Map<String, String> extraHeaders) {
        // M: For CU or CMCC customization, Set the x-wap-profile header
        String optr = SystemProperties.get("ro.operator.optr");
        if (optr.equals("OP01")|| optr.equals("OP02")) {
            if (extraHeaders == null) {
                extraHeaders = new HashMap<String, String>();
                extraHeaders.put("x-wap-profile", 
                        "http://www.lenovomobile.com/admin/module/product/DownFile/Lenovo_A698t_UAProfile.xml");
            } else {
                extraHeaders.put("x-wap-profile", 
                        "http://www.lenovomobile.com/admin/module/product/DownFile/Lenovo_A698t_UAProfile.xml");
            }
    ...
    private LoadListener startLoadingResource(int loaderHandle,
                                              ...
                                              String username,
                                              String password) {
        //For CU or CMCC customization, Set the x-wap-profile header
        String optr = SystemProperties.get("ro.operator.optr");
        if (optr.equals("OP01")|| optr.equals("OP02")) {
        		headers.put("x-wap-profile", "http://www-ccpp.tcl-ta.com/files/ALCATEL_one_touch_890D.xml");
        }
        ...
        /*if (DebugFlags.BROWSER_FRAME)*/ {
            Xlog.d(XLOGTAG, "startLoadingResource: url=" + url + ", method="
