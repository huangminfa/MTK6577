...
public class DmScomoPackageManager {
    ...
    synchronized public void install(final String absPkgPath,
    ...
    private void scanPackageInternal() {
        try {
            ...
            List<MdmScomoDc> dcs=MdmScomo.getInstance(DmConst.nodeUri.ScomoRootUri,DmScomoHandler.getInstance()).getDcs();
            ...
            dcsNamesTmp.removeAll(appNames); // dcsNamesTmp now contains pkg need to be removed from dcs
            appNamesTmp.removeAll(dcsNames); // appNamesTMp now contains pkg need to be added to dcs

            MdmScomo scomo=MdmScomo.getInstance(DmConst.nodeUri.ScomoRootUri,DmScomoHandler.getInstance());
