...
//        }	
    ...
    public void updateManageConferenceRow(final int i,
        ...
        if (connection != null) {
            ...
            ImageButton endButton = (ImageButton) mConferenceCallList[i].findViewById(R.id.conferenceCallerDisconnect);
            ImageButton separateButton = (ImageButton) mConferenceCallList[i].findViewById(R.id.conferenceCallerSeparate);
        ...
        if (ci != null) {
            ...
            if (TextUtils.isEmpty(callerName)) {
                ...
                if (ci.accountType != null && PhoneUtils.isAasEnabled(ci.accountType)) {
                    callerNumberType = PhoneUtils.getAasLabel(ci);
                } else {
                    /*
