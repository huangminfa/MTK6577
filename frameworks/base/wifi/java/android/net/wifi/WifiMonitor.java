...
public class WifiMonitor {
    ...
    private static final int NO_CONNECTABLE_AP = 10;   
     ...
     * </pre>
     */
    private static final String WPS_SUCCESS_STRING = "WPS-SUCCESS";
    /**
     * <pre>
     * WPS-ERROR
     * </pre>
     */
    private static final String WPS_ERROR_STRING = "WPS-ERROR";
    /**
     * <pre>
     * WPS-OVERLAP
     * </pre>
     */
    private static final String WPS_OEVELAP_STRING = "WPS-OVERLAP";
    /**
     * <pre>
     * WPS-NO-OVERLAP
     * </pre>
     */
    private static final String WPS_NO_OEVELAP_STRING = "WPS-NO-OVERLAP";
    /**
     * <pre>
     * WPS-AP-AVAILABLE-PIN
     * </pre>
     */
    private static final String WPS_AP_PIN_STRING = "WPS-AP-AVAILABLE-PIN";
    /**
     * <pre>
     * WPS-AP-AVAILABLE-PBC
     * </pre>
     */
    private static final String WPS_AP_PBC_STRING = "WPS-AP-AVAILABLE-PBC";    
    /**
     * <pre>
     * WPS-CRED-RECEIVED
     * </pre>
     */
    private static final String WPS_CRED_RECEIVED_STRING = "WPS-CRED-RECEIVED";
    
    private static final String WAPI_NO_CERTIFICATION_STRING = "EAP-NO-CERTIFICATION";
    private static final String NO_CONNECTABLE_AP_STRING = "NO-SUITABLE-AP-FOUND";
   ...
   /* Network connection completed */
    ...
    /* MTK events */
    public static final int WPS_SUCCESS_EVENT                    = BASE + 51;
    public static final int WPS_ERROR_EVENT                      = BASE + 52;
    public static final int MTK_WPS_OEVELAP_EVENT                = BASE + 53;
    public static final int MTK_WPS_NO_OEVELAP_EVENT             = BASE + 54;
    public static final int WPS_AP_PIN_EVENT                     = BASE + 55;
    public static final int WPS_AP_PBC_EVENT                     = BASE + 56;
    public static final int WPS_CRED_RECEIVED_EVENT              = BASE + 57;
    public static final int WAPI_NO_CERTIFICATION_EVENT          = BASE + 58;
    public static final int NO_CONNECTABLE_AP_EVENT              = BASE + 59;
    public static final int SUPPLICANT_HUNG_EVENT                = BASE + 60;
    ...
    public void startMonitoring(boolean isHotspot) {
    ...
    class MonitorThread extends Thread {
            ...
            for (;;) {
                ...
                if (!eventStr.startsWith(EVENT_PREFIX_STR)) {
                    if ((eventStr.startsWith(WPA_EVENT_PREFIX_STR) && 0 < eventStr.indexOf(PASSWORD_MAY_BE_INCORRECT_STR))
                        || (eventStr.startsWith(AUTHENTICATION_TIMEOUT_PREFIX_STR) && 0 < eventStr.indexOf(AUTHENTICATION_TIMEOUT_STR))) {
                    ...
                    // mtk03034 
                    // MTK proprietary : handle WPS related event  
                    else if (eventStr.startsWith(WPS_SUCCESS_STRING)) {
                        mStateMachine.sendMessage(WPS_SUCCESS_EVENT);
                    } else if (eventStr.startsWith(WPS_ERROR_STRING)) {
                        mStateMachine.sendMessage(WPS_ERROR_EVENT);
                    } else if (eventStr.startsWith(WPS_OEVELAP_STRING)) {
                        mStateMachine.sendMessage(MTK_WPS_OEVELAP_EVENT);
                    } else if (eventStr.startsWith(WPS_NO_OEVELAP_STRING)) {
                        mStateMachine.sendMessage(MTK_WPS_NO_OEVELAP_EVENT);
                    } else if (eventStr.startsWith(WPS_AP_PIN_STRING)) {
                        mStateMachine.sendMessage(WPS_AP_PIN_EVENT);
                    } else if (eventStr.startsWith(WPS_AP_PBC_STRING)) {
                        mStateMachine.sendMessage(WPS_AP_PBC_EVENT);
                    } else if (eventStr.startsWith(WPS_CRED_RECEIVED_STRING)) {
                        mStateMachine.sendMessage(WPS_CRED_RECEIVED_EVENT);
                    } else {
                    	Xlog.v(TAG, "No match event");
                    }
                    continue;
                }
                ...
                else if (eventName.equals(NO_CONNECTABLE_AP_STRING))
                    event = NO_CONNECTABLE_AP;
                else
                    event = UNKNOWN;
        ...
        private boolean connectToSupplicant() {
            ...
            while (true) {
                if (WifiNative.connectToSupplicant(mIsHotspot)) {
                    return true;
                }
                if (connectTries++ < 5) {
                    nap(1);
        ...
        void handleEvent(int event, String remainder) {
            switch (event) {
                ...
                /*case NO_CONNECTABLE_AP:
                    mStateMachine.sendMessage(NO_CONNECTABLE_AP_EVENT);
                    break;*/
