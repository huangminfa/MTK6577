...
public class CmmbActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SharedPreferences preferences = getSharedPreferences(CMMB_PREF,
                CmmbActivity.MODE_WORLD_READABLE);
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    case R.id.cmmb_internal_ft:
                        Elog.i("EM_CMMB", "click internal btn");
                    ...
                    case R.id.cmmb_external_ft:
                        Elog.i("EM_CMMB", "click external btn");
                    ...
                    Elog.v("CMMB", "Write Preferences Exception.");
                }
        ...
        try {
            String saveMfsFile = preferences.getString(CMMB_SAVEMFSFILE_KEY,
                    "0");
            if (saveMfsFile.equals("1")) {
            ...
            String memsetSpibuf = preferences.getString(CMMB_MEMSETSPIBUF_KEY,
                    "0");
            if (memsetSpibuf.equals("1")) {
            ...
            String mts = preferences.getString(CMMB_MTS_KEY, "0");
            if (mts.equals("1")) {
            ...
            String mbbms30 = preferences.getString(CMMB_MBBMS30_KEY, "0");
            if (mbbms30.equals("1")) {
            ...
            Elog.v("CMMB", "Read Preferences Exception.");
        }
