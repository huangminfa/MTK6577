 ...
 * .
 *
 * 10 19 2010 danny.kuo
 * [MAUI_02827360] [Maui][MPM] check in MMI Protocol Modulation revise
 * .
 *
 * 10 18 2010 mingtsung.sun
 * [MAUI_02827360] [Maui][MPM] check in MMI Protocol Modulation revise
 * fix build error on MT6573_BT
 *
 * 10 18 2010 mingtsung.sun
 * [MAUI_02827360] [Maui][MPM] check in MMI Protocol Modulation revise
 * RHR add header
 *
 * 10 14 2010 kitty.sung
 * [MAUI_02827360] [Maui][MPM] check in MMI Protocol Modulation revise
 * <saved by Perforce>
 *
 * 10 14 2010 kitty.sung
...
typedef struct
{
    kal_uint8 register_index;/*input*/
	kal_uint16 result;/*output*/
}pmu6223_read_reg_struct;


typedef struct
{
	kal_uint8 register_index;/*input*/
	kal_uint16 data;/*input*/
}pmu6223_write_reg_struct;

typedef struct
{
	kal_uint8 charger_status;/*output*/
}pmu6223_chr_state_struct;

typedef struct
{
    kal_int8 result; /* output */
}pmu6223_get_chr_en;

typedef struct
{
    kal_int8 is_on; /* input */
}pmu6223_set_chr_en;

typedef struct
{
    kal_int8 chr_curr; /* output */
}pmu6223_get_chr_curr;

typedef struct
{
    kal_int8 chr_curr; /* input */
}pmu6223_set_chr_curr;

typedef struct
{
    kal_int8 curr_offset; /* output */
}pmu6223_get_chr_curr_offset;

typedef struct
{
    kal_int8 curr_offset; /* input */
}pmu6223_set_chr_curr_offset;

typedef struct
{
    kal_int8 cv_threshold; /* output */
}pmu6223_get_cv_threshold;

typedef struct
{
    kal_uint32 cv_threshold; /* input */
}pmu6223_set_cv_threshold;

typedef struct
{
    kal_int8 info; /* output */
}pmu6223_get_drive_info;

typedef struct
{
    kal_int8 info; /* input */
}pmu6223_set_drive_info;

typedef struct
{
    kal_int8 type; /* input */
    kal_uint8 ldo_voltage; /* output */
}pmu6223_get_ldo_voltage;

typedef struct
{
    kal_int8 type; /* input */
    kal_uint8 ldo_voltage; /* input */
}pmu6223_set_ldo_voltage;

typedef struct
{
    kal_int8 enable; /* ouput */
}pmu6223_get_ldo_enable;

typedef struct
{
    kal_int8 ldo_enable; /* input */
}pmu6223_set_ldo_enable;

typedef struct
{
    kal_int8 type; /* input */
    kal_int8 calibration; /* ouput */
}pmu6223_get_bias_current;

typedef struct
{
    kal_int8 type; /* input */
    kal_int8 calibration; /* input */
}pmu6223_set_bias_current;

typedef struct
{
    pmu6223_read_reg_struct read_reg;
    pmu6223_write_reg_struct write_reg;
    pmu6223_chr_state_struct chr_state;
    pmu6223_get_chr_en get_chr_en;
    pmu6223_set_chr_en set_chr_en;
    pmu6223_get_chr_curr get_chr_curr;
    pmu6223_set_chr_curr set_chr_curr;
    pmu6223_get_chr_curr_offset get_chr_curr_offset;
    pmu6223_set_chr_curr_offset set_chr_curr_offset;
//    pmu6223_get_ov_th_freeze get_ov_th_freeze;
//    pmu6223_set_ov_th_freeze set_ov_th_freeze;
    pmu6223_get_cv_threshold get_cv_threshold;
    pmu6223_set_cv_threshold set_cv_threshold;
    pmu6223_get_drive_info get_drive_info;
    pmu6223_set_drive_info set_drive_info;
    pmu6223_get_ldo_voltage get_ldo_voltage;
    pmu6223_set_ldo_voltage set_ldo_voltage;
    pmu6223_get_ldo_enable get_ldo_enable;
    pmu6223_set_ldo_enable set_ldo_enable;
    pmu6223_get_bias_current get_bias_current;
    pmu6223_set_bias_current set_bias_current;
...
typedef struct
{
    kal_uint8 register_index;/*input*/
	kal_uint16 result;/*output*/
}pmu6238_read_reg_struct;

typedef struct
{
	kal_uint8 register_index;/*input*/
	kal_uint16 data;/*input*/
}pmu6238_write_reg_struct;

typedef struct
{
	kal_uint8 charger_status;/*output*/
}pmu6238_chr_state_struct;
...
{
    kal_int8 chr_curr; /* output */
}pmu6238_get_chr_curr;

typedef struct
{
    kal_int8 chr_curr; /* input */
}pmu6238_set_chr_curr;

typedef struct
{
    kal_int8 curr_offset; /* output */
}pmu6238_get_chr_curr_offset;

typedef struct
{
    kal_int8 curr_offset; /* input */
}pmu6238_set_chr_curr_offset;

typedef struct
{
    kal_int8 ov_th_freeze; /* output */
    kal_int8 ov_th_freeze_voltage; /* output */
}pmu6238_get_ov_th_freeze;

typedef struct
{
    kal_int8 ov_th_freeze; /* input */
    kal_int8 ov_th_threshold; /* input */
}pmu6238_set_ov_th_freeze;

typedef struct
{
    kal_int8 cv_threshold; /* output */
}pmu6238_get_cv_threshold;

typedef struct
{
    kal_uint32 cv_threshold; /* input */
}pmu6238_set_cv_threshold;

typedef struct
{
    kal_int8 info; /* output */
}pmu6238_get_drive_info;

typedef struct
{
    kal_int8 info; /* input */
}pmu6238_set_drive_info;

typedef struct
{
    kal_int8 index; /* input */
}pmu6238_get_ldo_vol_sel_vbt;

typedef struct
{
    kal_int8 index; /* input */
}pmu6238_set_ldo_vol_sel_vbt;

typedef struct
{
    kal_int8 index; /* input */
}pmu6238_get_ldo_vol_sel_vcamd;

typedef struct
{
    kal_int8 index; /* input */
}pmu6238_set_ldo_vol_sel_vcamd;

typedef struct
{
    kal_int8 index; /* input */
}pmu6238_get_ldo_vol_sel_vcama;

typedef struct
{
    kal_int8 index; /* input */
}pmu6238_set_ldo_vol_sel_vcama;

typedef struct
{
    kal_int8 index; /* input */
}pmu6238_get_ldo_vol_sel_vsim;

typedef struct
{
    kal_int8 index; /* input */
}pmu6238_set_ldo_vol_sel_vsim;

typedef struct
{
    kal_int8 type; /* input */
    kal_uint8 ldo_voltage; /* output */
}pmu6238_get_ldo_voltage_cal;

typedef struct
{
    kal_int8 type; /* input */
    kal_uint8 ldo_voltage; /* input */
}pmu6238_set_ldo_voltage_cal;

typedef struct
{
    kal_int16 enable; /* ouput */
}pmu6238_get_ldo_enable;

typedef struct
{
    kal_int8 ldo_type; /* input */
    kal_bool enable;  /* input */
}pmu6238_set_ldo_enable;

typedef struct
{
    kal_int8 type;  
    kal_int8 value;  
}pmu6238_get_dc_control;

typedef struct
{
    kal_int8 type;  
    kal_int8 value;  
}pmu6238_set_dc_control;

typedef struct
{
    kal_int8 type; /* input */
    kal_int8 calibration; /* ouput */
}pmu6238_get_bias_current;

typedef struct
{
    kal_int8 type; /* input */
    kal_int8 calibration; /* input */
}pmu6238_set_bias_current;

typedef struct
{
    pmu6238_read_reg_struct read_reg;
    pmu6238_write_reg_struct write_reg;
    pmu6238_chr_state_struct chr_state;
    pmu6238_get_chr_en get_chr_en;
    pmu6238_set_chr_en set_chr_en;
    pmu6238_get_chr_curr get_chr_curr;    
    pmu6238_set_chr_curr set_chr_curr;
    pmu6238_get_chr_curr_offset get_chr_curr_offset;
    pmu6238_set_chr_curr_offset set_chr_curr_offset;
    pmu6238_get_ov_th_freeze get_ov_th_freeze;
    pmu6238_set_ov_th_freeze set_ov_th_freeze;
    pmu6238_get_cv_threshold get_cv_threshold;
    pmu6238_set_cv_threshold set_cv_threshold;
    pmu6238_get_drive_info get_drive_info;
    pmu6238_set_drive_info set_drive_info;
    pmu6238_get_ldo_vol_sel_vbt get_ldo_vol_sel_vbt;
    pmu6238_set_ldo_vol_sel_vbt set_ldo_vol_sel_vbt;  
    pmu6238_get_ldo_vol_sel_vcamd get_ldo_vol_sel_vcamd;
    pmu6238_set_ldo_vol_sel_vcamd set_ldo_vol_sel_vcamd;
    pmu6238_get_ldo_vol_sel_vcama get_ldo_vol_sel_vcama;
    pmu6238_set_ldo_vol_sel_vcama set_ldo_vol_sel_vcama;
    pmu6238_get_ldo_vol_sel_vsim get_ldo_vol_sel_vsim;
    pmu6238_set_ldo_vol_sel_vsim set_ldo_vol_sel_vsim;
    pmu6238_get_ldo_voltage_cal get_ldo_voltage_cal;
    pmu6238_set_ldo_voltage_cal set_ldo_voltage_cal;
    pmu6238_get_ldo_enable get_ldo_enable;
    pmu6238_set_ldo_enable set_ldo_enable;
    pmu6238_get_dc_control get_dc_control;
    pmu6238_set_dc_control set_dc_control;    
    pmu6238_get_bias_current get_bias_current;
    pmu6238_set_bias_current set_bias_current;
...
typedef struct
{
    kal_uint8 register_index[3];/*input*/
	kal_uint8 result[3];/*output*/
}pmu6326_read_reg_struct;

typedef struct
{
	kal_uint8 register_index[3];/*input*/
	kal_uint16 data[3];/*input*/
}pmu6326_write_reg_struct;
