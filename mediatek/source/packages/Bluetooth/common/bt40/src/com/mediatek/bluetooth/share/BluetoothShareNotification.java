...
//		Notification n = NotificationFactory.getProfileNotification( NotificationFactory.NID_SHARE_MGMT_NOTIFICATION );
//		n.icon = R.drawable.bt_share;
//		n.tickerText = context.getString( R.string.bt_share_mgmt_notification_ticker );
...
//		return n;
		...
		//intent.setClassName( Options.APPLICATION_PACKAGE_NAME, BluetoothOppReceiver.class.getName());
