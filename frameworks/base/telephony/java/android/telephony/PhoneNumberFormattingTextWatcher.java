...
/* For test mode(CTA/FTA/IOT), mtk04070, 2012.02.06 */
...
public class PhoneNumberFormattingTextWatcher implements TextWatcher {
    ...
    public PhoneNumberFormattingTextWatcher(String countryCode) {
        /* Get test mode from SystemProperties, mtk04070, 2012.02.06 */
        getTestMode();
    ...
    public synchronized void afterTextChanged(Editable s) {
        /* 
           FTA test : dial number "+0123456789" will be changed to "+123456789",
        ...
        */
        ...
        /// M: Solve [ALPS00342966]Input "0001"/"0007", they will be reformatted to "001"/"007".
        if ((formatted != null) && (!formatted.equalsIgnoreCase(((CharSequence)s).toString()))) {
	...
	if (tmpFormatted != null) {
	   Log.d("reformat", "formatted = [" + formatted + "]");	
