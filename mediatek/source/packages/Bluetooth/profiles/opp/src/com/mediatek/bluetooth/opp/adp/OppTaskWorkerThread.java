...
public class OppTaskWorkerThread extends Thread {
	...
	private boolean hasMoreTask = false;

	private OppTaskHandler handler;
	...
	public void run() {
		...
		// need to increase the priority (higher than message-listener thread) or the event will be queued in EventQueue
		...
		while( !this.isInterrupted() ){
			...
			try {
				...
				OppLog.i( "OppTaskWorkerThread[" + this.getName() + "] interrupted: " + ex.getMessage() );
				break;
			}
		}
