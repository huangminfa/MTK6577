...
public class SimPhotoEditorViewPurple extends PhotoEditorView{
    
    private static final String TAG = "SimPhotoEditorViewPurple";
    ...
    protected void resetDefault() {
        ...
        mPhotoImageView.setImageResource(R.drawable.ic_contact_picture_sim_contact_purple);
