 ...
 */
 class StkAppInstaller {
    ...
    private static void setAppState(Context context, boolean install) {
        ...
        CatLog.d("StkAppInstaller", "Stk1 - setAppState - curState[" + miSTKInstalled + "] to state[" + install + "]" );
        ...
        {
            CatLog.d("StkAppInstaller", "Stk1 - Need not change app state!!");
        } else {
            CatLog.d("StkAppInstaller", "Stk1 - StkAppInstaller - Change app state[" + install + "]");			
