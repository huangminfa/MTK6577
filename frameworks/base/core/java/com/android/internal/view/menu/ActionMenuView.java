    ...
    private void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (!allTextItem) {
                ...
                allTextItem = itemView == null ? false : (itemView.getItemData().getIcon() == null);
            }
        ...
        if (cellsRemaining > 0 && smallestItemsAt != 0 &&
                (cellsRemaining < visibleItemCount - 1 || singleItem || maxCellsUsed > 1 || allTextItem)) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (child instanceof ActionMenuItemView) {
                    ...
                    if (i == 0 && !lp.preventEdgeOffset) {
                        ...
                        if (!singleItem) {
                            lp.leftMargin = -extraPixels / 2;  //if have only one item we don't want to push it out of sight
                        }                        
                    }
                    needsExpansion = true;
