...
public class ContactsSyncAdapter extends AbstractSyncAdapter {
    ...
    @Override
    public void sendSyncOptions(Double protocolVersion, Serializer s, int syncStatus) throws IOException  {
    ...
    public boolean isSyncable() {
        return ContentResolver.getMasterSyncAutomatically()
                && ContentResolver.getSyncAutomatically(mAccountManagerAccount, ContactsContract.AUTHORITY);
    }
   ...
   class EasContactsSyncParser extends AbstractSyncParser {
                        ...
                        try {
                            if (c.moveToFirst()) {
                                ...
                                try {
                                    ...
                                    // close entityIterator to prevent from leaking
    ...
    private void sendPhoto(Serializer s, ContentValues cv) throws IOException {
        if (cv.containsKey(Photo.PHOTO)) {
            ...
            if (bytes.length > PHOTO_SIZE_LIMIT) return;
