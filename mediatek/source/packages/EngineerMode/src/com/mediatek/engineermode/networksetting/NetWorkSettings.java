...
public class NetWorkSettings extends PreferenceActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final long ivsrCheckValue = Settings.System.getLong(
				getContentResolver(), Settings.System.IVSR_SETTING,
				Settings.System.IVSR_SETTING_DISABLE);

		final long croCheckValue = Settings.System.getLong(
				getContentResolver(), Settings.System.CRO_SETTING,
				Settings.System.CRO_SETTING_DISABLE);

		final long hooCheckValue = Settings.System.getLong(
				getContentResolver(), Settings.System.HOO_SETTING,
	...
	public boolean onPreferenceChange(Preference preference, Object newValue) {
		...
		if (preference.getKey().equals(IVSR_PREFERENCE_KEY)) {
			Xlog.i(TAG, "IVSR->onPreferenceChange(): " + newValue);
		...
		} else if (preference.getKey().equals(GCRO_PREFERENCE_KEY)) {
			Xlog.i(TAG, "CRO->onPreferenceChange(): " + newValue);
			if (newValue.equals(false)) {
				Settings.System.putLong(getContentResolver(),
						Settings.System.CRO_SETTING,
						Settings.System.CRO_SETTING_DISABLE);
				phone.setCRO(0, null);
			} else {
				Settings.System.putLong(getContentResolver(),
			...
			Xlog.i(TAG, "HOO->onPreferenceChange(): " + newValue);
			if (newValue.equals(false)) {
				Settings.System.putLong(getContentResolver(),
						Settings.System.HOO_SETTING,
						Settings.System.HOO_SETTING_DISABLE);
				phone.setCRO(2, null);
			} else {
				Settings.System.putLong(getContentResolver(),
