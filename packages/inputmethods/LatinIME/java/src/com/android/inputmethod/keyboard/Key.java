...
public class Key {
    ...
    /** Label's upper case for some complex languages*/
    public final CharSequence mUpperCaseLabel;
    ...
    public Key(Resources res, KeyboardParams params, KeyboardBuilder.Row row,
        ...
        mUpperCaseLabel = style.getText(keyAttr, R.styleable.Keyboard_Key_keyUpperCaseLabel);
