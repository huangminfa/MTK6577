...
public class InstallAppProgress extends Activity implements View.OnClickListener, OnCancelListener {
    ...
    public void initView() {
        ...
        //BEGIN mtk03923 [20120410][ALPS00264011][Rose][ICS][Free Test][packageinstaller]The "JE" about "com.android.packageinstaller" pops up after we tap "Open"(5/5).
        IntentFilter intentFilter = new IntentFilter();
        intentFilter.addAction(Intent.ACTION_PACKAGE_REMOVED);
        //BEGIN mtk03923 [20120523][ALPS00287901][Rose][ICS][MT6577][Free Test][APPIOT]The "Launch" will be displayed in gray after you install one apk twice.(5/5)
        intentFilter.addAction(Intent.ACTION_PACKAGE_ADDED);
        intentFilter.addAction(Intent.ACTION_PACKAGE_REPLACED);
        //END   mtk03923 [20120523][ALPS00287901][Rose][ICS][MT6577][Free Test][APPIOT]The "Launch" will be displayed in gray after you install one apk twice.(5/5)
        ...
        //END   mtk03923 [20120410][ALPS00264011][Rose][ICS][Free Test][packageinstaller]The "JE" about "com.android.packageinstaller" pops up after we tap "Open"(5/5).
    }
