...
public class BackupXmlParser {
	...
	final static int CONTACT = 0X01;
	final static int SMS = 0X02;
	final static int MMS = 0X04;
	final static int CALENDAR = 0X08;
	final static int APP = 0X10;
	final static int PICTURE = 0X20;
    final static int MUSIC = 0X80;
    final static int NOTEBOOK = 0X100;
