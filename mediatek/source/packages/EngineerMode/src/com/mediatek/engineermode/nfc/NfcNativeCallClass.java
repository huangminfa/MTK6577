...
public class NfcNativeCallClass {
	...
	public static native nfc_tag_read_response readTag(
			nfc_tag_read_request req);
	
	public static native nfc_test_response testEntry(
			nfc_test_request req);
	// ========================================================
	...
	public static final int UID_DATA_LEN = (7);
	...
	public static class nfc_setting_request {
		...
		public short[] test1 = new short[16];
		public short[][] test2 = new short[4][4];
	...
	public static class nfc_reg_notif_response {
		...
		public int se_status; /* secure element status, 0:off, 1:Virtual, 2:Wired */
	...
	public static class nfc_tag_det_response {
		...
		{
			String msg = String.format("tag_type %d, card_type %d, uid %s, sak %d, atag %d, appdata %d, maxdatarate %d",
					tag_type, card_type, new String(uid), sak, atag, appdata, maxdatarate);
			Elog.i(TAG, msg);
		}
