...
public class TodoProvider extends ContentProvider{
    ...
    static {
        sUriMatcher.addURI(AUTHORITY, "todos", TODOS);
        sUriMatcher.addURI(AUTHORITY, "todos/#", TODOS_ID);
        sTodoProjectionMap = new HashMap<String, String>();
        sTodoProjectionMap.put(TodoColumn._ID, TodoColumn._ID);
        sTodoProjectionMap.put(TodoColumn.TITLE, TodoColumn.TITLE);
        sTodoProjectionMap.put(TodoColumn.DESCRIPTION, TodoColumn.DESCRIPTION);
        sTodoProjectionMap.put(TodoColumn.PRIORITY, TodoColumn.PRIORITY);
        sTodoProjectionMap.put(TodoColumn.STATUS, TodoColumn.STATUS);
        sTodoProjectionMap.put(TodoColumn.DTEND, TodoColumn.DTEND);
        sTodoProjectionMap.put(TodoColumn.CREATE_TIME, TodoColumn.CREATE_TIME);
        sTodoProjectionMap.put(TodoColumn.COMPLETE_TIME, TodoColumn.COMPLETE_TIME);
