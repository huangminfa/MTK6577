 ...
 *
 * Nov 25 2009 mtk01264
 * [MAUI_01996819] [OCSP] Check-in OCSP for OpenSSL solution
 * Check-in OCSP. Add OCSP module in Certman.
 *
 ...
 *
 * Oct 22 2007 mtk01264
 * [MAUI_00563832] [SSL] New API sec_ssl_want_read() to probe the SSL receiving queue
 * Add sec_ssl_want_read()
 *
 * Oct 19 2007 mtk01264
 * [MAUI_00562116] [SSL] New API to enable/disable SSL plaintext logging mechanism
 * Add mf flag for multiple fragments
 *
 ...
 *
 * Oct 18 2007 mtk01264
 * [MAUI_00562248] [SSL] Add argument checking on sec_ssl_get_certreq_auth_names()
 * Check arguments in sec_ssl_get_certreq_auth_names()
 *
 * Oct 18 2007 mtk01264
 * [MAUI_00562116] [SSL] New API to enable/disable SSL plaintext logging mechanism
 * Send messages in plaintext to SOC
 *
 * Oct 18 2007 mtk01264
 * [MAUI_00561881] [SSL] New API to disable checking client authentication
 * Appliction can issue sec_ssl_disable_client_auth() to disable client auth check on the connection
 *
 * Oct 15 2007 mtk01264
 * [MAUI_00559724] [SSL] Change return code of sec_ssl_ctx_use_privatekey_file()
 * Change return value of loading private key API for consistency
 *
 * Oct 12 2007 mtk01264
 * [MAUI_00559097] [SSL] Add support to load trusted certs in DER format
 * Change return value of sec_ssl_ctx_load_verify_locations()
 *
 * Sep 21 2007 MTK01264
 * [MAUI_00037669] Error in sec_ssl_ctx_load_verify_locations()
 * Duplicate peer struct to ssl global context in wrapper
 *
 * Sep 16 2007 MTK01264
 * [MAUI_00547710] [SSL] New API to extract certificate authorities list from cert req message
 * Add back pointer from context context to global context in SSL layer
 *
 ...
 *
 * Sep 3 2007 MTK01264
 * [MAUI_00541863] [SSL] patch the function squeezing all certs
 * Add comments to header file.
 *
 * Aug 27 2007 MTK01264
 * [MAUI_00538582] [SSL] Identify handshake fail due to client authentication requested
 * Add new error cause to identify handshake error due to no local certificate
 *
 * Aug 27 2007 MTK01264
 * [MAUI_00538469] [SSL] Add argument to set alert reference
 * Add alert reference pointer for sending alert indication
 *
 * Aug 27 2007 MTK01264
 * [MAUI_00538402] [SSL] Add crypto strength enum mapping
 * Add mapping function for crypto strength
 *
 * Aug 20 2007 MTK01264
 * [MAUI_00535209] [SSL] correct return value for SSL APIs
 * Correct return value of SSL APIs
 *
 * Aug 6 2007 MTK01264
 * [MAUI_00530325] [SSL] add warning enum for certification verification
 * Add sec_cert_warn_enum.
 *
 * Aug 3 2007 MTK01264
 * [MAUI_00529649] [SSL] Change prototype of sec_ssl_ctx_set_cipher_list()
 * Change ciphersuites from string to enum
 *
 * Aug 1 2007 MTK01264
 * [MAUI_00528831] [SSL] Add support for setting cipher suites
 * Increase max ciphersuites to 32
 *
