...
enum {
    ...
    NATIVE_WINDOW_SET_S3D_OFFSET			= 15,   // [MTK] for S3D offset control
};
...
struct ANativeWindow
{
  ...
  */
#ifndef ANATIVEWIDNOW
#define ANATIVEWIDNOW
...
//--------------------------------------------------------------------------
static inline int native_window_set_s3d_offset(
        struct ANativeWindow* window,
        int offset)
{
    return window->perform(window, NATIVE_WINDOW_SET_S3D_OFFSET, offset);
}
