...
#include "platform.h"
#include "mt6577_usbd.h"

#if CFG_FPGA_PLATFORM
#include "mt6577_i2c.h"
#endif

#define MT6577_USB20_PHY_BASE  (0xc1260800)
#define MT6577_USB11_PHY_BASE  (0xc1260900)
...
#define USBPHY_READ8(offset)          __raw_readb(MT6577_USB20_PHY_BASE+offset)
#define USBPHY_WRITE8(offset, value)  __raw_writeb(value, MT6577_USB20_PHY_BASE+offset)
...
#define USB11PHY_READ8(offset)          __raw_readb(MT6577_USB11_PHY_BASE+offset)
#define USB11PHY_WRITE8(offset, value)  __raw_writeb(value, MT6577_USB11_PHY_BASE+offset)
