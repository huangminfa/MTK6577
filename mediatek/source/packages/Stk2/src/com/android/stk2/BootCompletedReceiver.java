        ...
        if (action.equals(Intent.ACTION_BOOT_COMPLETED)) {
            ...
            if(SIMID != GEMINI_SIM_2){
                ...
                //deal with SIM1
                    ...
                    if ((StkAppService.isSetupMenuCalled()) && (((IccCard.INTENT_VALUE_ICC_READY).equals(SIMStatus))||((IccCard.INTENT_VALUE_ICC_IMSI).equals(SIMStatus))||((IccCard.INTENT_VALUE_ICC_LOADED).equals(SIMStatus)))) {
                        bUnInstall = false;
                    }
