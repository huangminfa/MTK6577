...
public class SuggestedMemberListAdapter extends ArrayAdapter<SuggestedMember> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (byteArray == null) {
			...
			photoMgr.loadPhoto(icon, photoId, false, false);
            // The following lines are provided and maintained by Mediatek Inc.
//            int simId = member.getSimId();
//            int slotId = member.getSlotId();
//            int i = -1;
//            if (mSimInfoWrapper == null) {
//                mSimInfoWrapper = SIMInfoWrapper.getDefault();
//            }
//            int simType = member.getSimType();
//            if (FeatureOption.MTK_GEMINI_SUPPORT) {
//                Log.i(TAG, "[getView] mSlot = " + slotId);
...
////                    switch (slotId) {
////                        case 0: {
////                            icon.setImageResource(R.drawable.ic_contact_picture_sim1_contact);
////                            break;
////                        }
////                        case 1: {
////                            icon.setImageResource(R.drawable.ic_contact_picture_sim2_contact);
////                            break;
////                        }
////                        default:
...
//                if (slotId >= 0) {
//                    if (i == 0) {
//                        icon.setImageResource(R.drawable.ic_contact_picture_sim_contact_blue);
//                    } else if (i == 1) {
//                        icon.setImageResource(R.drawable.ic_contact_picture_sim_contact_orange);
//                    } else if (i == 2) {
//                        icon.setImageResource(R.drawable.ic_contact_picture_sim_contact_green);
//                    } else if (i == 3) {
//                        icon.setImageResource(R.drawable.ic_contact_picture_sim_contact_purple);
//                    }
//                } else {
//                    icon.setImageResource(R.drawable.ic_contact_picture_holo_light);
//                }
...
//                        || SimCardUtils.SimType.SIM_TYPE_SIM == simType) {
//                    Log.i(TAG, "[getView] simType : " + simType);
//                    icon.setImageResource(R.drawable.ic_contact_picture_sim_contact);
//                } else {
//                    icon.setImageResource(R.drawable.ic_contact_picture_holo_light);
//                }
//            }
    ...
    public class SuggestedMemberFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence prefix) {
            ...
            final String selection = " EXISTS ("
                    + " SELECT "
                    + RawContacts._ID
                    + " FROM raw_contacts WHERE raw_contacts.contact_id=view_contacts._id AND "
                    + accountFilter + ")";
