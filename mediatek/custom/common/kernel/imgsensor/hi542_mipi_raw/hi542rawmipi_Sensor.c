...
//changed by zhiqiang   original 35
	...
	HI542MIPI_write_cmos_sensor(0x0120, 0x00);
	HI542MIPI_write_cmos_sensor(0x0121, 0x2A);
	HI542MIPI_write_cmos_sensor(0x0122, 0xC1);
	HI542MIPI_write_cmos_sensor(0x0123, 0xF4);
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    if(HI542MIPI_5M == HI542MIPI_g_RES) //add start
    {
        ...
        sensor_config_data->Pixels = HI542MIPI_FULL_PERIOD_PIXEL_NUMS + HI542MIPI_FULL_PERIOD_EXTRA_PIXEL_NUMS + HI542MIPI_PV_dummy_pixels;
