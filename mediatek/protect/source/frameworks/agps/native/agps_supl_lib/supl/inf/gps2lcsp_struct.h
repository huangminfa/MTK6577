 ...
 * 
 *
 * Aug 11 2008 mbj06018
 * [MAUI_01100207] [AGPS]modify a defination to provite from memory cruption
 * 
 *
 * Aug 11 2008 mbj06018
 * [MAUI_01100207] [AGPS]modify a defination to provite from memory cruption
 ...
 * 
 *
 * Mar 13 2008 mbj06018
 * [MAUI_00731899] [A-GPS] Navigation data (PMTK710) not complete
 * 
 *
...
#define GPS_QUERY_TIMER_INTERVAL                    1000  //!!== Chiwei[2010/09/24]: 500 -> 1000
...
typedef struct 
{
    ...
    kal_bool    time_assist_meas_valid;
    gps_time_assist_meas_struct time_assist_meas;
...
#if 1//Hiki, add last_assist_data flag for GpsTask to identify wether all assist data has been received.
	kal_uint32  assist_data_mask; // GpsTask will send assist data to Chip when it recv all assist data from RRLP.
    kal_bool fgLastAssist;
#endif
...
typedef struct
{
    ...
    kal_uint32                  interval;           /*if send continue this is the interval with unit is ms*/
    gps_area_direction_enum     direction;          /*start send MSG after enter or leave*/
    union {
        gps_area_shape_circle_struct    circle;
        gps_area_shape_circle_struct    rectangle;
    } choice;
