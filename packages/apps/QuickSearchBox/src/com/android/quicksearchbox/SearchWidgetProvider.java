...
public class SearchWidgetProvider extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (AppWidgetManager.ACTION_APPWIDGET_ENABLED.equals(action)) {
            ...
            /// M: if bundle is null, this broadcast is comes from framework. @{
            String engineName = null;
            Bundle extral = intent.getExtras();
            
            if (null != extral) {
                engineName = extral.getString(SearchEngineItemsController.SEARCH_ENGINE_PREF);
            }
