...
public class NotificationManagerService extends INotificationManager.Stub
{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_PACKAGE_REMOVED)
                ...
                if (action.equals(Intent.ACTION_EXTERNAL_APPLICATIONS_UNAVAILABLE)) {
                    ...
                    ///M: distinguish the state of an application. just remove notificaiton in DISABLED STATE.
                ...
                mCallRinging = (intent.getStringExtra(TelephonyManager.EXTRA_STATE).equals(
            ...
            String tag, int id, int priority, Notification notification, int[] idOut)
    {
        ...
        synchronized (mNotificationList) {
            ...
            if(DBG){
                Log.d(TAG,"mDisabledNotifications="+mDisabledNotifications);
			    Log.d(TAG,"old ="+old );
            ...
            if ((((mDisabledNotifications & StatusBarManager.DISABLE_NOTIFICATION_ALERTS) == 0) || pkg.equals("com.android.mms"))
                    ...
                    && mSystemReady) {
			    if(DBG){
                    Log.d(TAG,"pakage="+pkg);
                    Log.d(TAG,"In NotificationMangerService, this notification soud, leds and vibrate enable");
                }
				...
				if(DBG){
				    Log.d(TAG,"audio="+(audioManager.getRingerMode() != (AudioManager.RINGER_MODE_SILENT)));
				    Log.d(TAG,"useDefaultVibrate="+useDefaultVibrate);
					Log.d(TAG,"notification.vibrate is not null="+(notification.vibrate != null));
				}
                if ((useDefaultVibrate || notification.vibrate != null)
                        && (audioManager.getRingerMode() != (AudioManager.RINGER_MODE_SILENT))) {                  
                    mVibrateNotification = r;
                       Slog.w(TAG, "set vibrate!");
    ...
    private void updateLightsLocked()
    {
        ...
        //we need flash when screen is on
        ...
        if (mLedNotification == null || mInCall || mCallRinging) {            
            ...
            if (mNotificationPulseEnabled) {
                // pulse repeatedly
                Slog.d(TAG, "notification setFlashing ledOnMS = "+ledOnMS + " ledOffMS = "+ ledOffMS);                
