...
public class SmsRegConst {
	 ...
	 * Config files
	 */
	public static final String CONFIG_PATH = "/system/etc/dm/smsSelfRegConfig.xml";
	public static final String SMS_REGIST_ENABLED_PATH = "/data/data/com.mediatek.engineermode/sharefile/cta_cmcc";
