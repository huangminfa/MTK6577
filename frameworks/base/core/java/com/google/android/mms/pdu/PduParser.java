            ...
            switch (headerField) {
                ...
                case PduHeaders.MESSAGE_SIZE:
                {
                    try {
                         ...
                         * 2.RetrivevConf's read status should use column "READ" in table pdu,
                         *   instead of "READ_STATUS" which is null in db*/
                        if (headerField == PduHeaders.DATE && mForRestore == false) {
    ...
    protected static boolean parsePartHeaders(ByteArrayInputStream pduDataStream,
        ...
        while(0 < lastLen) {
            ...
            if (header > TEXT_MAX) {
                ...
                // Check the header whether it is "Content-Id".
                if (true ==
                ...
                // Check the header whether it is "Content-Location".
                if (true ==
                ...
                // Check the header whether it is "Content-Disposition".
                if (true ==
                ...
                // Check the header whether it is "Name".
                if (true ==
