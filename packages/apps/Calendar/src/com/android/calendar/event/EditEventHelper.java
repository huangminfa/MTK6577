...
public class EditEventHelper {
    ...
    static final String[] CALENDARS_PROJECTION = new String[] {
            ...
            Calendars.ACCOUNT_TYPE, ///M:#Guest# 11
    };
    ...
    static final int CALENDARS_INDEX_ACCOUNT_TYPE = 11; ///M:#Guest# 11
    ...
    public static boolean canRespond(CalendarEventModel model) {
        ...
        ///M:#Guest#, we do not allow Local account's event to do response.@{
    ...
    ContentValues getContentValuesFromModel(CalendarEventModel model) {
        ...
        ///M:#Guest# if model's account type is local, do not allow it save attendees info.@{
        if(CalendarContract.ACCOUNT_TYPE_LOCAL.equals(model.mAccountType)) {
