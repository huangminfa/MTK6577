...
void *Read2ndMDVoiceRecordingThread(void *arg)
{
  ...
  while(1){
      ...
      {
         LOGD(AUDMSG"Unable to send ExtMD voice rec data, inStream=NULL!!!\n");
      }
      if(pATCommand->Spc_GetParameters(SPC_GET_PARAMS_REC_STATE) == false){
          LOGE(AUDMSG"Leave Read2ndMDVoiceRecordingThread bRecordState(%d)\n",pATCommand->Spc_GetParameters(SPC_GET_PARAMS_REC_STATE));
          break;
      }/*
      else{
          usleep(20*1000);
...
bool LAD::LAD_SendSphParaProcedure()
{
    ...
    if (pCCCI->A2MBufLock() == false) {
        LOGE(AUDMSG"LAD_SendSphParaProcedure fail to get A2M Buffer for ensuring share buffer control is completed");
    }
    else {
        pCCCI->A2MBufUnLock();
    }
...
bool LAD::LAD_OpenNormalRecPath(int32 format, int32 sampleRate)
{
   ...
   if(Flag_SecondModemPhoneCall == 1){
       LOGD("2nd MD LAD_OpenNormalRecPath: format(%d)/SR(%d)\n", format, sampleRate);
       ...
       if ( ret2 != 0 ){
           LOGE(AUDMSG"Fail to Create 2ndMD_ReadRecDataThread!\n");
       }
       return ret;
   }
#endif
...
bool LAD::LAD_CloseNormalRecPath()
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall == 1){
       LOGD("2nd MD LAD_CloseNormalRecPath");
...
bool LAD::LAD_NormalRecDataSendBack()
{
   ...
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_NormalRecDataSendBack: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
bool LAD::LAD_SetRecDropFrameCount( int32 frame_count)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_SetRecDropFrameCount: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
bool LAD::LAD_PCM2WayPlayOn()
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_PCM2WayPlayOn: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
   if( mPCM2WayState == 0 ) {
...
bool LAD::LAD_PCM2WayPlayOff()
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_PCM2WayPlayOff: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
   if( mPCM2WayState == 0 ) {
...
bool LAD::LAD_PCM2WayRecordOn()
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_PCM2WayRecordOn: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
   if( mPCM2WayState == 0 ) {
...
bool LAD::LAD_PCM2WayRecordOff()
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_PCM2WayRecordOff: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
   if( mPCM2WayState == 0 ) {
...
bool LAD::LAD_PCM2WayOn()
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_PCM2WayOn: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
bool LAD::LAD_PCM2WayOff()
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_PCM2WayOff: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
   mPCM2WayState = 0;
...
bool LAD::LAD_PCM2WayDataSendBack()
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_PCM2WayDataSendBack: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
bool LAD::LAD_PCM2WayDataNotify(uint32 offset, uint32 len)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_PCM2WayDataNotify: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
bool LAD::LAD_DualMic_2WayOn(int WBMode, int PlayRec)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_DualMic_2WayOn: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
   //mPCM2WayState = (PCM2WAY_PLAY_ON | PCM2WAY_REC_ON);
...
bool LAD::LAD_DualMic_2WayOff()
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_DualMic_2WayOff: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
bool LAD::LAD_BGSoundOn()
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_BGSoundOn: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
   pCCCI->mHw->SwitchAudioClock(true);
...
bool LAD::LAD_BGSoundOff()
{
   ...
   if(Flag_SecondModemPhoneCall != 0){
      ...
      LOGD("LAD_BGSoundOff: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
   bool ret;
...
bool LAD::LAD_BGSoundDataNotify(uint32 offset, uint32 len)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_BGSoundDataNotify: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
bool LAD::LAD_BGSoundConfig(uint32 UL_gain, uint32 DL_gain)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_BGSoundConfig: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
bool LAD::LAD_PlaybackTurnOn(int32 data_type)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_PlaybackTurnOn: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
bool LAD::LAD_PlaybackTurnOff()
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_PlaybackTurnOff: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
bool LAD::LAD_PlaybackDataNotify(uint32 offset, uint32 len)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_PlaybackDataNotify: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
bool LAD::LAD_SetOutputVolume(uint32 Gain)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
       LOGD("LAD_SetOutputVolume: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
       return true;
   }
#endif
...
bool LAD::LAD_SetGainTableOutputVolume(int32 Gain)
{
    ...
    Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
    if(Flag_SecondModemPhoneCall != 0){
        LOGD("LAD_SetGainTableOutputVolume: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
        return true;
    }
#endif
...
bool LAD::LAD_SetGainTableMicVolume(int32 Gain)
{
    ...
    Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
    if(Flag_SecondModemPhoneCall != 0){
        LOGD("LAD_SetGainTableMicVolume: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
        return true;
    }
#endif
...
bool LAD::LAD_SetMicrophoneVolume(uint32 Gain)
{
    ...
    Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
    if(Flag_SecondModemPhoneCall != 0){
        LOGD("2nd MD LAD SetMicrophoneVolume (0x%x), gain:%x",A2M_SetMicrophoneVolume,Gain);
...
bool LAD::LAD_MuteMicrophone(bool ENABLE)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
       LOGD("2nd LAD_MuteMicrophone (0x%x), en:%x",A2M_MuteMicrophone,ENABLE);
...
bool LAD::LAD_MuteSpeaker(bool ENABLE)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_MuteSpeaker: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
bool LAD::LAD_SetSidetoneVolume(uint32 Gain)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
     LOGD("2nd MD LAD_SetSidetoneVolume, gain:%x",Gain);
...
bool LAD::LAD_SetOutputDevice(LadOutPutDevice_Line HW_Mode)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("2nd MD LAD_SetOutputDevice (0x%x), HW_Mode:%x",A2M_SetOutputDevice,HW_Mode);
...
*/
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
       LOGD(AUDMSG"2nd MD LAD_SetInputSource, A2M_SetInputSource(0x%x) HW_Mode:%x",A2M_SetInputSource,HW_Mode);
...
bool LAD::LAD_ForceSetInputSource(LadInPutDevice_Line HW_Mode)
{
    ...
    m_InputSrc = (int)HW_Mode;
    LOGD(AUDMSG"LAD_ForceSetInputSource (0x%x), HW_Mode(%x)(%x)",A2M_SetInputSource,HW_Mode,m_InputSrc);
    return pCCCI->SendMessageInQueue(  CCCI_MSG1(A2M_SetInputSource, HW_Mode));
}
...
bool LAD::LAD_SetSpeechMode(ENUM_Speech_Mode Speech_Mode)
{
   ...
   if(Flag_SecondModemPhoneCall != 0){
      ...
      LOGD(AUDMSG"2nd MD LAD_SetSpeechMode, A2M_SetSpeechMode(0x%x) HW_Mode:%x",A2M_SetSpeechMode,Speech_Mode);
...
bool LAD::LAD_Speech_On(int sp_mode)
{
   int mode=0;
    ...
    if(Flag_SecondModemPhoneCall == 1){
       mode = 0;
       LOGD("2nd MD LAD_Speech_On, A2M_Speech_On(0x%x) mode:%x", A2M_Speech_On, mode);
       ...
       LOGE("LAD_Speech_On, A2M_Speech_On(0x%x) Invalid Flag_SecondModemPhoneCall:%d !!!!", A2M_Speech_On,Flag_SecondModemPhoneCall);
       return -1;
    }
#endif
   pCCCI->CheckMDSideSphCoefArrival(); // must pass; otherwise, set wrong speech mode (only this time)
...
bool LAD::LAD_Speech_Off()
{
   ...
   m_InputSrc = (int)0;
    ...
    if(Flag_SecondModemPhoneCall == 1){
        ...
        LOGE("LAD_Speech_Off, A2M_Speech_Off(0x%x) Invalid Flag_SecondModemPhoneCall:%d !!!!", A2M_Speech_Off, Flag_SecondModemPhoneCall);
        return -1;
    }
#endif
...
bool LAD::LAD_Default_Tone_Play(uint8 toneIdx)
{
    int Flag_SecondModemPhoneCall = 0, ret = 0;
    Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
    LOGD("LAD_Default_Tone_Play:Flag_SecondModemPhoneCall(%d), toneIdx(%d)", Flag_SecondModemPhoneCall, toneIdx);
    if(Flag_SecondModemPhoneCall == 0)
    {
        LOGD("LAD_Default_Tone_Play: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
        return true;
    }
    ...
    {
        LOGE("LAD_Default_Tone_Play, Invalid Flag_SecondModemPhoneCall:%d !!!!", Flag_SecondModemPhoneCall);
        return -1;
    }
}
...
bool LAD::LAD_Default_Tone_Stop()
{
    int Flag_SecondModemPhoneCall = 0, ret = 0;
    Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
    LOGD("LAD_Default_Tone_Stop:Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
    if(Flag_SecondModemPhoneCall == 0)
    {
        LOGD("LAD_Default_Tone_Stop: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
        return true;
    }
    else if(Flag_SecondModemPhoneCall == 1)
    {
    ...
    {
        LOGE("LAD_Default_Tone_Stop, Invalid Flag_SecondModemPhoneCall:%d !!!!", Flag_SecondModemPhoneCall);
        return -1;
    }
}
...
bool LAD::LAD_ATCMD_Test()
{
    ...
    LOGD("Test MD LAD_ATCMD_Test, A2M_Speech_On(0x%x) mode:%x", A2M_Speech_On, mode);
    return pATCmd->Spc_Speech_On(mode);  // Stan,  0:2G, 1:3G
}

bool LAD::LAD_SetOutputVolume(uint32 Gain,uint32 routes)
{
    int Flag_SecondModemPhoneCall = 0;
    Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
    if(Flag_SecondModemPhoneCall == 1){
        LOGD("2nd MD LAD_SetOutputVolume, Gain(%d) routes:%x", Gain, routes);
        return pATCmd->Spc_SetOutputVolume(Gain,routes);
    }
    else
    {
        LOGE("1st MD not support LAD_SetOutputVolume, Gain(%d) routes:%x", Gain, routes);
        return false;
    }
}
#endif
...
bool LAD::LAD_SetAfeLoopback(bool bLoopbackOn, bool bSwapADDA, bool bConnectAllADDA)
{
    ...
    Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
    if(Flag_SecondModemPhoneCall != 0){
       LOGD("LAD_SetAfeLoopback: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
       return true;
    }
#endif
...
bool LAD::LAD_SetAcousticLoopback(bool bLoopbackOn, bool bUseDMNR)
{
    ...
    Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
    if(Flag_SecondModemPhoneCall != 0){
       LOGD("LAD_SetAcousticLoopback: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
       return true;
    }
#endif
    pCCCI->CheckMDSideSphCoefArrival(); // must pass; otherwise, set wrong speech mode (only this time)
...
bool LAD::LAD_SetReceiverTest(bool turn_ON)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_SetReceiverTest: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
bool LAD::LAD_Set_DAI_Mode(bool turn_ON)
{
    ...
    Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
    if(Flag_SecondModemPhoneCall != 0){
       LOGD("LAD_Set_DAI_Mode: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
       return true;
    }
#endif
...
bool LAD::LAD_SwitchVCM(int32 TurnOn)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_SwitchVCM: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
bool LAD::LAD_Set_LoudSPK_RefMicMode(bool TurnOn)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_Set_LoudSPK_RefMicMode: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
bool LAD::LAD_SwitchMicBias(int32 TurnOn)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_SwitchMicBias(0x%x), TurnOn:%d, Flag_SecondModemPhoneCall(%d)",A2M_SetMicBias, TurnOn , Flag_SecondModemPhoneCall);
...
int LAD::LAD_SetSpeechParameters(AUDIO_CUSTOM_PARAM_STRUCT* pParam)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_SetSpeechParameters: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
int LAD::LAD_SetDualMicParameters(AUDIO_CUSTOM_EXTRA_PARAM_STRUCT* pParam)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_SetDualMicParameters: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
int LAD::LAD_SetWBSpeechParameters(AUDIO_CUSTOM_WB_PARAM_STRUCT* pWBParam)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_SetWBSpeechParameters: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
   int   ret = true;
...
int LAD::LAD_GetMDCapability(void)
{
    ...
    Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
    if(Flag_SecondModemPhoneCall != 0){
       LOGD("LAD_GetMDCapability: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
       return true;
    }
#endif
    int ret = true;
...
bool LAD::LAD_TtyCtmOn(int tty_mode)
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_TtyCtmOn: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
...
bool LAD::LAD_TtyCtmOff()
{
   ...
   Flag_SecondModemPhoneCall = pCCCI->mHw->GetFlag_SecondModemPhoneCall();
   if(Flag_SecondModemPhoneCall != 0){
      LOGD("LAD_TtyCtmOff: not support! Flag_SecondModemPhoneCall(%d)", Flag_SecondModemPhoneCall);
      return true;
   }
#endif
