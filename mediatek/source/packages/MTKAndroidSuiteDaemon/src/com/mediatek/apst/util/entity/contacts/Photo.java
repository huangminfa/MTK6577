 ...
 * <p>
 * <p>Description: 
 * <p>Photo data of a contact.
 *
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class Photo extends ContactData implements Cloneable {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    public int getRawSize(){
        ...
        // photoBytes
        size += RawTransUtil.sizeOfBytes(this.photoBytes);
        return size;
    }
    */
    //@Override
    public void writeRaw(ByteBuffer buffer) throws NullPointerException{
        ...
        // photoBytes
        RawTransUtil.putBytes(buffer, this.photoBytes);
    }
    ...
    public void readRaw(ByteBuffer buffer) throws NullPointerException{
        ...
        // photoBytes
        this.photoBytes = RawTransUtil.getBytes(buffer);
    }
