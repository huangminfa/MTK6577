...
public:
	...
	status_t setStartTimeOffset(uint64_t time_offset);//added by hai.li to support track time offset
	uint64_t getStartTimeOffset();
    ...
    status_t getMetaDataForSample(
            ...
            off64_t *offset,
            size_t *size,
            uint64_t *compositionTime,     // modify to uint64_t
...
#ifndef ANDROID_DEFAULT_CODE
	uint64_t mStartTimeOffset;//added by hai.li to support track time offset
#endif  //#ifndef ANDROID_DEFAULT_CODE
