...
extern void complain_copyfd_and_die(off_t sz);
...
extern void run_applet_no_and_exit(int a, char **argv);
#endif
...
parser_t* config_open2(const char *filename, FILE* FAST_FUNC (*fopen_func)(const char *path));
