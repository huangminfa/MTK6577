                ...
                if (Intent.ACTION_TIME_TICK.equals(action)
                    ...
                    if(IccCard.INTENT_VALUE_ICC_READY.equals(stateExtra)){
                        if (Phone.GEMINI_SIM_2 == simId) {
                            mPINFlag = mPINFlag & (0x1 << 2 | 0x1 << 0);
                        } else {
                            mPINFlag = mPINFlag & (0x1 << 3 | 0x1 << 1);
                        }  
                    }   
                    //for 00294828
                    Log.i(TAG, "ACTION_SIM_STATE_CHANGED, after stateExtra="+stateExtra+",simId="+simId+", mPINFlag="+mPINFlag);
