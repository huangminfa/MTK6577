...
public class SIM2 extends Activity{
	static final String LOG_TAG = "Dual_Talk_sim2NetworkInfo";
...
public static final int CheckInfomation_ID = Menu.FIRST;
	...
	{
		String mt = SystemProperties.get("gsm.baseband.capability2");
		Log.i(LOG_TAG, "gsm.baseband.capability2 " + mt);
		int mode = MODEM_NO3G;
		if (mt != null) {
			try {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sim2_networkinfo);
	...
	public boolean onOptionsItemSelected (MenuItem aMenuItem) {   
        ...
        switch (aMenuItem.getItemId()) {   
            case CheckInfomation_ID:
                ...
                Intent intent = new Intent(this, Sim2_Info.class);
