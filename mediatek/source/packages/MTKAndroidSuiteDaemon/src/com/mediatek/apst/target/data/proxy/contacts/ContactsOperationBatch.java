 ...
 * <p>Package: com.mediatek.apst.target.proxy.contacts
 * <p>Created on: 2010-8-6
 * <p>
 * <p>Description: 
 * <p>Used to build and apply contacts related content operation batch.
 * <p>
...
public class ContactsOperationBatch extends ContentProviderOperationBatch {
    ...
    // Methods                                                      
    //==============================================================
    public ContentProviderResult[] apply() throws 
    ...
    public boolean appendContactDataInsert(ContactData data){
        ...
        if (data instanceof StructuredName){
            ...
            .withValue(CommonDataKinds.StructuredName.SUFFIX, 
                    name.getSuffix())
            .withValue(CommonDataKinds.StructuredName.PHONETIC_FAMILY_NAME, 
                    name.getPhoneticFamilyName())
            .withValue(CommonDataKinds.StructuredName.PHONETIC_GIVEN_NAME, 
                    name.getPhoneticGivenName())
            .withValue(CommonDataKinds.StructuredName.PHONETIC_MIDDLE_NAME, 
            ...
            .withValue(ContactDataContent.COLUMN_BINDING_SIM_ID, phone.getBindingSimId())
            .build());
            ...
            .withValue(CommonDataKinds.Photo.PHOTO, photo.getPhotoBytes())
            .build());
            ...
            .withValue(CommonDataKinds.Im.DATA, im.getData()) 
            .withValue(CommonDataKinds.Im.TYPE, im.getType()) 
            .withValue(CommonDataKinds.Im.LABEL, im.getLabel())
            ...
            .withValue(CommonDataKinds.Email.DATA, email.getData()) 
            ...
            .withValue(CommonDataKinds.StructuredPostal.STREET, 
                    postal.getStreet())
            .withValue(CommonDataKinds.StructuredPostal.POBOX, 
                    postal.getPobox())
            ...
            .withValue(CommonDataKinds.Organization.TYPE, 
                    organization.getType()) 
            .withValue(CommonDataKinds.Organization.LABEL, 
            ...
            .withValue(CommonDataKinds.Organization.JOB_DESCRIPTION, 
                    organization.getJobDescription())
            .withValue(CommonDataKinds.Organization.SYMBOL, 
                    organization.getSymbol())
            .withValue(CommonDataKinds.Organization.PHONETIC_NAME, 
                    organization.getPhoneticName())
            .withValue(CommonDataKinds.Organization.OFFICE_LOCATION, 
            ...
            .withValue(CommonDataKinds.Nickname.NAME, nickname.getName()) 
            .withValue(CommonDataKinds.Nickname.TYPE, nickname.getType()) 
            .withValue(CommonDataKinds.Nickname.LABEL, nickname.getLabel()) 
            .build());
            ...
            .withValue(CommonDataKinds.Website.LABEL, website.getLabel()) 
            .build());
            ...
            .withValue(CommonDataKinds.Note.NOTE, note.getNote())
            .build());
            ...
            Debugger.logE(new Object[]{data}, "Illegal mime type: " + mimeType);
            return false;
        }
    ...
    public boolean appendContactDataUpdate(long id, ContactData newData){
        ...
        if (newData instanceof StructuredName){
            ...
            Debugger.logE(new Object[]{id, newData}, 
    ...
    public boolean appendRawContactInsert(RawContact rawContact){
        ...
        .withValue(RawContacts.STARRED, rawContact.isStarred())
        // Set new ringtone
        /*.withValue(RawContacts.CUSTOM_RINGTONE, rawContact.getCustomRingtone())*/
        .withValue(RawContacts.SEND_TO_VOICEMAIL,rawContact.isSendToVoicemail())
        .build());
    ...
    public boolean appendSimContactDelete(String name, String number){
        ...
        .withSelection(SimContactsContent.COLUMN_TAG + "='?'", new String[]{name})
        .withSelection(SimContactsContent.COLUMN_NUMBER + "='?'", 
                new String[]{number})
        .build());
    ...
    */
    public boolean appendGroupInsert(Group group){
        ...
        .withValue(Groups.TITLE, group.getTitle())
        .withValue(Groups.NOTES,group.getNotes())
        .build());
    ...
    public boolean appendGroupUpdate(long id, Group group){
        ...
        .withSelection(Groups._ID + "=?", new String[]{String.valueOf(id)})
        .withValue(Groups.TITLE, group.getTitle())
        .withValue(Groups.NOTES, group.getNotes())
        .build());
