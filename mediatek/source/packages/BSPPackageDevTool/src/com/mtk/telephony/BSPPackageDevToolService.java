...
public class BSPPackageDevToolService extends Service {
    ...
    private PhoneStateListener mPhone1StateListener = new PhoneStateListener() {
        ...
        public void onSignalStrengthsChanged(SignalStrength signalStrength) {
            ...
            updateNotifications(Phone.GEMINI_SIM_1);
        }
    ...
    private PhoneStateListener mPhone2StateListener = new PhoneStateListener() {
        ...
        public void onSignalStrengthsChanged(SignalStrength signalStrength) {
            ...
            updateNotifications(Phone.GEMINI_SIM_2);
        }
    ...
    public void onCreate() {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, BSPPackageDevToolActivity.class), 0);
