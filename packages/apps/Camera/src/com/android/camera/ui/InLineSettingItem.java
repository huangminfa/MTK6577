...
public abstract class InLineSettingItem extends LinearLayout {
    ...
    public void overrideSettings(String value) {
        ...
        if (mPreference != null) {
        	mPreference.setOverrideValue(value);
        }
        updateView();
    }
    
    //Mediatek merge begin
    public void overrideSettings(String value, String[] values) {
    	
    }
    
    public String getOverridValue() {
    	if (mPreference != null) {
    		return mPreference.getOverrideValue();
    	} 
    	return null;
    }
    //Mediatek merge end
