...
U32 pmic6329_init (void)
{
    ...
    ret_val =pmic_config_interface(0x44,0x17,0x1F,0x0);
    ret_val =pmic_config_interface(0x45,0x17,0x1F,0x0);
    ret_val =pmic_config_interface(0x46,0x17,0x1F,0x0);
    ret_val =pmic_config_interface(0x47,0x17,0x1F,0x0);
    ret_val =pmic_config_interface(0x48,0x17,0x1F,0x0);
    ret_val =pmic_config_interface(0x49,0x17,0x1F,0x0);
    ret_val =pmic_config_interface(0x4A,0x17,0x1F,0x0);
    ret_val =pmic_config_interface(0x8A,0x17,0x1F,0x0);
    ret_val =pmic_config_interface(0x8B,0x17,0x1F,0x0);
    printf("[pmic6329_init] All VPROC and VM12_INT => P.K.\n");
#else
...
int mt6577_detect_powerkey(void)
{
	...
	if (data & (BANK_0_PWRKEY_DEB_MASK << BANK_0_PWRKEY_DEB_SHIFT)){     
        printf("[PreLoader_mt6577_detect_powerkey] Release\n");
        //return 1;
        return 0;
    }else{
        printf("[PreLoader_mt6577_detect_powerkey] Press\n");
        //return 0;
        return 1;
    }
#endif
...
void hw_set_cc(int cc_val)
{
	...
	ret_val=pmic_config_interface(0x38, 0x01, 0x01, 0x02);
        ...
        if(hw_charger_ov_flag == 1)
        {
             ...
             printf("[PreLoader_mt6577_charger_ov]turn off charging \n"); 
              return;
        }
