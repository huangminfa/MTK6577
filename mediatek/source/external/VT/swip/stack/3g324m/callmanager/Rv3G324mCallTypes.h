...
#define RV_MPC_AUDIO_TYPES 0x06
#define RV_MPC_VIDEO_TYPES 0x38
...
typedef enum
{
    ...
    Rv3G324mCallParamSetDefaultControlPeerNSRPSupport /* Initialize MTK variable in control */
} Rv3G324mCallParam;
...
/******************************************************************************
 * Rv3G324mCallSetMonaMPCChannelEv
 * ----------------------------------------------------------------------------
 ...
 * Return Value: RV_OK on success. Other values on failure.
 *****************************************************************************/
typedef void (RVCALLCONV * Rv3G324mCallSetMonaMPCChannelEv) (
    IN  HAPPCALL                h3G324mAppCall,
    IN  HCALL                   h3G324mCall,
...
/******************************************************************************
 * Rv3G324mCallRemoveMonaMPCChannelEv
 * ----------------------------------------------------------------------------
 * General: Callback function 
 * 
 * Arguments:
 ...
 * Return Value: RV_OK on success. Other values on failure.
 *****************************************************************************/
typedef void (RVCALLCONV * Rv3G324mCallRemoveMonaMPCChannelEv) (
    IN  HAPPCALL                h3G324mAppCall,
    IN  HCALL                   h3G324mCall,
...
typedef struct
{
    ...
    Rv3G324mCallSetMonaMPCChannelEv             pfnSetMonaMPCChannelEv;
    Rv3G324mCallRemoveMonaMPCChannelEv      pfnRemoveMonaMPCChannelEv;
#endif /* USE_MONA */
} Rv3G324mCallEvHandlers;
