...
typedef enum
{
    ...
    //[MTK81058/20110525]: two states added for CMCC
...
/* MTK */
typedef int
    (RVCALLCONV *cmEvCallCapabilitiesMuxCapT)(
        IN      HAPPCALL            haCall,
...
/* MTK */
typedef int 
    (RVCALLCONV *cmEvCallRequestMultiplexEntryResponseT)(
        IN      HAPPCALL            haCall,
        IN      HCALL               hsCall,
        IN      RvBool              isACK,  /*if RV_TRUE = MESACK , RV_FALSE = MESReject*/
        IN      RvUint16            includedEntries,
...
typedef int
    (RVCALLCONV *cmEvCallRequestMultiplexEntryT)(
        IN      HAPPCALL            haCall,
        IN      HCALL               hsCall,
        IN      RvPvtNodeId         descriptors);

typedef int
    (RVCALLCONV *cmEvCallSendTerminalCapabilitySetT)(
        IN      HAPPCALL            haCall,
        IN      HCALL               hsCall);
...
typedef  struct
{
    ...
    /* MTK */
    cmEvCallCapabilitiesMuxCapT         cmEvCallCapabilitiesMuxCap;    
    /* MTK */
    ...
    /* MTK */
    cmEvCallRequestMultiplexEntryResponseT cmEvCallRequestMultiplexEntryResponse;
    cmEvCallRequestMultiplexEntryT         cmEvCallRequestMultiplexEntry;
    cmEvCallSendTerminalCapabilitySetT		cmEvCallSendTerminalCapabilitySet;
    /* MTK */
...
typedef void
    (RVCALLCONV *cmEvMPCChannelCloseT)(
        IN      HAPPCHAN                    haChan,
        IN      HCHAN                          hsChan, 
        IN      RvInt32                         lcn,
...
typedef struct
{
    ...
    cmEvMPCChannelCloseT                   cmEvMPCChannelClose;
#endif
...
RVAPI int RVCALLCONV 
cmCallGetLocalCapabilityNodeId(
               IN      HCALL                hsCall,
               OUT     RvPvtNodeId          *capId);
...
RVAPI
int RVCALLCONV cmChannelIsNullData(                 
         IN     HCHAN               hsChan);
