...
/**
 * Class Name: CalendarSlowSyncAddEventsReq
 * <p>Package: com.mediatek.apst.util.command.sync
 * <p>Created on: 2011-05-27
 * <p>
 * <p>Description: 
 * <p>Request for adding events in slow sync.
 * <p>
 * @author mtk81022 Shaoying Han
 * @version V1.0
 */
public class CalendarSlowSyncAddEventsReq extends RawBlockRequest {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    // Constructors                                                 
    //==============================================================
    public CalendarSlowSyncAddEventsReq(){
    ...
    public static class Builder extends RawBlockRequest.Builder {
        ...
        protected RawBlockRequest onCreateCommand(int featureId){
            return new CalendarSlowSyncAddEventsReq();
        }
         ...
         */
        public Builder appendEvent(CalendarEvent event, int versionCode) 
        throws BufferOverflowException {
            buffer().mark();
            try {
                if (0 == count){
        ...
        /**
         * Returns a CalendarSlowSyncAddEventsReq with data supplied 
         * to the builder.
         * @return The CalendarSlowSyncAddEventsReq instance.
         */
        public CalendarSlowSyncAddEventsReq build(){
            ...
            return (CalendarSlowSyncAddEventsReq)super.build();
        }
