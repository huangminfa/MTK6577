...
*/
    ...
    {RIL_REQUEST_MOBILEREVISION_AND_IMEI, dispatchInts, responseStrings, RIL_CMD_PROXY_3}//Add by mtk80372 for Barcode Number    
#else
    ...
    {RIL_REQUEST_SETUP_DATA_CALL, dispatchStrings, responseSetupDataCall, RIL_CMD_PROXY_3},
    ...
    {RIL_REQUEST_DEACTIVATE_DATA_CALL, dispatchStrings, responseVoid, RIL_CMD_PROXY_3},
    ...
    {RIL_REQUEST_LAST_DATA_CALL_FAIL_CAUSE, dispatchVoid, responseInts, RIL_CMD_PROXY_3},
    {RIL_REQUEST_DATA_CALL_LIST, dispatchVoid, responseDataCallList, RIL_CMD_PROXY_3},
    {RIL_REQUEST_RESET_RADIO, dispatchVoid, responseVoid, RIL_CMD_PROXY_1},
    {RIL_REQUEST_OEM_HOOK_RAW, dispatchRaw, responseRaw, RIL_CMD_PROXY_3},
