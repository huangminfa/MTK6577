...
public class ContactListItemView extends ViewGroup
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mContactExtention.measureExtentionIcon(mExtentionIcon);
        /*
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
      ...
      rightBound = mContactExtention.layoutExtentionIcon(leftBound, topBound, bottomBound, rightBound,mGapBetweenImageAndText,mExtentionIcon);
...
//        setSnippet(snippet);
    ...
    public void getExtentionIcon() {
        ...
        if(icon == null && null != ContactExtentionForRCS.getContactPlugin()){
            icon = ContactExtentionForRCS.getContactPlugin().getAppIcon();
            Log.i(TAG,"[getExtentionIcon] icon : "+icon);
        }
