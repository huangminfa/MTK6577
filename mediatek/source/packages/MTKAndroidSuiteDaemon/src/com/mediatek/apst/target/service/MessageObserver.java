...
ISelfChangeObserver {
    ...
    public void onChange(boolean selfChange) {
        ...
        Debugger.logW(new Object[]{selfChange}, "maxSentSmsId = " + maxSentSmsId);
        if (mObservering){
            if (!isSelfChangingContent()){
                ...
                if (maxSentSmsId > mMaxSentSmsId){
                    ...
                    EventDispatcher.dispatchSmsInsertedEvent(
                            new Event()
                            .put(ISmsListener.BY_SELF, false)
                            .put(ISmsListener.SMS, newSmsSent));
                }
            } else {
                Debugger.logI(new Object[]{selfChange}, 
