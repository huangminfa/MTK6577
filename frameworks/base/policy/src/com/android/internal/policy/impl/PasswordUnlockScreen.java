...
public class PasswordUnlockScreen extends LinearLayout implements KeyguardScreen,
    ...
    public PasswordUnlockScreen(Context context, Configuration configuration,
        ...
        if (enableScreenRotation)
        {
         if (mCreationOrientation != Configuration.ORIENTATION_LANDSCAPE) {
            if (FeatureOption.MTK_GEMINI_SUPPORT){
                Log.i(TAG, "we will initialize the password gemini portrait layout");
                layoutInflater.inflate(R.layout.keyguard_screen_password_portrait_gemini, this, true);
            } else {
                Log.i(TAG, "we will initialize the password portrait layout");
                layoutInflater.inflate(R.layout.keyguard_screen_password_portrait, this, true);
            }
          } else {
            if (FeatureOption.MTK_GEMINI_SUPPORT){
                Log.i(TAG, "we will initialize the password gemini land layout");
                layoutInflater.inflate(R.layout.keyguard_screen_password_landscape_gemini, this, true);
            } else {
                Log.i(TAG, "we will initialize the password portrait layout");
        ...
        mKeyboardView = (PasswordEntryKeyboardView) findViewById(R.id.keypad);
        ...
        if (mUpdateMonitor.DM_IsLocked()){//DM mode
           Log.i(TAG, "passworkunlock dm mode is enable");
           View unlockView = findViewById(R.id.unlock_widget);
    ...
    public void onKeyboardChange(boolean isKeyboardOpen) {
        ...
        boolean invisible = isKeyboardOpen || mUpdateMonitor.DM_IsLocked();
        mKeyboardView.setVisibility(invisible ? View.INVISIBLE : View.VISIBLE);
    }
    ...
    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
        ...
        if (actionId == EditorInfo.IME_NULL || actionId == EditorInfo.IME_ACTION_DONE
            ...
            if (imm != null && imm.isActive(v)) {
               Log.i(TAG, "onEditorAction, IME is showing, we should hide it");
