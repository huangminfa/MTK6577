...
typedef enum
{
	CUSTOME_SETTING, //custome setting 
...
// Bitstream Buffer Full (begin) [HungChih Lin]    // for MT6575 MP4 Video Encoder Drop Frame    
    VCODEC_ENC_BS_BUFFER_FULL
// Bitstream Buffer Full (end) [HungChih Lin]    // for MT6575 MP4 Video Encoder Drop Frame    
} VCODEC_ENC_ERROR_T;
