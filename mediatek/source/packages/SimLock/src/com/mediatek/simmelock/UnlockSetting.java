...
public class UnlockSetting extends Activity implements DialogInterface.OnKeyListener
{
                    ...
                    else
                    {
                    	...
                    	if (intSIMNumber == 0)
                    	{
                    		...
                    		//editPwdProcess(et, "12345678");       	//compare with the true password "lockPassword"	
                       	      mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(lockCategory,0,etPwd.getText().toString(),null,null,null,callback);
                    	}
                    	else
                    	{
                    		 Message callback = Message.obtain(mHandler,  UNLOCK_ICC_SML_COMPLETE);
                    		...
                    		//editPwdProcess(et, "12345678");       	//compare with the true password "lockPassword"	
                        	mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).setIccNetworkLockEnabled(lockCategory,0,etPwd.getText().toString(),null,null,null,callback);
                    	}
    ...
    protected void onResume(){
        ...
        else
        {
        	...
        	if (intSIMNumber == 0)
        	{
        		mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).QueryIccNetworkLock(lockCategory,0,null,null,null,null,callback3);
   
        	}
        	else
        	{
        		mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).QueryIccNetworkLock(lockCategory,0,null,null,null,null,callback3);
	...
	protected void  showAlertDialog(int id) {
    	...
    	if(id == DIALOG_UNLOCKFAILED ||id == DIALOG_PASSWORDLENGTHINCORRECT||id == DIALOG_UNLOCKSUCCEED||id == DIALOG_QUERYFAIL){
    	...
    	case DIALOG_UNLOCKFAILED: //password is wrong
    		{
    	    	...
    	    	.setMessage(R.string.strUnlockFail)
    	    	.setOnKeyListener(this)
    	    	.setNegativeButton(R.string.strYes, new DialogInterface.OnClickListener() 
    	    	{			
...
//	            		etPwdLeftChances.setText(String.valueOf(mPwdLeftChances));
    	...
    	case DIALOG_UNLOCKSUCCEED://Length is incorrect
	    	...
	    	AlertDialog succeedDialog =builder.setCancelable(false)
	    	.setTitle(R.string.strAttention)
	    	.setIcon(android.R.drawable.ic_dialog_alert)
	    	.setMessage(R.string.strUnlockSucceed)
	    	.setOnKeyListener(this)
    	...
    	.setTitle(R.string.strAttention)
    	.setIcon(android.R.drawable.ic_dialog_alert)
    	.setMessage(R.string.strQueryFailed)
    	.setOnKeyListener(this)
    	.setNegativeButton(R.string.strYes, new DialogInterface.OnClickListener() 
    		{			
			public void onClick(DialogInterface dialog, int id) 
