    ...
    public void setPhoneCallDetails(CallLogListItemView views, PhoneCallDetails details,
        ...
        */
        ...
        if (!TextUtils.isEmpty(details.number)
             ...
             * M:AAS
             */
            int slot = SIMInfo.getSlotById(mContext, details.contactSimId);
            ...
            if(OperatorUtils.isAasEnabled(accountType)) {
                numberFormattedLabel = USIMAas.getUSIMAASById(slot, details.numberType);
                Log.i(TAG,"AAS: getUSIMAASById, label = " + numberFormattedLabel);//TODO:remove it.
            } else {
            /*
             ...
             */
                 ...
                 * details.numberType, details.numberLabel); Descriptions:When
                 * the number type is custom, show "Custom",not the custom
                 * number
                 * */
