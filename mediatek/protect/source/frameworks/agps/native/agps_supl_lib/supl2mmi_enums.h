 ...
 * [MAUI_00774559] [AGPS] decode client name and notification incorrectly
 * 
 *
 * May 13 2008 mtk00563
 * [MAUI_00770930] [AGPS] Revise notification display when client name and requestor id are both empty
 * 
 *
...
#if 1 //!!== Chiwei [2010/11/16]: bit field should not overlap ==
#define SUPL_MMI_COMP_SUPP_NWK_INFO             0x0020  /* SUPL component: SUPPORT NETWORK INFO */
#else
