...
/**
 * Class Name: ContactsFastSyncDeleteContactsReq
 * <p>Package: com.mediatek.apst.util.command.sync
 * <p>Created on: 2010-12-20
 * <p>
 * <p>Description: 
 * <p>Request for deleting multiple contacts in fast sync.
 * <p>
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class ContactsFastSyncDeleteContactsReq extends RequestCommand {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    // Constructors                                                 
    //==============================================================
    public ContactsFastSyncDeleteContactsReq(){
        super(FEATURE_SYNC);
    }
