...
static item_t ftm_menu_items[] = {
    ...
    item(ITEM_FULL_TEST, "Full Test"),
    item(ITEM_ITEM_TEST, "Item Test"),
    item(ITEM_REPORT,    "Test Report"),
#ifdef FEATURE_FTM_CLEARFLASH
    item(ITEM_CLRFLASH,  "Clear Flash"),
#endif
#ifdef FEATURE_FTM_CLEAREMMC
    item(ITEM_CLREMMC,  "Clear eMMC"),
#endif
    item(ITEM_VERSION,   "Version"),    
    item(ITEM_REBOOT,    "Reboot"),
...
static item_t ftm_test_items[] = {
    ...
    item(ITEM_JOGBALL, "Jogball"),
#endif
#ifdef FEATURE_FTM_OFN;
    item(ITEM_OFN,     "OFN"),
#endif
#ifdef FEATURE_FTM_TOUCH
    item(ITEM_TOUCH,   "Touch Panel"),
#endif
#ifdef FEATURE_FTM_LCD
    item(ITEM_LCD,     "Backlight Level"),
#endif
#ifdef FEATURE_FTM_FLASH
    item(ITEM_FLASH,   "Nand Flash"),
#endif
    ...
    item(ITEM_MEMCARD, "Memory Card"),
#endif
#ifdef FEATURE_FTM_SIMCARD
    item(ITEM_SIMCARD, "SIM Card"),
#endif
#ifdef FEATURE_FTM_SIM
    item(ITEM_SIM, "SIM Detect"),
#endif
#endif
...
#else
    item(ITEM_SIGNALTEST, "Signaling Test"),
#endif
//#endif
#ifdef FEATURE_FTM_VIBRATOR
    item(ITEM_VIBRATOR,"Vibrator"),
#endif
    ...
    item(ITEM_RINGTONE,"Ringtone"),
    item(ITEM_RECEIVER,"Receiver"),
    item(ITEM_LOOPBACK,"Loopback"),
#ifdef FEATURE_FTM_ACSLB
	item(ITEM_ACOUSTICLOOPBACK,"Dual-Mic Acoustic Loopback"),
#endif
  #ifdef FEATURE_FTM_PHONE_MIC_HEADSET_LOOPBACK
    item(ITEM_LOOPBACK1,"Loopback-PhoneMic_HesdsetLR"),
  #endif
  #ifdef FEATURE_FTM_PHONE_MIC_SPEAKER_LOOPBACK
    item(ITEM_LOOPBACK2,"Loopback-PhoneMic_SpeakerLR"),
  #endif  
  #ifdef FEATURE_FTM_HEADSET_MIC_SPEAKER_LOOPBACK
    item(ITEM_LOOPBACK3,"Loopback-HeadsetMic_SpeakerLR"),
  #endif
  #ifdef FEATURE_FTM_WAVE_PLAYBACK
    item(ITEM_WAVEPLAYBACK,"WavePlayback"),
  #endif
#endif //FEATURE_FTM_AUDIO

#ifdef FEATURE_FTM_HEADSET
    item(ITEM_HEADSET, "Headset"),
#endif
#ifdef FEATURE_FTM_SPK_OC
    item(ITEM_SPK_OC, "Speaker OC Test"),
#endif
    ...
    item(ITEM_GSENSOR, "G-Sensor"),
#endif
#ifdef CUSTOM_KERNEL_ACCELEROMETER
    item(ITEM_GS_CALI, "G-Sensor Calibration"),
#endif    
#ifdef CUSTOM_KERNEL_MAGNETOMETER
    item(ITEM_MSENSOR, "M-Sensor"),
#endif
#ifdef CUSTOM_KERNEL_ALSPS
    item(ITEM_ALSPS,   "ALS/PS"),
#endif
#ifdef CUSTOM_KERNEL_BAROMETER
    item(ITEM_BAROMETER, "Barometer"),
#endif
#ifdef CUSTOM_KERNEL_GYROSCOPE
    item(ITEM_GYROSCOPE, "Gyroscope"),
    item(ITEM_GYROSCOPE_CALI, "Gyroscope Calibration"),
#endif
#ifdef FEATURE_FTM_MAIN_CAMERA
    item(ITEM_MAIN_CAMERA,  "Main Camera"),
#endif
#ifdef FEATURE_FTM_SUB_CAMERA
    item(ITEM_SUB_CAMERA, "Sub Camera"),
#endif 
    ...
    item(ITEM_FM,      "FM Radio"),
#endif
#endif
#ifdef FEATURE_FTM_FMTX
#ifdef MTK_FM_TX_SUPPORT
    item(ITEM_FMTX, "FM Transmitter"),
#endif
#endif
#endif
...
static int create_verinfo(char *info, int size)
{
...
#ifdef MTK_DT_SUPPORT
	fd2= openDeviceWithDeviceName("/dev/ttyMT0");
	if(-1 == fd2) {
    ...
    if(kernel_ver_fd!=-1) {
        read(kernel_ver_fd, kernel_ver, 128);
        close(kernel_ver_fd);
    }
...
static int item_test_report(item_t *items, char *buf, int bufsz)
{
    ...
    init_text(&tr_title, "Test Report", COLOR_YELLOW);
...
static int item_test_mode(char *buf, int bufsz)
{
    ...
    init_text(&title, "Item Test", COLOR_YELLOW);
...
int main(int argc, char **argv)
{
    ...
    init_text(&ftm_title, "Factory Mode", COLOR_YELLOW);
    init_text(&vi_title, "Version", COLOR_YELLOW);
    init_text(&rbtn, "Back", COLOR_YELLOW);
