...
typedef union
{
  VCODEC_ENC_GENERAL_SETTING_T   rMPEG4;
...
typedef struct
{
    ...
    void         (*pfnSetYUVBuffer)                  (IN HANDLE                              /* hDrv */, 
                                                      IN VCODEC_DEC_YUV_BUFFER_PARAM_T *  /* prYUVParam */
                                                      );
                                                      
    void         (*pfnGetYUVBuffer)                  (IN  HANDLE                             /* hDrv */,                                                       
...
#define MAX_BITSTREAM_BUFFER_INFO_NUM 4
#define MAX_REF_FREE_YUV_BUFFER_NUM 16
