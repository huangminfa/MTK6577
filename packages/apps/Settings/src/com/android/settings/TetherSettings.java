...
public class TetherSettings extends SettingsPreferenceFragment
    ...
    private static final String TETHER_APN_SETTING = "tether_apn_setting";
    ...
    private PreferenceScreen mTetherApnSetting;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mTetherApnSetting = (PreferenceScreen) findPreference(TETHER_APN_SETTING);
        ...
        if (wifiAvailable && !Utils.isMonkeyRunning()&&(FeatureOption.MTK_WIFI_HOTSPOT_SUPPORT == true)) {
        ...
        if(!FeatureOption.MTK_DEDICATEDAPN_SUPPORT && mTetherApnSetting != null){
            getPreferenceScreen().removePreference(mTetherApnSetting);
        }
    ...
    private void initWifiTethering() {
        ...
        if (mWifiConfig == null) {
            String s="";
            if(Utils.isCmccLoad()){
                 s = activity.getString(R.string.wifi_tether_configure_ssid_default_for_cmcc);
            }else{
    ...
    private class TetherChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context content, Intent intent) {
            ...
            if (action.equals(ConnectivityManager.ACTION_TETHER_STATE_CHANGED)) {
                ...
                SXlog.d(TAG, "TetherChangeReceiver - ACTION_TETHER_STATE_CHANGED");
                ...
                SXlog.d(TAG, "TetherChangeReceiver - ACTION_USB_STATE mUsbConnected: " + mUsbConnected + ", mUsbConfigured:  " + mUsbConfigured + ", mUsbHwDisconnected: " + mUsbHwDisconnected);
                if (mUsbConnected && mUsbConfigured && !mUsbHwDisconnected) mUsbTetherCheckEnable = true;
                updateState();
    ...
    private void updateUsbState(String[] available, String[] tethered,
        ...
        if (usbTethered) {
            ...
            mUsbTethering = false;
            SXlog.d(TAG, "updateUsbState - usbTethered - mUsbTetherCheckEnable: " + mUsbTetherCheckEnable);
            ...
            SXlog.d(TAG, "updateUsbState - usbAvailable - mUsbConfigured:  " + mUsbConfigured + " mUsbTethering: " + mUsbTethering + " mUsbTetherCheckEnable: " + mUsbTetherCheckEnable);
        } else if (usbErrored) {
            mUsbTether.setSummary(R.string.usb_tethering_errored_subtext);
            ...
            SXlog.d(TAG, "updateUsbState - usbAvailable - mUsbHwDisconnected:  " + mUsbHwDisconnected);
        }
    }
    ...
    private void updateBluetoothState(String[] available, String[] tethered,
        ...
        } else if (btState == BluetoothAdapter.STATE_ON && mBluetoothPan.isTetheringOn() && mBluetoothDun.isTetheringOn()) {
            mBluetoothTether.setChecked(true);
