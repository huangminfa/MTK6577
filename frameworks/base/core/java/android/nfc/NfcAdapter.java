...
public final class NfcAdapter {
    ...
    private static boolean hasNfcFeature() {
        ...
        Log.e(TAG, "This line is just for test");
        if (pm == null) {
    ...
    /** @hide */
    public static final int CARDMODE_OFF = 0;
    /** @hide */
    public static final int CARDMODE_ALWAYS_ENABLED = 1;
    /** @hide */
    public static final int CARDMODE_ENABLED_WHEN_SCREEN_ON = 2;
    /** @hide */
    public static final int CARDMODE_ENABLED_WHEN_SCREEN_UNLOCK = 3;

    /**
	 * [MTK only] Query current setting for card emulation.
	 *
	 * @return CARDMODE_OFF or CARDMODE_ENABLED_WHEN_SCREEN_UNLOCK or CARDMODE_ENABLED_WHEN_SCREEN_ON or CARDMODE_ALWAYS_ENABLED
     *
	 * @hide
	 */
    public int getCardEmulationConfig() {
		try {
			return sService.getCardEmulationConfig();
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return CARDMODE_OFF;
        }
    ...
    /**
	 * [MTK only] Set configuration to card emulation.
	 *
	 * @param CARDMODE_OFF or CARDMODE_ENABLED_WHEN_SCREEN_UNLOCK or CARDMODE_ENABLED_WHEN_SCREEN_ON or CARDMODE_ALWAYS_ENABLED
     *
	 * @hide
	 */
    public boolean setCardEmulationConfig(int config) {
		try {
			return sService.setCardEmulationConfig(config);
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return false;
        }
	...
	/**
	 * [MTK only] Query whether the P2p receive is enabled.
	 *
	 * <p>P2pRecv controls the "receive" function and "NdefPush" control the "send" function.
	 * Please refers to {@linke #isNdefPushEnabled}.
	 *
	 * @return whether the P2p receive is enabled.
	 *
	 * @hide
	 */
	public boolean isP2pRecvEnabled() {
		try {
			return sService.isP2pRecvEnabled();	
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return false;
		}
	...
	/**
	 * [MTK only] Enable NFC P2p receiving from other device.
	 *
	 * <p>If the function is called when NFC is on, the P2p recv will be switch immediately.
	 * Otherwise, this instruction will be applied when next time the NFC is on.
	 *
	 * @return true for success, false if something bad happened.
	 *
	 * @hide
	 */
	public boolean enableP2pRecv() {
		try {
			return sService.enableP2pRecv();
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return false;
		}
	...
	/**
	 * [MTK only] Disable NFC P2p receiving from other device.
	 *
	 * <p>If the function is called when NFC is on, the P2p recv will be switch immediately.
	 * Otherwise, this instruction will be applied when next time the NFC is on.
	 *
	...
	public boolean disableP2pRecv() {
		try {
			return sService.disableP2pRecv();
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return false;
		}
	...
	/**
	 * [MTK only] Query whether the NFC reader/writer mode is enabled.
	 *
	 * @return true if the NFC reader/writer mode is turned on.
	 *
	 * @hide
	 */
	public boolean isTagRwEnabled() {
		try {
			return sService.isTagRwEnabled();
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return false;
		}
	...
	/**
	 * [MTK only] Enable the NFC reader/writer mode functionality.
	 *
	 * <p>If this function is called when NFC is on, the Tag Reader Writer function
	 * will be switch immediately. Otherwise, this instruction will be applied when next 
	 * time the NFC is on.
	 *
	 * @return true for success, false if something bad heppened.
	 *
	 * @hide
	 */
	public boolean enableTagRw() {
		try {
			return sService.enableTagRw();
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return false;
		}
	...
	/**
	 * [MTK only] Disable the NFC reader/writer mode functionality.
	 *
	 * <p>If this function is called when NFC is on, the Tag Reader Writer function
	 * will be switch immediately. Otherwise, this instruction will be applied when next 
	 * time the NFC is on.
	...
	/**
	 * [MTK only] Query the behavior for automatically switch off NFC when enter
	 * airplane mode.
	 *
	 * <p>During original Google design, the NFC is turned off immediately after the device
	 * enter airplane mode. This hehavior can be disabled by {@link #disableAirplaneModeAutoSwitch}
	 * and enabled by {@linke #enableAirplaneModeAutoSwitch}.
	 *
	 * @return true if this autoswitch is enabled, false if not.
	 *
	 * @hide
	 */
	public boolean isAirplaneModeAutoSwitchEnabled() {
		try {
			return sService.isAirplaneModeAutoSwitchEnabled();
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return false;
		}
	...
	/**
	 * [MTK only] Enable the behavior for automatically switch off NFC when enter airplane mode.
	 *
	 * @return true for success, false if something bad happened.
	 *
	 * @hide
	...
	public boolean enableAirplaneModeAutoSwitch() {
		try {
			return sService.enableAirplaneModeAutoSwitch();
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return false;
		}
	...
	/**
	 * [MTK only] Disable the behavior for automatically switch off NFC when enter airplane mode.
	 *
	 * @return true for success, false if something bad happened.
	 *
	 * @hide
	...
	public boolean disableAirplaneModeAutoSwitch() {
		try {
			return sService.disableAirplaneModeAutoSwitch();
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return false;
		}
	...
	/**
	 * [MTK only] Query whether the NFC P2p can be transmitted in bitrate 106 kbps.
	 *
	 * @return true if we allow 106 kbps, false for denying the 106 kbps.
	 *
	 * @hide
	 */	
	public boolean isP2pBitrate106Enabled() {
		try {
			return sService.isP2pBitrate106Enabled();
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return false;
		}
	...
	/**
	 * [MTK only] Enable the NFC P2p transmission in 106 kbps.
	 *
	 * <p>This configuration will be applied when next time NFC is on. This is,
	 * if we call this API when NFC is on, the p2p bitrate setting will not be 
	 * changned unless we explicitly turn off then turn on the NFC.
	 *
	 * @return true for success, false if something bad happened.
	 *
	 * @hide
	...
	public boolean enableP2pBitrate106() {
		try {
			return sService.enableP2pBitrate106();
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return false;
		}
	...
	/**
	 * [MTK only] Disable the NFC P2p transmission in 106 kbps.
	 *
	 * <p>This configuration will be applied when next time NFC is on. This is,
	 * if we call this API when NFC is on, the p2p bitrate setting will not be 
	 * changned unless we explicitly turn off then turn on the NFC.
	...
	public boolean disableP2pBitrate106() {
		try {
			return sService.disableP2pBitrate106();
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return false;
		}
	...
	/**
	 * [MTK only] Query whether the vibration is enabled during NFC transaction.
	 *
	 * @return true if the vibration is on, false if the vibration is off.
	 *
	 * @hide
	 */
	public boolean isVibrationEnabled() {
		try {
			return sService.isVibrationEnabled();
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return false;
		}
	...
	/**
	 * [MTK only] Enable vibration during NFC transaction.
	 *
	 * @return true for success, false if something bad happened..
	 *
	 * @hide
	...
	public boolean enableVibration() {
		try {
			return sService.enableVibration();
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return false;
		}
	...
	/**
	 * [MTK only] Disable vibration during NFC transaction.
	 *
	 * @return true for success, false if something bad happened..
	 *
	 * @hide
	...
	public boolean disableVibration() {
		try {
			return sService.disableVibration();
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return false;
		}
	...
	/**
	 * [MTK only] Query whether the sound is enabled during NFC transaction.
	 *
	...
	public boolean isSoundEnabled() {
		try {
			return sService.isSoundEnabled();
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return false;
		}
	...
	/**
	 * [MTK only] Enable the sound during NFC transaction.
	 *
	 * @return true for success, false if something bad happened.
	 *
	 * @hide
	...
	/**
	 * [MTK only] Disable the sound during NFC transaction.
	 *
	 * @return true for success, false if something bad happened.
	 *
	 * @hide
	...
	/**
	 * [MTK only] Query whether framework performs the NDEF Signature RTD verification prompt mechanism.
	 *
	 * <p>Our NFC framework has the ability to verify the NDEF message who carries with
	 * NDEF signature RTD record. Incomming NDEF message will be dispatched only if they pass this certification.
	 * If the verification is fail, there will be a "prompt" dialog pop-up to ask whether the user 
	 * still wants to dispatch the NDEF message. The NDEF message is dispatched only if the user makes his confirmation.
	 * Otherwise, the NDEF message will be ignored.
	 *
	 * <P>If this ability is diabled, the NDEF message dispatch flow will be the same as the original one.
	 *
	 * @return true if the prompt mechanism is enabled, false if the prompt mechanism is disabled.
	 *
	 * @hide
	 */
	public boolean isPromptEnabled() {
		try {
			return sService.isPromptEnabled();
		} catch (RemoteException e) {
			attemptDeadServiceRecovery(e);
			return false;
		}
	...
	/**
	 * [MTK only] Enable the NDEF Signature RTD verification prompt mechanism.
	 *
	 * <p>Please refers to {@link #isPromptEnabled} for the detail about the NDEF signature RTD verification mechanism.
	 *
	 * @return true for success, false if something bad happened.
	 *
	 * @hide
	...
	/**
	 * [MTK only] Disable the NDEF Signature RTD verification prompt mechanism.
	 *
	 * <p>Please refers to {@link #isPromptEnabled} for the detail about the NDEF signature RTD verification mechanism.
	 * 
	 * @return true for success, false if something bad happened.
