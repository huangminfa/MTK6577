...
public abstract class DefaultUpdateBatchHelper extends OperationBatchHelper {
    ...
    // Constructors                                                 
    //==============================================================
    public DefaultUpdateBatchHelper(ContentProviderOperationBatch opBatch){
        super(opBatch);
    }
    ...
    public void run(int batchSize){
        updateResults = new boolean[batchSize];
        super.run(batchSize);
    }
    ...
    public void onOperationResult(ContentProviderResult opResult, 
        ...
        if (null == opResult){
            ...
            updateResults[executedPosition] = false;
        } else if (1 == opResult.count){
            updateResults[executedPosition] = true;
        } else {
            Debugger.logW(getName(), "onOperationResult", 
                    new Object[]{opResult, executedPosition}, 
