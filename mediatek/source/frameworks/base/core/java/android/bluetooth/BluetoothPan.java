...
public final class BluetoothPan implements BluetoothProfile {
    ...
    *********************************/
    ...
    public final static String BT_PAN_GN_DEVICE_AUTHORIZE  = "bt_pan_GN_device_authorize";  
    public final static String BT_PAN_NAP_DEVICE_AUTHORIZE  = "bt_pan_NAP_device_authorize";  
    public final static String BT_PAN_GN_DEVICE_CONNECTED  = "bt_pan_GN_device_connected";  
    public final static String BT_PAN_NAP_DEVICE_CONNECTED  = "bt_pan_NAP_device_connected";      
     ...
     */
    private static IBluetoothPan mService;
    ...
    /*package*/ BluetoothPan(Context context, ServiceListener l) {
        Log.d(TAG, "Start bind to Bluetooth PAN Service, mService: " + mService);
        mContext = context;
        mAdapter = BluetoothAdapter.getDefaultAdapter();
        mServiceListener = l;
        if (mService == null) {
            if (!context.bindService(
                    new Intent(IBluetoothPan.class.getName()), mConnection, Context.BIND_AUTO_CREATE)) {
...
*/        
    ...
    public boolean isTetheringOn() {
        if (DBG) log("isTetheringOn(), mService: " + mService);
        if (mService == null) {
            Log.d(TAG, "Service is not ready");
            return false;
        }
