...
public class Card2PhotoEditorView extends PhotoEditorView{
    
    private static final String TAG = "Card2PhotoEditorView";
    ...
    public Card2PhotoEditorView(Context context) {
        super(context);
    }

    public Card2PhotoEditorView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onFinishInflate() {
        ...
        mPhotoImageView = (ImageView) findViewById(R.id.card2_photo);
    ...
    protected void resetDefault() {
        ...
        mPhotoImageView.setImageResource(R.drawable.ic_contact_picture_sim2_contact);
