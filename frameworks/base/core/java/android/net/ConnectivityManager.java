...
public class ConnectivityManager {
    ...
    /** {@hide} */
    public static final int MAX_NETWORK_TYPE = TYPE_MOBILE_CMMAIL;
    ...
    /**
     * Check the validity of radio number. The radio number should be Phone.GEMINI_SIM_1 or Phone.GEMINI_SIM_2.
     */         
    static public boolean isRadioNumValid(int radioNum){
        return radioNum >= Phone.GEMINI_SIM_1 && radioNum <= Phone.GEMINI_SIM_2;
    }
    ...
    public boolean getMobileDataEnabledGemini(long simId) {
        try {
            return mService.getMobileDataEnabledGemini(simId);
        } catch (RemoteException e) {
            return true;
        }
    }
    ...
    /**
     * Gemini-DataUsage
     * Gets the subscriber id of actived Mobile data.
     *
     * @return Whether mobile data is enabled.
     * @hide
     */
    public String getDataActivedSubscriberId() {
        try {
            return mService.getDataActivedSubscriberId();
        } catch (RemoteException e) {
            return "";
        }
    }
    ...
    public boolean setMobileDataEnabledGemini(long simId) {
        try {
            return mService.setMobileDataEnabledGemini(simId);
        } catch (RemoteException e) {
            return true;
        }
    }
