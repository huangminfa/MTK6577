...
//    boolean needsPoll;
    ...
    CdmaCallTracker(CDMAPhone phone) {
        ...
        cm.registerForCallAccepted(this, EVENT_CDMA_CALL_ACCEPTED, null);
            ...
            if (conn == null && dc != null) {
                ...
                if (pendingMO != null && pendingMO.compareTo(dc)) {
                    ...
                    if (hangupPendingMO) {
                        hangupPendingMO = false;
                        //via support start
                        isEmergencyCall = PhoneNumberUtils.isLocalEmergencyNumber(connections[i].dialString, phone.getContext());
                ...
                //via support start
                    if (PhoneNumberUtils.isLocalEmergencyNumber(cn.dialString, phone.getContext()))
    ...
    private void handleCallAccepted() {
        Log.d(LOG_TAG,"handleCallAccepted");
        List connections = foregroundCall.getConnections();
    ...
    handleMessage (Message msg) {
        ...
        switch (msg.what) {
            ...
            case EVENT_CDMA_CALL_ACCEPTED:
               ...
               if (ar.exception == null) {
                   handleCallAccepted();
                   Log.d(LOG_TAG, "Event EVENT_CDMA_CALL_ACCEPTED Received");
               }    
               break;
            //Add by via for register CDMA call accepted message[end]
