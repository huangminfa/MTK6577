...
public class MessagingNotification {
    ...
    private static final class MmsSmsNotificationInfo {
        ...
        public MmsSmsNotificationInfo(
                ...
                CharSequence ticker, long timeMillis, String title, int count, int type, Uri uri) {
        ...
        public void deliver(Context context, boolean isNew, int count, int uniqueThreads) {
            ...
            updateNotification(
                    ...
                    mTimeMillis, mTitle, count, uniqueThreads, mType, mUri);
        }
    ...
    private static void updateNotification(
        ...
        if (messageCount > 1) {
            description = context.getResources().getQuantityString(
