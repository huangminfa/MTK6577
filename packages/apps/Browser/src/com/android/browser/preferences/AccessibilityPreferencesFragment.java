...
public class AccessibilityPreferencesFragment extends PreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (optr != null && optr.equals("OP01")) {
            e.setOnPreferenceChangeListener(this);
            updateFontFamilySummary(e, settings.getFontFamily());
        } else
        // MTK_OP01_PROTECT_END
        ((PreferenceGroup) findPreference("text_field")).removePreference(e);
    ...
    void updateFontFamilySummary(Preference pref, String fontFamily) {
    	pref.setSummary(fontFamily);
    }
    ...
    public boolean onPreferenceChange(Preference pref, Object objValue) {
        ...
        String optr = SystemProperties.get("ro.operator.optr");
        if (optr != null && optr.equals("OP01")) {
            if (PreferenceKeys.PREF_FONT_FAMILY.equals(pref.getKey())) {
                updateFontFamilySummary(pref, (String) objValue);
            }
        }
        // MTK_OP01_PROTECT_END
        return true;
