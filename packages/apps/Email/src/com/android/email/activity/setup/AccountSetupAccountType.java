...
public class AccountSetupAccountType extends AccountSetupActivity implements OnClickListener {
    ...
    private void onPop() {
        ...
        String serverName = AccountSettingsUtils.findManualInfoForDomain(this, hostAuth.mAddress, HostAuth.SCHEME_POP3);
        if (serverName != null) {
    ...
    private void onImap() {
        ...
        hostAuth.mLogin = hostAuth.mLogin + "@" + hostAuth.mAddress;
        String serverName = AccountSettingsUtils.findManualInfoForDomain(this, hostAuth.mAddress, HostAuth.SCHEME_IMAP);
        if (serverName != null) {
            hostAuth.mAddress = serverName;
        } else {
    ...
    private void onExchange() {
        ...
        String serverName = AccountSettingsUtils.findManualInfoForDomain(this, recvAuth.mAddress, HostAuth.SCHEME_EAS);
        if (serverName != null) {
