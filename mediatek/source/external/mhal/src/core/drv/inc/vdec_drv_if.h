...
typedef enum
{
	...
	VDEC_DRV_VIDEO_FORMAT_AVS                   = (1<<19), ///< AVS
	VDEC_DRV_VIDEO_FORMAT_MJPEG                 = (1<<20), ///< Motion JPEG
	VDEC_DRV_VIDEO_FORMAT_S263                  = (1<<21),  ///< Sorenson Spark
	VDEC_DRV_VIDEO_FORMAT_H264HP                = (1<<22)
} VDEC_DRV_VIDEO_FORMAT_T;
