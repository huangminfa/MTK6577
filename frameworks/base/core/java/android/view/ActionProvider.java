...
public abstract class ActionProvider {
    ...
    private DefaultButtonVisibilityListener mDefaultButtonVisibilityListener;
    ...
    /**
     * Notify the system that the visibility of an action view's width or height change.
     * Action menu view should update shown Action menu view when this callback is triggered, 
     * to avoid the case when ActivityChooserView's content changed, while ActionMenuView
     * did not update the shown ActionMenu.
     *
     * @hide
     */
    public void defaultButtonVisibilityChanged(boolean isVisible) {
        if (mDefaultButtonVisibilityListener != null) {
        	mDefaultButtonVisibilityListener.onDefaultButtonVisibilityChanged(isVisible);
        }
    }
     ...
     * @hide Internal use only
     */
    public void setDefaultButtonVisibilityListener(DefaultButtonVisibilityListener listener) {
    	mDefaultButtonVisibilityListener = listener;
    }
     ...
     * @hide Internal use only
     */
    public interface DefaultButtonVisibilityListener {
        public void onDefaultButtonVisibilityChanged(boolean isVisible);
    }
}
