...
*					-Removal of duplicate constants(i.e)2 or more constants used for same purpose
*			1.2 -> Removal of ts_EstimatedParam structure.
			1.3 -> modified 10-10-2011 by david.job@in.bosch.com
				-> modified as per ecompass v3.0 library 
*************************************************************************************************/
