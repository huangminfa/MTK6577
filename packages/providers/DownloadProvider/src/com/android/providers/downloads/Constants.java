...
public class Constants {
    ...
    public final static String DL_DRM = "DownloadManager/DRM";
    
    /** M: Tag used for Download enhancement log */
    public final static String DL_ENHANCE = "DownloadManager/Enhance";
     ...
     */
    public static final int RETRY_FIRST_DELAY = 10;//30;
