...
public class AlphaTag implements Parcelable {
    ...
    public static final Parcelable.Creator<AlphaTag> CREATOR
            = new Parcelable.Creator<AlphaTag>() {
    ...
    public String toString() {
        return "AlphaTag: '" + recordNumber + "' '"  + alphaTag + "' '" + pbrIndex + "'";
    }
    ...
    public boolean isEqual(AlphaTag uGas) {
        return ( stringCompareNullEqualsEmpty(alphaTag, uGas.alphaTag) );
    }
