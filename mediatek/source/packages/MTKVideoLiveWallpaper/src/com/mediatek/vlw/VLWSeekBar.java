...
public class VLWSeekBar extends SeekBar {
	static final String TAG = "VLWSeekBar";
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (isEnabled()) {
            ...
            if (DEBUG) {
            	Xlog.d(TAG, "onKeyDown, progress: " + progress + ", inc: " + increment);
            }
            ...
            switch (keyCode) {
                case KeyEvent.KEYCODE_DPAD_LEFT:
                	progress -= increment;
                	if (DEBUG) {
                		Xlog.d(TAG, "KEYCODE_DPAD_LEFT, progress: " + progress + ", lt: " + 
                    			mLeftThreshold + ", rt: " + mRightThreshold);
                	}
                ...
                case KeyEvent.KEYCODE_DPAD_RIGHT:
                	progress += increment;
                	if (DEBUG) {
                		Xlog.d(TAG, "KEYCODE_DPAD_RIGHT, progress: " + progress +", lt: " + 
                    			mLeftThreshold + ", rt: " + mRightThreshold);
                	}
