    ...
    public WifiP2pEnabler(Context context, CheckBoxPreference checkBox) {
        ...
        if (mWifiP2pManager != null) {
            ...
            if (mChannel == null) {
                ...
                Xlog.e(TAG, "Failed to set up connection with wifi p2p service");
                mWifiP2pManager = null;
                mCheckBox.setEnabled(false);
            }
        } else {
            Xlog.e(TAG, "mWifiP2pManager is null!");
        }
    ...
    private void handleP2pStateChanged(int state) {
        ...
        switch (state) {
            case WifiP2pManager.WIFI_P2P_STATE_ENABLED:
                ...
                long mEnableEndTime = System.currentTimeMillis();
                Xlog.i(TAG, "[Performance test][Settings][wifiP2P] wifiP2P enable end ["+ mEnableEndTime +"]"); 
                break;
            case WifiP2pManager.WIFI_P2P_STATE_DISABLED:
                mCheckBox.setChecked(false);
                long mDisableEndTime = System.currentTimeMillis();
                Xlog.i(TAG, "[Performance test][Settings][wifiP2P] wifiP2P disable end ["+ mDisableEndTime +"]"); 
                break;
            default:
                Xlog.e(TAG,"Unhandled wifi state " + state);
                break;
        }
    }
