...
public class MTCallTest extends TestCase {

    public MTCallTest() {
        super(null);
    }
    
    public MTCallTest(Handler reportHander) {
        super(reportHander);
    }
