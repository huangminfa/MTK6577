...
public class SimPhotoEditorViewBlue extends PhotoEditorView{
    
    private static final String TAG = "SimPhotoEditorViewBlue";
    ...
    protected void resetDefault() {
        ...
        mPhotoImageView.setImageResource(R.drawable.ic_contact_picture_sim_contact_blue);
