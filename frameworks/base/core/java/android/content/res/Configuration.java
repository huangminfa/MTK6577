...
public final class Configuration implements Parcelable, Comparable<Configuration> {
    ...
    public void setTo(Configuration o) {
        ...
        simSetLocale = o.simSetLocale; // [Note] SIM Locale feature
    ...
    public void setToDefaults() {
        ...
        locale = null;
        userSetLocale = false;
        simSetLocale = false; // [Note] SIM Locale feature
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(seq);
        dest.writeString(skin); // Theme feature
        // [Note] SIM Locale feature +
        if(simSetLocale) {
            dest.writeInt(1);
        } else {
    ...
    public void readFromParcel(Parcel source) {
        ...
        seq = source.readInt();
        skin = source.readString();// Theme feature
        simSetLocale = (source.readInt()==1); // [Note] SIM Locale feature
    }
