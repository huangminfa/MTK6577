...
public class GLSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    /**
     * Control whether the surface view's surface is used to as a stero3d 
     * surface
     */
    public void setFlagsEx(int flag, int mask) {
        if (FeatureOption.MTK_S3D_SUPPORT) {
            mGLThread.waitFor3DLayout(true);
            super.setFlagsEx(flag, mask);
            mGLThread.waitFor3DLayout(false);
        }
    }
    ...
    class GLThread extends Thread {
        ...
        public void waitFor3DLayout(boolean wait) {
            synchronized(sGLThreadManager) {
                mWaitFlag = wait;
                sGLThreadManager.notifyAll();
            }
