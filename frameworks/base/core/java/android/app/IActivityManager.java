...
public interface IActivityManager extends IInterface {
 ...
 // Retrieve running application processes in the system
    ...
    public void notifyLightWeightANR(int pid, String reason) throws RemoteException;
    ///@}
    ...
    ///M: 2012-06-22 ALPS00314133 WNR Debugging Mechanism @{
    int NOTIFY_WNR_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION+200;
    int NOTIFY_LIGHTWEIGHT_ANR_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION+201;    
    ///@}    
}
