...
public class AddBookmarkPage extends Activity
    ...
    private final static String XLOGTAG = "browser/AddBookmarkPage";
    ...
    // if folder already exist, return folder id
...
//                mTitle.setText(info.title);
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if(this.getResources().getBoolean(R.bool.isTablet) == true) {
        ...
        //M: TakMan add for bug ALPS00297585/ALPS00267462
        ...
        //M: TakMan add for bug ALPS00297585/ALPS00267462 end
        ...
        if (null != optr && optr.equals("OP01")) {
            ...
            //M: TakMan add for bug ALPS00297585
            mAddress.setFilters(contentFilters);
            //M: TakMan add for bug ALPS00297585 end
        }
        ...
        //M: suyong add for bug ALPS00267462
        mFolderNamer.setFilters(contentFilters);
        //M: suyong add for bug ALPS00267462 end
    ...
    private static class UpdateBookmarkTask extends AsyncTask<ContentValues, Void, Void> {
        ...
        protected void onPostExecute(Void o) {
            //Is editing a exist bookmark, so delete current bookmark.
    ...
    boolean save() {
        ...
        if (mOverwriteBookmarkId > 0) {
            //Is editing a exist bookmark, set flag to delete current bookmark.
    ...
    // get folder title from given id.
