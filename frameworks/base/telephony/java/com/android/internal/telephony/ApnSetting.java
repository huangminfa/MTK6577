    ...
    public boolean canHandleType(String type) {
        ...
        for (String t : types) {
            ...
            if (FeatureOption.MTK_DEDICATEDAPN_SUPPORT) {
                if (t.equals(Phone.APN_TYPE_TETHERING) && type.equals(Phone.APN_TYPE_DUN)) {
                    if (types.length == 1) {
                    ...
                    (t.equals(Phone.APN_TYPE_ALL) && !type.equals(Phone.APN_TYPE_DUN)))
                {
                    return true;
                } else if (t.equals(Phone.APN_TYPE_DEFAULT) && type.equals(Phone.APN_TYPE_HIPRI)) {
