...
private:
    ...
    // [mtk03712] for format conversion issue
    //----------------------------------------------------------------------------------------------
private:
...
public:
    // get connected api type, especially for HWComposer layer usage
    ...
    bool isFormatNeedConversion() const {
        ...
        //       HAL_PIXEL_FORMAT_YV12 == mPixelFormat;
        return HAL_PIXEL_FORMAT_I420 == mPixelFormat;
    }
    ...
    // for sync with MDP buffer use
    Mutex mMdpMutex;

private:
    virtual status_t bypassGL() { return 0; }
...
public:
	...
	int getS3DOffset() const { return mS3DOffset; }
