...
public class SearchActivity extends ListActivity implements DraftCache.OnDraftChangedListener {
    ...
    public static class TextViewSnippet extends TextView {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            ...
            Xlog.d(TAG, "onLayout startPos = " + startPos + " searchStringWidth = " + searchStringWidth 
            ...
            if (searchStringWidth > textFieldWidth) {
                try {
                     ...
                     Xlog.w(TAG, " StringIndexOutOfBoundsException ");
                     e.printStackTrace();
    ...
    public void onCreate(Bundle icicle) {
        ...
        mQueryHandler = new AsyncQueryHandler(cr) {
            protected void onQueryComplete(int token, Object cookie, Cursor c) {
                ...
                Xlog.d(TAG, "onQueryComplete msgTypePos = " + msgTypePos);
                ...
                setListAdapter(new CursorAdapter(SearchActivity.this,
                    ...
                    public void bindView(View view, Context context, Cursor cursor) {
                            ...
                            if (body == null || body.equals("")){
                                ...
                                try {
                                    body = new String(body.getBytes("ISO-8859-1"), "UTF-8");
                                     ...
                                     Xlog.w(TAG, "onQueryComplete UnsupportedEncodingException");
                                     e.printStackTrace();
                                }
                            }
                        }
                        ...
                        Xlog.d(TAG, "onQueryComplete msgType = " + msgType + "rowid =" + rowid);
                        ...
                        view.setOnClickListener(new View.OnClickListener() {
                            public void onClick(View v) {
                            	...
                            	if(FeatureOption.MTK_WAPPUSH_SUPPORT == true){
                                    ...
                                    Xlog.d(TAG, "onClickIntent1 dirMode =" + dirMode);
                                    if (!dirMode) {
                                    ...
                                    boolean dirMode = MmsConfig.getMmsDirMode();
                                    Xlog.d(TAG, "onClickIntent2 dirMode =" + dirMode);
                                    if (!dirMode){
                                        onClickIntent = new Intent(SearchActivity.this, ComposeMessageActivity.class);
                                    } else {
                                        Xlog.d(TAG, "onClickIntent2 msgType =" + msgType);
                                        onClickIntent = new Intent();
                                        if (msgType == 1) {
                                            if (msgBox == 3){//draft
                                                onClickIntent = new Intent(SearchActivity.this, ComposeMessageActivity.class);
