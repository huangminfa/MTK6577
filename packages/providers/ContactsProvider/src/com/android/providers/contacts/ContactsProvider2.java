...
//import com.mediatek.providers.contacts.SIMInfoWrapper;
...
public class ContactsProvider2 extends AbstractContactsProvider
    ...
    private static final int PHONE_EMAIL = 3011; //add by MTK
    private static final int PHONE_EMAIL_FILTER = 3012; //add by MTK
    ...
    private static final ProjectionMap sPhoneLookupProjectionMap = ProjectionMap.builder()
            ...
            .add("account_type", "raw_contacts.account_type")///M:AAS
    ...
    public boolean onCreate() {
		...
		mUseStrictPhoneNumberComparation = getContext().getResources()
				.getBoolean(com.android.internal.R.bool.config_use_strict_phone_number_comparation);
        super.onCreate();
        try {
            return initialize();
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        if (VERBOSE_LOGGING) {
            Log.v(TAG, "query begin uri [" + uri + "] selection [ " + selection + " ]");
        }
        try {
            // Enforce stream items access check if applicable.
            enforceSocialStreamReadPermission(uri);
            ...
            if (directory == null) {
                return addSnippetExtrasToCursor(uri, queryLocal(uri, projection, selection,
                        selectionArgs, sortOrder, -1));
            } else if (directory.equals("0")) {
                return addSnippetExtrasToCursor(uri, queryLocal(uri, projection, selection,
                        selectionArgs, sortOrder, Directory.DEFAULT));
            } else if (directory.equals("1")) {
                return addSnippetExtrasToCursor(uri, queryLocal(uri, projection, selection,
                        selectionArgs, sortOrder, Directory.LOCAL_INVISIBLE));
            }
            ...
            if (VERBOSE_LOGGING) {
                Log.v(TAG, "query directoryUri:" + directoryUri + "|selection:" + selection
                        + "|cursor:" + (cursor == null));
            }
            if (cursor == null) {
                return null;
            ...
            if (VERBOSE_LOGGING) {
                Log.v(TAG, "query crossProcessCursor: " + (crossProcessCursor == null));
            }
            ...
            if (VERBOSE_LOGGING) {
                Log.v(TAG, "query end uri [" + uri + "] selection [ " + selection + " ]");
            }
        }
    }
    ...
    protected Cursor queryLocal(Uri uri, String[] projection, String selection,
        ...
        switch (match) {
            ...
            case PHONES: {
                ...
                // TBD: To Check if Android default code could work well. If not, use previous code.
                // added for CR 66890, 2011-8-26
                // if (selection != null) {
                //     String tempStr = selection;
                //     if (tempStr.toUpperCase().indexOf("GROUP BY") == -1) {
                //         // mtk, 2010-9-17
                //         groupBy = Contacts._ID + ", "+
                //              Contacts.DISPLAY_NAME + ", "
                //              + Data.DATA1 + ", "
            ...
            // Keep previous code here.
            // TBD: To Check if Android default code could work well. If not, use previous code            
//            case LIVE_FOLDERS_PHONES_CONTACTS:
//                qb.setTables(Views.CONTACTS);
//                qb.setProjectionMap(sLiveFoldersProjectionMap);
//                qb.appendWhere(RawContacts.INDICATE_PHONE_SIM + "=" + RawContacts.INDICATE_PHONE);
//                //qb.appendWhere("indicate_phone_or_sim_contact" + "=-1" );
//                break;
//                
//            case LIVE_FOLDERS_SIM1_CONTACTS:
//                qb.setTables(Views.CONTACTS);
//                qb.setProjectionMap(sLiveFoldersProjectionMap);
//                qb.appendWhere(RawContacts.INDICATE_PHONE_SIM + "=" + 0);
//                //qb.appendWhere("indicate_phone_or_sim_contact" + "=1" );
//                break;
//            case LIVE_FOLDERS_SIM_CONTACTS:
//                qb.setTables(Views.CONTACTS);
//                qb.setProjectionMap(sLiveFoldersProjectionMap);
//                qb.appendWhere(RawContacts.INDICATE_PHONE_SIM + "=" + 0);
//                //qb.appendWhere("indicate_phone_or_sim_contact" + "=0" );
//                break;
//                
//            case LIVE_FOLDERS_SIM2_CONTACTS:
//                qb.setTables(Views.CONTACTS);
//                qb.setProjectionMap(sLiveFoldersProjectionMap);
//                qb.appendWhere(RawContacts.INDICATE_PHONE_SIM + "=" + 1);
//                //qb.appendWhere("indicate_phone_or_sim_contact" + "=2" );
//                break;
//
//            case LIVE_FOLDERS_USIM1_CONTACTS:
//                qb.setTables(Views.CONTACTS);
//                qb.setProjectionMap(sLiveFoldersProjectionMap);
//                qb.appendWhere(RawContacts.INDICATE_PHONE_SIM + "=" + 0);
//                //qb.appendWhere("indicate_phone_or_sim_contact" + "=1" );
//                break;
//            case LIVE_FOLDERS_USIM_CONTACTS:
//                qb.setTables(Views.CONTACTS);
//                qb.setProjectionMap(sLiveFoldersProjectionMap);
//                qb.appendWhere(RawContacts.INDICATE_PHONE_SIM + "=" + 0);
//                //qb.appendWhere("indicate_phone_or_sim_contact" + "=0" );
//                break;
//                
//            case LIVE_FOLDERS_USIM2_CONTACTS:
//                qb.setTables(Views.CONTACTS);
//                qb.setProjectionMap(sLiveFoldersProjectionMap);
//                qb.appendWhere(RawContacts.INDICATE_PHONE_SIM + "=" + 1);
//                //qb.appendWhere("indicate_phone_or_sim_contact" + "=2" );
//                break;
         // The previous lines are provided and maintained by Mediatek inc.            
            ...
            case DIALER_SEARCH_SIMPLE: {
            	return queryDialerSearchSimple(mActiveDb.get(), uri);
            }
            
            case DIALER_SEARCH_INCREMENT: {
            	return queryDialerSearchIncrement(mActiveDb.get(), uri);
            }
        	// The previous lines are provided and maintained by Mediatek inc.
    ...
    private boolean handleDataUsageFeedback(Uri uri) {
        ...
        //Arrays.fill(questionMarks, "?");
        final String where = Data._ID + " IN (" + TextUtils.join(",", ids) + ")";
        ...
        if (filterParam.indexOf("init") > -1) { // the initial state of dialer search is call log list
            ...
            if(prevSearchNumberLeng ==0 ){
                ...
                db.execSQL("CREATE TEMP TABLE  " + TEMP_DIALER_SEARCH_TABLE 
                        + " AS SELECT * FROM " + Tables.DIALER_SEARCH 
    ...
    protected void loadAccountsInBackground() {
        ...
        if (SimCardUtils.isSimInserted(slotid)) {
            ...
            //UIM
            deleteLocalSimAccounts(ACCOUNT_NAME_UIM);
            //UIM
        ...
        if (FeatureOption.MTK_GEMINI_SUPPORT) {
            ...
            if (SimCardUtils.isSimInserted(slotid)) {
                ...
                //UIM
                deleteLocalSimAccounts(ACCOUNT_NAME_UIM2);
                //UIM
            }
        }         
    ...
    protected void loadLocalSimAccounts(String accountName, String accountType, int slotid) {
        ...
        try {
            ...
            if (slotid == SimCardUtils.SimSlot.SLOT_ID1) {
                if (accountName.equals(ACCOUNT_NAME_SIM)) {
                    //UIM
...
//                    }
                    ...
                    deleteLocalSimAccounts(ACCOUNT_NAME_UIM);
                    //UIM
                } else if (accountName.equals(ACCOUNT_NAME_USIM)) {
                    //UIM
//                    Cursor c = db.rawQuery("SELECT " + Settings.ACCOUNT_NAME + ","
//                            + Settings.ACCOUNT_TYPE + " FROM " + Tables.SETTINGS + " WHERE "
...
//                    }
                ...
                //UIM
                else if (accountName.equals(ACCOUNT_NAME_UIM)){
                    Log.i(TAG, "Handle UIM1 Accounts -c.count:");
                    deleteLocalSimAccounts(ACCOUNT_NAME_SIM);
                    deleteLocalSimAccounts(ACCOUNT_NAME_USIM);
                    }
                //UIM
...
//                        }
                        ...
                        deleteLocalSimAccounts(ACCOUNT_NAME_UIM2);
                        //UIM
                    } else if (accountName.equals(ACCOUNT_NAME_USIM2)) {
                        //UIM
//                        Cursor c = db.rawQuery("SELECT " + Settings.ACCOUNT_NAME + ","
//                                + Settings.ACCOUNT_TYPE + " FROM " + Tables.SETTINGS + " WHERE "
...
//                        }
                    ...
                    //UIM
                    else if (accountName.equals(ACCOUNT_NAME_UIM2)){
                        Log.i(TAG, "Handle UIM2 Accounts -c.count:");
                        deleteLocalSimAccounts(ACCOUNT_NAME_SIM2);
                        deleteLocalSimAccounts(ACCOUNT_NAME_USIM2);
                        }
                    //UIM
    ...
    public String getSimAccountNameBySlot(int slotId) {
        ...
        //UIM
            ...
            retSimName = ACCOUNT_NAME_UIM;
            if (SimCardUtils.SimSlot.SLOT_ID2 == slotId) {
                retSimName = ACCOUNT_NAME_UIM2;
            }
        } 
        //UIM
        else {
