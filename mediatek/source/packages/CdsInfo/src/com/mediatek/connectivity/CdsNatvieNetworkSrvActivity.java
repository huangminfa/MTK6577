...
public class CdsNatvieNetworkSrvActivity extends Activity {
    private final String TAG = "CdsNatvieNetworkSrvActivity";
    private final String errorString = "Command Error";

    private final String netCfgCmd = "netcfg";
    private final String ifConfigCmd = "mtk_ifconfig";
    private final String ipRouteCmd = "ip -4 route show"; //
    //private final String ipTablesCmd = "iptables -L";
    private final String netStatCmd = "mtk_netstat";
    ...
    private void updateFrameworkSrvInfo() {
        ...
        try {
            ...
            executeShellCmd(netCfgCmd, R.id.network_list);
            //CdsShellExe.execCommand(netCfgCmd);
            mNetworkList.setText(R.string.loading_string);

            executeShellCmd(ifConfigCmd, R.id.network_config);
            //CdsShellExe.execCommand(ifConfigCmd);
            mNetworkConfig.setText(R.string.loading_string);

            executeShellCmd(ipRouteCmd, R.id.ip_route);
            //CdsShellExe.execCommand(ipRouteCmd);
            mIpRoute.setText(R.string.loading_string);
            
            //executeShellCmd(ipTablesCmd, R.id.ip_route);
            //CdsShellExe.execCommand(ipTablesCmd);
            //mIpTables.setText(CdsShellExe.getOutput());
            
            executeShellCmd(netStatCmd, R.id.net_stat);
            //CdsShellExe.execCommand(netStatCmd);
