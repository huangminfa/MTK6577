...
//                    ringtoneUri == null ? null : ringtoneUri.toString());
			...
			ed.putString("ringtoneUri", ringtoneUri == null ? "silent" : ringtoneUri.toString());
			ed.apply();
			Log.v("onSaveRingtone ringtoneUri is " + ringtoneUri);
        }
    }
    ...
    protected Uri onRestoreRingtone() {
        ...
        Log.v("onRestoreRingtone the mAlert is " + mAlert);
		if (RingtoneManager.getRingtone(getContext(), mAlert) == null && mAlert != null) {
			setAlert(RingtoneManager.getActualDefaultRingtoneUri(getContext(),
                    RingtoneManager.TYPE_ALARM));
		}
        return mAlert;
    }
