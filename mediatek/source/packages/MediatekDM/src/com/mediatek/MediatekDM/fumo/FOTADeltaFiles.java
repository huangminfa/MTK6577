...
public class FOTADeltaFiles {
    ...
    public static int unpackAndVerify(String updateFile) {
        ...
        MD5ChecksumTable checksumTable = MD5ChecksumTable.newTable(DELTA_FOLDER
                                         + DELTA_CHECKSUM, files);
        ...
        for (String delta : files) {
            ...
            if (checksumComputed == null
                    || !checksumComputed.equals(checksumStored)) {
                Log.e(TAG.Common, "[parsing delta]-- checksum incorrect>>"
                      + delta);
