...
public class DownloadList extends Activity {
    ...
    private void handleDRMRight() {
    	String selection = "(" + Downloads.Impl.COLUMN_MIME_TYPE + " == " + 
    				DrmStore.DrmObjectMime.MIME_RIGHTS_WBXML + ") OR (" + 
    				Downloads.Impl.COLUMN_MIME_TYPE + " == " + 
    				DrmStore.DrmObjectMime.MIME_RIGHTS_XML + ")";
    	Cursor cursor = null;
    	try {
	    	cursor = getContentResolver().query(
	    			...
	    			new String[] {DrmStore.DrmObjectMime.MIME_RIGHTS_WBXML, 
	    					DrmStore.DrmObjectMime.MIME_RIGHTS_XML}, 
	    			null);
    ...
    private void handleOmaDownload() {
        ...
        if (Downloads.Impl.MTK_OMA_DOWNLOAD_SUPPORT == true) {
            whereClause =  "(" + Downloads.Impl.COLUMN_STATUS + " == '" + Downloads.Impl.STATUS_NEED_HTTP_AUTH + "') OR (" + 
                            Downloads.Impl.COLUMN_STATUS + " == '" + Downloads.Impl.OMADL_STATUS_DOWNLOAD_COMPLETELY + "' AND " +
                            ...
                            Downloads.Impl.COLUMN_OMA_DOWNLOAD_STATUS + " == '" + Downloads.Impl.OMADL_STATUS_PARSE_DDFILE_SUCCESS + "' OR " + 
                            Downloads.Impl.COLUMN_OMA_DOWNLOAD_STATUS + " == '" + Downloads.Impl.OMADL_STATUS_HAS_NEXT_URL + "'))";
        ...
        return new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (showReason == Downloads.Impl.OMADL_STATUS_PARSE_DDFILE_SUCCESS) {
                    ...
                    // Add this for OP01 and integrate with FileManager for OMA DL
                    ...
                    if (optr != null && optr.equals("OP01")) {
                    	...
                    	try {
                    		cursor = getContentResolver().query(
                    				...
                    				new String[] {Downloads.Impl.DOWNLOAD_PATH_SELECTED_FROM_FILEMANAGER}, 
                    				null, null, null);
                    		...
                    		if (cursor != null && cursor.moveToFirst()) {
                    			...
                    			Xlog.d(LOG_OMA_DL, "Query selected download path: " + selectedPath);
                    		}
                    	} catch (IllegalStateException e) {
        ...
        return new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (showReason == Downloads.Impl.OMADL_STATUS_PARSE_DDFILE_SUCCESS) {
                    ...
                    // Delete the .dd file
                    ContentValues values = new ContentValues();
                    if (downloadInfo.mSupportByDevice == false) {
                        values.put(Downloads.Impl.COLUMN_OMA_DOWNLOAD_STATUS, 
                    ...
                    Xlog.i(XTAG_ENHANCE, "DownloadList:getOmaDownloadClickHandler(): Authencticate Download:user click Cancel" );
                    ContentValues values = new ContentValues();
        ...
        return new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
            	try {
            		...
            		Toast.makeText(DownloadList.this, R.string.download_error, Toast.LENGTH_LONG).show();
            	}
                // M: Add to support Queue AlertDialog
                mCurrentDialog = null;
                showNextDialog(); 
    ...
    private void openCurrentDownload(Cursor cursor) {
    	String mLocalUriCursorString = cursor.getString(mLocalUriColumnId);
    	if (mLocalUriCursorString == null ) {
    		return ;
    	}else {
    		Uri localUri = Uri.parse(mLocalUriCursorString);
    		try {
            ...
            if (FeatureOption.MTK_DRM_APP && null != mimeType &&
            	...
            	Xlog.i(XTAG_DRM, "DownloadList:will send DRM intent");
            	DrmManagerClient drmClient = new DrmManagerClient(this);
        		String oriMimeType = drmClient.getOriginalMimeType(path); 
        		if (oriMimeType != null && !oriMimeType.isEmpty()) {
        			mimeType = oriMimeType;
        			Xlog.d(XTAG_DRM, "DownloadList:Open DRM file:" + path + " MimeType is" + mimeType);
        		}
            }
...
//        }
    ...
    private void deleteDownload(long downloadId) {
        ...
        // M: For CU customization. Close this activity
    ...
    void handleDownloadsChanged() {
    	try {
    		...
    		Xlog.e(XTAG_ENHANCE, "exception is: " + e.toString());
    	}
    ...
    public boolean shareDownloadedFiles() {
        ...
        if (mSelectedIds.size() > 1) {
            ...
            for (SelectionObjAttrs item : mSelectedIds.values()) {
                ...
                if (FeatureOption.MTK_DRM_APP && null != mimeType) {
                    if (mimeType.equals(DrmStore.DrmObjectMime.MIME_DRM_CONTENT)) {
                        DrmManagerClient drmClient = new DrmManagerClient(this);
                    ...
                    } else if (mimeType.equals(DrmStore.DrmObjectMime.MIME_DRM_MESSAGE)
                               || mimeType.equals(DrmStore.DrmObjectMime.MIME_RIGHTS_XML)
                               || mimeType.equals(DrmStore.DrmObjectMime.MIME_RIGHTS_WBXML)) {
