...
/**
 * Class Name: UpdateSimContactReq
 * <p>Package: com.mediatek.apst.util.command.contacts
 * <p>Created on: 2010-12-18
 * <p>
 * <p>Description: 
 * <p>Request for updating a SIM contact.
 * <p>
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class UpdateSimContactReq extends RequestCommand {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    private BaseContact newOne;
    
    //==============================================================
    // Constructors                                                 
    //==============================================================
    public UpdateSimContactReq(){
        super(FEATURE_CONTACTS);
        this.simId = DataStoreLocations.SIM;
    }
    ...
    public void setNewOne(BaseContact newOne){
        this.newOne = newOne;
    }
