 ...
 *
 * May 12 2009 mtk01476
 * [MAUI_01684674] [Certman]codegen hang problem
 * 
 *
...
/* This is a dummy certman parse context for application to use the certman file parsing service */
typedef struct certman_ctx_parse_struct certman_ctx_parse_struct;

/* This is a dummy certman import context for application to use the certman import service */
typedef struct certman_ctx_import_struct certman_ctx_import_struct;

/* This is a dummy certman validate context for application to use the certman validation service */
typedef struct certman_ctx_validate_struct certman_ctx_validate_struct;
