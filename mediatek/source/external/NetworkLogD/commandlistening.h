...
class command
{
	...
	public:
		...
		virtual void runcommand(int fd , char *location , char *action , char *address) = 0;
...
public:
	...
	class tcpdump_cmd : public command{
		...
		public:
			...
			virtual void runcommand(int fd , char *location , char *action , char *address);
	};
	...
	static void *threadStart(void *obj);
        ...
        static int netlink_parse_info (int (*filter) (struct sockaddr_nl *, struct nlmsghdr *,void *),
		    struct nlsock *nl,void * arg);
        static int   netlink_information_fetch (struct sockaddr_nl *snl, struct nlmsghdr *h,void *arg);
        static void *listen_network_event(void *arg);
	void  runListener();
