...
#else
#define H324mLogAPIEnter(_args) RvLogEnter (_args)
#define H324mLogCBEnter(_args) RvLogEnter (_args)
...
#else
#define H324mLogAPIExit(_args) RvLogLeave (_args)
#define H324mLogCBExit(_args) RvLogLeave (_args)
