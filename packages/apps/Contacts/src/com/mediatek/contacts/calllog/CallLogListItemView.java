...
public class CallLogListItemView extends ViewGroup implements SelectionBoundsAdjuster {
 ...
 // Style values for layout and appearance
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mCallLogExtention.measureExtention(mExtentionIcon);
//        measureRCSIcon();
        //RCS
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
      ...
      //RCS
        ...
        rightBound = mCallLogExtention.layoutRCSIcon(leftBound, topBound, bottomBound, rightBound, mGapBetweenImageAndText,mExtentionIcon);
//        rightBound = layoutRCSIcon(leftBound, topBound, bottomBound, rightBound);
...
//            setMarqueeText(mTextViewNumber, number.toCharArray(), number.length());
    ...
    public void getExtentionIconView(){
        ...
        if(icon == null && null != CallLogExtentionForRCS.getCallLogPlugin()){
            icon = CallLogExtentionForRCS.getCallLogPlugin().getAppIcon();
            Log.i(TAG,"[getExtentionIconView] icon : "+icon);
        }
        mExtentionIcon.setImageDrawable(icon);
