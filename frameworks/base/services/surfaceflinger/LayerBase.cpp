      ...
      mInvalidate(0)
{
    ...
    // mLogTransaction for transactions setting
    //------------------------------------------------------------------------------------------
...
void LayerBase::initStates(uint32_t w, uint32_t h, uint32_t flags)
{
    ...
    // [mtk03712] init for additional info
    //-----------------------------------------------------------
    mCurrentState.flagsEx = ISurfaceComposer::eExS3D_Unknown;
    mCurrentState.s3d_requested_flags = ISurfaceComposer::eExInvalid;
    mCurrentState.s3d_buffer_flags = ISurfaceComposer::eExS3D_2D;
