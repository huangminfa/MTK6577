...
public class EditEventFragment extends Fragment implements EventHandler {
    ...
    private class QueryHandler extends AsyncQueryHandler {
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            ...
            ///M:When onResume,check the status of repeat spinner set@{
            long begin = mModel.mStart;
            long end = mModel.mEnd;
            mView.enableSpinnerByTime(begin, end);
            ///@}
        }
    }
    ...
    private void setModelIfDone(int queryType) {
        synchronized (this) {
            ...
            if (mOutstandingQueries == 0) {
                ...
                LogUtil.performanceEnd("EditEvent UI launch");
            }
        }
    }
    ...
    private void startQuery() {
        ...
        ///M:Remove this.Because when the time is after UTC,
        ///the Millis will less than 0.@{
        /*
         * if (mBegin <= 0) {
