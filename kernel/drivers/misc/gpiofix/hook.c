...
{
	int i;
	SYMSEARCH_BIND_FUNCTION_TO(gpio_eint, kallsyms_lookup_name, pkallsyms_lookup_name);
	SYMSEARCH_BIND_FUNCTION_TO(gpio_eint, kallsyms_lookup, pkallsyms_lookup);
	//lock_kernel();
