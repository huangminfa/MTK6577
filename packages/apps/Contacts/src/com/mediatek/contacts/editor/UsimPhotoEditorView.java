...
public class UsimPhotoEditorView extends PhotoEditorView{
    
    private static final String TAG = "UsimPhotoEditorView";
    ...
    protected void onFinishInflate() {
        ...
        mPhotoImageView = (ImageView) findViewById(R.id.usim_photo);
    ...
    protected void resetDefault() {
        ...
        mPhotoImageView.setImageResource(R.drawable.ic_contact_picture_usim_contact);
