...
{
   DAL_PRINT("phDal4Nfc_i2c_initialize");
...
{
   DAL_DEBUG("phDal4Nfc_i2c_initialize: pDalHwContext[%p]", pDalHwContext);
...
{
   DAL_DEBUG("phDal4Nfc_i2c_is_opened: ret %d", gI2cPortContext.nOpened);
