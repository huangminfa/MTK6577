...
public class MetaData {
    ...
    ///M: clear instance range. @{
    private static final String TAG = "MetaData";
    private static final int DAY_IN_SECONDS = 24 * 60 * 60;
    private static final int DAY_IN_MILLIS = DAY_IN_SECONDS * 1000;
    /**
     * M: 1000 day's millis. if the instance time range beyond this range, some 
     * problems will happen to daily event. for framework can only support the 
     * max instance amount is 2000 {@link RecurrenceProcessor}
     */
    private static final long INSTANCE_TIME_RANGE_LIMIT = DAY_IN_MILLIS * 1000;
    ///@}
