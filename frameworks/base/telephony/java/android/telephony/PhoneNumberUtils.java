...
//MTK-START [mtk04070][111116][ALPS00093395]Use Gemini object
import static com.android.internal.telephony.Phone.GEMINI_SIM_1;
import static com.android.internal.telephony.Phone.GEMINI_DEFAULT_SIM_PROP;
import static com.android.internal.telephony.Phone.GEMINI_SIM_ID_KEY;
import java.util.regex.Pattern;
import java.util.regex.Matcher;
import com.mediatek.featureoption.FeatureOption;
//MTK-END [mtk04070][111116][ALPS00093395]Use Gemini object

/// M: For check if SIMs are inserted or not for ECC call. @{
import com.android.internal.telephony.ITelephony;
import android.os.ServiceManager;
import static com.android.internal.telephony.Phone.GEMINI_SIM_2;
/// @}
...
public class PhoneNumberUtils
{
    ...
    public static String getNumberFromIntent(Intent intent, Context context) {
        ...
        //MTK-START [mtk04070][111116][ALPS00093395]Return voice mail number according to sim id.
        ...
        if (scheme.equals("voicemail")) {
            ...
            return TelephonyManager.getDefault().getVoiceMailNumberGemini(simId);
        }
        //MTK-END [mtk04070][111116][ALPS00093395]Return voice mail number according to sim id.
    ...
    public static String stripSeparators(String phoneNumber) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (isNonSeparator(c) || isPause(c) || isToneWait(c)) {
                ret.append(c);
            }
        }
    ...
    compareLoosely(String a, String b) {
        ...
        //MTK-START [mtk04070][111116][ALPS00093395]Determine  the minimum match length acording to feature option
        int minMatchLen = 0;
        ...
        //MTK-END [mtk04070][111116][ALPS00093395]Determine  the minimum match length acording to feature option
    ...
    calledPartyBCDToString (byte[] bytes, int offset, int length) {
        ...
        if (prependPlus) {
            //MTK-START [mtk04070][111116][ALPS00093395]Replace origin codes with prependPlusToNumber method
            ret = new StringBuilder(prependPlusToNumber(ret.toString()));
            //MTK-END [mtk04070][111116][ALPS00093395]Replace origin codes with prependPlusToNumber method
        }
    ...
    //MTK-START [mtk04070][111116][ALPS00093395]Add a constant integer
    static final int MIN_MATCH_CTA = 11;
    //MTK-END [mtk04070][111116][ALPS00093395]Add a constant integer

    //MTK-START [mtk04070][111116][ALPS00093395]Refine isEmergencyNumber method
    /**
    ...
    public static boolean isEmergencyNumber(String number) {
        ...
        if (!TextUtils.isEmpty(numbers)) {
            ...
            if (null != optr && optr.equals("OP01")) {
                final int eccNo = 6;
                String []emergencyNumList = {"000", "08", "110", "118", "119", "999"};
        ...
        if (FeatureOption.EVDO_DT_SUPPORT) {
            if (FeatureOption.EVDO_DT_VIA_SUPPORT) {
               String [] emergencyNumList_cdma = {"112", "911", "000", "08", "110", "118", "119", "999","120"};
               eccNo = 9;
               emergencyNumList = emergencyNumList_cdma;
               Log.d(LOG_TAG, "yangli eccNo = " + eccNo + ", emergencyNumList_cdma[8] = " + emergencyNumList[8]);
            }
        }
    ...
    //MTK-END [mtk04070][111116][ALPS00093395]Refine isEmergencyNumber method
    ...
    private static boolean isEmergencyNumberInternal(String number, boolean useExactMatch) {
        //MTK-START [mtk04070][111220][ALPS00093395]Replace this method with our own isEmergencyNumber method
        return isEmergencyNumber(number);
        //MTK-END [mtk04070][111220][ALPS00093395]Replace this method with our own isEmergencyNumber method
		/*
        // If the number passed in is null, just return false:
        if (number == null) return false;
    ...
    */
    ...
    //MTK-START [mtk04070][111116][ALPS00093395]MTK proprietary methods(functions)
    /**
    ...
    public static boolean isVoiceMailNumberGemini(String number, int simId) {
        ...
        try {
            vmNumber = TelephonyManager.getDefault().getVoiceMailNumberGemini(simId);
        } catch (SecurityException ex) {
            return false;
        }
    ...
    public static boolean isSpecialEmergencyNumber(String dialString) {
        //Return false directly if there is no any SIM inserted.
        boolean bWithSim = false;
        try {
            ITelephony iTel = ITelephony.Stub.asInterface(ServiceManager.getService(Context.TELEPHONY_SERVICE));
            bWithSim = (iTel.isSimInsert(GEMINI_SIM_1) || iTel.isSimInsert(GEMINI_SIM_2));
    	  } catch(Exception e) {
            //Do nothing.
    	  }
    	  if (!bWithSim) {
    ...
    //MTK-END [mtk04070][111116][ALPS00093395]MTK proprietary methods(functions)
}
