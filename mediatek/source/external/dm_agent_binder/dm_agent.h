...
#include "../../external/mtd_util/mtd_util.h"
...
enum {
    ...
    TRANSACTION_setRebootFlag= IBinder::FIRST_CALL_TRANSACTION+100,
    TRANSACTION_getLockType= IBinder::FIRST_CALL_TRANSACTION+101,
    TRANSACTION_getOperatorID= IBinder::FIRST_CALL_TRANSACTION+102,
    TRANSACTION_getOperatorName= IBinder::FIRST_CALL_TRANSACTION+103,
    TRANSACTION_isHangMoCallLocking= IBinder::FIRST_CALL_TRANSACTION+104,
    TRANSACTION_isHangMtCallLocking= IBinder::FIRST_CALL_TRANSACTION+105,
    TRANSACTION_clearRebootFlag= IBinder::FIRST_CALL_TRANSACTION+106,
    TRANSACTION_isBootRecoveryFlag= IBinder::FIRST_CALL_TRANSACTION+107,
    TRANSACTION_getUpgradeStatus= IBinder::FIRST_CALL_TRANSACTION+108,
    TRANSACTION_restartAndroid = IBinder::FIRST_CALL_TRANSACTION + 109,
    TRANSACTION_isWipeSet=IBinder::FIRST_CALL_TRANSACTION+201,
    TRANSACTION_setWipeFlag=IBinder::FIRST_CALL_TRANSACTION+202,
    TRANSACTION_clearWipeFlag=IBinder::FIRST_CALL_TRANSACTION+203,

    TRANSACTION_readOtaResult=IBinder::FIRST_CALL_TRANSACTION+204,
};
...
public:
    ...
    char * readMiscPartition(int miscNum, int readSize);
