...
class GLES20Canvas extends HardwareCanvas {
    ...
    @Override
    public boolean drawDisplayList(DisplayList displayList, int width, int height, Rect dirty) throws InvalidDrawException {
    ...
    public void drawBitmapMesh(Bitmap bitmap, int meshWidth, int meshHeight, float[] verts,
        ...
        Xlog.w(TAG, "drawBitmapMesh() Colors are ignored for now");
        colors = null;
        colorOffset = 0;
    ...
    public void drawPosText(char[] text, int index, int count, float[] pos, Paint paint) {
        // TODO: Implement
    	Xlog.w(TAG, "drawPosText() Unimplemented method, ignored");
    }
    ...
    public void drawTextOnPath(char[] text, int index, int count, Path path, float hOffset,
        ...
        // TODO: Implement
    	Xlog.w(TAG, "drawTextOnPath() Unimplemented method, ignored");
    }
    ...
    public void drawVertices(VertexMode mode, int vertexCount, float[] verts, int vertOffset,
        ...
        // TODO: Implement
        Xlog.w(TAG, "drawVertices() Unimplemented method, ignored");
    }
    ...
    private int setupModifiers(Paint paint) {
        ...
        final MaskFilter maskFilter = paint.getMaskFilter();
        if (maskFilter != null) {
        	Xlog.w(TAG, "setupModifiers() MaskFilter is ignored for now");
        }
        return modifiers;
    }
    ...
    /**
     * Exception thrown when display is freeed
     */
    public static class InvalidDrawException extends RuntimeException {
        public InvalidDrawException() {
        }
        public InvalidDrawException(String name) {
            super(name);
        }
    }
}
