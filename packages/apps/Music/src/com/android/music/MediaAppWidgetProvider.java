...
public class MediaAppWidgetProvider extends AppWidgetProvider {
    ...
    private boolean hasInstances(Context context) {
        ...
        if (null == appWidgetIds) {
            MusicLogUtils.i(TAG, "hasInstances:appWidgetIds is null");
        } else {
            MusicLogUtils.i(TAG, "hasInstances number is " + appWidgetIds.length);
        }
    ...
    void performUpdate(MediaPlaybackService service, int[] appWidgetIds) {
        ...
        //If the artist name get from database is equal to "unknown",use R.string.unknown_artist_name string replace.
        ...
        if (errorState != null) {
            ...
            if (titleName != null && titleName.toString().startsWith("http://")) {
