...
static const char tag[] = "pn544_libhardware";
...
uint8_t EEDATA_Settings[EEDATA_SETTINGS_NUMBER][4] = {
    ...
    // Enable PBTF
    ,{0x00,0x98,0x00,0x0F} // SECURE_ELEMENT_CONFIGURATION - No Secure Element
...
static int nfc_open(const hw_module_t* module, const char* name,
    ...
    if (strcmp(name, NFC_PN544_CONTROLLER) == 0) {
        ...
        /* Example settings */
        dev->num_eeprom_settings = sizeof(EEDATA_Settings)/4;
        dev->eeprom_settings = (uint8_t*)EEDATA_Settings;
