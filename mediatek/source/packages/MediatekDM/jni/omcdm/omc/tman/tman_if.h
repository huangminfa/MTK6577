 ...
 *
 *		Version:				$Id: //depot/main/base/omc/tman/tman_if.h#5 $
 *
...
/*! \file
 *		Defines the API used to allow other programs to access the
 *		DM tree.
 *
 * \brief	DM tree access API
 */

#ifndef _OMC_TMAN_TMAN_IF_H_
#define _OMC_TMAN_TMAN_IF_H_
...
===============================================================================
 */
extern OMC_Error TMAN_OMC_initSession(UTF8CStr program, OMC_UserDataPtr udp,
...
===============================================================================
 */
extern void TMAN_OMC_termSession(OMC_TreeSessionPtr tsp);
...
===============================================================================
 */
extern OMC_Yield TMAN_OMC_addInterior(OMC_TreeSessionPtr tsp, UTF8CStr path,
	UTF8CStr type);
...
===============================================================================
 */
extern OMC_Yield TMAN_OMC_addLeaf(OMC_TreeSessionPtr tsp, UTF8CStr path,
...
===============================================================================
 */
extern OMC_Yield TMAN_OMC_deleteNode(OMC_TreeSessionPtr tsp, UTF8CStr path);
...
===============================================================================
 */
extern OMC_Yield TMAN_OMC_getProperty(OMC_TreeSessionPtr tsp, UTF8CStr path,
...
===============================================================================
 */
extern OMC_Yield TMAN_OMC_replaceProperty(OMC_TreeSessionPtr tsp, UTF8CStr path,
...
===============================================================================
 */
extern OMC_Yield TMAN_OMC_getValue(OMC_TreeSessionPtr tsp, UTF8CStr path,
...
===============================================================================
 */
extern OMC_Yield TMAN_OMC_replaceValue(OMC_TreeSessionPtr tsp, UTF8CStr path,
...
===============================================================================
 */
extern OMC_Yield TMAN_OMC_execNode(OMC_TreeSessionPtr tsp, UTF8CStr path,
