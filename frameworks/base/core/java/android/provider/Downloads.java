...
public final class Downloads {
    ...
    public static final class Impl implements BaseColumns {
         ...
         */
        /**
         * The column is used to define OMA Download. If this column is set to "1",
         * it means this download action is OMA download (include download .dd file or media object).
         * If this column is 0 or other value, it isn't OMA DL.
         * <P>Type: INTEGER</P>
         * <P> Owner can Init/Read/Write</P>
         */
        ...
        /**
         * The column is used to store the object url after parsed .dd file for OMA download.
         * Programm can use this url to download the media object 
         * <P>Type: TEXT</P>
         * <P> Owner can Init/Read/Write</P>
         */
        ...
        /**
         * The column is used to store the next url after parsed .dd file for OMA download.
         * This url will be shown to user. 
         * If user confirm, program will open this url by Browser. .
         * <P>Type: TEXT</P>
         * <P> Owner can Init/Read/Write</P>
         */
        ...
        /**
         * The column is used to store the install url after parsed .dd file for OMA download. 
         * If .dd file contain this url, program will post the status to this url.
         * It is used to tell the webserver the OMA download status.
         * <P>Type: TEXT</P>
         * <P> Owner can Init/Read/Write</P>
         */
        ...
        /**
         * The column is used to store the media object name after parsed .dd file for OMA download. 
         * This file name will be shown to user. It is show the media object name.
         * <P>Type: TEXT</P>
         * <P> Owner can Init/Read/Write</P>
         */
        ...
        /**
         * The column is used to store the media object vendor after parsed .dd file for OMA download. 
         * The vendor will be shown to user. It is show the media object's vendor name.
         * <P>Type: TEXT</P>
         * <P> Owner can Init/Read/Write</P>
         */
        ...
        /**
         * The column is used to store the media object size after parsed .dd file for OMA download. 
         * The size will be shown to user. It is show the media object's size.
         * <P>Type: INTEGER</P>
         * <P> Owner can Init/Read/Write</P>
         */
        ...
        /**
         * The column is used to store the media object type after parsed .dd file for OMA download. 
         * The type will be shown to user. It is show the media object MIME type.
         * <P>Type: TEXT</P>
         * <P> Owner can Init/Read/Write</P>
         */
        ...
        /**
         * The column is used to store the description after parsed .dd file for OMA download. 
         * The description will be shown to user. It is show the media object description.
         * <P>Type: TEXT</P>
         * <P> Owner can Init/Read/Write</P>
         */
        ...
        /**
         * The column is used to support CU customization. 
         * If this column is ture, user continue download even with same file name
         * If this column is false, A alert dialog will show to user, then user decide to download or not. 
         * <P>Type: boolean</P>
         * <P> Owner can Init/Read/Write</P>
         */
         ...
         * This column contain the path where will store download object 
         * in external storage. The path is selected from FileManager.
         * <P>Type: TEXT</P>
         * <P> Owner can Init/Read/Write</P>
         */
        ...
        /** 
         * The column define to support MTK DRM
         * If the status is true, the DRM right is valid
         * <P>Type: TEXT</P>
         * <P> Owner can Init/Read/Write</P>
         * */
        ...
        /**
         * This status means download media object successfully and it has next url
         */
        public static final int OMADL_STATUS_HAS_NEXT_URL = 203;
        
        //OMA DL error
        /**
         * This String is cooperate with download error exception. 
         * It means that OMA DL encount error and need to notify web server through install notify url.
         */
        public static final String OMADL_OCCUR_ERROR_NEED_NOTIFY = "OMADL_ERROR_NEED_NOTIFY";
        
        
        /**
         * This status means download Media object completely, 
         * but failed to post message to webserver through notify URL (install failed) 
         */
        public static final int OMADL_STATUS_ERROR_INSTALL_FAILED = 400;
        
        
        /**
         * When download Media object, insufficient space while writing destination file. Show this error.
         * This status means insufficient space
         */
        public static final int OMADL_STATUS_ERROR_INSUFFICIENT_MEMORY = 403;
        
        /**
         * This status means download dd file completely, but when parse dd file, occur Invalid descriptor error
         */
        public static final int OMADL_STATUS_ERROR_INVALID_DESCRIPTOR = 404;
        
        
        /**
         * This status means downloaded dd file successfully, 
         * but user cancel this action and no need to download media object.
         */
        public static final int OMADL_STATUS_ERROR_USER_CANCELLED = 490;
        
        /**
         * This status means downloaded dd file successfully, 
         * and user click "OK" to download MediaObject.
         */
         ...
         * This status means downloaded dd file successfully, 
         * but user cancel this action and no need to download media object.
         * At the moment, the content can not support by device, then set this status.
         */
        public static final int OMADL_STATUS_ERROR_NON_ACCEPTABLE_CONTENT = 492;
        
        
        /**
         * When download Media object, check if the header's mimeType same with Download info's MimeType. 
         * If not same, show this error.
         * This status means attribute mismatch.
         */
        public static final int OMADL_STATUS_ERROR_ATTRIBUTE_MISMATCH = 512;
        
        
        /**
         * This status means download dd file completely, but the DDversion is invalid
         */
        public static final int OMADL_STATUS_ERROR_INVALID_DDVERSION = 515;
        
        /**
         * For OMA DL and authenticate, 
         * this status means that program had been shown a AlertDialog to user.
         */
         ...
         */
        /**
         * The column is used to store the username. 
         * If the it's a authenticate download, user need to input username.
         * <P>Type: TEXT</P>
         * <P> Owner can Init/Read/Write</P>
         */
        ...
        /**
         * The column is used to store the password. 
         * If the it's a authenticate download, user need to input password.
         * <P>Type: TEXT</P>
         * <P> Owner can Init/Read/Write</P>
         */
        ...
        /**
         * This status means that the download is authenticate. It need user name and password
         * A dialog will show to user to input user name and password.
         */
