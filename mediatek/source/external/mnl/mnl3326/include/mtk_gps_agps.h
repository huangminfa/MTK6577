...
typedef struct 
{
  ...
  MTK_TOW_SV_T atSV[TOW_MAX_N_SAT];
} MTK_ASSIST_TOW_T;
 ...
 *****************************************************************************/
mtk_int32
mtk_gps_set_agps_data (const MTK_AGPS_CMD_DATA_T *prAdt, mtk_uint16 srcMod, mtk_uint16 dstMod);
...
/*****************************************************************************
 * FUNCTION
 *  mtk_gps_agps_disaptcher_callback
 * DESCRIPTION
