...
/**
 * Class Name: AsyncGetAllRawContactsRsp
 * <p>Package: com.mediatek.apst.util.command.contacts
 * <p>Created on: 2010-12-18
 * <p>
 * <p>Description: 
 * <p>Response for asynchronously getting all raw contacts. Detailed contact 
 * data is not included.
 * <p>
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class AsyncGetAllRawContactsRsp extends RawBlockResponse {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    // Constructors                                                 
    //==============================================================
    public AsyncGetAllRawContactsRsp(int requestToken){
    ...
    //==============================================================
    /**
     * Gets the raw contacts list.
     * @return The raw contacts list.
     */
    public ArrayList<RawContact> getAll(int versionCode){
        ByteBuffer buffer = ByteBuffer.wrap(this.getRaw());
        int count = buffer.getInt();
        ArrayList<RawContact> list = new ArrayList<RawContact>(count);
