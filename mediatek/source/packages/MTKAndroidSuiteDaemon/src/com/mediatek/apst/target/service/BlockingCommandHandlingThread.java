 ...
 * <p>Created on: 2010-7-5
 * <p>
 * <p>Description: 
 * <p>Thread synchronously handles commands.
 * <p>
...
public abstract class BlockingCommandHandlingThread extends Thread {
    ...
    public synchronized boolean enqueue(BaseCommand cmd, boolean waitWhenFull){
        ...
        if (waitWhenFull) {
            try {
                ...
                Debugger.logE(this.getClassName(), "enqueue", 
                        new Object[]{cmd, waitWhenFull}, null, e);
                return false;
            }
        } else {
            ...
            if (b){
                ...
                Debugger.logW(this.getClassName(), "enqueue", 
                        new Object[]{cmd, waitWhenFull}, 
                        "Failed, command queue is full.");
                return false;
            }
        }
    }
    ...
    //@Override
    public void run(){
        Debugger.logI(this.getClassName(), "run", null,"Thread start running.");
