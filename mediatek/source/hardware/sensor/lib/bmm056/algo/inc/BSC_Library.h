...
/** \mainpage eCompass Library API
* 
*       \section intro_sec Introduction
*       The eCompass Library provides all necessary functionality for the integration 
*       of the electronic compass on the target platform. The library has directly access 
*       to hadware and allows to use the best settings of the compass sensor to provide the optimal orientation data.
...
* Bosch Sensortec.
*               
*       \author Gokul.Rajendran@in.bosch.com, Bhavya.C@in.bosch.com 
*       \version    3.1
*       \revision   1.2
*       \date 2012/01/19 
*/
/*************************************************************************************************
 *  $Revision History
			   1.0 -> created 09-16-2011 by Gokul.Rajendran@in.bosch.com, Bhavya.C@in.bosch.com
				   -> modified 10-10-2011 by david.job@in.bosch.com
 					  - function modified as per other module changes
	 				  - general function optimization
				   -> modified 04-11-2011 by david.job@in.bosch.com
					  - as per matlab updates and optimization
				   ->  3.0.1 Bug Fixes 
			   1.1 ->  Support added for BMCA022e and BMCA050e	
				   ->  Changes related to skip the samples after updating magnetometer calibration 
               1.2 ->  Advance Pre-Filtering
					   profile.	
*************************************************************************************************/
