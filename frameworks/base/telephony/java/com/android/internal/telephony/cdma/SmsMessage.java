...
public class SmsMessage extends SmsMessageBase {
    ...
    /**
     * Create an PDU from an SMS record.
     *
    ...
    */
    ...
    protected void parseSms() {
        ...
        if (originatingAddress != null) {
            ...
            if (Config.DEBUG) Log.v(LOG_TAG, "SMS originating address: "
        ...
        if (Config.DEBUG) Log.d(LOG_TAG, "SMS SC timestamp: " + scTimeMillis);
