 ...
 *  JEITA battery temperature standard
    ...
    CV threshold would be reconfigurated.temperature hysteresis default 6C.
    reference table:
...
void select_charging_curret_bq24158()
{
    ...
    {        
	   ...
	   else 
	   {
		 ...
		 // bq24158_set_ac_charging_current(0x02);
                 bq24158_config_interface_reg(0x04,0x29); //set IOCHARGE
    ...
    {   
        g_temp_CC_value = USB_CHARGER_CURRENT;
						 ...
						 {
						        bq24158_config_interface_reg(0x05,0x04);
							//bq24158_config_interface_reg(0x02);
                                                        bq24158_config_interface_reg(0x04,0x29); //set IOCHARGE
							bq24158_config_interface_reg(0x01,0x78);
...
PMU_STATUS BAT_BatteryStatusFailAction(void)
{
    if (Enable_BATDRV_LOG == 1) {
       ...
       #ifdef MTK_JEITA_STANDARD_SUPPORT
