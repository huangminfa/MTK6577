...
public class DcfDecoder {
    ...
    public static byte[] decryptFile(String pathName, boolean consume) {
        if (null == pathName) {
    ...
    public static byte[] decryptUri(ContentResolver cr, Uri uri, boolean consume) {
    ...
    public static byte[] forceDecryptUri(ContentResolver cr, Uri uri, boolean consume) {
        String filepath = getFilepathFromUri(cr, uri);
        if (null == filepath) {
     ...
     */
    public static Bitmap decodeFile(String pathName, Options opts, boolean consume) {
        if (null == pathName) {
     ...
     *         size be returned (in opts.outWidth and opts.outHeight)
     */
    public static Bitmap forceDecodeFile(String pathName, Options opts, boolean consume) {
        if (null == pathName) {
     ...
     *         size be returned (in opts.outWidth and opts.outHeight)
     */
    public static Bitmap decodeUri(ContentResolver cr, Uri uri, Options opts, boolean consume) {
        String filepath = getFilepathFromUri(cr, uri);
        if (null == filepath) {
    ...
    private static native Bitmap nativeDecodeFile(String pathName, Options opts, boolean consume);

    private static native Bitmap nativeForceDecodeFile(String pathName, Options opts, boolean consume);

    private static native byte[] nativeDecryptFile(String pathName, boolean consume);

    private static native byte[] nativeForceDecryptFile(String pathName, boolean consume);

    //if uri is context://media, query file path from data base
    //if uri is file://, get corresponding String
    //else return null
    private static String getFilepathFromUri(ContentResolver cr, Uri uri) {
