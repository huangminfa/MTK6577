...
static const nsecs_t kStandbyTimeInNsecs = milliseconds(600);
    //add by chipeng fot fm io_ouput_handler
    static int mHardwarePlayckThreadId =0; 
#else
...
public:
    ...
    // add by chipeng to check fasync
    struct sigaction action;
    int mFd;
    virtual void SetFsync();
