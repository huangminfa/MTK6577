...
import com.mediatek.hdmi.HDMINative; // add for HDMI orientation control
...
class LockScreen extends LinearLayout implements KeyguardScreen {
    ...
    //public static final boolean FAKE_GEMINI = true;
    ...
    private HDMINative mHDMI = new HDMINative();	// add for HDMI orientation control
    ...
    class WaveViewMethods implements WaveView.OnTriggerListener, UnlockWidgetCommonMethods {
        ...
        /** {@inheritDoc} */
        public void onTrigger(View v, int whichHandle) {
            Log.i(TAG, "onTrigger, whichHandle="+whichHandle);
            if (whichHandle == WaveView.OnTriggerListener.CENTER_HANDLE) {
                Log.i(TAG, "onTrigger, requestUnlockScreen");
                requestUnlockScreen();
            }
        }
    ...
    LockScreen(Context context, Configuration configuration, LockPatternUtils lockPatternUtils,
        ...
        //if (mCreationOrientation != Configuration.ORIENTATION_LANDSCAPE) {
            if (FeatureOption.MTK_GEMINI_SUPPORT){
                Log.i(TAG, "we will initialize the LockScreen single portrait layout");
                inflater.inflate(R.layout.keyguard_screen_tab_unlock_gemini, this, true);
            } else {
                Log.i(TAG, "we will initialize the LockScreen gemini portrait layout");
        ...
        if (mUpdateMonitor.DM_IsLocked()){
            Log.i(TAG, "we should hide unlock widget");
