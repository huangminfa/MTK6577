...
// Morris Yang 20110120 [
        if (FeatureOption.MTK_RMVB_PLAYBACK_SUPPORT) {
            addFileType("RMVB", FILE_TYPE_RM, "video/rmff");
            addFileType("RM", FILE_TYPE_RM, "video/rmff");
            addFileType("RAM", FILE_TYPE_RM, "video/rmff");
            addFileType("RV", FILE_TYPE_RM, "video/rmff");
            addFileType("RA", FILE_TYPE_RA, "audio/rmff");
        } else if (FeatureOption.MTK_TB_DEBUG_SUPPORT) {
