...
public class AccountCheckSettingsFragment extends SafeFragment {
    ...
    public final static String BUNDLE_KEY = "AccountCheckSettingFragment.checkMode";
    ...
    public final static int CHECK_SETTINGS_USER_CANCEL = 4;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (mAccountCheckTask == null) {
            ...
            mAccountCheckTask = (AccountCheckTask)
                    new AccountCheckTask(mCheckMode, checkAccount)
                    .executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
            Logging.d(this + " ### onActivityCreated  #### checkMode = "
                    + mCheckMode + "  " + mAccountCheckTask);
       }
    }
            ...
            switch (newState) {
                case STATE_CHECK_OK:
                    ...
                    if (isResumed()) {
                        ...
                        Logging.d("The curren fragment is in backgroud, the call back will be send on Resume");
                    }
                    break;
                ...
                case STATE_AUTODISCOVER_RESULT:
                    ...
                    if (isResumed()) {
                        ...
                        addResumeRunnable(new Runnable(){
                            ...
                            @Override
                            public void run() {
                                Logging.d("Exit curren fragment in thread, state: AUTODISCOVER, isResume:"+isResumed());
                                fm.popBackStack();
                            }});
                    }
    ...
    private void onSecurityRequiredDialogResultOk(boolean okPressed) {
        ...
        FragmentManager fm = getFragmentManager();
        if (fm != null) {
            Logging.d("Kill current fragment if not already killed (onSecurityRequiredDialogResultOk)");
            fm.popBackStack();
        }
    }
            ...
            try {
                ...
                if ((mMode & SetupData.CHECK_INCOMING) != 0) {
                    ...
                    if (bundle != null) {
                        ...
                        String protocolVerion = bundle.getString(EmailServiceProxy.VALIDATE_BUNDLE_PROTOCOL_VERSION, null);
    ...
    public static class CheckingDialog extends DialogFragment {
        ...
        private final static String EXTRA_PROGRESS_STRING = "CheckProgressDialog.Progress";
    ...
    public static class ErrorDialog extends DialogFragment {
        ...
        private final static String ARGS_EXCEPTION_MESSAGE = "ErrorDialog.ExceptionMessage";
        private final static String ARGS_EXCEPTION_DATA = "ErrorDialog.ExceptionData";
