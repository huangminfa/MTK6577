...
#ifndef _VIA_GPS_API_ADP_H
#define _VIA_GPS_API_ADP_H
#ifdef __cplusplus
extern "C" {
#endif
...
//gps_power_on_type.fix_mode
/*Unkown: 0; MSA: 1, MSB: 2, MSS: 3, Control Plane: 4*/
typedef enum
{
    VIA_GPS_FIXMODE_UNKNOWN,
    VIA_GPS_FIXMODE_MSA,
    VIA_GPS_FIXMODE_MSB,
    VIA_GPS_FIXMODE_MSS,
    VIA_GPS_FIXMODE_CP,
} via_gps_power_on_type_fix_mode_enum;

enum //loc_result mask
{
