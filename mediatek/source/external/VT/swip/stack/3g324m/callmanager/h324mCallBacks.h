...
/* MTK */
/******************************************************************************
 * Rv3G324mCallCheckMUXforRME
 * ----------------------------------------------------------------------------
 * General: Get the validEntries of the mux table.
 *
 * Return Value: RV_OK  - if successful.
 *               Other on failure - in which case, the procedure should be
 *               rejected.
 ...
 *                            of the entries or other problems.
 *****************************************************************************/
RvStatus Rv3G324mCallCheckMUXforRME(
    IN  HCALL           h3G324mCall,
    OUT RvUint16        *validEntries);
/******************************************************************************
 * Rv3G324mCallRMETriggerMES
 * ----------------------------------------------------------------------------
 * General: Trigger to send selected multiplex entries
 *
 * Return Value: RV_OK  - if successful.
 *               Other on failure - in which case, the procedure should be
 *               rejected.
 ...
 *                            of the entries or other problems.
 *****************************************************************************/
RvStatus Rv3G324mCallRMETriggerMES(
    IN  HCALL           h3G324mCall,
    OUT RvUint16        *entries);
