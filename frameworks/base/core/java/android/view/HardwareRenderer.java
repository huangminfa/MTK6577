...
public abstract class HardwareRenderer {
    ...
    /**
     * System property used to debug dirty region.
     * 
     * Possible values:
     * "true", enable to mark red as rendering the dirty region
     * "false", do nothing
     */
    static final String DIRTY_REGION_PROPERTY = "hwui.dirty_region";
    ...
    static abstract class GlRenderer extends HardwareRenderer {
        ...
        int mFrameCount;
        Paint mDebugPaint;
        final boolean mDebugDirtyRegion;
        ...
        GlRenderer(int glVersion, boolean translucent) {
            ...
            final String debugDirtyProperty = SystemProperties.get(DIRTY_REGION_PROPERTY, "");
            mDebugDirtyRegion = "true".equalsIgnoreCase(debugDirtyProperty);
        }
        ...
        int checkCurrent() {
            ...
            // If it has been terminated because of Low Memory
            Gl20Renderer.Gl20RendererEglContext managedContext = sEglContextStorage.get();
            if (managedContext == null) {
            	Xlog.w(LOG_TAG, "!!! Has been terminated !!!");
            	// No need to call destroy()
            	setEnabled(false);
            	// No need to call destroyHardwareLayer()
