...
// pi part
/* 247 + 128 entries */
/* 128 entries: 128 * 128 = 16384 bytes*/
/* ==> need additional 16384 bytes,  32768 + 16384 = 49062 */

// pa part
/* 247 + 128 tocs*/
/* 128 tocs: 128 *4 = 512 bytes*/
/* ==> need additional 512 btyes, 1024 +512 = 1536 bytes*/
/* or */
/* ==> Total = 49062 + 512 = 49574*/
...
static void write_persistent_property(const char *name, const char *value)
{
    ...
    //sync persist settings with storage
    NOTICE("set prop[%s:%s], fsync fs Start \n", name, value);
    fsync(fd);	
    NOTICE("set prop[%s:%s], fsync fs End \n", name, value);
    close(fd);
