...
//        String title = ch.getTitle();
	...
	public final void bind(Context context, final OmacpMessageListItemData ch) {
        ...
        Drawable background = ch.isRead()?
                mContext.getResources().getDrawable(R.drawable.message_item_background_read) :
                mContext.getResources().getDrawable(R.drawable.message_item_background_unread);
