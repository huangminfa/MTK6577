...
public final class MTKConnectivity {
    ...
    public static int startUsingNetworkFeatureGemini(ConnectivityManager connMgr,
            int type,String feature, int simId) {
        return connMgr.startUsingNetworkFeatureGemini(type,feature,simId);
    }

    public static int stopUsingNetworkFeatureGemini(ConnectivityManager connMgr,
            int type,String feature, int simId) {
