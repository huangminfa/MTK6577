...
public class InputMethodManagerService extends IInputMethodManager.Stub
    ...
    public InputMethodManagerService(Context context) {
        ...
        /** M: Add MTK IPO support @{ **/
        if (true == FeatureOption.MTK_IPO_SUPPORT) {
    ...
    public void onServiceDisconnected(ComponentName name) {
        synchronized (mMethodMap) {
            ...
            if (mCurMethod != null && mCurIntent != null
                ...
                mInputShown = false;
                // If the mCurMethod disconnected, try to cancel the IME icon show in StatusBar.
                if (mNotificationShown && mNotificationManager != null) {
                    Slog.d(TAG, "Try to cancel IME StatusBar.");
    ...
    /**
     * M: Changed for hardware qwerty project.
     */
    ...
    private void printUsage(PrintWriter pw) {
        ...
        pw.println("         0 : InputManagerService");
