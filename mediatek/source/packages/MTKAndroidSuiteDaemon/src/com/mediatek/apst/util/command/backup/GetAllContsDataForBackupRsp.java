...
/**
 * Class Name: GetAllContsDataForBackupRsp
 * <p>Package: com.mediatek.apst.util.command.contacts
 * <p>Created on: 2010-12-18
 * <p>
 * <p>Description:
 * <p>Response for asynchronously getting all contact data.
 * <p>
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class GetAllContsDataForBackupRsp extends RawBlockResponse {
    //==============================================================
    // Constants
    //==============================================================
    ...
    // Constructors
    //==============================================================
    public GetAllContsDataForBackupRsp(int requestToken) {
    ...
    //==============================================================
    /**
     * Gets the contact data list.
     * @return The contact data list.
     */
    public ArrayList<ContactData> getAll(int versionCode) {
        ByteBuffer buffer = ByteBuffer.wrap(this.getRaw());
        int count = buffer.getInt();
        ArrayList<ContactData> list = new ArrayList<ContactData>(count);
