...
public class MmsThumbnailPresenter extends Presenter {
    ...
    private void presentImageThumbnail(SlideViewInterface view, ImageModel image) {
        if (image != null) {
            Xlog.d(TAG, "MmsThumbnailPresent. presentImageThumbnail. image src:" + image.getSrc());
        }
        	...
        	if (FeatureOption.MTK_DRM_APP) {
        	    ...
        	    if (extName.equals("dcf") && mSlideCount == 1) {
                    ...
                    try {
                        ...
                        view.setImage(image.getSrc(), BitmapFactory.decodeResource(this.mContext.getResources(),
                            R.drawable.ic_missing_thumbnail_picture));
                    }
        	    }
        	} else {
