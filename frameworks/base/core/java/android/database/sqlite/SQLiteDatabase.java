...
public class SQLiteDatabase extends SQLiteClosable {
    ...
    private static final boolean ENABLE_DB_SAMPLE = true; // true to enable stats in event log
    ...
    private int executeSql(String sql, Object[] bindArgs) throws SQLException {
        ...
        if (sqlType == DatabaseUtils.STATEMENT_ATTACH) {
            disableWriteAheadLogging();
            mHasAttachedDbs = true;
        }
        SQLiteStatement statement = new SQLiteStatement(this, sql, bindArgs,sqlType);
        try {
            return statement.executeUpdateDelete();
        } catch (SQLiteDatabaseCorruptException e) {
            onCorruption();
