...
public class Utils {
    ...
    public static String KEY_EDIT_TODO = "key_edit_todo";
    public static String KEY_EDIT_RESULT = "key_edit_result";
    public static String KEY_PASSED_DATA = "data_passed";
     ...
     * @param asyncQuery
     */
    private static void syncWithDB(QueryListener listener, TodoInfo todoInfo, AsyncQueryHandler asyncQuery, int operatorCode) {
        String idColumnName = TodoColumn._ID;
    ...
    public static void prompt(Context context, int promptStringId) {
        if (mToast == null) {
            mToast = Toast.makeText(context, promptStringId, Toast.LENGTH_SHORT);
        } else {
            mToast.setText(promptStringId);
        }
        mToast.show();
    }
