...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    private void showPopupUnchecked(int maxActivityCount) {
		...
		} else if (maxActivityCount != ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED
                && activityCount > maxActivityCount + maxActivityCountOffset) {
            mAdapter.setShowFooterView(true);
            mAdapter.setMaxActivityCount(maxActivityCount - 1);
        } else {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (getListPopupWindow().isShowing()) {
            if (ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED == mAdapter.getMaxActivityCount()){
    ...
    private void updateAppearance() {
        ...
        if (activityCount > 0 && historySize > 0) {
            ...
            if (mProvider != null) {
                mProvider.defaultButtonVisibilityChanged(true);
            }
            ...
            if (mProvider != null) {
                mProvider.defaultButtonVisibilityChanged(false);
            }
        }
