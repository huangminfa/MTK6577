 ...
 *
 * Feb 26 2010 mtk01476
 * [MAUI_02364135] [Certman]Gadget signature verification check-in
 * 
 *
 * Jan 21 2010 mtk01476
 * [MAUI_02338737] [Certman]x509 version 1 format certificate change to other group feature check-in
 * x509 v1 format certificate re-group change feature check-in
 *
 * Dec 22 2009 mtk01264
 * [MAUI_02020522] [OCSP] Shorten retry interval to 6 seconds
 * Customizable retry timer
 *
 * Dec 7 2009 mtk01264
 * [MAUI_01997593] [Change feature Pre SQC] The OCSP time out should independent with AP.
 * Add timer in OCSP for a user friendly timeout value
 *
 * Dec 4 2009 mtk01264
 * [MAUI_01806383] [Known Issue] The G icon display very long during MIDlet installation after abort if
 * Add new API to abort the validation process
 *
 ...
 *
 * Sep 15 2009 mtk01476
 * [MAUI_01955810] [Certman]Java TCK autogen change feature check-in
 * 
 *
 * Aug 26 2009 mtk01476
 * [MAUI_01944337] [1] Fatal Error (4, 83fa9f8) - CERTMAN
 * feature to delete the TCK certificates in Certman DB in bootup process if found the DB file
 *
 * May 14 2009 mtk01476
 * [MAUI_01687001] [MBA]custpack for java and certman preinstall certificates
 * 
 *
 * May 14 2009 mtk01476
 * [MAUI_01686950] OpenSSL_Delete all CA,then some CA can't be deleted
 * 
 *
 * May 11 2009 mtk01476
 ...
 * 
 *
 * Mar 19 2009 mtk01476
 * [MAUI_01508627] [Certificate manager] Install a certificate, always pop up "Incorrect password".
 * 
 *
 ...
 * 
 *
 * Feb 10 2009 mtk01476
 * [MAUI_01514099] [Certificate manager] Install a certificate, always pop up "Incorrect password".
 * 
 *
 * Dec 28 2007 mtk01434
 * [MAUI_00597617] [CERTMAN] reduce number of preconfigred certificates and set upper bounds
 * added CERTMAN_NUM_CERT_IN_DATABASE
 *
 * Dec 17 2007 mtk01434
 * [MAUI_00592380] [CERTMAN] reduce local parameter memory usage
 * replace filename array with filename pointer in request primitives
 *
 * Dec 6 2007 mtk01434
 * [MAUI_00493309] [Download Agent] The screen always stay at "Start Installing"
 * added validation feature
 *
 * Nov 5 2007 mtk01434
 * [MAUI_00570799] [CERTMAN] checkin upgrades
 * 
 *
 * Nov 2 2007 mtk01434
 * [MAUI_00570799] [CERTMAN] checkin upgrades
 * 
 *
 * Oct 22 2007 mtk01434
 * [MAUI_00563531] [CERTMAN] feature checkin
 * 
 * 
 *
 *------------------------------------------------------------------------------
...
#define CERTMAN_NUM_CERT_IN_VALIDATE    20  /* max number of certificates in validate request certificate chain */
...
#define CERTMAN_JAVA_TCK_FOLDER         L"z:\\@Java\\TCK\\"

/* JAVA TCK trusted ca certs working folder */
#define CERTMAN_JAVA_TCK_VERIFY_PATH    L"z:\\@Java\\TCK\\verify\\"
