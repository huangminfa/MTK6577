...
#define IMAGE_SENSOR_DRVNAME SENSOR_DRVNAME_SP0828_YUV
...
*/
 ...
 #define SYSTEM_CLK                           (52*1000*1000)
  ...
  #define PIXEL_CLK							    (SYSTEM_CLK/8)		// 52/8 MHz
   ...
   #define SP0828_VIDEO_NORMALMODE_FRAME_RATE							30		// Limitation for MPEG4 Encode Only
   #define SP0828_VIDEO_NIGHTMODE_FRAME_RATE							15
	...
	#define SP0828_SENSOR_NIGHT_MODE_GAIN					0x08	// Please refer to OV7670 Implementation Guide
	
	/* SENSOR VGA SIZE */
	#define IMAGE_SENSOR_VGA_WIDTH					(240-8)
	#define IMAGE_SENSOR_VGA_HEIGHT					(320-6)


    #define IMAGE_SENSOR_FULL_WIDTH          (240-8) 
    #define IMAGE_SENSOR_FULL_HEIGHT         (320-6) 
	...
	#define SP0828_WRITE_ID								0x30
	#define SP0828_READ_ID								0x31
