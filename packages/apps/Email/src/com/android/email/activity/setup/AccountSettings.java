...
public class AccountSettings extends PreferenceActivity {
    ...
    // Do not enable the menu "add account" before LoadAccountListTask.onPostExecute->invalidateHeaders()
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (title != null) {
            ...
            // Force the title so that it doesn't get overridden by a direct launch of a specific settings screen.
    ...
    private class LoadAccountListTask extends AsyncTask<Long, Void, Object[]> {
        ...
        protected void onPostExecute(Object[] result) {
            ...
            if (headers == null || headers.length <= 0) {
                ...
                Intent intent = new Intent(AccountSettings.this, AccountSetupBasics.class);
            ...
            AccountSettings.this.runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if (onIsMultiPane()) {
                        ...
                        if(AccountSettings.this.isFinishing()){
                            Logging.d(TAG, "no more account, not switch the header just finsh itself.");
                            return;
                        }
                        Header prefsHeader = getAppPreferencesHeader();
                        AccountSettings.this.switchToHeader(prefsHeader.fragment, prefsHeader.fragmentArguments);
    ...
    public static class WaitingRemoveAccountDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            progressDialog.setMessage(context.getString(R.string.account_settings_delete_account_label) 
                    + "...");
    ...
    public static class LoginWarningDialog extends DialogFragment
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            if (which == DialogInterface.BUTTON_NEGATIVE) {
                ...
                loginFailedCallback.onChangePwd(getArguments().getLong(ACCOUNT_ID));
            }
        }
    }
