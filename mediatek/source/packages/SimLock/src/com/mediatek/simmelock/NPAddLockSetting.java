    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        btnConfirm.setOnClickListener(new Button.OnClickListener()
        {
        	public void onClick(View view)
        	{
               ...
               // else if (etPwd.getText().toString().equals("12345678") == false)
               // {
...
//                }
                ...
                else
                {
                    ...
                    if(false == FeatureOption.MTK_GEMINI_SUPPORT)
                    {
                    	...
                    	{
                    		phone.getIccCard().setIccNetworkLockEnabled(0,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),null,null,callback);
                    	}
                    	else
                    	{
                    		phone.getIccCard().setIccNetworkLockEnabled(0,2,etPwd.getText().toString(),msSIMMCCMNC,null,null,callback);
                    	}                	                	
                    }
                    else
                    {
                    	...
                    	if (intSIMNumber == 0)
                    	{
                        	...
                        	{
                        		mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(0,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),null,null,callback);
                        	}
                        	else
                        	{
                        		mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_1).setIccNetworkLockEnabled(0,2,etPwd.getText().toString(),msSIM1MCCMNC,null,null,callback);
                        	}                	
                    	}
                    	else
                    	{
                        	...
                        	{
                        		mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).setIccNetworkLockEnabled(0,2,etPwd.getText().toString(),etMCCMNC.getText().toString(),null,null,callback);
                        	}
                        	else
                        	{
                        		mGeminiPhone.getIccCardGemini(Phone.GEMINI_SIM_2).setIccNetworkLockEnabled(0,2,etPwd.getText().toString(),msSIM2MCCMNC,null,null,callback);
                        	} 
                        }
    		        }                
              ...
              case ADDLOCK_ICC_SML_COMPLETE:
               {
            	   ...
            	   {
            		   //Toast.makeText(NPAddLockSetting.this, "Np add lock fail", Toast.LENGTH_LONG).show();
            		   showDialog(DIALOG_ADDLOCKFAIL);
            	   }
            	   else
            	   {
            		   //Toast.makeText(NPAddLockSetting.this, "Np add lock succeed!", Toast.LENGTH_LONG).show();
