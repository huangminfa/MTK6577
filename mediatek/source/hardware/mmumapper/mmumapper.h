...
typedef struct mmu_mapper_device_t {
    ...
    int (*register_buffer)(unsigned int addr, unsigned int size, unsigned int *mva);
    int (*unregister_buffer)(unsigned int addr, unsigned int size, unsigned int mva);
    int (*query_buffer)(unsigned int addr, unsigned int size, unsigned int *mva);
