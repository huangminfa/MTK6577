...
public class TestMainActivity extends Activity implements View.OnClickListener {
	...
	private static final String[] TEST_CASE = {
					...
					,"Print Message Id"
					,"Start Proximity Monitor Service"
					,"Start Proximity Monitor UI"
					,"Start Proximity Reporter Service"
					,"Start Proximity Reporter UI"
					,"Test Message - GlueGen"
					};
	...
	public void onCreate( Bundle savedInstanceState ){
		...
		this.testBtn = new Button[TEST_CASE.length];
		for( int i=0; i<this.testBtn.length; i++ ){

			this.testBtn[i] = new Button( this );
			this.testBtn[i].setLayoutParams( new LayoutParams( LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT ) );
			this.testBtn[i].setText( TEST_CASE[i] );
			this.testBtn[i].setOnClickListener( this );
			ll.addView( this.testBtn[i] );
		}
	}
	...
	public void onClick( View view ){
		...
		// Start Proximity Monitor UI (Advanced Settings)
		else if( view == this.testBtn[index++] ){
