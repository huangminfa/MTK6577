...
public class Watchdog extends Thread {
    ...
    private File dumpAllBackTraces(ArrayList<Integer> pids) {
        ...
        File stack = ActivityManagerService.dumpStackTraces(true, pids, null, null);
        synchronized(ANRStats.class){
            File fulltracesFile = ANRStats.createFullStackTracesFile(true);

            if((fulltracesFile!=null) && (stRef!=null)) {
                stRef.dumpAllBackTrace(2,ANRStats.ANRStatsFilePath,pids);
            }
        }
        return stack; 
    }
