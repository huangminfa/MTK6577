 ...
 * <p>Package: com.mediatek.apst.target.receiver
 * <p>Created on: 2010-6-30
 * <p>
 * <p>Description: 
 * <p>This receiver is activated even the main service is not started, thus, 
 * it should be used to do task when main service is not running. Typically 
 * it's used to start the main service, or react to some system events without 
...
public class DaemonReceiver extends BroadcastReceiver {
    ...
    // Constants                                                    
    //==============================================================
    public static final String ACTION_START_MAIN_SERVICE = 
        "com.mediatek.apst.target.action.START_MAIN_SERVICE";
//    public static final String SERVICE_NAME="com.mediatek.apst.target.service.MainService";
...
//                    + (endTime - startTime));
            ...
            try {
                int contactsAppUid = context.getPackageManager().getPackageInfo(
                ...
                if (contactsAppUid == uid){
                    ...
                    // outlook sync 
                    SharedPrefs.open(context).edit()
                    .putBoolean(SharedPrefs.SYNC_NEED_REINIT, true)
                    .commit();
                }
