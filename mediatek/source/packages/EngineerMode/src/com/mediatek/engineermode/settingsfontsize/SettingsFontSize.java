...
public class SettingsFontSize extends Activity {
    ...
    private final static String TAG = "EM_SetFontSize";

    private final static String SMALL = "settings_fontsize_small";
    private final static String LARGE = "settings_fontsize_large";
    private final static String EXTRALARGE = "settings_fontsize_extralarge";

    private EditText mEditSmall, mEditLarge, mEditExtraLarge;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                float smallValue = 1, largeValue = 1, extraLargeValue = 1;
                ...
                boolean isSuccessSm, isSuccessLa, isSuccessEx;
                if (!small.equals("")) {
