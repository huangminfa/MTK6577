...
public class BSPPackageDevToolActivity extends Activity {
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_DATA_DEFAULT_SIM_CHANGED)) {
                long simInfoId = intent.getLongExtra(Phone.MULTI_SIM_ID_KEY, Settings.System.DEFAULT_SIM_NOT_SET);
                mDefaultDataSimId = SIMInfo.getSlotById(BSPPackageDevToolActivity.this, simInfoId);
    ...
    private OnClickListener mStatusbarNotificationOnClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (mIsStatusBarNotificationEnabled)
                startService(new Intent(BSPPackageDevToolActivity.this, BSPPackageDevToolService.class));
            else
                stopService(new Intent(BSPPackageDevToolActivity.this, BSPPackageDevToolService.class));
        }
    };
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btn_default_sim_sim1:
                    mDefaultSimId = Phone.GEMINI_SIM_1;
                    break;
                case R.id.btn_default_sim_sim2:
                    mDefaultSimId = Phone.GEMINI_SIM_2;
                    break;
            }

            try {
                mTelephony.setDefaultPhone(mDefaultSimId);
                SystemProperties.set(Phone.GEMINI_DEFAULT_SIM_PROP, String.valueOf(mDefaultSimId));
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.btn_default_data_sim1:
                    mDefaultDataSimId = Phone.GEMINI_SIM_1;
                    break;
                case R.id.btn_default_data_sim2:
                    mDefaultDataSimId = Phone.GEMINI_SIM_2;
                    break;
                case R.id.btn_default_data_off:
                    mDefaultDataSimId = -1;
            }

            SIMInfo simInfo = SIMInfo.getSIMInfoBySlot(BSPPackageDevToolActivity.this, mDefaultDataSimId);
            if (simInfo != null) {
                intent.putExtra(Phone.MULTI_SIM_ID_KEY,
                        SIMInfo.getSIMInfoBySlot(BSPPackageDevToolActivity.this, mDefaultDataSimId).mSimId);
            }
    ...
    private PhoneStateListener mPhone1StateListener = new PhoneStateListener() {
        ...
        public void onServiceStateChanged(ServiceState serviceState) {
            ...
            if (serviceState.getState() == ServiceState.STATE_IN_SERVICE) {
                ...
                mNetworkTypeSim1.setText(Utility.getNetworkTypeString(mTelephonyManager.getNetworkTypeGemini(Phone.GEMINI_SIM_1)));
            } else {
        ...
        public void onDataConnectionStateChanged(int state, int networkType) {
            ...
            int peerSimState = mTelephonyManager.getDataStateGemini(Phone.GEMINI_SIM_2);
            if (peerSimState > 0) {
                if (peerSimState == TelephonyManager.DATA_CONNECTED) {
                    mDataConnectionTypeSim2.setText(Utility.getNetworkTypeString(mTelephonyManager.getNetworkTypeGemini(Phone.GEMINI_SIM_2)));
                } else {
    ...
    private PhoneStateListener mPhone2StateListener = new PhoneStateListener() {
        ...
        public void onServiceStateChanged(ServiceState serviceState) {
            ...
            if (serviceState.getState() == ServiceState.STATE_IN_SERVICE) {
                ...
                mNetworkTypeSim2.setText(Utility.getNetworkTypeString(mTelephonyManager.getNetworkTypeGemini(Phone.GEMINI_SIM_2)));
            } else {
        ...
        public void onDataConnectionStateChanged(int state, int networkType) {
            ...
            int peerSimState = mTelephonyManager.getDataStateGemini(Phone.GEMINI_SIM_1);
            if (peerSimState > 0) {
                if (peerSimState == TelephonyManager.DATA_CONNECTED) {
                    mDataConnectionTypeSim1.setText(Utility.getNetworkTypeString(mTelephonyManager.getNetworkTypeGemini(Phone.GEMINI_SIM_1)));
                } else {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mIsStatusBarNotificationEnabled = BSPPackageDevToolService.isRunning();

        mDefaultSimId = SystemProperties.getInt(Phone.GEMINI_DEFAULT_SIM_PROP, Phone.GEMINI_SIM_1);
    ...
    protected void onDestroy() {
        super.onDestroy();
        mTelephonyManager.listenGemini(mPhone1StateListener, PhoneStateListener.LISTEN_NONE, Phone.GEMINI_SIM_1);
        mTelephonyManager.listenGemini(mPhone2StateListener, PhoneStateListener.LISTEN_NONE, Phone.GEMINI_SIM_2);
        unregisterReceiver(mBroadcastReceiver);
    }

    private void updateUI() {
        if (mDefaultSimId == Phone.GEMINI_SIM_1) {
