...
struct wpa_driver_ops {
	 ...
	 */
	 ...
	 /**
     * set_value - Setting the Sigma define p2p value
     * @priv: private driver interface data
     * @idx: The Sigma p2p set cmd map index
     * @value: the value to set to driver
     * @result: TRUE, or  FALSE
     *
     * Returns: 0 on success, -1 on failure
     */
     int (*set_value)(void *priv, struct wpa_driver_test_params *params);
};
...
Boolean wpa_supplicant_hotspot(void *ctx);
