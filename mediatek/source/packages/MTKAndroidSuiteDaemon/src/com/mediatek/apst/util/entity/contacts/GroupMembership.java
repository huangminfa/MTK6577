...
/**
 * Class Name: GroupMembership
 * <p>Package: com.mediatek.apst.util.entity.contacts
 * <p>Created on: 2010-6-21
 * <p>
 * <p>Description: 
 * <p>Group membership data of a contact.
 *
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class GroupMembership extends ContactData implements Cloneable {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    //@Override
    public GroupMembership clone() throws CloneNotSupportedException{
        GroupMembership copy = (GroupMembership)(super.clone());
