...
public class SignalStrength implements Parcelable {
    ...
    private int mGsmRscpQdbm; // This valus is GSM 3G rssi value
    ...
    public int getGsmLevel() {
        ...
        if(IS_CMCC)
        {
            ...
            else if (asu >= 29) level = SIGNAL_STRENGTH_HIGHEST;
            else if (asu >= 16) level = SIGNAL_STRENGTH_GREAT;
