...
extern int mt6577_nand_read_page_hw(u32 page, u8 *dat, u8 *oob);
extern bool nand_block_bad_hw(u32 offset);
extern bool mt6577_nand_erase_hw(u32 offset);
extern bool mark_block_bad_hw(u32 offset);
extern int mt6577_nand_write_page_hw(u32 page, u8 *dat, u8 *oob);

#elif defined(__UBOOT_NAND__)

extern int mt6577_nand_exec_read_page_hw(struct nand_chip *nand, u32 page, u32 page_size, u8 *dat, u8 *oob);
