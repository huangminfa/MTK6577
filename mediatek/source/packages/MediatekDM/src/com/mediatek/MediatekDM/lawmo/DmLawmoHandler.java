...
public class DmLawmoHandler implements LawmoHandler {
    ...
    public LawmoOperationResult executeFactoryReset() {
        ...
        try
        {
            ...
            mDmAgent.setWipeFlag("FactoryReset");
            Log.i(TAG.Lawmo, "executeFactoryReset FactoryReset has been set");
            File wipeFile = new File(DmConst.pathname.PathWipe);
    ...
    public LawmoOperationResult executePartiallyLock() {
        ...
        try
        {
            ...
            mDmAgent.setLockFlag("partially");
            ...
            Log.i(TAG.Lawmo, "executePartiallyLock Intent : com.mediatek.MediatekDM.LAWMO_LOCK broadcasted.");
            ...
            Log.i(TAG.Lawmo, "After write status, the lawmo staus is "+ mDmTree.getIntValue(lawmoUri));
    ...
    public LawmoOperationResult executeUnLock() {
        ...
        try
        {
            if (mDmAgent==null)
            {
                ...
                return new LawmoOperationResult(
                           new LawmoResultCode(LawmoResultCode.UNLOCK_FAILED));
            }
            ...
            Log.i(TAG.Lawmo, "executeUnLock Intent : com.mediatek.MediatekDM.LAWMO_UNLOCK broadcasted.");
    ...
    public boolean isRestartAndroid()
    {
        ...
        try
        {
            File configFileInSystem = new File(DmConst.pathname.DmConfigFileInSystem);
            if (configFileInSystem!=null&&configFileInSystem.exists()) {
                DmXMLParser xmlParser = new DmXMLParser(DmConst.pathname.DmConfigFileInSystem);
                if (xmlParser!=null)
                {
