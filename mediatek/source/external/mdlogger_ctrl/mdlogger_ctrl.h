...
#undef LOG_TAG
#define LOG_TAG "MDLOGGER_CTRL"
#include <utils/Log.h>	//Logcat

#define MDL_DATA_DIR 	"/data/mdl/"
#define SERVER_FIFO		"/data/mdl/mdl_serv_fifo"
#define CLIENT_FIFO		"/data/mdl/mdl_cli_fifo"
