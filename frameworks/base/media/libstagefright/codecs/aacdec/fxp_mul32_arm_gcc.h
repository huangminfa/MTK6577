...
#define MAX_64 (int64_t)(0x7FFFFFFFFFFFFFFF)
#define MIN_64 (int64_t)(0x8000000000000000)
    
#define _saturate32(a) (a > MAX_32 ?  MAX_32 : a < MIN_32 ? MIN_32 : a)
            
     /*
     * Saturating 32-bit integer addition.
     */
     static inline Int32 qadd(Int32 x, Int32 y)
     {
        register Int32 ret;
        
        asm volatile ( "qdadd %[ret], %[x], %[y] \n"
           : [ret]"=r"(ret)
           : [x]"%r"(x), [y]"r"(y));
     ...
     */
    static inline Int32 qsub(Int32 x, Int32 y)
    {
        register Int32  ret;

        asm volatile ( "qsub %[ret], %[x], %[y] \n"
           : [ret]"=r"(ret)
           : [x]"%r"(x), [y]"r"(y));
    ...
    static inline int64_t L_add64(int64_t L_var1, int64_t L_var2)
    {
        int64_t L_var_out;
    ...
    static inline  int64_t fxp_mac64_Q31(int64_t sum, const Int32 L_var1, const Int32 L_var2)
    {
#ifndef ANDROID_DEFAULT_CODE
        sum = L_add64(sum, (int64_t)L_var1 * L_var2); 
#else
