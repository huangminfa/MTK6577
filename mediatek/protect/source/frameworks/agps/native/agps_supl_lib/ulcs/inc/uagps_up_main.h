 ...
 * Description:
 * --------------------------------------------------------
 *   Declaration of funcitons of main entry for UAGPS_UP.
 *
 * Author:
 * --------------------------------------------------------
 *   David Niu
...
#ifndef _UAGPS_UP_MAIN_H
#define _UAGPS_UP_MAIN_H
...
extern void uagps_up_main(ilm_struct * pIlm);


#endif /* _UAGPS_UP_MAIN_H */
