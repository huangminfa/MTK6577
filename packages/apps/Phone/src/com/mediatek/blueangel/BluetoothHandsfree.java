...
public class BluetoothHandsfree {
    ...
    private class BluetoothPhoneState {
        ...
        private static final int PHONE_NEW_RINGING_CONNECTION = 8;
        ...
        private Handler mStateChangeHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                case PHONE_NEW_RINGING_CONNECTION:
                    log("[MSG] PHONE_NEW_RINGING_CONNECTION");
                    Connection cdmaConnection = null;
                    cdmaConnection = (Connection) ((AsyncResult) msg.obj).result;
                    Phone phone = cdmaConnection.getCall().getPhone();
                    if (phone.getPhoneType() != Phone.PHONE_TYPE_CDMA) {
                        break;
                    }
                    ///M: only cdma call will process PHONE_INCOMING_CDMA_RING
        ...
        private void registerPhoneEvents(boolean register) {
            ...
            if(register) {
                ...
                if (FeatureOption.MTK_GEMINI_SUPPORT == true) {
        	      ...
        	      // SH : Merge Yufeng's modification
        	         mMCM.registerForNewRingingConnectionGemini(mStateChangeHandler, PHONE_NEW_RINGING_CONNECTION, null, Phone.GEMINI_SIM_1);
        	      ...
        	      // SH : Merge Yufeng's modification
                   mMCM.registerForNewRingingConnectionGemini(mStateChangeHandler, PHONE_NEW_RINGING_CONNECTION, null, Phone.GEMINI_SIM_2);
		      ...
		      if( FeatureOption.MTK_VT3G324M_SUPPORT == true )
		      {
                    ...
                    mCM.registerForNewRingingConnection(mStateChangeHandler, 
                ...
                if (FeatureOption.MTK_GEMINI_SUPPORT == true) {
                    ...
                    mMCM.unregisterForNewRingingConnectionGemini(mStateChangeHandler, Phone.GEMINI_SIM_1);
                    ...
                    mMCM.unregisterForNewRingingConnectionGemini(mStateChangeHandler, Phone.GEMINI_SIM_2);
			   ...
			   mMCM.unregisterForVtRingInfoGemini(mStateChangeHandler, Phone.GEMINI_SIM_2);
                    ...
                    mCM.unregisterForNewRingingConnection(mStateChangeHandler);
    ...
    /* package */ synchronized void userWantsAudioOn() {
        ...
        if (mIsProcAudioOff == true) {
            log("[API] user want audio on when audio off is processing");
