...
public class FMTransmitterContentProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        if (v.containsKey(FMTransmitterStation.Station.COLUMN_STATION_NAME)== false
            || v.containsKey(FMTransmitterStation.Station.COLUMN_STATION_FREQ)== false
            || v.containsKey(FMTransmitterStation.Station.COLUMN_STATION_TYPE)== false) {
