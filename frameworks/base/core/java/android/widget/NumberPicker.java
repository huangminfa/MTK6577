...
public class NumberPicker extends LinearLayout {
    ...
    private void initializeSelectorWheel() {
        ...
        mCurrentScrollOffset = mInitialScrollOffset;
        Xlog.i(TAG, "initializeSelectorWheel, mCurrentScrollOffset="+mCurrentScrollOffset
            +", mSelectorElementHeight="+mSelectorElementHeight
            +", editTextTextPosition="+editTextTextPosition
            +", mSelectorElementHeight="+mSelectorElementHeight
            +", mSelectorTextGapHeight="+mSelectorTextGapHeight
            +", mTextSize="+mTextSize
            +", totalTextHeight="+totalTextHeight
            +", totalTextGapHeight="+totalTextGapHeight
            +", textGapCount="+textGapCount);
        updateInputTextView();
    }
