...
public class MdmTree {
     ...
     * Node operations
     */
    public void addLeafNode(String nodeUri, String format, String type, byte[] data) throws MdmException {
        if (false == mTMA.addLeaf(nodeUri, format, type, data)) {
            throw new MdmException(MdmError.INTERNAL);
        }
    }

    public void addChildLeafNode(String parentUri, String nodeName, String format, String type, byte[] data) throws MdmException {
    ...
    public void addInteriorChildNode(String parentUri, String nodeName, String type) throws MdmException {
    ...
    public void registerDeleteSubTree(String nodeUri, NodeDeleteHandler handler) throws MdmException {
        // TODO
        throw new NotImplementedError();
    }
    ...
    public void replaceProperty(String nodeUri, String propertyName, String value) throws MdmException {
