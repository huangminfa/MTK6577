...
/**
 * Class Name: AddContactDataRsp
 * <p>Package: com.mediatek.apst.util.command.contacts
 * <p>Created on: 2010-12-18
 * <p>
 * <p>Description: 
 * <p>Response for adding a contact data.
 * <p>
 * @author mtk80734 Siyang.Miao
 * @version V1.0
 */
public class AddContactDataRsp extends ResponseCommand {
    //==============================================================
    // Constants                                                    
    //==============================================================
    ...
    // Constructors                                                 
    //==============================================================
    public AddContactDataRsp(int requestToken){
    ...
    public void setResult(ContactData result){
        this.result = result;
    }
