...
class WifiApConfigStore extends StateMachine {
    ...
    private void setDefaultApConfiguration() {
        WifiConfiguration config = new WifiConfiguration();
        config.SSID = mContext.getString(com.android.internal.R.string.wifi_tether_configure_ssid_default);
        //MTK_OP01_PROTECT_START
        String OPTR = SystemProperties.get("ro.operator.optr", "");
        if (OPTR.equals("OP01")) {
            config.SSID = mContext.getString(com.mediatek.internal.R.string.wifi_tether_configure_ssid_default_for_cmcc);
        }
