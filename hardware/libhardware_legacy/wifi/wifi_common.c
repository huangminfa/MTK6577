...
void close_supplicant_connection_no_wait(const struct _SUPPLICANT_PARA_T * prTar, P_SUPPLICANT_INFO_T prTarInfo)
{
...
void close_supplicant_connection(const struct _SUPPLICANT_PARA_T * prTar, P_SUPPLICANT_INFO_T prTarInfo)
{
    ...
    close_supplicant_connection_no_wait(prTar, prTarInfo);
