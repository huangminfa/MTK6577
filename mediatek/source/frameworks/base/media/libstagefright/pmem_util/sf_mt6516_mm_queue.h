...
#ifndef __SF_MT6516_MM_QUEUE_H__
#define __SF_MT6516_MM_QUEUE_H__
...
typedef struct _sf_mm_queue_info_t {
...
typedef struct _sf_mm_queue_list_t {
    sf_mm_queue_info info;
    struct _sf_mm_queue_list_t *next;
} sf_mm_queue_list;

#endif //__SF_MT6516_MM_QUEUE_H__