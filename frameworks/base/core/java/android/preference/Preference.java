...
public class Preference implements Comparable<Preference>, OnDependencyChangeListener { 
    ...
    // Add listener for gemini use.
    private OnViewChangedListener mViewChangedListener = null;
    ...
    public View getView(View convertView, ViewGroup parent) {
        ...
        if (mViewChangedListener != null) {
            mViewChangedListener.giveViewInformation(convertView, this);
        }
        return convertView;
    }
     ...
     * @param listener
     */
    public void setOnViewChangeListener(OnViewChangedListener listener) {
        mViewChangedListener = listener;
    }

    /**
     * Interface definition for a callback to be invoked when the view of this
