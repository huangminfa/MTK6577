...
package com.mediatek.engineermode.cpufreq;

import com.mediatek.engineermode.emsvr.*; //import com.mediatek.engineermode.baseband.EMbaseband;
...
public class Cpufreq extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mBtnStopTest.setVisibility(View.GONE);
	}
