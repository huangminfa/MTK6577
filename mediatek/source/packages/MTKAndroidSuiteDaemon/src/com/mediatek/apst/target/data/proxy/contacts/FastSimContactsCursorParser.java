...
public class FastSimContactsCursorParser extends FastCursorParser{
    ...
    // Constructors                                                 
    //==============================================================
    public FastSimContactsCursorParser(Cursor c, IRawBlockConsumer consumer, 
            ByteBuffer buffer, int simId) {
    ...
    public int onParseCursorToRaw(Cursor c, ByteBuffer buffer){
        return SimContactsContent.cursorToRaw(c, buffer, mSimId);
    }
