...
public class DefaultContactListAdapter extends ContactListAdapter {
    ...
    public ProfileAndContactsLoader sdnLoader = null;
    ...
    public void configureLoader(CursorLoader loader, long directoryId) {
        if (loader instanceof ProfileAndContactsLoader) {
        	sdnLoader = (ProfileAndContactsLoader) loader;
            ...
            case ContactListFilter.FILTER_TYPE_ACCOUNT: {
                ...
                if (AccountType.ACCOUNT_TYPE_LOCAL_PHONE.equals(filter.accountType)) {
                    selection.append("EXISTS ("
                                    ...
                                    + " FROM raw_contacts"
                                    + " WHERE ( "
                                    + RawContacts.IS_SDN_CONTACT + " = 0 AND "
    ...
    protected void bindView(View itemView, int partition, Cursor cursor, int position) {
        ...
        mContactExtention.bindExtentionIcon(view, partition, cursor);
        /*
    ...
    public void updateIndexer(Cursor cursor) {
        ...
        if (this.sdnLoader != null) {        	 
            if (this.sdnLoader.hasSdnContact()) {
            	sectionIndexer.setSdnHeader("SDN", this.sdnLoader.getSdnContactCount());
            }
        }
