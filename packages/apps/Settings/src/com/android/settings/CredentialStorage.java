...
public final class CredentialStorage extends Activity {
    ...
    private static AlertDialog mConfigureKeyGuardDialog = null;
    private static AlertDialog mResetDialog = null;
    private static AlertDialog mUnlockDialog = null;
            ...
            implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener
    {
        ...
        private ConfigureKeyGuardDialog() {
        	if (mConfigureKeyGuardDialog == null) {
        		AlertDialog dialog = new AlertDialog.Builder(CredentialStorage.this)
                	.setTitle(android.R.string.dialog_alert_title)
                	.setIcon(android.R.drawable.ic_dialog_alert)
                	...
                	.setNegativeButton(android.R.string.cancel, this)
                	.create();
        		mConfigureKeyGuardDialog = dialog;
		        dialog.setOnDismissListener(this);
		        dialog.show();
        	}
        ...
        private UnlockDialog() {
            ...
            if (mUnlockDialog == null) {
            	AlertDialog dialog = new AlertDialog.Builder(CredentialStorage.this)
            		...
            		.setNegativeButton(android.R.string.cancel, this)
            		.create();
            	mUnlockDialog = dialog;
		        dialog.setOnDismissListener(this);
		        dialog.show();
            }
            mButton = mUnlockDialog.getButton(DialogInterface.BUTTON_POSITIVE);
