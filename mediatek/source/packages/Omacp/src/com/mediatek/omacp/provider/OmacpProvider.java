...
public class OmacpProvider extends ContentProvider {
	...
	private static final String XLOG = "Omacp/OmacpProvider";
    ...
    static{
        sUriMatcher.addURI("omacp", null , OMACP_ALL);
        sUriMatcher.addURI("omacp", "#" , OMACP_ID);
    }
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        case OMACP_ID:
            ...
            try{
                ...
                Xlog.e(XLOG, "OmacpProvider Delete: Bad Message ID");
                return 0;
            }
            ...
            break;
        default:
            Xlog.e(XLOG, "OmacpProvider Unknown URI: " + uri);
            return 0;
        }
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		switch(sUriMatcher.match(uri)){
			case OMACP_ALL:
		        ...
		        if (rowId > 0) {
		            Uri insertUri = ContentUris.withAppendedId(OmacpProviderDatabase.CONTENT_URI, rowId);
		            ContentResolver cr = getContext().getContentResolver();
		            cr.notifyChange(uri, null);
		            return insertUri;
		        }else{
		            Xlog.e(XLOG, "OmacpProvider Failed to insert! "+ values.toString());
		        }
				break;
			default:
				Xlog.e(XLOG, "OmacpProvider insert Unknown URI: " + uri);
	            return null;
		}
	...
	public Cursor query(Uri uri, String[] projection, String selection,
        ...
        case OMACP_ID:
            ...
            break;
        default:
            Xlog.e(XLOG, "OmacpProvider query Unknown URI: " + uri);
            return null;
        }
	...
	public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        case OMACP_ALL:
            ...
            break;            
        case OMACP_ID:
        	String newIdSelection = OmacpProviderDatabase._ID + "=" + uri.getPathSegments().get(0) + (!TextUtils.isEmpty(selection) ? " AND (" + selection + ')' : "");
            count = db.update(TABLE_OMACP, values, newIdSelection, selectionArgs);
            break;
        default:
            Xlog.e(XLOG, "OmacpProvider update Unknown URI: " + uri);
            return count;
        }
