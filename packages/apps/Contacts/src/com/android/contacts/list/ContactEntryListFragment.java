...
public abstract class ContactEntryListFragment<T extends ContactEntryListAdapter>
    ...
    public void onCreate(Bundle savedState) {
        ...
        intentFilter.addAction(ContactExtentionManager.RCS_CONTACT_PRESENCE_CHANGED);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        if (id == DIRECTORY_LOADER_ID) {
            ...
            long directoryId = args != null && args.containsKey(DIRECTORY_ID_ARG_KEY)
                    ...
                    : Directory.DEFAULT;
            mAdapter.setTempFlag((this instanceof ContactsMultiDeletionFragment) ? "delete" : null);
    ...
    private BroadcastReceiver mRCSPresenceChangedListener = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (ContactExtentionManager.RCS_CONTACT_PRESENCE_CHANGED.equals(intent.getAction())){
