            ...
            public void run() {
				...
				try{
                    ...
                    synchronized (sListeners) {
                    	...
                    	}catch(NullPointerException e){Log.e(TAG,"sensorObject -> Null");}
						
                    }
					} catch(NullPointerException e){
						if(sListeners.equals(null)){Log.e(TAG,"sListeners -> Null");}
						if(sHandleToSensor.equals(null)){Log.e(TAG,"sHandleToSensor -> Null");}
						Log.e(TAG,"SensorManager thread.run function error!");
					}
                }
