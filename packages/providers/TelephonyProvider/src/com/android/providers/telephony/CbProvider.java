...
public class CbProvider extends ContentProvider {
    ...
    private void notifyChange() {
        ...
        cr.notifyChange(Telephony.CbSms.CONTENT_URI, null);
        cr.notifyChange(Telephony.CbSms.Conversations.CONTENT_URI, null);
    ...
    public Cursor query(Uri url, String[] projection, String selection,
        ...
        case URL_MESSAGES:
            ...
            Cursor ret = qb.query(dbmmssms, projection, selection, selectionArgs, null,
                    null, sortOrder);
            if(ret != null)
                ret.setNotificationUri(getContext().getContentResolver(), Telephony.CbSms.CONTENT_URI);
            return ret;
            //break;
        case URL_CHANNEL:
        ...
        case URL_CONVERSATION:
            ...
            if(retmmssms != null)
            	retmmssms.setNotificationUri(getContext().getContentResolver(), Telephony.CbSms.CONTENT_URI);
            return retmmssms;
            //break;
        case URL_ADDRESS:
        ...
        case URL_CONVERSATIONS_MESSAGES:
            ...
            if(retmmssmsconv != null)
            	retmmssmsconv.setNotificationUri(getContext().getContentResolver(), Telephony.CbSms.CONTENT_URI);
    ...
    private void insertThread(String recipientIds, int numberOfRecipients) {
        ...
        values.put(Telephony.CbSms.DATE, date - date % 1000);
        //values.put(Telephony.CbSms.Conversations.ADDRESS_ID, recipientIds);
        values.put("recipient_ids", recipientIds);
        values.put(Telephony.CbSms.Conversations.MESSAGE_COUNT, 0);
    ...
    private void setThreadStatus(ContentValues values) {
        ...
        statusValues.put(Threads.STATUS, 0);
    ...
    public Uri insert(Uri url, ContentValues initialValues) {
        ...
        case URL_CHANNEL:
            ...
            if (values.containsKey(Telephony.CbSms.CbChannel.NAME) == false) {
                values.put(Telephony.CbSms.CbChannel.NAME, "");
            }
            if (values.containsKey(Telephony.CbSms.CbChannel.NUMBER) == false) {
                values.put(Telephony.CbSms.CbChannel.NUMBER, "");
            }
            if (values.containsKey(Telephony.CbSms.CbChannel.ENABLE) == false) {
                values.put(Telephony.CbSms.CbChannel.ENABLE, false);
            }
        ...
        case URL_CONVERSATION:
            ...
            if (values.containsKey(Telephony.CbSms.Conversations.SNIPPET) == false) {
                values.put(Telephony.CbSms.Conversations.SNIPPET, "");
            }
            if (values.containsKey(Telephony.CbSms.CHANNEL_ID) == false) {
                values.put(Telephony.CbSms.CHANNEL_ID, -1);
            }
            ...
            if (values.containsKey(Telephony.CbSms.Conversations.ADDRESS_ID) == false) {
                values.put(Telephony.CbSms.Conversations.ADDRESS_ID, -1);
            }
            if (values
                    .containsKey(Telephony.CbSms.Conversations.MESSAGE_COUNT) == false) {
                values.put(Telephony.CbSms.Conversations.MESSAGE_COUNT, 0);
            }
        ...
        case URL_ADDRESS:
            ...
            if (values
                    .containsKey(Telephony.CbSms.CanonicalAddressesColumns.ADDRESS) == false) {
                values.put(Telephony.CbSms.CanonicalAddressesColumns.ADDRESS,
                        -1);
            }
            rowID = db.insert(table, null, values);
            if (rowID > 0) {
