...
public class MediaRecorder
{
    ...
    private static final String KEY_TOUCHFOCUS_X = "af-x";
    private static final String KEY_TOUCHFOCUS_Y = "af-y";
    ...
    public void setHDRecordMode(int mode, boolean isVideo) {
        ...
        if (isVideo) {
            setParameter(String.format(new Locale("en"), "audio-param-hdrecvideomode=%d", mode));
        } else {
            setParameter(String.format(new Locale("en"), "audio-param-hdrecvoicemode=%d", mode));
        }
    }
    ...
    public void setOrientationHint(int degrees) {
        ...
        setParameter(String.format(new Locale("en"), "video-param-rotation-angle-degrees=%d", degrees));
    }
    ...
    public void setAudioSamplingRate(int samplingRate) {
        ...
        setParameter(String.format(new Locale("en"), "audio-param-sampling-rate=%d", samplingRate));
    }
    ...
    public void setZoomValue(int value) {
        ...
        setParametersExtra(String.format(new Locale("en"), "video-param-camera-digizoom=%d", value));
    } 
    ...
    public void setAudioChannels(int numChannels) {
        ...
        setParameter(String.format(new Locale("en"), "audio-param-number-of-channels=%d", numChannels));
    }
    ...
    public void setAudioEncodingBitRate(int bitRate) {
        ...
        setParameter(String.format(new Locale("en"), "audio-param-encoding-bitrate=%d", bitRate));
    }
    ...
    public void setVideoEncodingBitRate(int bitRate) {
        ...
        setParameter(String.format(new Locale("en"), "video-param-encoding-bitrate=%d", bitRate));
    }
    ...
    public interface AutoFocusCallback {
        void onAutoFocus(boolean success, MediaRecorder mr);
    }
    ...
    public void autoFocus(AutoFocusCallback cb) {
        ...
        setParametersExtra("video-param-camera-dofocus=1");
    }
    ...
    public void cancelAutoFocus() {
        ...
        setParametersExtra("video-param-camera-cancelfocus=1");
    }
    
    /**
     * @hide
     */
    public void setFocusPosX(int x) {
       // String focusPos = KEY_TOUCHFOCUS_X + "=" + Integer.toString(x) + ";" + KEY_TOUCHFOCUS_Y + "=" + Integer.toString(y);
        setParametersExtra(String.format(new Locale("en"), "video-param-camera-focus-afx=%d", x));
    }

    /**
     * @hide
     */
    public void setFocusPosY(int y) {
        setParametersExtra(String.format(new Locale("en"), "video-param-camera-focus-afy=%d", y));
    }
    ...
    private class EventHandler extends Handler
    {
        ...
        private static final int MEDIA_RECORDER_EVENT_FOCUS = 0x200;
        private static final int MEDIA_RECORDER_EVENT_LIST_END   = 0x200;
        ...
        public void handleMessage(Message msg) {
            ...
            case MEDIA_RECORDER_TRACK_EVENT_INFO:
                ...
                return;
            case MEDIA_RECORDER_EVENT_FOCUS:
            Log.v(TAG, "mediaRecorder autoFocusCallback: " + mAutoFocusCallback);
                if (mAutoFocusCallback != null) {
                    mAutoFocusCallback.onAutoFocus(msg.arg1 == 0 ? false : true , mMediaRecorder);
                }
    ...
    /**
     * Special case for camera release notify.
     */
    private static final int MEDIA_RECORDER_EVENT_INFO = 2;
                                            ...
                                            int what, int arg1, int arg2, Object obj)
    {
        ...
        if (mr.mEventHandler != null) {
            if (what == MEDIA_RECORDER_EVENT_INFO &&
                ...
                Log.i(TAG, "MediaRecorder MEDIA_RECORDER_INFO_CAMERA_RELEASE");
                if (mr.mOnCameraReleasedListener != null) {
                    //call notify in binder thread, video camera can go on its job. 
    ...
    private native void setParametersExtra(String nameValuePair);

    @Override
    protected void finalize() { native_finalize(); }
    
    /**
     * Pauses recording. Call start() to resume.
