...
extern "C" {
#endif
#ifndef __nsrpProcessState__
#define __nsrpProcessState__

extern vt_nsrp_state_enum nsrpProcessState;
#endif
...
/******************************************************************************
 * MTK: vt_isMuxerMuxtableEntryValid (for ACP checking)
 * ----------------------------------------------------------------------------
 * General: 
 *
 * Return Value: RV_OK                  - if successful.
 ...
 *****************************************************************************/
RvStatus vt_isMuxerMuxtableEntryValid(
    IN    HMUXER        hmuxer,
 ...
 *****************************************************************************/
 ...
 RvStatus RvH223ReceiveFirstH223PDU(
     IN     HMUXER              hmuxer);
