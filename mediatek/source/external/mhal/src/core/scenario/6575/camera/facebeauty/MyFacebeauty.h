...
*
*******************************************************************************/
#define MY_DBG(fmt, arg...)     LOGD("{FBShot}"fmt, ##arg)
#define MY_INFO(fmt, arg...)    LOGI("{FBShot}"fmt, ##arg)
#define MY_WARN(fmt, arg...)    LOGW("{FBShot}"fmt, ##arg)
#define MY_ERR(fmt, arg...)     LOGE("{FBShot}<%s:#%d>"fmt, __FILE__, __LINE__, ##arg)
