...
extern kal_int32 app_ucs2_strnicmp(const kal_int8 *str_src, const kal_int8 *str_dst, kal_uint32 count);
...
extern kal_int32 app_ucs2_wcsncmp(const kal_wchar *str_src, const kal_wchar *str_dst, kal_uint32 count);
...
extern kal_int32 app_ucs2_wcsnicmp(const kal_wchar *str_src, const kal_wchar *str_dst, kal_uint32 count);
