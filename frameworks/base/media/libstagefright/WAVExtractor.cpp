...
#define ENABLE_WAVEX_DEBUGLOG
#ifdef ENABLE_WAVEX_DEBUGLOG
#define WAV_EXTR_DBG(fmt, arg...) SXLOGD(fmt, ##arg)
#define WAV_EXTR_WARN(fmt, arg...) SXLOGW(fmt, ##arg)
#define WAV_EXTR_ERR(fmt, arg...)  SXLOGE("Err: %5d:, "fmt, __LINE__, ##arg)
#else
#define WAV_EXTR_DBG(a,...)
#define WAV_EXTR_WARN(a,...)
#define WAV_EXTR_ERR(a,...)
#endif
#endif
namespace android {
