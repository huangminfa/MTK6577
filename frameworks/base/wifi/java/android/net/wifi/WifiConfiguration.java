...
public class WifiConfiguration implements Parcelable {
     ...
     * @hide
     */
    public static final String imsiVarName = "imsi";
    /**
     * @hide
     */
    public static final String simSlotVarName = "sim_slot";
    /**
     * @hide
     */
    public static final String pcscVarName = "pcsc";
    // Add for EAP-SIM end
    ...
    public String toString() {
        ...
        sbuf.append("\n");
        if (FeatureOption.MTK_EAP_SIM_AKA) {
            sbuf.append(" IMSI: ").append(this.IMSI).append(" SIMSLOT: ").append(this.SIMSLOT).append(" PCSC: ").append(this.PCSC).append('\n');
        }
