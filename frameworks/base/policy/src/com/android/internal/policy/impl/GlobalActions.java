...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    //[ALPS00301284]To resolve this issue, we add this flag to record the theme state. If it is changed, re-create the dialog.
    ...
    public void showDialog(boolean keyguardShowing, boolean isDeviceProvisioned) {
        // if the window of power off shows, we don't want to show the dialog.
        if (ShutdownThread.isPowerOffDialogShowing()) {
            return;
        }
        //[ALPS00285749] In order to solve the JE caused by WMS warning the window type change from ICS, 
        // we dimiss the dialog to detroy the original window. It can avoid window type change issue.
        if (mDialog != null && mKeyguardShowing != keyguardShowing) {
            mDialog.dismiss();
            mDialog = null;
        }
    ...
    PhoneStateListener mPhoneStateListener = new PhoneStateListener() {
        ...
        public void onServiceStateChanged(ServiceState serviceState) {
            ...
            if (FeatureOption.MTK_GEMINI_SUPPORT != true) {
                ...
                inAirplaneMode = Settings.System.getInt(mContext.getContentResolver(), Settings.System.AIRPLANE_MODE_ON, 0) != 0;
           }
