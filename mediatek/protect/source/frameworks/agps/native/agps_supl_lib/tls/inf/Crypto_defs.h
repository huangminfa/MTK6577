...
#define CRYPTO_MHASH_SHA256 17

typedef void* (*crypto_malloc_cb)(kal_uint32 size);
typedef void (*crypto_mfree_cb)(void*);

typedef struct {
    crypto_malloc_cb malloc_cb;
    crypto_mfree_cb mfree_cb;
} crypto_cb_data_struct;
