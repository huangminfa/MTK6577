...
public interface GoogleOtaBinder extends android.os.IInterface {
    public static abstract class Stub extends android.os.Binder implements
        ...
        public static GoogleOtaBinder asInterface(android.os.IBinder obj) {
            if ((obj == null)) {
                return null;
            }
            android.os.IInterface iin = (android.os.IInterface) obj
                    .queryLocalInterface(DESCRIPTOR);
            if (((iin != null) && (iin instanceof GoogleOtaBinder))) {
                return ((GoogleOtaBinder) iin);
            }
            return new GoogleOtaBinder.Stub.Proxy(obj);
        }
        ...
        private static class Proxy implements GoogleOtaBinder {
