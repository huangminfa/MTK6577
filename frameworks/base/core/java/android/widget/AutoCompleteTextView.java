    ...
    private void performCompletion(View selectedView, int position, long id) {
        if (isPopupShowing()) {
            ...
            if (mItemClickListener != null) {
                ...
                Xlog.d(TAG, "onItemClick: position = " + position + ",id = " + id + ",mPopup = "
                        + mPopup + ",selectedView = " + selectedView + ",this = " + this);
                // We only need to get the selectedView when position is bigger than 0.
                if (selectedView == null) {
                    if (position < 0) {
                        selectedView = list.getSelectedView();
                        position = list.getSelectedItemPosition();
                        id = list.getSelectedItemId();
                        Xlog.d(TAG, "List selectedView is null, change position to " + position
                                + ",this = " + this);
                    } else {
                        selectedView = list.getSelectedView();
                    }
                    ...
                    position = list.getSelectedItemPosition();
                    id = list.getSelectedItemId();
                    Xlog.d(TAG, "Change position to " + position + ",this = " + this);
                }
