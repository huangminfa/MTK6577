        ...
        if (mInvalidGesture) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN: {
                ...
                if (index0 < 0 || index0 == index1) {
                    ...
                    Xlog.i(TAG, "Touch ACTION_POINTER_DOWN: event = " + event + ",index1 = "
                            + index1 + ",index0 = " + index0 + ",mActiveId1 = " + mActiveId1
                            + ",mActiveId0 =  " + mActiveId0 + ",event count = "
                            + event.getPointerCount() + ",this = " + this);
                    if (index0 >= 0) {
                ...
                if (mSloppyGesture) {
                    ...
                    if (pointerCount > 2) {
                        ...
                        if (index < 0) {
                            ...
                            Log.e(TAG, "Invalid MotionEvent stream detected: mActiveId1 = "
                                    + mActiveId1 + ",mActiveId0 = " + mActiveId0 + ",index = "
                                    + index + ",this = " + this, new Throwable());
            ...
            switch (action) {
                case MotionEvent.ACTION_POINTER_DOWN: {
                    ...
                    if (index0 < 0 || mActiveId0 == mActiveId1) {
                        ...
                        Xlog.i(TAG, "Touch ACTION_POINTER_DOWN when long press: event = " + event
                                + ",index0 = " + index0 + ",mActiveId1 = " + mActiveId1
                                + ",mActiveId0 =  " + mActiveId0 + ",event count = "
                                + event.getPointerCount() + ",this = " + this);
                        if (index0 >= 0) {
                            mActiveId0 = event.getPointerId(index0);
