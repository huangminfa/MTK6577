...
LOCAL_SRC_FILES := sensors_hwmsen.c  custom/hwmsen_custom.c
LOCAL_C_INCLUDES+= \
        $(MTK_PATH_SOURCE)/hardware/sensor/hwmsen/custom/


ifeq ($(MTK_PLATFORM), MT6516)
LOCAL_MODULE := sensors.mt6516
endif
ifeq ($(MTK_PLATFORM), MT6575)
LOCAL_MODULE := sensors.mt6575
endif
ifeq ($(MTK_PLATFORM), MT6573)
LOCAL_MODULE := sensors.mt6573
endif
ifeq ($(MTK_PLATFORM), MT6575T)
LOCAL_MODULE := sensors.mt6575
endif
ifeq ($(MTK_PLATFORM), MT6577)
LOCAL_MODULE := sensors.mt6577
endif
