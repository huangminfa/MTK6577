...
public class LatinIME extends InputMethodServiceCompatWrapper implements KeyboardActionListener,
    ...
    private void showSubtypeSelectorAndSettings() {
        ...
        final AlertDialog dialog = getSubtypeSelectorAndSettingsDialog(items, title, listener);
        showOptionDialogInternal(dialog);
    }
    ...
    private AlertDialog getSubtypeSelectorAndSettingsDialog(CharSequence[] items, CharSequence title,
            DialogInterface.OnClickListener listener) {
        final AlertDialog dialog = new AlertDialog.Builder(this)
                .setItems(items, listener)
                .setTitle(title).create();

        dialog.setOnWindowFocusChangeListener(new AlertDialog.OnWindowFocusChangeListener() {
            @Override
