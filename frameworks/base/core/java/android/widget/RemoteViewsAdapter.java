...
public class RemoteViewsAdapter extends BaseAdapter implements Handler.Callback {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        synchronized (mCache) {
            ...
            if (DBG) {
                Xlog.d(TAG, "getView: position = " + position + ",convertView = " + convertView
                        + ",parent = " + parent + ",isInCache = " + isInCache + ",isConnected = "
                        + isConnected + ",mCache = " + mCache + ",item count = " + getCount());
            }
